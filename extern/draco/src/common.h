...
/**
 * Library for the Draco encoding/decoding feature inside the glTF-3IXAM-IO project.
 *
 * The python script within glTF-3IXAM-IO uses the CTypes library to open the DLL,
