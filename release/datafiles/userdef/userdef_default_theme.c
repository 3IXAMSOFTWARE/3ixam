...
/**
 * Generated by 'source/tools/utils/ixam_theme_as_c.py'
 *
...
const bTheme U_theme_default = {
  ...
  .tui = {
    .wcol_regular = {
      .outline = RGBA(0x00A9F3D0),
      .inner = RGBA(0x181E24FF),
      .inner_sel = RGBA(0x1E3546FF),
      .item = RGBA(0x00A9F3D0),
      .text = RGBA(0xe6e6e6ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = 0.0f,
    },
    .wcol_tool = {
      .outline = RGBA(0x00A9F300),
      .inner = RGBA(0x1E7A4680),
      .inner_sel = RGBA(0x1E7A46FF),
      .item = RGBA(0xBFBEBEFF),
      .text = RGBA(0xe6e6e6ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = 0.0f,
    },
    ...
    .wcol_toolbar_item_pro = {
      .outline = RGBA(0x369D8A80),
      .inner = RGBA(0x181E24D0),
      .inner_sel = RGBA(0x181E24FF),
      .item = RGBA(0x00A9F3D0),
      .text = RGBA(0xe6e6e6ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = 0.0f,
    ...
    .wcol_radio = {
      ...
      .inner = RGBA(0x181E24ff),
      .inner_sel = RGBA(0x181E24ff),
      .item = RGBA(0x181E24ff),
      .text = RGBA(0xe6e6e6ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = 0.f,
    },
    .wcol_option = {
      .outline = RGBA(0x11221100),
      .inner = RGBA(0x3B9CDE80),
      .inner_sel = RGBA(0x3B9CDEFF),
      .item = RGBA(0x00A9F3D0),
      .text = RGBA(0xe6e6e6ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = .2f,
    ...
    .wcol_menu = {
      .outline = RGBA(0x00A9F3D0),
      .inner = RGBA(0x181E24A0),
      .inner_sel = RGBA(0x295E85FF),
      .item = RGBA(0x00A9F3D0),
      .text = RGBA(0xe6e6e6ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = 0.f,
    ...
    .wcol_menu_item = {
      .outline = RGBA(0x00A9F3D0),
      .inner = RGBA(0x181E2400),
      .inner_sel = RGBA(0x00A9F300),
      .item = RGBA(0x00A9F3D0),
    ...
    .wcol_progress = {
      .outline = RGBA(0x059648ff),
      .inner = RGBA(0x181F29D0),
      .inner_sel = RGBA(0x1E7A46ff),
      .item = RGBA(0x1E7A46ff),
      .text = RGBA(0xe6e6e6ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = 0.0f,
    },
    ...
    .wcol_animbar = {
      .outline = RGBA(0x112211ff),
      .inner = RGBA(0x248B78ff),
      .inner_sel = RGBA(0x0A6050ff),
      .item = RGBA(0x112211ff),
    ...
    .wcol_prefs_regular = {
      .outline = RGBA(0x00A9F300),
      .inner = RGBA(0x295E85FF),
      .inner_sel = RGBA(0x3B9CDEFF),
      .item = RGBA(0x00A9F3FF),
      .text = RGBA(0xd9d9d9ff),
      .text_sel = RGBA(0xffffffff),
      .roundness = 0.2f,
    },
    ...
    .text_color = RGBA(0xd9d9d9ff),
    .line_color = RGBA(0x00A9F3FF),
  },
  .space_properties = {
    .back = RGBA(0x181E24FF),
    ...
    .tab_back = RGBA(0x181E24FF),
    .tab_outline = RGBA(0x3d3d3dff),
    .button = RGBA(0x181E24FF),
    ...
    .panelcolors = {
      .header = RGBA(0x181E24FF),
      .back = RGBA(0x181E24FF),
      .sub_back = RGBA(0x0000001f),
    },
    .active = RGBA(0x00A9F3D0),
    .vertex_size = 3,
    .outline_width = 1,
    .facedot_size = 4,
    .match = RGBA(0x00A9F3D0),
  },
  .space_view3d = {
    .back = RGBA(0x181E2400),
    .back_grad = RGBA(0x181E2400),
    .background_type = 2,
    .title = RGBA(0xeeeeeeff),
    .text = RGBA(0xe6e6e6ff),
    .text_hi = RGBA(0xffffffff),
    .header = RGBA(0x181E2400), 
    .header_text = RGBA(0xeeeeeeff),
    .header_text_hi = RGBA(0xffffffff),
    ...
    .button = RGBA(0x181E2400),
    .button_title = RGBA(0xffffffff),
    .button_text = RGBA(0xccccccff),
    .button_text_hi = RGBA(0xffffffff),
    .navigation_bar = RGBA(0x1d1d1d00),
    .execution_buts = RGBA(0x181E24ff),
    .panelcolors = {
      .header = RGBA(0x181E2400),
      .back = RGBA(0x181E2400),
      .sub_back = RGBA(0x00000000),
    },
    .grid = RGBA(0x5d5e5e80),
    .wire = RGBA(0x000000ff),
    .wire_edit = RGBA(0x000000ff),
    .select = RGBA(0x3B9CDEFF),
    .lamp = RGBA(0x00000050),
    .speaker = RGBA(0x000000ff),
    .empty = RGBA(0x000000ff),
    .camera = RGBA(0x000000ff),
    .active = RGBA(0x3B9CDEFF),
    ...
    .face_back = RGBA(0xff7300a2),
    .face_front = RGBA(0x2d89e500),
  ...
  .space_file = {
    ...
    .header_text = RGBA(0xeeeeeeff),
    .header_text_hi = RGBA(0xffffffff),
    .tab_active = RGBA(0x181E24FF),
    .tab_inactive = RGBA(0x181E24FF),
    .tab_back = RGBA(0x181E24FF),
    .tab_outline = RGBA(0x3d3d3dff),
    .button = RGBA(0x181E24FF),
    .button_title = RGBA(0xffffffff),
  ...
  .space_graph = {
    .back = RGBA(0x131c2b00),
    .title = RGBA(0xffffffff),
    .text = RGBA(0xa6a6a6ff),
    .text_hi = RGBA(0xffffffff),
    .header = RGBA(0x131c2b00),
    .header_text = RGBA(0xeeeeeeff),
    .header_text_hi = RGBA(0xffffffff),
    .tab_active = RGBA(0x303030ff),
    .tab_inactive = RGBA(0x1d1d1dff),
    ...
    .tab_outline = RGBA(0x3d3d3dff),
    .button = RGBA(0x131c2b00),
    .button_title = RGBA(0xffffffff),
    .button_text = RGBA(0xccccccff),
    .button_text_hi = RGBA(0xffffffff),
    .list = RGBA(0x131c2b00),
    ...
    .cframe = RGBA(0x00A9F3D0),
    .time_scrub_background = RGBA(0x131c2b00),
    ...
    .syntaxb = RGBA(0xff7a00ff),
    .syntaxc = RGBA(0x197adcff),
    .syntaxd = RGBA(0x19af96ff),
    .syntaxl = RGBA(0x96c832ff),
  },
  .space_info = {
  ...
  .space_action = {
    ...
    .button_text = RGBA(0xccccccff),
    .button_text_hi = RGBA(0xffffffff),
    .list = RGBA(0x131c2bff),
    .list_title = RGBA(0xffffffff),
    .list_text = RGBA(0xb8b8b8ff),
    .list_text_hi = RGBA(0xffaf23ff),
    .navigation_bar = RGBA(0x131c2b00),
    .execution_buts = RGBA(0x303030ff),
    .panelcolors = {
      .header = RGBA(0x3d3d3dff),
      .back = RGBA(0x3d3d3dff),
    ...
    .shade2 = RGBA(0x216d5b67),
    .hilite = RGBA(0x216d5b67),
    .grid = RGBA(0x161616ff),
    .group = RGBA(0x216d5b67),
    .group_active = RGBA(0x216d5bff),
  ...
  .space_image = {
    ...
    .button_text = RGBA(0xccccccff),
    .button_text_hi = RGBA(0xffffffff),
    .navigation_bar = RGBA(0x181E24ff),
    .execution_buts = RGBA(0x303030ff),
    .panelcolors = {
      .header = RGBA(0x181E24ff),
      .back = RGBA(0x181E24ff),
    ...
    .grid = RGBA(0x181E24FF),
    .wire_edit = RGBA(0x181E24FF),
    .vertex_select = RGBA(0xff8500ff),
  ...
  .space_node = {
    ...
    .panelcolors = {
      .header = RGBA(0x181E24ff),
      .back = RGBA(0x181E24ff),
      .sub_back = RGBA(0x181E24ff),
    },
    .shade2 = RGBA(0x7f7f7f64),
    .grid = RGBA(0x00628300),
    .wire = RGBA(0x00A9F3ff),
    .select = RGBA(0x00A9F3ff),
    .active = RGBA(0x00A9F3ff),
    ...
    .nodeclass_output = RGBA(0x05002Aff),
    .nodeclass_filter = RGBA(0x868588ff),
    .nodeclass_vector = RGBA(0x026CC0ff),
    .nodeclass_texture = RGBA(0xC9E6ACff),
    .nodeclass_shader = RGBA(0xB56A6Fff),
    .nodeclass_script = RGBA(0x084D3Eff),
    .nodeclass_pattern = RGBA(0xC8C5CAff),
    .nodeclass_layout = RGBA(0x424142ff),
    .nodeclass_geometry = RGBA(0x00D65Cff),
    .nodeclass_attribute = RGBA(0x6D5A69ff),
  ...
  .space_preferences = {
    .back = RGBA(0x171f2cff),
    .title = RGBA(0xeeeeeeff),
    .text = RGBA(0xe6e6e6ff),
    .text_hi = RGBA(0xffffffff),
    .header = RGBA(0x171f2cff),
    .header_text = RGBA(0xeeeeeeff),
    .header_text_hi = RGBA(0xffffffff),
    .tab_active = RGBA(0x171f2cff),
    .tab_inactive = RGBA(0x171f2cff),
    .tab_back = RGBA(0x171f2cff),
    .tab_outline = RGBA(0x098EAFF),
    .button = RGBA(0x1d1d1dff),
    .button_title = RGBA(0xffffffff),
    .button_text = RGBA(0xccccccff),
    .button_text_hi = RGBA(0xffffffff),
    .navigation_bar = RGBA(0x171f2cff),
    .execution_buts = RGBA(0x171f2cff),
    .panelcolors = {
      .header = RGBA(0x171f2cff),
      .back = RGBA(0x171f2cff),
      .sub_back = RGBA(0x171f2cff),
    },
    .vertex_size = 3,
    .outline_width = 1,
    .facedot_size = 4,
  ...
  .space_render = {
    .back = RGBA(0x11191DFF),
    .back_grad = RGBA(0x11191DFF),
    .background_type = 2,
    .title = RGBA(0xeeeeeeff),
    .text = RGBA(0xe6e6e6ff),
    .text_hi = RGBA(0xffffffff),
  ...
  .space_matlib = {
    ...
    .face = RGBA(0xffffff02),
    .face_select = RGBA(0xffa5522e),
    .face_back = RGBA(0xff9200b3),
    .face_front = RGBA(0x009effb3),
    .face_dot = RGBA(0xff8a00ff),
    .extra_edge_len = RGBA(0x150806ff),
    .extra_edge_angle = RGBA(0x4d4d00ff),
    .extra_face_angle = RGBA(0x0000ccff),
