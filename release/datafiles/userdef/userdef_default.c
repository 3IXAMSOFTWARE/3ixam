...
const UserDef U_default = {
    .versionfile = IXAM_FILE_VERSION,
    .subversionfile = IXAM_FILE_SUBVERSION,
    ...
    .uiflag = (USER_FILTERFILEEXTS | USER_DRAWVIEWINFO | USER_PLAINMENUS |
               ...
               USER_CONTINUOUS_MOUSE | USER_SAVE_PROMPT | USER_PLAY_INTRO),
    ...
    /** Initialized by #BKE_ixamfile_userdef_from_defaults. */
    .addons = {NULL},
    ...
    .smooth_viewtx = 200,
    .glreslimit = 0,
    .color_picker_type = USER_CP_SQUARE_SV,
    .hand_type = USER_HAND_RIGHT,
    ...
    .space_data =
        {
            .section_active = USER_SECTION_SCENE_PREFERENCES,
        },
