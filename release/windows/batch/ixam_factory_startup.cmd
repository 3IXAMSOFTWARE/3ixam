@echo off
echo Starting ixam with factory settings, log files will be created
...
set PYTHONPATH=
"%~dp0\ixam" --factory-startup --python-expr "import bpy; bpy.ops.wm.sysinfo(filepath=r'%temp%\ixam\debug_logs\ixam_system_info.txt')" > "%temp%\ixam\debug_logs\ixam_debug_output.txt" 2>&1
