...
def _template_items_context_menu(menu, key_args_primary):
    return [
        ...
        for kmi_args in (key_args_primary,)
    ]
    ...
    if toolbar_key is not None:
        items.append(
            ("wm.context_toggle", toolbar_key,
             {"properties": [("data_path", 'space_data.show_regions_pro_menu_and_toolbar')]})
        )
...
def _template_items_select_actions(params, operator):
    if not params.use_select_all_toggle:
        return [
            (operator, {"type": 'A', "value": 'PRESS', "ctrl": True}, {"properties": [("action", 'SELECT')]}),
            (operator, {"type": 'D', "value": 'PRESS', "ctrl": True, "extra_tip": "Deselection"}, {"properties": [("action", 'DESELECT')]}),
            (operator, {"type": 'I', "value": 'PRESS', "ctrl": True, "extra_tip": "Invert"}, {"properties": [("action", 'INVERT')]}),
            (operator, {"type": 'A', "value": 'DOUBLE_CLICK', "only_debug": True}, {"properties": [("action", 'DESELECT')]}),
        ]
    elif params.legacy:
        ...
        return [
            (operator, {"type": 'A', "value": 'PRESS', "ctrl": True, "extra_tip": "Toggle"}, {"properties": [("action", 'TOGGLE')]}),
            (operator, {"type": 'D', "value": 'PRESS', "ctrl": True, "extra_tip": "Deselection"}, {"properties": [("action", 'DESELECT')]}),
            (operator, {"type": 'I', "value": 'PRESS', "ctrl": True, "extra_tip": "Invert"}, {"properties": [("action", 'INVERT')]}),
        ]
...
def _template_items_hide_reveal_actions(op_hide, op_reveal):
    return [
        (op_reveal, {"type": 'H', "value": 'PRESS', "shift": True}, None),
        (op_hide, {"type": 'H', "value": 'PRESS'}, {"properties": [("unselected", False)]}),
        (op_hide, {"type": 'H', "value": 'PRESS', "shift": True, "extra_tip": "Unselected", "only_debug": True}, {"properties": [("unselected", True)]}),
    ]
...
def _template_items_object_subdivision_set():
    return [
        ("object.subdivision_set",
         {"type": NUMBERS_0[i], "value": 'PRESS', "ctrl": True, "extra_tip": "Level: %d" % i},
...
def _template_items_editmode_mesh_select_mode(params):
    if params.legacy:
        ...
        return [
            (
                "mesh.select_mode",
                {"type": NUMBERS_1[i], "value": 'PRESS', **key_expand, **key_extend, "extra_tip": f"%s %s %s" % (e.title(), "Extend" if prop_extend else "", "Expand" if prop_expand else "")},
...
def _template_items_uv_select_mode(params):
    if params.legacy:
        ...
        return [
            ...
            *(("uv.select_mode", {"type": NUMBERS_1[i], "value": 'PRESS', "extra_tip": "%s" % e.title()},
               {"properties": [("type", e)]})
...
def _template_items_proportional_editing(params, *, connected, toggle_data_path):
    return [
        ...
        *(() if not connected else (
            ("wm.context_toggle", {"type": 'O', "value": 'PRESS', "alt": True, "extra_tip": "Proportional"},
...
def _template_items_tool_select_actions(operator, *, type, value):
    ...
    return [
        ...
        (operator, {**kmi_args, "shift": True, "extra_tip": "Add"},
         {"properties": [("mode", 'ADD')]}),
        (operator, {**kmi_args, "ctrl": True, "extra_tip": "Subtract"},
         {"properties": [("mode", 'SUB')]}),
        (operator, {**kmi_args, "shift": True, "ctrl": True, "extra_tip": "And"},
         {"properties": [("mode", 'AND')]}),
    ]
...
def _template_items_tool_select_actions_simple(operator, *, type, value, properties=()):
    ...
    return [
        ...
        (operator, {**kmi_args | {"extra_tip": "Add"}, "shift": True},
         {"properties": [*properties, ("mode", 'ADD')]}),
        (operator, {**kmi_args | {"extra_tip": "Subtract"}, "ctrl": True},
...
def km_window(params):
    ...
    items.extend([
        ...
        ("wm.quit_ixam", {"type": 'Q', "value": 'PRESS', "ctrl": True}, None),


        # Fast editor switching
        *(
            ("screen.space_type_set_or_cycle",
             {"type": k, "value": 'PRESS', "shift": True, "only_debug": True},
        ...
        # NDOF settings
        op_panel("USERPREF_PT_ndof_settings", {"type": 'NDOF_BUTTON_MENU', "value": 'PRESS', "only_debug": True}),
        ("wm.context_scale_float", {"type": 'NDOF_BUTTON_PLUS', "value": 'PRESS', "only_debug": True},
         {"properties": [("data_path", 'preferences.inputs.ndof_sensitivity'), ("value", 1.1)]}),
        ("wm.context_scale_float", {"type": 'NDOF_BUTTON_MINUS', "value": 'PRESS', "only_debug": True},
         {"properties": [("data_path", 'preferences.inputs.ndof_sensitivity'), ("value", 1.0 / 1.1)]}),
        ("wm.context_scale_float", {"type": 'NDOF_BUTTON_PLUS', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("data_path", 'preferences.inputs.ndof_sensitivity'), ("value", 1.5)]}),
        ("wm.context_scale_float", {"type": 'NDOF_BUTTON_MINUS', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("data_path", 'preferences.inputs.ndof_sensitivity'), ("value", 2.0 / 3.0)]}),
        ("info.reports_display_update", {"type": 'TIMER_REPORT', "value": 'ANY', "any": True, "only_debug": True}, None),
    ])
...
def km_screen(params):
    ...
    items.extend([
        ...
        ("screen.space_context_cycle", {"type": 'TAB', "value": 'PRESS', "ctrl": True, "extra_tip": "Next", "only_debug": True},
         {"properties": [("direction", 'NEXT')]}),
        ("screen.space_context_cycle", {"type": 'TAB', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Previous", "only_debug": True},
         {"properties": [("direction", 'PREV')]}),
        ("screen.workspace_cycle", {"type": 'PAGE_DOWN', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("direction", 'NEXT')]}),
        ("screen.workspace_cycle", {"type": 'PAGE_UP', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("direction", 'PREV')]}),
        # Quad view
        ("screen.region_quadview", {"type": 'Q', "value": 'PRESS', "ctrl": True, "alt": True, "only_debug": True}, None),
        # Repeat last
        ("screen.repeat_last", {"type": 'R', "value": 'PRESS', "shift": True, "repeat": True}, None),
        # Files
        ("file.execute", {"type": 'RET', "value": 'PRESS'}, None),
        ("file.execute", {"type": 'NUMPAD_ENTER', "value": 'PRESS', "only_debug": True}, None),
        ...
        ("render.render", {"type": 'F12', "value": 'PRESS', "ctrl": True, "extra_tip": "Animation"},
    ...
    if not params.legacy:
        items.extend([
            ...
            ("screen.screen_full_area", {"type": 'SPACE', "value": 'PRESS', "ctrl": True, "alt": True, "extra_tip": "& Hide Panels"},
...
def km_screen_editing(params):
    ...
    keymap = ("Screen Editing",
              {"space_type": 'EMPTY', "region_type": 'WINDOW', "only_debug": False},
              {"items": items})
...
def km_view2d(_params):
    ...
    items.extend([
        ...
        ("view2d.scroller_activate", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "only_debug": True}, None),
        # Pan/scroll
        ("view2d.pan", {"type": 'MIDDLEMOUSE', "value": 'PRESS'}, None),
        ("view2d.pan", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True, "only_debug": True}, None),
        ("view2d.pan", {"type": 'TRACKPADPAN', "value": 'ANY' , "extra_tip": "Alt"}, None),
        ...
        ("view2d.ndof", {"type": 'NDOF_MOTION', "value": 'ANY', "only_debug": True}, None),
        ...
        ("view2d.zoom_out", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "repeat": True, "only_debug": True}, None),
        ("view2d.zoom_in", {"type": 'NUMPAD_PLUS', "value": 'PRESS', "repeat": True, "only_debug": True}, None),
        ...
        ("view2d.scroll_down", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS', "extra_tip": "No Zoom"}, None),
        ("view2d.scroll_up", {"type": 'WHEELUPMOUSE', "value": 'PRESS', "extra_tip": "No Zoom"}, None),
        ("view2d.scroll_right", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS', "extra_tip": "No Zoom"}, None),
        ("view2d.scroll_left", {"type": 'WHEELUPMOUSE', "value": 'PRESS', "extra_tip": "No Zoom"}, None),
        # Zoom with drag and border
        ("view2d.zoom", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "ctrl": True}, None),
        ("view2d.zoom", {"type": 'TRACKPADZOOM', "value": 'ANY', "extra_tip": "Alt"}, None),
...
def km_view2d_buttons_list(_params):
    ...
    items.extend([
        ...
        ("view2d.scroll_down", {"type": 'PAGE_DOWN', "value": 'PRESS', "repeat": True, "extra_tip": "Page"},
         {"properties": [("page", True)]}),
        ("view2d.scroll_up", {"type": 'PAGE_UP', "value": 'PRESS', "repeat": True, "extra_tip": "Page"},
         {"properties": [("page", True)]}),
        # Zoom
        ("view2d.zoom", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "ctrl": True}, None),
        ("view2d.zoom", {"type": 'TRACKPADZOOM', "value": 'ANY', "extra_tip": "Alt"}, None),
        ("view2d.zoom", {"type": 'TRACKPADPAN', "value": 'ANY', "ctrl": True, "only_debug": True}, None),
        ("view2d.zoom_out", {"type": 'MINUS', "value": 'PRESS', "repeat": True}, None),
        ("view2d.zoom_in", {"type": 'PLUS', "value": 'PRESS', "repeat": True}, None),
...
def km_user_interface(_params):
    ...
    items.extend([
        ...
        ("ui.copy_data_path_button", {"type": 'C', "value": 'PRESS', "shift": True, "ctrl": True, "alt": True, "extra_tip": "Full"},
...
def km_mask_editing(params):
    ...
    keymap = (
        "Mask Editing",
        {"space_type": 'EMPTY', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_property_editor(_params):
    ...
    keymap = (
        "Property Editor",
        {"space_type": 'PROPERTIES', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_outliner(params):
    ...
    keymap = (
        "Outliner",
        {"space_type": 'OUTLINER', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_uv_editor(params):
    ...
    items.extend([
        ...
        *_template_uv_select(
        ...
        ("uv.select_loop",
         {"type": params.select_mouse, "value": params.select_mouse_value, "shift": True, "alt": True, "extra_tip": "Extend"},
         {"properties": [("extend", True)]}),
        ("uv.select_edge_ring",
         {"type": params.select_mouse, "value": params.select_mouse_value, "ctrl": True, "alt": True}, None),
        ("uv.select_edge_ring",
         {"type": params.select_mouse, "value": params.select_mouse_value, "ctrl": True, "shift": True, "alt": True, "extra_tip": "Extend"},
         {"properties": [("extend", True)]}),
        ("uv.shortest_path_pick",
         {"type": params.select_mouse, "value": params.select_mouse_value_fallback, "ctrl": True},
         {"properties": [("use_fill", False)]}),
        ("uv.shortest_path_pick",
         {"type": params.select_mouse, "value": params.select_mouse_value_fallback, "ctrl": True, "shift": True, "extra_tip": "Fill"},
        ...
        ("uv.select_box", {"type": 'B', "value": 'PRESS', "ctrl": True, "extra_tip": "Pinned"},
         {"properties": [("pinned", True)]}),
        op_tool_optional(
            ("uv.select_circle", {"type": 'C', "value": 'PRESS'}, None),
            (op_tool, "builtin.select_circle"), params),
        ("uv.select_lasso", {"type": params.action_mouse, "value": 'CLICK_DRAG', "ctrl": True, "extra_tip": "Add"},
         {"properties": [("mode", 'ADD')]}),
        ("uv.select_lasso", {"type": params.action_mouse, "value": 'CLICK_DRAG', "shift": True, "ctrl": True, "extra_tip": "Subtract"},
         {"properties": [("mode", 'SUB')]}),
        ("uv.select_linked", {"type": 'L', "value": 'PRESS', "ctrl": True}, None),
        ("uv.select_linked_pick", {"type": 'L', "value": 'PRESS', "extra_tip": "Extend"},
         {"properties": [("extend", True), ("deselect", False)]}),
        ("uv.select_linked_pick", {"type": 'L', "value": 'PRESS', "shift": True},
         {"properties": [("deselect", True)]}),
        ("uv.select_more", {"type": 'PLUS', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
        ...
        *_template_items_hide_reveal_actions("uv.hide", "uv.reveal"),
        ...
        ("uv.pin", {"type": 'P', "value": 'PRESS', "alt": True, "extra_tip": "Clear"},
        ...
        *_template_items_proportional_editing(
        ...
        ("transform.translate", {"type": params.select_mouse, "value": 'CLICK_DRAG', "extra_tip": "Alt"}, None),
        op_tool_optional(
            ("transform.translate", {"type": 'G', "value": 'PRESS'}, None),
        ...
        ("wm.context_toggle", {"type": 'ACCENT_GRAVE', "value": 'PRESS', "ctrl": True, "extra_tip": "Gizmo"},
    ...
    if params.cursor_tweak_event:
        items.extend([
            ("uv.cursor_set", params.cursor_set_event, None),
            ("transform.translate", {**params.cursor_tweak_event, "extra_tip": "Release"},
             {"properties": [("release_confirm", True), ("cursor_transform", True)]}),
        ])
    else:
        items.extend([
...
def km_view3d_generic(_params):
    ...
    items.extend([
        *_template_space_region_type_toggle(
            toolbar_key={"type": 'B', "value": 'PRESS'}
        )
    ])
...
def km_view3d(params):
    ...
    items.extend([
        # Visibility.
        ("view3d.localview", {"type": 'NUMPAD_SLASH', "value": 'PRESS', "only_debug": True}, None),
        ("view3d.localview", {"type": 'SLASH', "value": 'PRESS'}, None),
        ("view3d.localview", {"type": 'MOUSESMARTZOOM', "value": 'ANY', "extra_tip": "Alt"}, None),
        ("view3d.localview_remove_from", {"type": 'NUMPAD_SLASH', "value": 'PRESS', "alt": True, "only_debug": True}, None),
        ("view3d.localview_remove_from", {"type": 'SLASH', "value": 'PRESS', "alt": True}, None),
        # Navigation.
        ("view3d.rotate", {"type": 'MOUSEROTATE', "value": 'ANY', "only_debug": True}, None),
        *((
            ("view3d.rotate", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True}, None),
            ("view3d.move", {"type": 'MIDDLEMOUSE', "value": 'PRESS'}, None),
            ("view3d.rotate", {"type": 'TRACKPADPAN', "value": 'ANY', "shift": True, "extra_tip": "Alt"}, None),
            ("view3d.move", {"type": 'TRACKPADPAN', "value": 'ANY', "extra_tip": "Alt"}, None),
            ...
            ("view3d.rotate", {"type": 'TRACKPADPAN', "value": 'ANY', "extra_tip": "Alt"}, None),
            ("view3d.move", {"type": 'TRACKPADPAN', "value": 'ANY', "shift": True, "extra_tip": "Alt"}, None),
        )),
        ...
        ("view3d.view_selected", {"type": 'PERIOD', "value": 'PRESS', "ctrl": True, "extra_tip": "Regions"},
         {"properties": [("use_all_regions", True)]}),
        ("view3d.view_selected", {"type": 'PERIOD', "value": 'PRESS'},
         {"properties": [("use_all_regions", False)]}),
        ("view3d.smoothview", {"type": 'TIMER1', "value": 'ANY', "any": True}, None),
        ("view3d.zoom", {"type": 'TRACKPADZOOM', "value": 'ANY', "extra_tip": "Alt"}, None),
        ("view3d.zoom", {"type": 'TRACKPADPAN', "value": 'ANY', "ctrl": True}, None),
        ("view3d.zoom", {"type": 'EQUAL', "value": 'PRESS', "repeat": True},
         {"properties": [("delta", 1)]}),
        ("view3d.zoom", {"type": 'MINUS', "value": 'PRESS', "repeat": True},
         {"properties": [("delta", -1)]}),
        ("view3d.zoom", {"type": 'EQUAL', "value": 'PRESS', "ctrl": True, "repeat": True, "extra_tip": "+", "only_debug": True},
         {"properties": [("delta", 1)]}),
        ("view3d.zoom", {"type": 'MINUS', "value": 'PRESS', "ctrl": True, "repeat": True, "extra_tip": "-", "only_debug": True},
         {"properties": [("delta", -1)]}),
        ("view3d.zoom", {"type": 'WHEELINMOUSE', "value": 'PRESS', "extra_tip": "+ Alt"},
         {"properties": [("delta", 1)]}),
        ("view3d.zoom", {"type": 'WHEELOUTMOUSE', "value": 'PRESS', "extra_tip": "- Alt"},
         {"properties": [("delta", -1)]}),
        ("view3d.dolly", {"type": 'NUMPAD_PLUS', "value": 'PRESS', "shift": True, "repeat": True, "only_debug": True},
         {"properties": [("delta", 1)]}),
        ("view3d.dolly", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "shift": True, "repeat": True, "only_debug": True},
         {"properties": [("delta", -1)]}),
        ("view3d.dolly", {"type": 'EQUAL', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "extra_tip": "+"},
         {"properties": [("delta", 1)]}),
        ("view3d.dolly", {"type": 'MINUS', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "extra_tip": "-"},
         {"properties": [("delta", -1)]}),
        ...
        ("view3d.view_all", {"type": 'HOME', "value": 'PRESS', "ctrl": True, "extra_tip": "Regions"},
         {"properties": [("use_all_regions", True), ("center", False)]}),
        ("view3d.view_all", {"type": 'C', "value": 'PRESS', "shift": True, "extra_tip": "Center"},
        ...
        *(() if not params.use_pie_click_drag else
        ...
        # Numpad views.
        ("view3d.view_camera", {"type": 'NUMPAD_0', "value": 'PRESS', "only_debug": True},
         {"properties": [("camera", None)]}),
        ("view3d.view_axis", {"type": 'NUMPAD_1', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'FRONT')]}),
        ("view3d.view_orbit", {"type": 'NUMPAD_2', "value": 'PRESS', "repeat": True, "only_debug": True},
         {"properties": [("type", 'ORBITDOWN')]}),
        ("view3d.view_axis", {"type": 'NUMPAD_3', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'RIGHT')]}),
        ("view3d.view_orbit", {"type": 'NUMPAD_4', "value": 'PRESS', "repeat": True, "only_debug": True},
         {"properties": [("type", 'ORBITLEFT')]}),
        ("view3d.view_persportho", {"type": 'NUMPAD_5', "value": 'PRESS', "only_debug": True}, None),
        ("view3d.view_orbit", {"type": 'NUMPAD_6', "value": 'PRESS', "repeat": True, "only_debug": True},
         {"properties": [("type", 'ORBITRIGHT')]}),
        ("view3d.view_axis", {"type": 'NUMPAD_7', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'TOP')]}),
        ("view3d.view_orbit", {"type": 'NUMPAD_8', "value": 'PRESS', "repeat": True, "only_debug": True},
         {"properties": [("type", 'ORBITUP')]}),
        ("view3d.view_axis", {"type": 'NUMPAD_1', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("type", 'BACK')]}),
        ("view3d.view_axis", {"type": 'NUMPAD_3', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("type", 'LEFT')]}),
        ("view3d.view_axis", {"type": 'NUMPAD_7', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("type", 'BOTTOM')]}),
        ("view3d.view_pan", {"type": 'NUMPAD_2', "value": 'PRESS', "ctrl": True, "repeat": True, "only_debug": True},
         {"properties": [("type", 'PANDOWN')]}),
        ("view3d.view_pan", {"type": 'NUMPAD_4', "value": 'PRESS', "ctrl": True, "repeat": True, "only_debug": True},
         {"properties": [("type", 'PANLEFT')]}),
        ("view3d.view_pan", {"type": 'NUMPAD_6', "value": 'PRESS', "ctrl": True, "repeat": True, "only_debug": True},
         {"properties": [("type", 'PANRIGHT')]}),
        ("view3d.view_pan", {"type": 'NUMPAD_8', "value": 'PRESS', "ctrl": True, "repeat": True, "only_debug": True},
         {"properties": [("type", 'PANUP')]}),
        ("view3d.view_roll", {"type": 'NUMPAD_4', "value": 'PRESS', "shift": True, "repeat": True, "only_debug": True},
         {"properties": [("type", 'LEFT')]}),
        ("view3d.view_roll", {"type": 'NUMPAD_6', "value": 'PRESS', "shift": True, "repeat": True, "only_debug": True},
         {"properties": [("type", 'RIGHT')]}),
        ("view3d.view_orbit", {"type": 'NUMPAD_9', "value": 'PRESS', "only_debug": True},
         {"properties": [("angle", pi), ("type", 'ORBITRIGHT')]}),
        ("view3d.view_axis", {"type": 'NUMPAD_1', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("type", 'FRONT'), ("align_active", True)]}),
        ("view3d.view_axis", {"type": 'NUMPAD_3', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("type", 'RIGHT'), ("align_active", True)]}),
        ("view3d.view_axis", {"type": 'NUMPAD_7', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("type", 'TOP'), ("align_active", True)]}),
        ("view3d.view_axis", {"type": 'NUMPAD_1', "value": 'PRESS', "shift": True, "ctrl": True, "only_debug": True},
         {"properties": [("type", 'BACK'), ("align_active", True)]}),
        ("view3d.view_axis", {"type": 'NUMPAD_3', "value": 'PRESS', "shift": True, "ctrl": True, "only_debug": True},
         {"properties": [("type", 'LEFT'), ("align_active", True)]}),
        ("view3d.view_axis", {"type": 'NUMPAD_7', "value": 'PRESS', "shift": True, "ctrl": True, "only_debug": True},
         {"properties": [("type", 'BOTTOM'), ("align_active", True)]}),
        *((
            ("view3d.view_axis", {"type": 'MIDDLEMOUSE', "value": 'CLICK_DRAG', "direction": 'NORTH', "alt": True, "extra_tip": "North"},
             {"properties": [("type", 'TOP'), ("relative", True)]}),
            ("view3d.view_axis", {"type": 'MIDDLEMOUSE', "value": 'CLICK_DRAG', "direction": 'SOUTH', "alt": True, "extra_tip": "South"},
             {"properties": [("type", 'BOTTOM'), ("relative", True)]}),
            ("view3d.view_axis", {"type": 'MIDDLEMOUSE', "value": 'CLICK_DRAG', "direction": 'EAST', "alt": True, "extra_tip": "East"},
             {"properties": [("type", 'RIGHT'), ("relative", True)]}),
            ("view3d.view_axis", {"type": 'MIDDLEMOUSE', "value": 'CLICK_DRAG', "direction": 'WEST', "alt": True, "extra_tip": "West"},
        ...
        ("view3d.ndof_orbit_zoom", {"type": 'NDOF_MOTION', "value": 'ANY', "only_debug": True}, None),
        ("view3d.ndof_orbit", {"type": 'NDOF_MOTION', "value": 'ANY', "ctrl": True, "only_debug": True}, None),
        ("view3d.ndof_pan", {"type": 'NDOF_MOTION', "value": 'ANY', "shift": True, "only_debug": True}, None),
        ("view3d.ndof_all", {"type": 'NDOF_MOTION', "value": 'ANY', "shift": True, "ctrl": True, "only_debug": True}, None),
        ("view3d.view_selected", {"type": 'NDOF_BUTTON_FIT', "value": 'PRESS', "only_debug": True},
         {"properties": [("use_all_regions", False)]}),
        ("view3d.view_roll", {"type": 'NDOF_BUTTON_ROLL_CW', "value": 'PRESS', "only_debug": True},
         {"properties": [("angle", pi_2)]}),
        ("view3d.view_roll", {"type": 'NDOF_BUTTON_ROLL_CCW', "value": 'PRESS', "only_debug": True},
         {"properties": [("angle", -pi_2)]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_FRONT', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'FRONT')]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_BACK', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'BACK')]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_LEFT', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'LEFT')]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_RIGHT', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'RIGHT')]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_TOP', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'TOP')]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_BOTTOM', "value": 'PRESS', "only_debug": True},
         {"properties": [("type", 'BOTTOM')]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_FRONT', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("type", 'FRONT'), ("align_active", True)]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_RIGHT', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("type", 'RIGHT'), ("align_active", True)]}),
        ("view3d.view_axis", {"type": 'NDOF_BUTTON_TOP', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("type", 'TOP'), ("align_active", True)]}),
        # Selection.
        *_template_view3d_select(
        ...
        op_tool_optional(
            ("view3d.select_box", {"type": 'B', "value": 'PRESS', "only_debug": True}, None),
            (op_tool, "builtin.select_box"), params),
        ("view3d.select_lasso", {"type": params.action_mouse, "value": 'CLICK_DRAG', "ctrl": True, "extra_tip": "Add"},
         {"properties": [("mode", 'ADD')]}),
        ("view3d.select_lasso", {"type": params.action_mouse, "value": 'CLICK_DRAG', "shift": True, "ctrl": True, "extra_tip": "Subtract"},
         {"properties": [("mode", 'SUB')]}),
        op_tool_optional(
        ...
        # Cameras.
        ("view3d.camera_to_view", {"type": 'NUMPAD_0', "value": 'PRESS', "ctrl": True, "alt": True, "only_debug": True}, None),
        ("view3d.object_as_camera", {"type": 'NUMPAD_0', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
        # Copy/paste.
...
def km_image_generic(params):
    ...
    keymap = (
        "Image Generic",
        {"space_type": 'IMAGE_EDITOR', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
    ...
    items.extend([
        *_template_space_region_type_toggle(
        ...
        ("image.cycle_render_slot", {"type": 'J', "value": 'PRESS', "alt": True, "repeat": True, "extra_tip": "Repeat"},
...
def km_image(params):
    ...
    items.extend([
        ...
        ("image.view_all", {"type": 'HOME', "value": 'PRESS', "shift": True, "extra_tip": "Fit"},
         {"properties": [("fit_view", True)]}),
        ("image.view_selected", {"type": 'PERIOD', "value": 'PRESS'}, None),
        ("image.view_cursor_center", {"type": 'C', "value": 'PRESS', "shift": True}, None),
        ("image.view_pan", {"type": 'MIDDLEMOUSE', "value": 'PRESS'}, None),
        ("image.view_pan", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True, "only_debug": True}, None),
        ("image.view_pan", {"type": 'TRACKPADPAN', "value": 'ANY', "extra_tip": "Alt"}, None),
        ("image.view_all", {"type": 'NDOF_BUTTON_FIT', "value": 'PRESS', "only_debug": True}, None),
        ("image.view_ndof", {"type": 'NDOF_MOTION', "value": 'ANY', "only_debug": True}, None),
        ("image.view_zoom_in", {"type": 'WHEELINMOUSE', "value": 'PRESS'}, None),
        ("image.view_zoom_out", {"type": 'WHEELOUTMOUSE', "value": 'PRESS'}, None),
        ("image.view_zoom_in", {"type": 'NUMPAD_PLUS', "value": 'PRESS', "repeat": True, "only_debug": True}, None),
        ("image.view_zoom_out", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "repeat": True, "only_debug": True}, None),
        ("image.view_zoom", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "ctrl": True}, None),
        ("image.view_zoom", {"type": 'TRACKPADZOOM', "value": 'ANY', "extra_tip": "Alt"}, None),
        ("image.view_zoom", {"type": 'TRACKPADPAN', "value": 'ANY', "ctrl": True, "only_debug": True}, None),
        ("image.view_zoom_border", {"type": 'B', "value": 'PRESS', "shift": True}, None),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_8', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("ratio", 8.0)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_4', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("ratio", 4.0)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_2', "value": 'PRESS', "ctrl": True, "only_debug": True},
         {"properties": [("ratio", 2.0)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_8', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("ratio", 8.0)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_4', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("ratio", 4.0)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_2', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("ratio", 2.0)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_1', "value": 'PRESS', "only_debug": True},
         {"properties": [("ratio", 1.0)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_2', "value": 'PRESS', "only_debug": True},
         {"properties": [("ratio", 0.5)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_4', "value": 'PRESS', "only_debug": True},
         {"properties": [("ratio", 0.25)]}),
        ("image.view_zoom_ratio", {"type": 'NUMPAD_8', "value": 'PRESS', "only_debug": True},
         {"properties": [("ratio", 0.125)]}),
        ("image.change_frame", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
        ("image.sample", {"type": params.action_mouse, "value": 'PRESS'}, None),
        ("image.curves_point_set", {"type": params.action_mouse, "value": 'PRESS', "ctrl": True, "extra_tip": "White"},
         {"properties": [("point", 'BLACK_POINT')]}),
        ("image.curves_point_set", {"type": params.action_mouse, "value": 'PRESS', "shift": True, "extra_tip": "Black"},
         {"properties": [("point", 'WHITE_POINT')]}),
        ("object.mode_set", {"type": 'TAB', "value": 'PRESS'},
         {"properties": [("mode", 'EDIT'), ("toggle", True)]}),
        *(
            (("wm.context_set_int",
              {"type": NUMBERS_1[i], "value": 'PRESS', "only_debug": True},
...
def km_node_generic(_params):
    ...
    keymap = (
        "Node Generic",
        {"space_type": 'NODE_EDITOR', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_matpro_generic(_params):
    items = []
    keymap = (
        "MatPro Generic",
        {"space_type": 'MATPRO', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_matpro_material_list(_params):
    items = []
    keymap = (
        "MatPro Material List",
        {"space_type": 'MATPRO', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )

    items.extend([
        # *_template_items_context_menu("MATPRO_MT_matlist_context_menu", _params.context_menu_event),
    ])
    return keymap
...
def km_node_editor(params):
    ...
    items.extend([
        ("node.select_box", {"type": params.select_mouse, "value": 'CLICK_DRAG'},
         {"properties": [("tweak", True)]}),
        ("node.select_lasso", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "alt": True, "extra_tip": "Add"},
         {"properties": [("mode", 'ADD')]}),
        ("node.select_lasso", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "shift": True, "ctrl": True, "alt": True, "extra_tip": "Subtract"},
         {"properties": [("mode", 'SUB')]}),
        op_tool_optional(
        ...
        ("node.link", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "extra_tip": "Detach"},
        ...
        ("node.backimage_zoom", {"type": 'V', "value": 'PRESS', "repeat": True, "extra_tip": "Precision"},
        ...
        ("node.link_make", {"type": 'F', "value": 'PRESS', "shift": True, "extra_tip": "Replace"},
        ...
        ("node.duplicate_move_linked", {"type": 'D', "value": 'PRESS', "alt": True},
         {"properties": [("NODE_OT_translate_attach", [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])])]}),
        ("node.duplicate_move_keep_inputs", {"type": 'D', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Keep Inputs"},
         {"properties": [("NODE_OT_translate_attach", [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])])]}),
        ...
        ("node.view_all", {"type": 'NDOF_BUTTON_FIT', "value": 'PRESS', "only_debug": True}, None),
        ("node.view_selected", {"type": 'PERIOD', "value": 'PRESS'}, None),
        op_menu_pie("NODE_MT_view_pie", {"type": 'ACCENT_GRAVE', "value": 'PRESS'}),
        ("node.delete", {"type": 'X', "value": 'PRESS', "only_debug": True}, None),
        ("node.delete", {"type": 'DEL', "value": 'PRESS'}, None),
        ("node.delete_reconnect", {"type": 'X', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
        ...
        *_template_items_select_actions(params, "node.select_all"),
        ...
        ("node.select_grouped", {"type": 'G', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Extend"},
         {"properties": [("extend", True)]}),
        ...
        ("node.group_edit", {"type": 'TAB', "value": 'PRESS', "ctrl": True, "extra_tip": "Exit"},
        ...
        ("node.translate_attach",
         {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "only_debug": True},
         {"properties": [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])]}),
        ...
        *([] if params.select_mouse == 'LEFTMOUSE' else (
        ...
        ("node.move_detach_links_release",
         {"type": params.action_mouse, "value": 'CLICK_DRAG', "alt": True, "extra_tip": "Release"},
         {"properties": [("NODE_OT_translate_attach", [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])])]}),
...
# Editor MatPro
def km_matpro_editor(params):
    items = []
    keymap = (
        "MatPro Editor",
        {"space_type": 'MATPRO', "region_type": 'WINDOW'},
        {"items": items},
    )
    if not params.legacy:
        items.extend(_template_matpro_select(type=params.select_mouse,
                     value=params.select_mouse_value, select_passthrough=True))
        # Allow node selection with both for RMB select.
        if params.select_mouse == 'RIGHTMOUSE':
            items.extend(_template_matpro_select(type='LEFTMOUSE', value='PRESS', select_passthrough=True))
    else:
        items.extend(_template_matpro_select(
            type='RIGHTMOUSE', value=params.select_mouse_value, select_passthrough=True))
        items.extend(_template_matpro_select(
            type='LEFTMOUSE', value='PRESS', select_passthrough=True))

    items.extend([
        ("matpro.select_box", {"type": params.select_mouse, "value": 'CLICK_DRAG'},
         {"properties": [("tweak", True)]}),
        ("matpro.select_lasso", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "alt": True, "extra_tip": "Add"},
         {"properties": [("mode", 'ADD')]}),
        ("matpro.select_lasso", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "shift": True, "ctrl": True, "alt": True, "extra_tip": "Subtract"},
         {"properties": [("mode", 'SUB')]}),
        op_tool_optional(
            ("matpro.select_box", {"type": 'B', "value": 'PRESS'},
             {"properties": [("tweak", False)]}),
            (op_tool, "builtin.select_box"), params),
        op_tool_optional(
            ("matpro.select_circle", {"type": 'C', "value": 'PRESS'}, None),
            (op_tool, "builtin.select_circle"), params),
        ("matpro.link", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG'},
         {"properties": [("detach", False)]}),
        ("matpro.link", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "extra_tip": "Detach"},
         {"properties": [("detach", True)]}),
        ("matpro.resize", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG'}, None),
        ("matpro.add_reroute",
         {"type": 'LEFTMOUSE' if params.legacy else 'RIGHTMOUSE', "value": 'CLICK_DRAG', "shift": True}, None),
        ("matpro.links_cut",
         {"type": 'LEFTMOUSE' if params.legacy else 'RIGHTMOUSE', "value": 'CLICK_DRAG', "ctrl": True}, None),
        ("matpro.links_mute", {"type": 'RIGHTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "alt": True}, None),
        ("matpro.select_link_viewer", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True}, None),
        ("matpro.backimage_move", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "alt": True}, None),
        ("matpro.backimage_zoom", {"type": 'V', "value": 'PRESS', "repeat": True, "extra_tip": "Precision"},
         {"properties": [("factor", 1.0 / 1.2)]}),
        ("matpro.backimage_zoom", {"type": 'V', "value": 'PRESS', "alt": True, "repeat": True},
         {"properties": [("factor", 1.2)]}),
        ("matpro.backimage_fit", {"type": 'HOME', "value": 'PRESS', "alt": True}, None),
        ("matpro.backimage_sample", {"type": params.action_mouse, "value": 'PRESS', "alt": True}, None),
        ("matpro.link_make", {"type": 'F', "value": 'PRESS'},
         {"properties": [("replace", False)]}),
        ("matpro.link_make", {"type": 'F', "value": 'PRESS', "shift": True, "extra_tip": "Replace"},
         {"properties": [("replace", True)]}),
        op_menu("NODE_MT_add", {"type": 'A', "value": 'PRESS', "shift": True}),
        ("matpro.duplicate_move", {"type": 'D', "value": 'PRESS', "shift": True},
         {"properties": [("MATPRO_OT_translate_attach", [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])])]}),
        ("matpro.duplicate_move_linked", {"type": 'D', "value": 'PRESS', "alt": True},
         {"properties": [("MATPRO_OT_translate_attach", [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])])]}),
        ("matpro.duplicate_move_keep_inputs", {"type": 'D', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Keep Inputs"},
         {"properties": [("MATPRO_OT_translate_attach", [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])])]}),
        ("matpro.parent_set", {"type": 'P', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.detach", {"type": 'P', "value": 'PRESS', "alt": True}, None),
        ("matpro.join", {"type": 'J', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.hide_toggle", {"type": 'H', "value": 'PRESS'}, None),
        ("matpro.mute_toggle", {"type": 'M', "value": 'PRESS'}, None),
        ("matpro.preview_toggle", {"type": 'H', "value": 'PRESS', "shift": True}, None),
        ("matpro.hide_socket_toggle", {"type": 'H', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.view_all", {"type": 'HOME', "value": 'PRESS'}, None),
        ("matpro.view_all", {"type": 'NDOF_BUTTON_FIT', "value": 'PRESS', "only_debug": True}, None),
        ("matpro.view_selected", {"type": 'PERIOD', "value": 'PRESS'}, None),
        op_menu_pie("NODE_MT_view_pie", {"type": 'ACCENT_GRAVE', "value": 'PRESS'}),
        ("matpro.delete", {"type": 'X', "value": 'PRESS', "only_debug": True}, None),
        ("matpro.delete", {"type": 'DEL', "value": 'PRESS'}, None),
        ("matpro.delete_reconnect", {"type": 'X', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
        ("matpro.delete_reconnect", {"type": 'DEL', "value": 'PRESS', "ctrl": True}, None),
        *_template_items_select_actions(params, "matpro.select_all"),
        ("matpro.select_linked_to", {"type": 'L', "value": 'PRESS', "shift": True}, None),
        ("matpro.select_linked_from", {"type": 'L', "value": 'PRESS'}, None),
        ("matpro.select_grouped", {"type": 'G', "value": 'PRESS', "shift": True}, None),
        ("matpro.select_grouped", {"type": 'G', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Extend"},
         {"properties": [("extend", True)]}),
        ("matpro.select_same_type_step", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "shift": True},
         {"properties": [("prev", False)]}),
        ("matpro.select_same_type_step", {"type": 'LEFT_BRACKET', "value": 'PRESS', "shift": True},
         {"properties": [("prev", True)]}),
        ("matpro.find_node", {"type": 'F', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.group_make", {"type": 'G', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.group_ungroup", {"type": 'G', "value": 'PRESS', "ctrl": True, "alt": True}, None),
        ("matpro.group_separate", {"type": 'P', "value": 'PRESS'}, None),
        ("matpro.group_edit", {"type": 'TAB', "value": 'PRESS'},
         {"properties": [("exit", False)]}),
        ("matpro.group_edit", {"type": 'TAB', "value": 'PRESS', "ctrl": True, "extra_tip": "Exit"},
         {"properties": [("exit", True)]}),
        ("matpro.read_viewlayers", {"type": 'R', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.render_changed", {"type": 'Z', "value": 'PRESS'}, None),
        ("matpro.clipboard_copy", {"type": 'C', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.clipboard_paste", {"type": 'V', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.viewer_border", {"type": 'B', "value": 'PRESS', "ctrl": True}, None),
        ("matpro.clear_viewer_border", {"type": 'B', "value": 'PRESS', "ctrl": True, "alt": True}, None),
        ("matpro.translate_attach",
         {"type": 'G', "value": 'PRESS'},
         {"properties": [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])]}),
        ("matpro.translate_attach",
         {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "only_debug": True},
        ...
        # Avoid duplicating the previous item.
        *([] if params.select_mouse == 'LEFTMOUSE' else (
            ("matpro.translate_attach", {"type": params.select_mouse, "value": 'CLICK_DRAG'},
             {"properties": [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])]}),
        )),
        ("transform.translate", {"type": 'G', "value": 'PRESS'}, {"properties": [("view2d_edge_pan", True)]}),
        ("transform.translate", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG'},
        ...
        *([] if params.select_mouse == 'LEFTMOUSE' else (
        ...
        ("transform.rotate", {"type": 'R', "value": 'PRESS'}, None),
        ("transform.resize", {"type": 'S', "value": 'PRESS'}, None),
        ("matpro.move_detach_links_release",
         {"type": params.action_mouse, "value": 'CLICK_DRAG', "alt": True, "extra_tip": "Release"},
         {"properties": [("MATPRO_OT_translate_attach", [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])])]}),
        ("matpro.move_detach_links",
         {"type": params.select_mouse, "value": 'CLICK_DRAG', "alt": True},
         {"properties": [("TRANSFORM_OT_translate", [("view2d_edge_pan", True)])]}),
        ("wm.context_toggle", {"type": 'TAB', "value": 'PRESS', "shift": True},
         {"properties": [("data_path", 'tool_settings.use_snap_node')]}),
        ...
        ("wm.context_toggle", {"type": 'Z', "value": 'PRESS', "alt": True, "shift": True},
         {"properties": [("data_path", "space_data.overlay.show_overlays")]}),
        *_template_items_context_menu("MATPRO_MT_context_menu", params.context_menu_event),
    ])
...
def km_info(params):
    ...
    keymap = (
        "Info",
        {"space_type": 'INFO', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_file_browser(params):
    ...
    items.extend([
        *_template_space_region_type_toggle(
        ...
        ("wm.context_toggle", {"type": 'N', "value": 'PRESS', "extra_tip": "Properties"},
        ...
        ("file.delete", {"type": 'X', "value": 'PRESS', "only_debug": True}, None),
        ...
        ("file.filenum", {"type": 'PLUS', "value": 'PRESS', "repeat": True, "extra_tip": "1"},
         {"properties": [("increment", 1)]}),
        ("file.filenum", {"type": 'PLUS', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "10"},
         {"properties": [("increment", 10)]}),
        ("file.filenum", {"type": 'PLUS', "value": 'PRESS', "ctrl": True, "repeat": True, "extra_tip": "100"},
         {"properties": [("increment", 100)]}),
        ("file.filenum", {"type": 'MINUS', "value": 'PRESS', "repeat": True, "extra_tip": "-1"},
         {"properties": [("increment", -1)]}),
        ("file.filenum", {"type": 'MINUS', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "-10"},
         {"properties": [("increment", -10)]}),
        ("file.filenum", {"type": 'MINUS', "value": 'PRESS', "ctrl": True, "repeat": True, "extra_tip": "-100"},
         {"properties": [("increment", -100)]}),
...
def km_file_browser_main(params):
    ...
    items.extend([
        ...
        ("file.select", {"type": 'LEFTMOUSE', "value": 'CLICK', "ctrl": True, "extra_tip": "Extend"},
         {"properties": [("extend", True), ("open", False)]}),
        ("file.select", {"type": 'LEFTMOUSE', "value": 'CLICK', "shift": True, "extra_tip": "Fill"},
         {"properties": [("extend", True), ("fill", True), ("open", False)]}),
        ("file.select_walk", {"type": 'UP_ARROW', "value": 'PRESS', "repeat": True, "extra_tip": "Up"},
         {"properties": [("direction", 'UP')]}),
        ("file.select_walk", {"type": 'UP_ARROW', "value": 'PRESS', "shift": True, "extra_tip": "Up Extend"},
         {"properties": [("direction", 'UP'), ("extend", True)]}),
        ("file.select_walk", {"type": 'UP_ARROW', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "extra_tip": "Up Fill"},
         {"properties": [("direction", 'UP'), ("extend", True), ("fill", True)]}),
        ("file.select_walk", {"type": 'DOWN_ARROW', "value": 'PRESS', "repeat": True, "extra_tip": "Down"},
         {"properties": [("direction", 'DOWN')]}),
        ("file.select_walk", {"type": 'DOWN_ARROW', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "Down Extend"},
         {"properties": [("direction", 'DOWN'), ("extend", True)]}),
        ("file.select_walk", {"type": 'DOWN_ARROW', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "extra_tip": "Down Fill"},
         {"properties": [("direction", 'DOWN'), ("extend", True), ("fill", True)]}),
        ("file.select_walk", {"type": 'LEFT_ARROW', "value": 'PRESS', "repeat": True, "extra_tip": "Left"},
         {"properties": [("direction", 'LEFT')]}),
        ("file.select_walk", {"type": 'LEFT_ARROW', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "Left Extend"},
         {"properties": [("direction", 'LEFT'), ("extend", True)]}),
        ("file.select_walk", {"type": 'LEFT_ARROW', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "extra_tip": "Left Fill"},
         {"properties": [("direction", 'LEFT'), ("extend", True), ("fill", True)]}),
        ("file.select_walk", {"type": 'RIGHT_ARROW', "value": 'PRESS', "repeat": True, "extra_tip": "Right"},
         {"properties": [("direction", 'RIGHT')]}),
        ("file.select_walk", {"type": 'RIGHT_ARROW', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "Right Extend"},
         {"properties": [("direction", 'RIGHT'), ("extend", True)]}),
        ("file.select_walk", {"type": 'RIGHT_ARROW', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "extra_tip": "Right Fill"},
        ...
        *_template_items_select_actions(params, "file.select_all"),
        ...
        ("file.select_box", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "only_debug": True}, None),
        ("file.select_box", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "shift": True, "extra_tip": "Add"},
         {"properties": [("mode", 'ADD')]}),
        ("file.select_box", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "extra_tip": "Subtract"},
         {"properties": [("mode", 'SUB')]}),
...
def km_nla_generic(_params):
    ...
    keymap = (
        "NLA Generic",
        {"space_type": 'NLA_EDITOR', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_text_generic(_params):
    ...
    keymap = (
        "Text Generic",
        {"space_type": 'TEXT_EDITOR', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_sequencercommon(params):
    ...
    keymap = (
        "SequencerCommon",
        {"space_type": 'SEQUENCE_EDITOR', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_console(_params):
    ...
    keymap = (
        "Console",
        {"space_type": 'CONSOLE', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_spreadsheet_generic(_params):
    ...
    keymap = (
        "Spreadsheet Generic",
        {"space_type": 'SPREADSHEET', "region_type": 'WINDOW', "only_debug": True},
        {"items": items},
    )
...
def km_frames(params):
    ...
    items.extend([
        # Frame offsets
        ("screen.frame_offset", {"type": 'LEFT_ARROW', "value": 'PRESS', "repeat": True, "extra_tip": "1"},
         {"properties": [("delta", -1)]}),
        ("screen.frame_offset", {"type": 'RIGHT_ARROW', "value": 'PRESS', "repeat": True, "extra_tip": "-1"},
         {"properties": [("delta", 1)]}),
        ("screen.frame_jump", {"type": 'RIGHT_ARROW', "value": 'PRESS', "shift": True, "repeat": True},
         {"properties": [("end", True)]}),
        ("screen.frame_jump", {"type": 'LEFT_ARROW', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "Backwards"},
         {"properties": [("end", False)]}),
        ("screen.keyframe_jump", {"type": 'UP_ARROW', "value": 'PRESS', "repeat": True},
         {"properties": [("next", True)]}),
        ("screen.keyframe_jump", {"type": 'DOWN_ARROW', "value": 'PRESS', "repeat": True, "extra_tip": "Backwards"},
         {"properties": [("next", False)]}),
        ("screen.keyframe_jump", {"type": 'MEDIA_LAST', "value": 'PRESS', "only_debug": True},
         {"properties": [("next", True)]}),
        ("screen.keyframe_jump", {"type": 'MEDIA_FIRST', "value": 'PRESS', "only_debug": True},
         {"properties": [("next", False)]}),
        ("screen.frame_offset", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS', "alt": True, "extra_tip": "1"},
         {"properties": [("delta", 1)]}),
        ("screen.frame_offset", {"type": 'WHEELUPMOUSE', "value": 'PRESS', "alt": True, "extra_tip": "-1"},
         {"properties": [("delta", -1)]}),
    ])
    ...
    if not params.legacy:
        ...
        items.extend([
            ("screen.animation_play", {"type": 'SPACE', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Reverse"},
             {"properties": [("reverse", True)]}),
        ])
    else:
        # Old playback
    ...
    items.extend([
        ...
        ("screen.animation_play", {"type": 'MEDIA_PLAY', "value": 'PRESS', "only_debug": True}, None),
        ("screen.animation_cancel", {"type": 'MEDIA_STOP', "value": 'PRESS', "only_debug": True}, None),
    ])
...
def km_pose(params):
    ...
    items.extend([
        ...
        *_template_items_hide_reveal_actions("pose.hide", "pose.reveal"),
        op_menu("VIEW3D_MT_pose_apply", {"type": 'A', "value": 'PRESS', "ctrl": True, "shift": True}),
        ...
        ("pose.paste", {"type": 'V', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Flipped"},
         {"properties": [("flipped", True)]}),
        *_template_items_select_actions(params, "pose.select_all"),
        ("pose.select_parent", {"type": 'P', "value": 'PRESS', "shift": True}, None),
        ("pose.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS', "repeat": True, "extra_tip": "Left"},
         {"properties": [("direction", 'PARENT'), ("extend", False)]}),
        ("pose.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "Left Extend"},
         {"properties": [("direction", 'PARENT'), ("extend", True)]}),
        ("pose.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "repeat": True, "extra_tip": "Right"},
         {"properties": [("direction", 'CHILD'), ("extend", False)]}),
        ("pose.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "shift": True, "repeat": True, "extra_tip": "Right Extend"},
         {"properties": [("direction", 'CHILD'), ("extend", True)]}),
        ("pose.select_linked", {"type": 'L', "value": 'PRESS', "ctrl": True}, None),
        ("pose.select_linked_pick", {"type": 'L', "value": 'PRESS', "extra_tip": "Pick"}, None),
...
def km_object_mode(params):
    ...
    items.extend([
        ...
        *_template_items_select_actions(params, "object.select_all"),
        ("object.select_more", {"type": 'NUMPAD_PLUS', "value": 'PRESS', "ctrl": True, "repeat": True, "only_debug": True}, None),
        ("object.select_less", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "ctrl": True, "repeat": True, "only_debug": True}, None),
        ("object.select_linked", {"type": 'L', "value": 'PRESS', "shift": True, "only_debug": True}, None),
        ("object.select_grouped", {"type": 'G', "value": 'PRESS', "shift": True, "only_debug": True}, None),
        ("object.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS', "repeat": True, "only_debug": True},
         {"properties": [("direction", 'PARENT'), ("extend", False)]}),
        ("object.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS', "shift": True, "repeat": True, "only_debug": True},
         {"properties": [("direction", 'PARENT'), ("extend", True)]}),
        ("object.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "repeat": True, "only_debug": True},
         {"properties": [("direction", 'CHILD'), ("extend", False)]}),
        ("object.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "shift": True, "repeat": True, "only_debug": True},
         {"properties": [("direction", 'CHILD'), ("extend", True)]}),
        ("object.parent_set", {"type": 'P', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
        ("object.parent_clear", {"type": 'P', "value": 'PRESS', "alt": True, "only_debug": True}, None),
        ("object.location_clear", {"type": 'G', "value": 'PRESS', "alt": True, "only_debug": True},
         {"properties": [("clear_delta", False)]}),
        ("object.rotation_clear", {"type": 'R', "value": 'PRESS', "alt": True, "only_debug": True},
         {"properties": [("clear_delta", False)]}),
        ("object.scale_clear", {"type": 'S', "value": 'PRESS', "alt": True, "only_debug": True},
         {"properties": [("clear_delta", False)]}),
        ("object.delete", {"type": 'X', "value": 'PRESS', "only_debug": True},
         {"properties": [("use_global", False)]}),
        ("object.delete", {"type": 'X', "value": 'PRESS', "shift": True, "only_debug": True},
         {"properties": [("use_global", True)]}),
        ("object.delete", {"type": 'DEL', "value": 'PRESS'},
         {"properties": [("use_global", False), ("confirm", False)]}),
        ("object.delete", {"type": 'DEL', "value": 'PRESS', "shift": True, "extra_tip": "Global"},
         {"properties": [("use_global", True), ("confirm", False)]}),
        op_menu("VIEW3D_MT_add", {"type": 'A', "value": 'PRESS', "shift": True, "only_debug": True}),
        op_menu("VIEW3D_MT_object_apply", {"type": 'A', "value": 'PRESS', "ctrl": True, "only_debug": True}),
        op_menu("VIEW3D_MT_make_links", {"type": 'L', "value": 'PRESS', "ctrl": True, "only_debug": True}),
        ("object.duplicate_move", {"type": 'D', "value": 'PRESS', "shift": True}, None),
        ("object.duplicate_move_linked", {"type": 'D', "value": 'PRESS', "alt": True, "only_debug": True}, None),
        ...
        *_template_items_object_subdivision_set(),
        ("object.move_to_collection", {"type": 'M', "value": 'PRESS'}, None),
        ("object.link_to_collection", {"type": 'M', "value": 'PRESS', "shift": True, "only_debug": True}, None),
...
def km_curve(params):
    ...
    items.extend([
        ...
        *_template_items_select_actions(params, "curve.select_all"),
        ...
        ("curve.select_more", {"type": 'PLUS', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
        ...
        ("curve.select_linked_pick", {"type": 'L', "value": 'PRESS'},
         {"properties": [("deselect", False)]}),
        ("curve.select_linked_pick", {"type": 'L', "value": 'PRESS', "shift": True, "extra_tip": "Deselect"},
         {"properties": [("deselect", True)]}),
        ...
        op_menu("VIEW3D_MT_edit_curve_delete", {"type": 'X', "value": 'PRESS', "only_debug": True}),
        op_menu("VIEW3D_MT_edit_curve_delete", {"type": 'DEL', "value": 'PRESS'}),
        ("curve.dissolve_verts", {"type": 'X', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
...
def _template_paint_radial_control(paint, rotation=False, secondary_rotation=False, color=False, zoom=False):
    ...
    items.extend([
        ("wm.radial_control", {"type": 'F', "value": 'PRESS', "extra_tip": "Size"},
         radial_control_properties(
             paint, 'size', 'use_unified_size', secondary_rotation=secondary_rotation, color=color, zoom=zoom)),
        ("wm.radial_control", {"type": 'F', "value": 'PRESS', "shift": True, "extra_tip": "Strength"},
         radial_control_properties(
    ...
    if rotation:
        items.extend([
            ("wm.radial_control", {"type": 'F', "value": 'PRESS', "ctrl": True, "extra_tip": "Angle"},
...
def _template_view3d_select(*, type, value, legacy, select_passthrough, exclude_mod=None):
    ...
    items = [(
        "view3d.select",
        {"type": type, "value": value, **{m: True for m in mods} | {"extra_tip": tip if tip else ""}},
        {"properties": [(c, True) for c in props]},
    ) for props, mods, tip in (
        ...
        (("toggle", *props_vert_without_handles), ("shift",), "Vert"),
        (("center", "object"), ("ctrl",), "Center"),
        (("enumerate",), ("alt",), "Enumerate"),
        (("toggle", "center"), ("shift", "ctrl"), "Center"),
        (("center", "enumerate"), ("ctrl", "alt"), "Center Enum"),
        (("toggle", "enumerate"), ("shift", "alt"), "Toggle Enum"),
        (("toggle", "center", "enumerate"), ("shift", "ctrl", "alt"), "All"),
...
def _template_node_select(*, type, value, select_passthrough):
    items = [
        ("node.select", {"type": type, "value": value, "extra_tip": "Deselection"},
         {"properties": [("deselect_all", True), ("select_passthrough", select_passthrough)]}),
        ("node.select", {"type": type, "value": value, "ctrl": True}, None),
        ("node.select", {"type": type, "value": value, "alt": True, "only_debug": True}, None),
        ("node.select", {"type": type, "value": value, "ctrl": True, "alt": True, "only_debug": True}, None),
        ("node.select", {"type": type, "value": value, "shift": True},
         {"properties": [("toggle", True)]}),
        ("node.select", {"type": type, "value": value, "shift": True, "ctrl": True, "only_debug": True},
         {"properties": [("toggle", True)]}),
        ("node.select", {"type": type, "value": value, "shift": True, "alt": True, "only_debug": True},
         {"properties": [("toggle", True)]}),
        ("node.select", {"type": type, "value": value, "shift": True, "ctrl": True, "alt": True, "only_debug": True},
         {"properties": [("toggle", True)]}),
    ]
...
def _template_matpro_select(*, type, value, select_passthrough):
    items = [
        ("matpro.select", {"type": type, "value": value, "extra_tip": "Deselection"},
         {"properties": [("deselect_all", True), ("select_passthrough", select_passthrough)]}),
        ("matpro.select", {"type": type, "value": value, "ctrl": True}, None),
        ("matpro.select", {"type": type, "value": value, "alt": True, "only_debug": True}, None),
        ("matpro.select", {"type": type, "value": value, "ctrl": True, "alt": True, "only_debug": True}, None),
        ("matpro.select", {"type": type, "value": value, "shift": True},
         {"properties": [("toggle", True)]}),
        ("matpro.select", {"type": type, "value": value, "shift": True, "ctrl": True, "only_debug": True},
         {"properties": [("toggle", True)]}),
        ("matpro.select", {"type": type, "value": value, "shift": True, "alt": True, "only_debug": True},
         {"properties": [("toggle", True)]}),
        ("matpro.select", {"type": type, "value": value, "shift": True, "ctrl": True, "alt": True, "only_debug": True},
         {"properties": [("toggle", True)]}),
    ]
    ...
    items.extend([
        ...
        *_template_items_editmode_mesh_select_mode(params),
        ...
        ("mesh.loop_select",
         {"type": params.select_mouse, "value": params.select_mouse_value, "alt": True}, None),
        ("mesh.loop_select",
         {"type": params.select_mouse, "value": params.select_mouse_value, "shift": True, "alt": True, "extra_tip": "Toggle"},
         {"properties": [("toggle", True)]}),
        # Selection
        ("mesh.edgering_select",
         {"type": params.select_mouse, "value": params.select_mouse_value, "ctrl": True, "alt": True}, None),
        ("mesh.edgering_select",
         {"type": params.select_mouse, "value": params.select_mouse_value, "shift": True, "ctrl": True, "alt": True, "extra_tip": "Toggle"},
         {"properties": [("toggle", True)]}),
        ("mesh.shortest_path_pick",
         {"type": params.select_mouse, "value": params.select_mouse_value_fallback, "ctrl": True},
         {"properties": [("use_fill", False)]}),
        ("mesh.shortest_path_pick",
         {"type": params.select_mouse, "value": params.select_mouse_value_fallback, "shift": True, "ctrl": True, "extra_tip": "Fill"},
         {"properties": [("use_fill", True)]}),
        *_template_items_select_actions(params, "mesh.select_all"),
        ...
        ("mesh.select_next_item",
         {"type": 'NUMPAD_PLUS', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "only_debug": True}, None),
        ("mesh.select_prev_item",
         {"type": 'NUMPAD_MINUS', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True, "only_debug": True}, None),
        ("mesh.select_linked", {"type": 'L', "value": 'PRESS', "ctrl": True}, None),
        ("mesh.select_linked_pick", {"type": 'L', "value": 'PRESS'},
         {"properties": [("deselect", False)]}),
        ("mesh.select_linked_pick", {"type": 'L', "value": 'PRESS', "shift": True, "extra_tip": "Deselect"},
         {"properties": [("deselect", True)]}),
        ...
        ("mesh.normals_make_consistent", {"type": 'N', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Inside"},
        ...
        ("mesh.quads_convert_to_tris", {"type": 'T', "value": 'PRESS', "ctrl": True, "extra_tip": "Beauty"},
         {"properties": [("quad_method", 'BEAUTY'), ("ngon_method", 'BEAUTY')]}),
        ("mesh.quads_convert_to_tris", {"type": 'T', "value": 'PRESS', "shift": True, "ctrl": True, "extra_tip": "Clip"},
        ...
        ("mesh.rip_move", {"type": 'V', "value": 'PRESS', "alt": True, "extra_tip": "Fill"},
        ...
        op_menu("VIEW3D_MT_edit_mesh_split", {"type": 'M', "value": 'PRESS', "alt": True, "extra_tip": "Menu"}),
        ...
        ("mesh.separate", {"type": 'P', "value": 'PRESS'}, {"properties": [("type", 'SELECTED')]}),
        ...
        ("mesh.dupli_extrude_cursor", {"type": params.action_mouse, "value": 'CLICK', "shift": True, "ctrl": True, "extra_tip": "Rotate"},
         {"properties": [("rotate_source", False)]}),
        op_menu("VIEW3D_MT_edit_mesh_delete", {"type": 'X', "value": 'PRESS', "only_debug": True}),
        op_menu("VIEW3D_MT_edit_mesh_delete", {"type": 'DEL', "value": 'PRESS'}),
        ("mesh.dissolve_mode", {"type": 'X', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
        ...
        ("mesh.knife_tool", {"type": 'K', "value": 'PRESS', "shift": True, "extra_tip": "Selected"},
...
def km_armature(params):
    ...
    items.extend([
        ...
        *_template_items_select_actions(params, "armature.select_all"),
        ...
        ("armature.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS', "extra_tip": "Left"},
         {"properties": [("direction", 'PARENT'), ("extend", False)]}),
        ("armature.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS', "shift": True, "extra_tip": "Left Extend"},
         {"properties": [("direction", 'PARENT'), ("extend", True)]}),
        ("armature.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "extra_tip": "Right"},
         {"properties": [("direction", 'CHILD'), ("extend", False)]}),
        ("armature.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "shift": True, "extra_tip": "Right Extend"},
         {"properties": [("direction", 'CHILD'), ("extend", True)]}),
        ("armature.select_more", {"type": 'PLUS', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
        ...
        ("armature.select_linked_pick", {"type": 'L', "value": 'PRESS'},
         {"properties": [("deselect", False)]}),
        ("armature.select_linked_pick", {"type": 'L', "value": 'PRESS', "shift": True, "extra_tip": "Deselect"},
         {"properties": [("deselect", True)]}),
        ("armature.select_linked", {"type": 'L', "value": 'PRESS', "ctrl": True}, None),
        ("armature.shortest_path_pick",
         {"type": params.select_mouse, "value": params.select_mouse_value_fallback, "ctrl": True}, None),
        # Editing.
        op_menu("VIEW3D_MT_edit_armature_delete", {"type": 'X', "value": 'PRESS', "only_debug": True}),
        op_menu("VIEW3D_MT_edit_armature_delete", {"type": 'DEL', "value": 'PRESS'}),
        ("armature.duplicate_move", {"type": 'D', "value": 'PRESS', "shift": True}, None),
        ("armature.dissolve", {"type": 'X', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
        ...
        op_tool_optional(
            ("transform.transform", {"type": 'S', "value": 'PRESS', "alt": True, "extra_tip": "Envelope"},
             {"properties": [("mode", 'BONE_ENVELOPE')]}),
            (op_tool_cycle, "builtin.bone_envelope"), params),
        op_tool_optional(
            ("transform.transform", {"type": 'R', "value": 'PRESS', "ctrl": True, "extra_tip": "Roll"},
...
def km_sculpt_curves(params):
    ...
    items.extend([
        ("sculpt_curves.brush_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS'},
         {"properties": [("mode", 'NORMAL')]}),
        ("sculpt_curves.brush_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True, "extra_tip": "Invert"},
         {"properties": [("mode", 'INVERT')]}),
        ("sculpt_curves.brush_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "extra_tip": "Smooth"},
         {"properties": [("mode", 'SMOOTH')]}),
        ("curves.set_selection_domain", {"type": 'ONE', "value": 'PRESS', "extra_tip": "Point"}, {"properties": [("domain", 'POINT')]}),
        ("curves.set_selection_domain", {"type": 'TWO', "value": 'PRESS', "extra_tip": "Curve"}, {"properties": [("domain", 'CURVE')]}),
        ("curves.disable_selection", {"type": 'ONE', "value": 'PRESS', "alt": True}, None),
        ("curves.disable_selection", {"type": 'TWO', "value": 'PRESS', "alt": True, "extra_tip": "Alt"}, None),
...
def km_object_non_modal(params):
    ...
    if params.legacy:
        items.extend([
            ("object.mode_set", {"type": 'TAB', "value": 'PRESS'},
             {"properties": [("mode", 'EDIT'), ("toggle", True)]}),
            ("object.mode_set", {"type": 'TAB', "value": 'PRESS', "ctrl": True, "only_debug": True},
             {"properties": [("mode", 'POSE'), ("toggle", True)]}),
            ("object.mode_set", {"type": 'V', "value": 'PRESS', "only_debug": True},
             {"properties": [("mode", 'VERTEX_PAINT'), ("toggle", True)]}),
            ("object.mode_set", {"type": 'TAB', "value": 'PRESS', "ctrl": True, "only_debug": True},
             {"properties": [("mode", 'WEIGHT_PAINT'), ("toggle", True)]}),

            ("object.origin_set", {"type": 'C', "value": 'PRESS', "shift": True, "ctrl": True, "alt": True, "only_debug": True}, None),
        ])
    else:
        items.extend([
            # NOTE: this shortcut (while not temporary) is not ideal, see: T89757.
            ("object.transfer_mode", {"type": 'Q', "value": 'PRESS', "alt": True, "only_debug": True}, None),
        ])
        ...
        if params.use_pie_click_drag:
            items.extend([
                ("object.mode_set", {"type": 'TAB', "value": 'CLICK'},
                 {"properties": [("mode", 'EDIT'), ("toggle", True)]}),
                op_menu_pie("VIEW3D_MT_object_mode_pie", {"type": 'TAB', "value": 'CLICK_DRAG', "only_debug": True}),
                ("view3d.object_mode_pie_or_toggle", {"type": 'TAB', "value": 'PRESS', "ctrl": True, "only_debug": True}, None),
            ])
            ...
            items.extend([
                ("object.mode_set", {"type": 'TAB', "value": 'PRESS', "ctrl": True},
                 {"properties": [("mode", 'EDIT'), ("toggle", True)]}),
                op_menu_pie("VIEW3D_MT_object_mode_pie", {"type": 'TAB', "value": 'PRESS', "only_debug": True}),
            ])
        else:
            items.extend([
                ("object.mode_set", {"type": 'TAB', "value": 'PRESS'},
...
def km_eyedropper_modal_map(_params):
    ...
    keymap = (
        ...
        {"space_type": 'EMPTY', "region_type": 'WINDOW', "modal": True, "only_debug": True},
        {"items": items},
    )
...
def km_standard_modal_map(_params):
    ...
    items.extend([
        ...
        ("APPLY", {"type": 'NUMPAD_ENTER', "value": 'PRESS', "any": True, "only_debug": True}, None),
...
def km_knife_tool_modal_map(_params):
    ...
    items.extend([
        ...
        ("CONFIRM", {"type": 'RET', "value": 'PRESS', "any": True}, None),
        ("CONFIRM", {"type": 'NUMPAD_ENTER', "value": 'PRESS', "any": True, "only_debug": True}, None),
        ("CONFIRM", {"type": 'SPACE', "value": 'PRESS', "any": True}, None),
...
def km_bevel_modal_map(_params):
    ...
    items.extend([
        ...
        ("SEGMENTS_UP", {"type": 'NUMPAD_PLUS', "value": 'PRESS', "any": True, "only_debug": True}, None),
        ("SEGMENTS_DOWN", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS', "any": True}, None),
        ("SEGMENTS_DOWN", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "any": True, "only_debug": True}, None),
...
def km_view3d_fly_modal(_params):
    ...
    items.extend([
        ...
        ("CONFIRM", {"type": 'SPACE', "value": 'PRESS', "any": True}, None),
        ("CONFIRM", {"type": 'NUMPAD_ENTER', "value": 'PRESS', "any": True, "only_debug": True}, None),
        ("ACCELERATE", {"type": 'NUMPAD_PLUS', "value": 'PRESS', "any": True, "repeat": True, "only_debug": True}, None),
        ("DECELERATE", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "any": True, "repeat": True, "only_debug": True}, None),
...
def km_image_editor_view_pan(params):
    return (
        "Image Editor Tool: Pan",
        {"space_type": 'IMAGE_EDITOR', "region_type": 'WINDOW'},
        {"items": [
            ("image.view_pan",
...
def km_image_editor_view_zoom(params):
    return (
        "Image Editor Tool: Zoom",
        {"space_type": 'IMAGE_EDITOR', "region_type": 'WINDOW'},
        {"items": [
            ("image.view_zoom",
             {**params.tool_maybe_tweak_event,
...
def km_matpro_tool_select(params, *, fallback):
    return (
        _fallback_id("MatPro Tool: Tweak", fallback),
        {"space_type": 'MATPRO', "region_type": 'WINDOW'},
        {"items": [
            # The node key-map already selects, leave this empty.
            # NOTE: intentionally don't check `fallback` here (unlike other tweak tool checks).
            # as this should only be used on LMB select which would otherwise activate on click, not press.
            *([] if (params.select_mouse == 'RIGHTMOUSE') else
              _template_matpro_select(type=params.select_mouse, value='PRESS', select_passthrough=True)),
        ]},
    )
...
def km_matpro_tool_select_box(params, *, fallback):
    return (
        _fallback_id("MatPro Tool: Select Box", fallback),
        {"space_type": 'MATPRO', "region_type": 'WINDOW'},
        {"items": [
            *([] if (fallback and not params.use_fallback_tool) else _template_items_tool_select_actions_simple(
                "matpro.select_box",
            ...
            *([] if (params.select_mouse == 'RIGHTMOUSE') else
              _template_matpro_select(type='LEFTMOUSE', value='PRESS', select_passthrough=True)),
        ]},
    )
...
def km_3d_view_tool_cursor(params):
    return (
        "3D View Tool: Cursor",
        {"space_type": 'VIEW_3D', "region_type": 'WINDOW', "only_debug": True},
        {"items": [
...
def km_3d_view_tool_move_trackpad(params):
    return (
        "3D View Tool: Move",
        {"space_type": 'VIEW_3D', "region_type": 'WINDOW', "workspace_type": 'VR_HANDS'},
        {"items": [
            ("transform.translate", {"type": 'TRACKPADPAN', "value": 'ANY'},
...
def km_3d_view_tool_rotate_trackpad(params):
    return (
        "3D View Tool: Rotate",
        {"space_type": 'VIEW_3D', "region_type": 'WINDOW', "workspace_type": 'VR_HANDS'},
        {"items": [
            ("transform.rotate", {"type": 'TRACKPADPAN', "value": 'ANY'},
             {"properties": [("release_confirm", False)]}),
        ]},
    )
...
def km_3d_view_tool_scale_trackpad(params):
    return (
        "3D View Tool: Scale",
        {"space_type": 'VIEW_3D', "region_type": 'WINDOW', "workspace_type": 'VR_HANDS'},
        {"items": [
            ("transform.resize", {"type": 'TRACKPADPAN', "value": 'ANY'},
             {"properties": [("release_confirm", True)]}),
        ]},
    )
...
def km_3d_view_tool_measure(params):
    return (
        ...
        {"items": [
            ...
            ("view3d.ruler_remove", {"type": 'X', "value": 'PRESS', "only_debug": True}, None),
...
def km_3d_view_translation_add(params):
    return (
        "3D View Tool: Translate, Rotate",
        {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
        {"items": [
            ("view3d.view_translation_add",
             {**params.tool_maybe_tweak_event,
              # While "Alt" isn't an important shortcut to support,
              # when the preferences to activate tools when "Alt" is held is used,
              # it's illogical not to support holding "Alt", even though it is not required.
              **({"any": True} if "alt" in params.tool_modifier else any_except("alt"))},
             #{"properties": [("wait_for_input", False)]},
             {"properties": [("use_cursor_init", False)]},
             ),
        ]},
    )
...
def generate_keymaps(params=None):
    ...
    return [
        ...
        km_matpro_generic(params),
        km_matpro_material_list(params),
        km_matpro_editor(params),
        ...
        *(km_image_editor_tool_uv_select_lasso(params, fallback=fallback) for fallback in (False, True)),
        ...
        km_image_editor_view_pan(params),
        km_image_editor_view_zoom(params),
        ...
        *(km_matpro_tool_select(params, fallback=fallback) for fallback in (False, True)),
        *(km_matpro_tool_select_box(params, fallback=fallback) for fallback in (False, True)),
        ...
        *(km_3d_view_tool_select_lasso(params, fallback=fallback) for fallback in (False, True)),
        ...
        km_3d_view_translation_add(params),
...
#
# Allows running outside of 3IXAM to generate data for diffing
#
# To compare:
#
#    python3 release/scripts/presets/keyconfig/keymap_data/ixam_default.py && \
...
#
#    pylint \
#        release/scripts/presets/keyconfig/keymap_data/ixam_default.py \
