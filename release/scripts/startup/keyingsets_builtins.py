...
None of these Keying Sets should be removed, as these are needed by various parts of 3IXAM in order for them
to work correctly.
...
class BUILTIN_KSI_BendyBones(KeyingSetInfo):
    """Insert a keyframe for each of the BJoint shape properties"""
    bl_label = "BJoint Shape"
...
class BUILTIN_KSI_WholeCharacterSelected(WholeCharacterMixin, KeyingSetInfo):
    ...
    bl_label = "Whole Character (Selected Joints Only)"
