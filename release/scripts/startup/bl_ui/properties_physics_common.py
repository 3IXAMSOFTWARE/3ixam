...
class PhysicButtonsPanel:
    ...
    def poll(cls, context):
        return (context.object) and not context.object.protect and context.engine in cls.COMPAT_ENGINES
...
class PHYSICS_PT_add(PhysicButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        if not obj.field or obj.field.type == 'NONE':
            col.operator("object.forcefield_toggle", text="Physics Forces", icon='FORCE_FORCE')
        else:
            col.operator("object.forcefield_toggle", text="Physics Forces", icon='X')

        if obj.type == 'MESH':
            row = physics_add(col, context.collision, "Toggle Collision", 'COLLISION', 'MOD_PHYSICS', False)
        ...
        col = flow.column()
        physics_add(col, context.cloth, "Cloth Surface", 'CLOTH', 'MOD_CLOTH', False)
        ...
        if obj.type == 'MESH':
            ...
            physics_add_special(
                col, obj.rigid_body, "Physics Body",
