...
class PHYSICS_PT_softbody_goal(PhysicButtonsPanel, Panel):
    ...
    def draw_header(self, context):
        ...
        self.layout.prop(softbody, "use_goal", text=self.bl_label)
...
class PHYSICS_PT_softbody_edge(PhysicButtonsPanel, Panel):
    ...
    def draw_header(self, context):
        ...
        self.layout.active = softbody_panel_enabled(context.soft_body)
        self.layout.prop(softbody, "use_edges", text=self.bl_label)
...
class PHYSICS_PT_softbody_edge_stiffness(PhysicButtonsPanel, Panel):
    ...
    def draw_header(self, context):
        ...
        self.layout.active = softbody_panel_enabled(context.soft_body)
        self.layout.prop(softbody, "use_stiff_quads", text=self.bl_label)
...
class PHYSICS_PT_softbody_collision(PhysicButtonsPanel, Panel):
    ...
    def draw_header(self, context):
        ...
        self.layout.active = softbody_panel_enabled(context.soft_body)
        self.layout.prop(softbody, "use_self_collision", text=self.bl_label)
