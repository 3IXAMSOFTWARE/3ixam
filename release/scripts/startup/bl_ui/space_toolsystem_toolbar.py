...
class _defs_view3d_generic:
    ...
    def parameters():
        return dict(
            idname="VIEW3D_PT_parameters",
            label="Parameters",
            icon="ops.object.parameters",
            widget=None,
            keymap="3D View Tool: Tweak",
            type="Panel",
            align='LEFT'
    ...
    def rig_parameters():
        return dict(
            idname="VIEW3D_PT_rig_edit",
            label="Rig Parameters",
            icon="ops.armature.rig_parameters",
            widget=None,
            keymap="3D View Tool: Tweak",
            type="Panel",
            align='LEFT'
    ...
    def ik_parameters():
        return dict(
            idname="VIEW3D_PT_ik_edit",
            label="Inverse Kinematic Parameters",
            icon="ops.armature.ik_parameters",
            widget=None,
            keymap="3D View Tool: Tweak",
            type="Panel",
            align='LEFT'
    ...
    def bone_constraints():
        return dict(
            idname="VIEW3D_PT_bone_constraints",
            label="Bone Constraints",
            icon="ops.armature.joint_constraints",
            widget=None,
            keymap="3D View Tool: Tweak",
            type="Panel",
            align='LEFT'
    ...
    def joint_parameters():
        return dict(
            idname="VIEW3D_PT_joint_edit",
            label="Joint Parameters",
            icon="ops.armature.joint_parameters",
            widget=None,
            keymap="3D View Tool: Tweak",
            type="Panel",
            align='LEFT'
...
class _defs_view3d_render:
    ...
    def render_animation():
        return dict(
            ...
            keymap="3D View Tool: Tweak",
            type='Operator',
            properties={'use_viewport' : True, 'animation': True},
        )
...
class _defs_view3d_select:
    ...
    def modifiers():
        return dict(
            idname="VIEW3D_PT_modifiers",
            label="Deformers",
            icon="ops.modificators",
            widget=None,
            keymap="3D View Tool: Tweak",
            type="Panel",
            align='LEFT'
    ...
    def constraints():
        return dict(
            idname="VIEW3D_PT_constraints",
            label="Constraints",
            icon="ops.armature.constraints_icon",
            widget=None,
            keymap="3D View Tool: Tweak",
            type="Panel",
            align='LEFT'
...
class _defs_view3d_add:
    ...
    def shapes2d_icon():
        return dict(
            idname="VIEW3D_MT_2d",
            label="2D",
            icon="ops.mesh.primitive_2dshapes_add_gizmo",
            type="Menu",
        )
    ...
    def forces_icon():
        return dict(
            idname="VIEW3D_MT_forces",
            label="Forces",
            icon="ops.mesh.primitive_dummy_simple",
            type="Menu",
        )
    ...
    def add_point():
        return dict(
            ...
            label="Add Point",
            type="Operator",
            icon='ops.mesh.primitive_shapes_add_point',
            properties={
                "Simple_Type": "Point",
                "use_cyclic_u": False,
            },         
    ...
    def add_line():
        return dict(
            ...
            label="Add Line",
            type="Operator",
            icon='ops.mesh.primitive_shapes_add_line',
            properties={
                "Simple_Type": "Line",
                "use_cyclic_u": False,
                "shape": "3D",
    ...
    def add_arc():
        return dict(
            ...
            label="Add Arc",
            type="Operator",
            icon='ops.mesh.primitive_shapes_add_curve',
            properties={
                "Simple_Type": "Arc",
                "use_cyclic_u": False,
                "shape": "3D",
    ...
    def add_rectangle():
        return dict(
            ...
            label="Add Rectangle",
            type="Operator",
            icon='ops.mesh.primitive_shapes_add_rectangle',
            properties={
    ...
    def add_circle():
        return dict(
            ...
            label="Add Circle",
            type="Operator",
            icon='ops.mesh.primitive_shapes_add_circle',
            properties={
                "Simple_Type": "Circle",
                "use_cyclic_u": True,
                "shape": "3D",
    ...
    def add_polygon():
        return dict(
            ...
            label="Add Polygon",
            type="Operator",
            icon='ops.mesh.primitive_shapes_add_hexagon',
            properties={
                "Simple_Type": "Polygon",
                "use_cyclic_u": True,
                "shape": "3D",
    ...
    def draw_curve():
        return dict(
            idname="curve.draw",
            label="Draw freehand spline",
            type="Operator",
            icon='ops.mesh.draw_spline',
            context='INVOKE_REGION_WIN',        
        )
    ...
    def add_text2d():
        return dict(
            idname="object.text_add",
            label="Add Text Object",
            type="Operator",
            icon='ops.mesh.primitive_shapes_add_text',
            context='INVOKE_REGION_WIN',
        )
    ...
    def add_keyframe():
        return dict(
            idname="anim.keyframe_insert_menu",
            label="Add Keyframe",
            icon="ops.armature.add_keyframe",
            type="Operator",
        )
    ...
    def remove_keyframe():
        return dict(
            idname="anim.keyframe_delete_v3d",
            label="Remove Keyframe",
            icon="ops.armature.remove_keyframe",
            type="Operator",
    ...
    def bone_add():
        return dict(
            idname="VIEW3D_MT_skelet",
            label="Add Joint",
            icon="ops.armature.joint_add",
            type="Menu",
        )
    ...
    def bone_primitive_add():
        return dict(
            idname="armature.bone_primitive_add",
            label="Add Single Joint",
            icon="ops.armature.joint_add",
            type="Operator",
        )
    ...
    def bone_extrude():
        return dict(
            ...
            label="Extrude",
            icon="ops.armature.joint_extrude",
    ...
    def tube_add():
        def draw_settings(_context, layout, tool, *, extra=False):
            ...
            if show_extra:
                layout.popover("TOPBAR_PT_tool_settings_extra", text="...")
        return dict(
            idname="builtin.primitive_tube_add",
            label="Add Tube",
            icon="ops.mesh.primitive_tube_add_gizmo",
            description=lambda *args: _defs_view3d_add.description_interactive_add(
                *args, prefix=tip_("Add tube to mesh interactively"),
            ),
            widget="VIEW3D_GGT_placement",
            keymap="3D View Tool: Object, Add Primitive",
            draw_settings=draw_settings,
    ...
    def torus_add():
        ...
        return dict(
            idname="builtin.primitive_torus_add",
            label="Add Torus",
            icon="ops.mesh.primitive_torus_add_gizmo",
            description=lambda *args: _defs_view3d_add.description_interactive_add(
                *args, prefix=tip_("Add torus to mesh interactively"),
            ),
            widget="VIEW3D_GGT_placement",
            keymap="3D View Tool: Object, Add Primitive",
            draw_settings=draw_settings,
    ...
    def pyramid_add():
        ...
        return dict(
            idname="builtin.primitive_pyramid_add",
            label="Add Pyramid",
            icon="ops.mesh.primitive_prism_add_gizmo",
            description=lambda *args: _defs_view3d_add.description_interactive_add(
                *args, prefix=tip_("Add pyramid to mesh interactively"),
            ),
            widget="VIEW3D_GGT_placement",
            keymap="3D View Tool: Object, Add Primitive",
            draw_settings=draw_settings,
    ...
    def hexagon_add():
        def draw_settings(_context, layout, tool, *, extra=False):
            ...
            if show_extra:
                layout.popover("TOPBAR_PT_tool_settings_extra", text="...")
        return dict(
            idname="builtin.primitive_hexagon_add",
            label="Add Hexagon",
            icon="ops.mesh.primitive_hexagon_add_gizmo",
            description=lambda *args: _defs_view3d_add.description_interactive_add(
                *args, prefix=tip_("Add hexagon to mesh interactively"),
            ),
            widget="VIEW3D_GGT_placement",
            keymap="3D View Tool: Object, Add Primitive",
            draw_settings=draw_settings,
    ...
    def plane_add():
        def draw_settings(_context, layout, tool, *, extra=False):
            ...
            props = tool.operator_properties("mesh.primitive_plane_add")

            if show_extra:
                layout.popover("TOPBAR_PT_tool_settings_extra", text="...")
        return dict(
            idname="builtin.primitive_plane_add",
            label="Add Plane",
            icon="ops.mesh.primitive_plane_add_gizmo",
            description=lambda *args: _defs_view3d_add.description_interactive_add(
                *args, prefix=tip_("Add plane to mesh interactively"),
            ),
            widget="VIEW3D_GGT_placement",
            keymap="3D View Tool: Object, Add Primitive",
            draw_settings=draw_settings,
    ...
    def grid_add():
        def draw_settings(_context, layout, tool, *, extra=False):
            ...
            props = tool.operator_properties("mesh.primitive_grid_add")

            if show_extra:
                layout.popover("TOPBAR_PT_tool_settings_extra", text="...")
        return dict(
            idname="builtin.primitive_grid_add",
            label="Add Grid",
            icon="ops.mesh.primitive_grid_add_gizmo",
            description=lambda *args: _defs_view3d_add.description_interactive_add(
                *args, prefix=tip_("Add grid to mesh interactively"),
            ),
            widget="VIEW3D_GGT_placement",
            keymap="3D View Tool: Object, Add Primitive",
            draw_settings=draw_settings,
...
class _defs_image_uv_select:
    ...
    def find():
        return dict(
            idname="image.view_selected_as_tool",
...
class IMAGE_PT_tools_active(ToolSelectPanelHelper, Panel):
    ...
    def align(self):
        ...
        return 'RIGHT' if hand_type == 'HAND_RIGHT' else 'LEFT'
...
class MATPRO_PT_tools_active(ToolSelectPanelHelper, Panel):
    ...
    # Satisfy the 'ToolSelectPanelHelper' API.
    keymap_prefix = "MatPro Editor Tool:"
    ...
    _tools_select = (
        (
            _defs_matpro_select.select,
            _defs_matpro_select.box,
        ),
    )
...
class VIEW3D_PT_tools_active(ToolSelectPanelHelper, Panel):
    ...
    _tools_cube_planar = (
        (
            ...
            _defs_view3d_add.plane_add,
            _defs_view3d_add.grid_add,
        ),
    )
    ...
    _tools_view3d_2d = (
        (
            _defs_view3d_add.shapes2d_icon, #TODO Line, Polyline, Spline, Rectangle, Ellipse, Donut, Arc, Helix
    ...
    _tools_render = (
        (
            _defs_view3d_render.render_icon,  
            _defs_view3d_render.render,  
            _defs_view3d_render.add_camera
        ),
    )

    _tools_view3d_light = (
        (
            _defs_view3d_light.light_icon,  
            _defs_view3d_light.point_light,
            _defs_view3d_light.sun_light
        ),
    )
    ...
    _3ixam_pose_edit = (
        ...
        *_tools_select,
        None,
        _defs_view3d_add.add_keyframe,
        None,
        _defs_view3d_add.remove_keyframe,
        None,
        None,
        None,
        None,
        None,
        _defs_view3d_generic.ik_parameters, 
        None,
        _defs_view3d_generic.rig_parameters,
        None,
        _defs_view3d_generic.bone_constraints, 
        None,
        _defs_view3d_generic.joint_parameters, 
        _defs_view3d_select.constraints,
        None,
    ...
    _3ixam_joints_edit = (
        ...
        *_tools_select,
        None,
        _defs_view3d_add.bone_primitive_add,
        None,
        _defs_view3d_add.bone_roll,
        None,
        _defs_view3d_add.bone_extrude,
        None,
        None,
        None,
        None,
    ...
    _3ixam_default = (
        ...
        *_tools_cube_planar,
        ...
        _defs_view3d_add.forces_icon,
        None,
        _defs_view3d_add.hexagon_add,  
        None,
        *_tools_cone_group,
        None,
        _defs_view3d_add.bone_add,
        None,
        _defs_view3d_generic.material,
        _defs_view3d_light.light_icon,
        None,
        _defs_view3d_render.render, 
        None,
        _defs_view3d_select.modifiers,
        _defs_view3d_select.constraints,
        None,
        _defs_view3d_generic.folders,  #TODO Folders
        _defs_view3d_generic.parameters,  #TODO Parameters
