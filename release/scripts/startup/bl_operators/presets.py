...
class ExecutePreset(Operator):
    ...
    def execute(self, context):
        ...
        display_name = bpy.path.display_name(basename(filepath), title_case=False)
        preset_class.bl_label = display_name
        ...
        if ext == ".py":
            ...
            if preset_class is bpy.types.USERPREF_MT_interface_theme_presets:
                context.preferences.current_theme = display_name
