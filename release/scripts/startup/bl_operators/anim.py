...
class NLA_OT_bake(Operator):
    ...
    only_selected: BoolProperty(
        name="Only Selected Joints",
        description="Only key selected joints (Pose baking only)",
        default=True,
    )
    ...
    clear_constraints: BoolProperty(
        ...
        description="Remove all constraints from keyed object/joints, and do 'visual' keying",
        default=False,
    )
    ...
    use_current_action: BoolProperty(
        ...
        "(useful for baking only part of joints in an rig)",
        default=False,
    )
    ...
    bake_types: EnumProperty(
        ...
        options={'ENUM_FLAG'},
        items=(
             ('POSE', "Pose", "Bake joints transformations"),
