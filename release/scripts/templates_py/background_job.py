# This script is an example of how you can run ixam from the command line
...
#  ixam --background --factory-startup --python $HOME/background_job.py -- \
#          --text="Hello World" \
#          --render="/tmp/hello" \
#          --save="/tmp/hello.ixam"
#
...
#
# '--' causes ixam to ignore all following arguments so python can use them.
#
# See ixam --help for details.
...
def main():
    ...
    # get the args passed to 3IXAM after "--", all of which are ignored by
    # ixam so scripts may receive their own arguments
    argv = sys.argv
    ...
    usage_text = (
        "Run ixam in background mode with this script:"
        "  ixam --background --python " + __file__ + " -- [options]"
    )
