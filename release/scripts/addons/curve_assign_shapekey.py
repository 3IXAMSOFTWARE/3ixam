...
# This Ixam add-on assigns one or more Bezier Curves as shape keys to another
# Bezier Curve
#
# Supported Ixam Versions: 2.8x
#
...
bl_info = {
    ...
    "doc_url": "{IXAM_MANUAL_URL}/addons/add_curve/assign_shape_keys.html",
    "category": "Add Curve",
}
