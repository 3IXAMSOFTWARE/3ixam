...
bl_info = {
    ...
    "doc_url": "{IXAM_MANUAL_URL}/addons/import_export/scene_dxf.html",
...
class IMPORT_OT_dxf(bpy.types.Operator):
    ...
    merge: BoolProperty(
            name="Merged Objects",
            description="Merge DXF entities to Ixam objects",
            default=T_Merge,
    ...
    merge_options: EnumProperty(
            name="Merge",
            description="Merge multiple DXF entities into one Ixam object",
            items=[('BY_LAYER', "By Layer", "Merge DXF entities of a layer to an object"),
                   ...
                   ('BY_CLOSED_NO_BULGE_POLY', "By Layer AND closed no-bulge polys", "Polys can have a transformation attribute that makes DXF polys resemble Ixam mesh faces quite a bit. Merging them results in one MESH object."),
