...
bl_info = {
    ...
    "warning": "",
    "doc_url": "{IXAM_MANUAL_URL}/addons/3d_view/precision_drawing_tools/index.html",
    "category": "3D View",
}
...
class PDTPreferences(AddonPreferences):
    ...
    debug: BoolProperty(
        ...
        default=False,
        description="NOTE: Does not enable debugging globally in Ixam (only in PDT scripts)",
    )
...
def enumlist_objects(self, context):
    ...
    Args:
        context: Ixam bpy.context instance.
...
class PDTSceneProperties(PropertyGroup):
    ...
    trig_cycles : IntProperty(name="Real #", default=1, min=1,
    ...
    trig_len : FloatProperty(name="Cycle Length", default=2, min=0.02,
        description="Length in Ixam Units of 1 Cycle")
