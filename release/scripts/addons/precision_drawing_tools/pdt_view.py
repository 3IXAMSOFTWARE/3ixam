...
class PDT_OT_Reset3DView(Operator):
    ...
    bl_options = {"REGISTER", "UNDO"}
    bl_description = "Reset 3D View to Ixam Defaults"

    def execute(self, context):
        """Reset 3D View to Ixam Defaults.
