...
# --- example usage
ixam --python release/scripts/addons/system_demo_mode/demo_mode.py
...
# ---
/data/src/ixam/lib/tests/rendering/
"""
...
def demo_mode_init():
    ...
    if global_config["mode"] == 'PLAY':
        ...
        try:
            # XXX - without this rendering will crash because of a bug in ixam!
