...
Used as a ixam script, it load all the stl files in the scene:

ixam --python stl_utils.py -- file1.stl file2.stl file3.stl ...
"""
...
def _header_version():
    import bpy
    return "Exported from Ixam-" + bpy.app.version_string
...
if __name__ == '__main__':
    import sys
    import bpy
    from io_mesh_stl import ixam_utils
    ...
    for filepath in filepaths:
        ...
        ixam_utils.create_and_link_mesh(objName, tris, pts)
