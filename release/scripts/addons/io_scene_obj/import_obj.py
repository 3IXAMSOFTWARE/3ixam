...
"""
This script imports a Wavefront OBJ files to Ixam.

Usage:
Run this script from "File->Import" menu and then load the desired OBJ file.
Note, This loads mesh objects and materials only, nurbs and curves are not supported.

http://wiki.ixam.org/index.php/Scripts/Manual/Import/wavefront_obj
"""
...
def create_materials(filepath, relpath,
    ...
    def load_material_image(ixam_material, mat_wrap, context_material_name, img_data, line, type):
        """
            ...
            for line in mtl:  # .readlines():
                ...
                if line_id == b'newmtl':
                    ...
                    if line_id == b'ka':
                        ...
                        # rgb, filter color, ixam has no support for this.
...
def create_nurbs(context_nurbs, vert_loc, new_objects):
    """
    Add nurbs object to ixam, only support one type at the moment
    """
...
def load(context,
    ...
    def create_face(context_material, context_smooth_group, context_object_key):
        ...
        return (
            ...
            context_smooth_group,
            context_object_key,
            [],  # If non-empty, that face is a Ixam-invalid ngon (holes...), need a mutable object for that...
        )
        ...
        with open(filepath, 'rb') as f:
            for line in f:
                ...
                if vdata_len:
                    ...
                    if not context_multi_line:
                        # Means we have finished a face, we have to do final check if ngon is suspected to be ixam-invalid...
                        if face_invalid_blenpoly:
