...
def write_mtl(scene, filepath, path_mode, copy_set, mtl_dict):
    ...
    with open(filepath, "w", encoding="utf8", newline="\n") as f:
        ...
        for mtl_mat_name, mat in mtl_dict_values:
            # Get the Ixam data for the material and the image.
...
def write_nurb(fw, ob, ob_mat):
    ...
    for nu in cu.splines:
        ...
        fw('curv 0.0 1.0 %s\n' % (" ".join([str(i) for i in curve_ls])))  # Ixam has no U and V values for the curve
...
def write_file(filepath, objects, depsgraph, scene,
    ...
    eg.
    write( 'c:\\test\\foobar.obj', Ixam.Object.GetSelected() ) # Using default options.
    """
...
def save(context,
    ...
    _write(context, filepath,
           ...
           EXPORT_BLEN_OBS=use_ixam_objects,
