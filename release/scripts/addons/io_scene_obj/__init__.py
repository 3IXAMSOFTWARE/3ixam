...
bl_info = {
    ...
    "warning": "",
    "doc_url": "{IXAM_MANUAL_URL}/addons/import_export/scene_obj.html",
    "support": 'OFFICIAL',
...
class ImportOBJ(bpy.types.Operator, ImportHelper):
    ...
    use_split_objects: BoolProperty(
        name="Object",
        description="Import OBJ Objects into Ixam Objects",
        default=True,
    )
    use_split_groups: BoolProperty(
        name="Group",
        description="Import OBJ Groups into Ixam Objects",
        default=False,
    )
...
class ExportOBJ(bpy.types.Operator, ExportHelper):
    ...
    # grouping group
    use_ixam_objects: BoolProperty(
        name="OBJ Objects",
        description="Export Ixam objects as OBJ objects",
        default=True,
    )
    group_by_object: BoolProperty(
        name="OBJ Groups",
        description="Export Ixam objects as OBJ groups",
        default=False,
    )
...
class OBJ_PT_export_include(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.prop(operator, 'use_ixam_objects')
