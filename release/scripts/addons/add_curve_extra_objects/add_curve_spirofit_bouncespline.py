...
bl_info = {
    ...
    "warning": "",
    "doc_url": "{IXAM_MANUAL_URL}/addons/add_curve/extra_objects.html",
    "category": "Object",
}
...
# Spirofit, original ixam 2.45 script by: Antonio Osprite
...
# https://ixamartists.org/forum/showthread.php?331750-Fiber-Mesh-Emulation
# ------------------------------------------------------------
def noise(var=1):
