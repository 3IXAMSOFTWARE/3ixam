...
#-----------------------------------------------------
def mesh_drawIxam(vertList, edgeList, faceList, name="dxfMesh", flatten=False, AT_CUR=True, link=True):
    #print 'deb:mesh_drawIxam started XXXXXXXXXXXXXXXXXX' #---------
...
#-----------------------------------------------------
def curve_drawIxam(vertList, org_point=[0.0,0.0,0.0], closed=0, name="dxfCurve", flatten=False, AT_CUR=True, link=True):
    #print 'deb:curve_drawIxam started XXXXXXXXXXXXXXXXXX' #---------
