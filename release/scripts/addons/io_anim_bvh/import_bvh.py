...
def load(
    ...
    if bvh_frame_time is None:
        report(
            ...
            "section, assuming the BVH and Ixam scene have the same "
            "frame rate"
        )
    ...
    if update_scene_fps:
        ...
        # Now that we have a 1-to-1 mapping of Ixam frames and BVH frames, there is no need
