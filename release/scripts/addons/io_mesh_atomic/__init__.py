...
#  Homepage(Wiki)    : http://development.root-1.de/Atomic_Ixam.php
#
#  Start of project                  : 2011-08-31 by CB
#  First publication in Ixam      : 2011-11-11 by CB
...
bl_info = {
    "name": "Atomic Ixam PDB/XYZ",
    "description": "Importing atoms listed in PDB or XYZ files as balls into Ixam",
    "author": "Clemens Barth",
    "version": (1, 8),
    "ixam": (2, 80, 0),
    "location": "File -> Import -> PDB (.pdb) and File -> Import -> XYZ (.xyz)",
    "warning": "",
    "doc_url": "{IXAM_MANUAL_URL}/addons/import_export/mesh_atomic.html",
