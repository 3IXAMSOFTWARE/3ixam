...
# During executing Atomic Ixam, the list will be initialized with the fixed
    ...
    while j > -1:
        ...
        # If 'ATOM or 'HETATM' appears in the line then do ...
            ...
            if line[12:13] == " " or line[12:13].isdigit() == True:
                ...
                print("Atomic Ixam: Strange error in PDB file.\n"
...
def camera_light_source(use_camera,
    ...
    if use_light == True:
        ...
        # distance of 58. This value was determined manually inside Ixam.
...
def import_pdb(Ball_type,
    ...
    # Ixam scene and changing the color of this atom, one changes the color
