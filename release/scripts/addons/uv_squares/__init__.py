#    <Uv Squares, 3IXAM addon for reshaping UV vertices to grid.>
...
bl_info = {
    ...
    "category": "UV",
    "wiki_url": "http://wiki.3ixam.com/index.php/Extensions:2.6/Py/Scripts/UV/Uv_Squares"
}
...
def main1(obj, context, operator, square, snapToClosest):
    ...
    # bm.faces.layers.tex.verify()  # currently ixam needs both layers.
...
def register():
    ...
    # we can add operators manually instead
    #menu
