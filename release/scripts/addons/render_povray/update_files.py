...
# Todo:
# *update this file to just cover 2.79 to  3.xx and ui it from a Ixam internal to pov menu
...
# be salvaged from older version of this operator from within latest stable ixam 2.79 version.
# else if bpy.app.version[0] == 2 and bpy.app.version[1] <= 92 and and bpy.app.version[1] >= 79:
# warn users to update ixam to 3.xx for creating their newer files then try to salvage
# using this script
#
...
def update2_0_0_9():
    """Update properties from older Ixam versions. The render API changed a lot up to  2.79."""
