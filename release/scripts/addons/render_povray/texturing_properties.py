...
class WorldTextureSlot(PropertyGroup):
    ...
    bl_idname = ("pov_texture_slots",)
    bl_description = ("Texture_slots from Ixam-2.79",)
...
# ---------------------------------------------------------------- #
# Space properties from  removed former Ixam Internal
# ---------------------------------------------------------------- #
...
class RenderPovSettingsTexture(PropertyGroup):
    ...
    # former Space properties from removed Ixam Internal
    ...
    tex_pattern_type: EnumProperty(
        name="Texture_Type",
        description="Choose between Ixam or POV parameters to specify texture",
        items=(
            ...
            ("emulator", "Ixam Type Emulator", "", "SCRIPTPLUGINS", 37),
        ),
        default="emulator",
    )
