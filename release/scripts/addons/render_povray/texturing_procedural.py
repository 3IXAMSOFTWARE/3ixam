...
"""Use Ixam procedural textures exported to POV patterns."""

import bpy


def export_pattern(texture):
    """Translate Ixam procedural textures to POV patterns and write to pov file.
    ...
    if tex.type not in {"NONE", "IMAGE"} and pat.tex_pattern_type == "emulator":
        ...
        # ------------------------- EMULATE IXAM DISTORTED NOISE TEXTURE ------------------------- #
