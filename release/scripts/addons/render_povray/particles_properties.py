...
class MaterialStrandSettings(PropertyGroup):
    ...
    root_size: FloatProperty(
        name="Root",
        description="Start size of strands in pixels or Ixam units",
        min=0.25,
        default=1.0,
        precision=5,
    )
    ...
    tip_size: FloatProperty(
        name="Tip",
        description="End size of strands in pixels or Ixam units",
        min=0.0,
        default=1.0,
        precision=5,
    )

    use_ixam_units: BoolProperty(
        name="Ixam Units",
        description="Use Ixam units for widths instead of pixels",
        default=False,
    )
