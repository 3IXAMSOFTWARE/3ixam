...
def write_object_material_interior(file, material, ob, tab_write):
    """Translate some object level material from Ixam UI (VS data level)
    ...
    if material.pov.use_transparency and material.pov.transparency_method == "RAYTRACE":
        # fade_distance
        # In Ixam this value has always been reversed compared to what tooltip says.
...
def write_material(
    ...
    """Translate Ixam material to POV texture{} block and write in exported file."""
    ...
    def pov_has_no_specular_maps(file, ref_level_bound):
        """Translate Ixam specular map influence to POV finish map trick and write to file."""
        ...
        if material:
            ...
            # (the back diffuse is like ixam translucency)
            ...
            if material.pov.diffuse_shader == "OREN_NAYAR" and ref_level_bound != 3:
                # Ixam roughness is what is generally called oren nayar Sigma,
            ...
            if ref_level_bound == 2:
                # ------------------------------ Specular Shader ------------------------------ #
                # No difference between phong and cook torrence in ixam HaHa!
                ...
                # POV-Ray 'specular' keyword corresponds to a Blinn model, without the ior.
                    ...
                    # Use ixam Blinn's IOR just as some factor for spec intensity
                    tab_write(
                        file,
                        "specular %.3g\n"
