...
"""
#group some native Ixam (SSS) and POV (Fade)settings under such a parent panel?
...
class MATERIAL_PT_strand(MaterialButtonsPanel, Panel):
    """Use this class to define Ixam strand antialiasing buttons."""
