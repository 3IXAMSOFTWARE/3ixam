...
"""Translate ixam texture influences into POV."""
import os
import bpy
...
def write_texture_influence(
    ...
    """Translate Ixam texture influences to various POV texture tricks and write to pov file."""
    ...
    # Close first layer of POV "texture" (Ixam material)
    tab_write(file, "}\n")
