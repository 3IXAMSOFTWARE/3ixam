...
class UI_OT_i18n_edittranslation_update_mo(Operator):
    """Try to "compile" given po file into relevant ixam.mo file"""
...
class UI_OT_i18n_edittranslation(Operator):
    ...
    update_po: BoolProperty(
        description="Update po file, try to rebuild mo file, and refresh Ixam's UI",
        default=False,
        options={'SKIP_SAVE'},
    )

    update_mo: BoolProperty(
        description="Try to rebuild mo file, and refresh Ixam's UI",
        default=False,
        options={'SKIP_SAVE'},
    )
