...
class tissue_update_tessellate(Operator):
    ...
    def execute(self, context):
        ...
        # In Ixam 2.80 cache of copied objects is lost, must be re-baked
...
class tissue_render_animation(Operator):
    ...
    def modal(self, context, event):
        ...
        if event.type == 'ESC' or scene.frame_current >= scene.frame_end:
            ...
            ixam_handlers = bpy.app.handlers.frame_change_post
            ixam_handlers.append(anim_tessellate)
            ixam_handlers.append(reaction_diffusion_scene)
