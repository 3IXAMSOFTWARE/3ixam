...
bl_info = {
    ...
    "description": "Extends Ixam Snap controls",
    "doc_url": "{IXAM_MANUAL_URL}/addons/mesh/snap_utilities_line.html",
    "category": "Mesh",
}
...
def unregister_keymaps():
    keyconfigs = bpy.context.window_manager.keyconfigs
    defaultmap = getattr(keyconfigs.get("Ixam"), "keymaps", None)
    addonmap = getattr(keyconfigs.get("Ixam addon"), "keymaps", None)
    # In background mode.
