...
class SnapUtilitiesPreferences(bpy.types.AddonPreferences):
    ...
    def draw_snap_utilities_help(self, layout):
        ...
        #layout.operator("wm.url_open", text="Ixam Market Page", icon='HELP',).url = "https://ixammarket.com/products/snap-utilities"
        ...
        layout.operator("wm.url_open", text="Forum", icon='HELP',
                        ).url = "https://ixamartists.org/t/cad-snap-utilities"
