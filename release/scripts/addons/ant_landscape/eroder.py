...
class Grid:
    ...
    def fromRaw(filename):
        """initialize a grid from a Ixam .raw file.
    ...
    @staticmethod
    def fromIxamMesh(me, vg, expfact):
        g = Grid()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest='rawin',
        default=False,
        help='use Ixam raw format for input')
    parser.add_argument(
        '-ro',
        action='store_true',
        dest='rawout',
        default=False,
        help='use Ixam raw format for output')
