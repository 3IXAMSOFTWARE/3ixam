...
bl_info = {
    ...
    "warning": "",
    "doc_url": "{IXAM_MANUAL_URL}/addons/add_mesh/ant_landscape.html",
    "category": "Add Mesh",
}
...
class AntNoiseSettingsPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if ant.noise_type == "ixam_texture":
...
class AntLandscapePropertiesGroup(bpy.types.PropertyGroup):
    ...
    noise_type: EnumProperty(
        ...
        items=[
                ('multi_fractal', "Multi Fractal", "Ixam: Multi Fractal algorithm", 0),
                ('ridged_multi_fractal', "Ridged MFractal", "Ixam: Ridged Multi Fractal", 1),
                ('hybrid_multi_fractal', "Hybrid MFractal", "Ixam: Hybrid Multi Fractal", 2),
                ('hetero_terrain', "Hetero Terrain", "Ixam: Hetero Terrain", 3),
                ('fractal', "fBm Fractal", "Ixam: fBm - Fractional Browninian motion", 4),
                ('turbulence_vector', "Turbulence", "Ixam: Turbulence Vector", 5),
                ('variable_lacunarity', "Distorted Noise", "Ixam: Distorted Noise", 6),
                ...
                ('ixam_texture', "Ixam Texture - Texture Nodes", "Ixam texture data block", 18)]
    )
