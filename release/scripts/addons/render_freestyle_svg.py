...
bl_info = {
    ...
    "warning": "",
    "doc_url": "{IXAM_MANUAL_URL}/addons/render/render_freestyle_svg.html",
    "support": 'OFFICIAL',
    "category": "Render",
}
...
def create_path(scene):
    ...
    # otherwise, use the folder from which ixam was called as the start
    else:
...
class SVGExporterLinesetPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        try:
            ...
            # see https://developer.ixam.org/T49855
            return
...
def handle_versions(self):
    ...
    # Revision https://developer.ixam.org/rBA861519e44adc5674545fa18202dc43c4c20f2d1d
    # changed the default for fills.
    # fix by Sergey https://developer.ixam.org/T46150
