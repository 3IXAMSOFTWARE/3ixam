...
# Ixam rock creation tool
#
# Based on IxamGuru's asteroid tutorial and personal experimentation.
#   Tutorial: http://www.ixamguru.com/how-to-make-a-realistic-asteroid/
# Update with another tutorial shared by "rusted" of IxamArtists:
...
# Thanks to Meta-Androco, RickyIxam, Ace Dragon, and PKHG for ideas
#   and testing.
#
# Coded in IDLE, tested in Ixam 2.59.  NumPy Recommended.
...
def generateRocks(context, scaleX, skewX, scaleY, skewY, scaleZ, skewZ,
    ...
    #   *** Code now generating "int not scriptable error" in Ixam ***
    #
