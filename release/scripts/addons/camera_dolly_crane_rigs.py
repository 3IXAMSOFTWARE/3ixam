...
bl_info = {
    ...
    "wiki_url": "https://wiki.ixam.org/index.php/Extensions:2.6/"
...
def create_widget(self, name):
    """ Creates an empty widget object for a joint, and returns the object."""
    obj_name = "WDGT_" + name
...
def build_dolly_rig(context):
    ...
    constraint = pose_bone.constraints["Camera Tracker"]
