...
It's called "global" to avoid confusion with the Ixam World data-block.
"""
...
class OBJECT_OT_copy_global_transform(Operator):
    ...
    # This operator cannot be un-done because it manipulates data outside Ixam.
    bl_options = {'REGISTER'}
...
class OBJECT_OT_paste_transform(Operator):
    ...
    def parse_print_m4(value: str) -> Optional[Matrix]:
        """Parse output from Ixam's print_m4() function.
