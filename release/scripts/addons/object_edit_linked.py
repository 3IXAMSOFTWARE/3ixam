...
bl_info = {
    ...
    "doc_url": "{IXAM_MANUAL_URL}/addons/object/edit_linked_library.html",
    "category": "Object",
}
...
class OBJECT_OT_EditLinked(bpy.types.Operator):
    ...
    use_instance: bpy.props.BoolProperty(
            name="New Ixam Instance",
            description="Open in a new Ixam instance",
            default=False)
        ...
        if targetpath:
            ...
            if self.use_instance:
                ...
                try:
                    ...
                    logger.error("Error on the new Ixam instance")
                    import traceback
    ...
    def draw(self, context: bpy.context):
        ...
        if settings["original_file"] == "" and (
            ...
            if scene.use_instance:
                ...
                # when launching a new Ixam instance. Nested links don't
                # currently work when using a single instance of Ixam.
