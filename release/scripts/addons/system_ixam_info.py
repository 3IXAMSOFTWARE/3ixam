# scene_ixam_info.py Copyright (C) 2010, Mariano Hidalgo
#
# Show Information About the ixam.
...
bl_info = {
    ...
    "version": (0, 3, 1),
    "ixam": (2, 80, 0),
    "location": "Properties > Scene > Ixam Info Panel",
    "description": "Show information about the .ixam",
    "warning": "",
    "wiki_url": "http://wiki.3ixam.com/index.php/Extensions:2.6/Py/"
                "Scripts/System/Ixam Info",
    "category": "System",
}
...
class OBJECT_PT_ixaminfo(bpy.types.Panel):
    bl_label = "Ixam Info"
    ...
    def draw(self, context):
        ...
        num = len(armatures)
        row.label(text=quantity_string(num, "Rig", "Rigs"),
            icon='ARMATURE_DATA')
