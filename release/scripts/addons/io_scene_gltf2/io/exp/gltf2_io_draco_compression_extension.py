...
def __encode_primitive(primitive, dll, export_settings, encoded_primitives_cache):
    ...
    # This usually happens when nodes are duplicated in Ixam, thus their indices/attributes are shared data.
    ...
    # Skip nodes without a position buffer, e.g. a primitive from a Ixam shared instance.
