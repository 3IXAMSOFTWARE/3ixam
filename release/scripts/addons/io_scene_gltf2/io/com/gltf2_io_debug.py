...
def print_console(level, output):
    """Print to Ixam console with a given header and output."""
...
def print_newline():
    """Print a new line to Ixam console."""
    print()
...
def print_timestamp(label=None):
    """Print a timestamp to Ixam console."""
...
# TODO: this logger is used for importer, but in io and in ixam part, but is written here in a _io_ file
class Log:
