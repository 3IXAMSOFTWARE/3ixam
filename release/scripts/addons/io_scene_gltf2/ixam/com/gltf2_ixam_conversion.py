...
def texture_transform_ixam_to_gltf(mapping_transform):
    """
    Converts the offset/rotation/scale from a Mapping node applied in Ixam's
...
def texture_transform_gltf_to_ixam(texture_transform):
    """
    Converts a KHR_texture_transform into the equivalent offset/rotation/scale
    for a Mapping node applied in Ixam's UV space.
    """
