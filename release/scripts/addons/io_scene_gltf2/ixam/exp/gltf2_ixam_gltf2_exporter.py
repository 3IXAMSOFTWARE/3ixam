...
class GlTF2Exporter:
    ...
    def __init__(self, export_settings):
        ...
        copyright = export_settings[gltf2_ixam_export_keys.COPYRIGHT] or None
        asset = gltf2_io.Asset(
            copyright=copyright,
            extensions=None,
            extras=None,
            generator='Khronos glTF Ixam I/O v' + get_version_string(),
            min_version=None,
            version='2.0')
    ...
    def finalize_images(self):
        ...
        Write all images.
        """
        output_path = self.export_settings[gltf2_ixam_export_keys.TEXTURE_DIRECTORY]
    ...
    def __add_image(self, image: gltf2_io_image_data.ImageData):
        ...
        texture_dir = self.export_settings[gltf2_ixam_export_keys.TEXTURE_DIRECTORY]
        abs_path = os.path.join(texture_dir, name + image.file_extension)
        rel_path = os.path.relpath(
            abs_path,
            start=self.export_settings[gltf2_ixam_export_keys.FILE_DIRECTORY],
        )
