...
from .gltf2_ixam_pbrMetallicRoughness import MaterialHelper, pbr_metallic_roughness
from .gltf2_ixam_KHR_materials_pbrSpecularGlossiness import pbr_specular_glossiness
from .gltf2_ixam_KHR_materials_unlit import unlit
...
class IxamMaterial():
    ...
    def create(gltf, material_idx, vertex_color):
        ...
        pymaterial.ixam_material[vertex_color] = mat.name

        set_extras(mat, pymaterial.extras)
        IxamMaterial.set_double_sided(pymaterial, mat)
        IxamMaterial.set_alpha_mode(pymaterial, mat)
        IxamMaterial.set_viewport_color(pymaterial, mat, vertex_color)
        ...
        # We need to store link between material idx in glTF and Ixam Material id
