...
from ..com.gltf2_ixam_material_helpers import get_gltf_node_name, create_settings_group
from .gltf2_ixam_texture import texture
from .gltf2_ixam_KHR_materials_clearcoat import \
    clearcoat, clearcoat_roughness, clearcoat_normal
from .gltf2_ixam_KHR_materials_transmission import transmission
from .gltf2_ixam_KHR_materials_ior import ior
from .gltf2_ixam_KHR_materials_volume import volume
from .gltf2_ixam_KHR_materials_specular import specular
from .gltf2_ixam_KHR_materials_sheen import sheen
...
def make_settings_node(mh):
    """
    Make a Group node with a hookup for Occlusion. No effect in Ixam, but
