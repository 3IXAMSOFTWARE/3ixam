...
from .gltf2_ixam_animation_node import IxamNodeAnim
from .gltf2_ixam_animation_weight import IxamWeightAnim
from .gltf2_ixam_animation_utils import simulate_stash, restore_animation_on_object
    ...
    def anim(gltf, anim_idx):
        ...
        for vnode_id in gltf.vnodes:
            if isinstance(vnode_id, int):
                IxamNodeAnim.anim(gltf, anim_idx, vnode_id)
            IxamWeightAnim.anim(gltf, anim_idx, vnode_id)
    ...
    def restore_animation(gltf, animation_name):
        ...
        for vnode_id in gltf.vnodes:
            ...
            if vnode.type == VNode.Bone:
                obj = gltf.vnodes[vnode.bone_arma].ixam_object
