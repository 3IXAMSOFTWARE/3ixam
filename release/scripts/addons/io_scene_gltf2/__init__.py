...
bl_info = {
    ...
    'warning': '',
    'doc_url': "{IXAM_MANUAL_URL}/addons/import_export/scene_gltf2.html",
    'tracker_url': "https://github.com/KhronosGroup/glTF-Ixam-IO/issues/",
    'support': 'OFFICIAL',
...
#
# Script reloading (if the user calls 'Reload Scripts' from Ixam)
#
...
class ConvertGLTF2_Base:
    ...
    convert_lighting_mode: EnumProperty(
        ...
        items=(
            ...
            ('RAW', 'Raw (Deprecated)', 'Ixam lighting strengths with no conversion'),
        ),
...
class ExportGLTF2_Base(ConvertGLTF2_Base):
    ...
    export_original_specular: BoolProperty(
        ...
        description=(
            'Export original glTF PBR Specular, instead of Ixam Principled Shader Specular'
        ),
        default=False,
    )
    ...
    will_save_settings: BoolProperty(
        ...
        description='Store glTF export settings in the Ixam project',
        default=False)
    ...
    def execute(self, context):
        import os
        import datetime
        from .ixam.exp import gltf2_ixam_export
        ...
        return gltf2_ixam_export.save(context, export_settings)
...
class ImportGLTF2(Operator, ConvertGLTF2_Base, ImportHelper):
    ...
    bone_heuristic: EnumProperty(
        name="Bone Dir",
        items=(
            ("IXAM", "Ixam (best for re-importing)",
                "Good for re-importing glTFs exported from Ixam. "
    ...
    def unit_import(self, filename, import_settings):
        ...
        from .ixam.imp.gltf2_ixam_gltf import IxamGlTF
        ...
        try:
            ...
            print("Data are loaded, start creating Ixam stuff")

            start_time = time.time()
            IxamGlTF.create(gltf_importer)
...
def gltf_variant_ui_update(self, context):
    from .ixam.com.gltf2_ixam_ui import variant_register, variant_unregister
...
def register():
    import io_scene_gltf2.ixam.com.gltf2_ixam_ui as ixam_ui
    for c in classes:
