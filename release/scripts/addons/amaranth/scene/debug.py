...
class AMTH_SCENE_OT_ixam_instance_open(Operator):
    """Open in a new Ixam instance"""
    bl_idname = "scene.ixam_instance_open"
    bl_label = "Open Ixam Instance"
    ...
    def execute(self, context):
        if self.filepath:
            ...
            try:
                ...
                print("Error opening a new Ixam instance")
                import traceback
                traceback.print_exc()
    ...
    def draw(self, context):
        ...
        if AMTH_store_data.obj_mat_slots_lib:
            ...
            for ilib, libs in enumerate(AMTH_store_data.obj_mat_slots_lib):
                ...
                row.alignment = "LEFT"
                row.operator(
                    AMTH_SCENE_OT_ixam_instance_open.bl_idname,
...
classes = (
    ...
    AMTH_SCENE_OT_ixam_instance_open,
