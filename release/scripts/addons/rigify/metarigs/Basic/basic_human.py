...
def create(obj):
    ...
    pbone.bone.layers = [False, False, False, True, False, False, False, False, False, False]
    try:
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    pbone.bone.layers = [False, False, False, False, False, False, False, False, True, False]
    try:
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    pbone.bone.layers = [False, False, False, False, False, False, False, True, False, False]
    try:
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    pbone.bone.layers = [False, False, False, False, False, False, True, False, False, False]
    try:
        pbone.rigify_parameters.ik_local_location = False
    except AttributeError:
        pass
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    pbone.bone.layers = [False, False, False, False, False, False, False, False, False, True]
    try:
        pbone.rigify_parameters.ik_local_location = False
    except AttributeError:
        pass
    ...
    arm.layers = [(x in [3, 7, 10, 13, 16]) for x in range(10)]
