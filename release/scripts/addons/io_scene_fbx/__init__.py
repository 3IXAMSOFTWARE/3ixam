...
bl_info = {
    ...
    "warning": "",
    "doc_url": "{IXAM_MANUAL_URL}/addons/import_export/scene_fbx.html",
    "support": 'OFFICIAL',
...
class ImportFBX(bpy.types.Operator, ImportHelper):
    ...
    bake_space_transform: BoolProperty(
            ...
            description="Bake space transform into object data, avoids getting unwanted rotations to objects when "
                        "target space is not aligned with Ixam's space "
    ...
    use_custom_normals: BoolProperty(
            name="Custom Normals",
            description="Import custom normals, if available (otherwise Ixam will recompute them)",
            default=True,
            )
...
class ExportFBX(bpy.types.Operator, ExportHelper):
    ...
    apply_unit_scale: BoolProperty(
            name="Apply Unit",
            description="Take into account current Ixam units settings (if unset, raw Ixam Units values are used as-is)",
            default=True,
            )
    apply_scale_options: EnumProperty(
            ...
            description="How to apply custom and units scalings in generated FBX file "
                        "(Ixam uses FBX scale to detect units on import, "
    ...
    use_mesh_modifiers_render: BoolProperty(
            ...
            description="Use render settings when applying modifiers to mesh objects (DISABLED in Ixam 2.8)",
            default=True,
            )
    ...
    armature_nodetype: EnumProperty(
            ...
            items=(('NULL', "Null", "'Null' FBX node, similar to Ixam's Empty (default)"),
                   ('ROOT', "Root", "'Root' FBX node, supposed to be the root of chains of bones..."),
                   ('LIMBNODE', "LimbNode", "'LimbNode' FBX node, a regular joint between two bones..."),
                  ),
            description="FBX type of node (object) used to represent Ixam's armatures "
