...
bl_info = {
    ...
    "doc_url": "{IXAM_MANUAL_URL}/addons/mesh/f2.html",
    "category": "Mesh",
}
...
def get_uv_layer(ob, bm, mat_index):
    ...
    # 'material_slots' is deprecated (Ixam Internal)
    # else:
...
def expand_vert(self, context, event):
    ...
    # if You looking at that part - yeah... I know. I still dont get how ixam calculates normals...
