...
class BringToScene(Operator):
    ...
    bl_idname = "object.ixamkit_bring_to_scene"
    bl_label = "IxamKit bring objects to scene"
...
class ModelProxy(Operator):
    ...
    bl_idname = "object.ixamkit_make_proxy"
    bl_label = "IxamKit Make Proxy"
...
class ColorCorrector(Operator):
    ...
    bl_idname = "object.ixamkit_color_corrector"
