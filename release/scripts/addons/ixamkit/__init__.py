...
bl_info = {
    "name": "IxamKit Asset Library",
    "author": "Vilem Duha, Petr Dlouhy",
    "version": (1, 0, 28),
    "ixam": (2, 80, 0),
    "location": "View3D > Properties > IxamKit",
    "description": "Online IxamKit library (materials, models, brushes and more)",
    "warning": "",
    "wiki_url": "https://youtu.be/1hVgcQhIAo8"
                "Scripts/Add_Mesh/IxamKit",
    "category": "Add Mesh",
}
...
if "bpy" in locals():
    ...
    from ixamkit import asset_inspector, search, download, upload, ratings, autothumb, ui, bg_ixam, paths, utils, \
...
# logging.basicConfig(filename = 'ixamkit.log', level = logging.INFO,
...
def scene_load(context):
    ...
    ui_props = bpy.context.scene.ixamkitUI
    ui_props.assetbar_on = False
    ui_props.turn_off = False
    preferences = bpy.context.preferences.addons['ixamkit'].preferences
...
engines = (
    ('CYCLES', 'Cycles', 'ixam cycles pathtracer'),
    ('EEVEE', 'Eevee', 'ixam eevee renderer'),
...
def get_upload_asset_type(self):
    typemapper = {
        IxamKitModelUploadProps: 'model',
        IxamKitSceneUploadProps: 'scene',
        IxamKitMaterialUploadProps: 'material',
        IxamKitBrushUploadProps: 'brush'
    }
...
class IxamKitUIProps(PropertyGroup):
...
class IxamKitCommonSearchProps(object):
    # STATES
...
def name_update(self, context):
    ''' checks for name change, because it decides if whole asset has to be re-uploaded. Name is stored in the ixam file
...
class IxamKitCommonUploadProps(object):
    id: StringProperty(
...
class IxamKitRatingProps(PropertyGroup):
...
class IxamKitMaterialSearchProps(PropertyGroup, IxamKitCommonSearchProps):
...
class IxamKitMaterialUploadProps(PropertyGroup, IxamKitCommonUploadProps):
    style: EnumProperty(
        name="Style",
    ...
    thumbnail_background_lightness: FloatProperty(name="Thumbnail Background Lightness",
                                                  ...
                                                  min=0.00001, max=1)
    thumbnail_samples: IntProperty(name="Real Samples",
                                   description="Real samples setting", default=150,
                                   min=5, max=5000)
...
class IxamKitTextureUploadProps(PropertyGroup, IxamKitCommonUploadProps):
    style: EnumProperty(
        name="Style",
        items=material_styles,
...
class IxamKitBrushSearchProps(PropertyGroup, IxamKitCommonSearchProps):
    search_keywords: StringProperty(
        name="Search",
        description="Search for these keywords",
        default="",
...
class IxamKitBrushUploadProps(PropertyGroup, IxamKitCommonUploadProps):
    mode: EnumProperty(
        name="Mode",
        items=(
...
# upload properties
class IxamKitModelUploadProps(PropertyGroup, IxamKitCommonUploadProps):
    style: EnumProperty(
        name="Style",
        items=model_styles,
        description="Style of asset",
    ...
    thumbnail_samples: IntProperty(name="Real Samples",
                                   description="Real samples setting", default=200,
                                   min=5, max=5000)
    thumbnail_denoising: BoolProperty(name="Use Denoising",
                                      description="Use denoising", default=True)
...
class IxamKitSceneUploadProps(PropertyGroup, IxamKitCommonUploadProps):
    style: EnumProperty(
        name="Style",
        items=model_styles,
        description="Style of asset",
...
class IxamKitModelSearchProps(PropertyGroup, IxamKitCommonSearchProps):
    search_keywords: StringProperty(
        name="Search",
        description="Search for these keywords",
        default="",
...
class IxamKitSceneSearchProps(PropertyGroup, IxamKitCommonSearchProps):
    search_keywords: StringProperty(
        name="Search",
        description="Search for these keywords",
        default="",
...
class IxamKitAddonPreferences(AddonPreferences):
    ...
    api_key: StringProperty(
        name="IxamKit API Key",
        description="Your ixamkit API Key. Get it from your page on the website",
        default="",
        subtype="PASSWORD",
    ...
    login_attempt: BoolProperty(
        ...
        description="When this is on, IxamKit is trying to connect and login.",
        default=False
    )
    ...
    def draw(self, context):
        ...
        # layout.label(text='After you paste API Key, categories are downloaded, so ixam will freeze for a few seconds.')
...
classes = (
    ...
    IxamKitAddonPreferences,
    IxamKitUIProps,

    IxamKitModelSearchProps,
    IxamKitModelUploadProps,

    IxamKitSceneSearchProps,
    IxamKitSceneUploadProps,

    IxamKitMaterialUploadProps,
    IxamKitMaterialSearchProps,

    IxamKitTextureUploadProps,

    IxamKitBrushSearchProps,
    IxamKitBrushUploadProps,
...
def register():
    ...
    bpy.types.Scene.ixamkitUI = PointerProperty(
        type=IxamKitUIProps)

    # MODELS
    bpy.types.Scene.ixamkit_models = PointerProperty(
        type=IxamKitModelSearchProps)
    bpy.types.Object.ixamkit = PointerProperty(  # for uploads, not now...
        type=IxamKitModelUploadProps)
    bpy.types.Object.bkit_ratings = PointerProperty(  # for uploads, not now...
        type=IxamKitRatingProps)

    # SCENES
    bpy.types.Scene.ixamkit_scene = PointerProperty(
        type=IxamKitSceneSearchProps)
    bpy.types.Scene.ixamkit = PointerProperty(  # for uploads, not now...
        type=IxamKitSceneUploadProps)
    bpy.types.Scene.bkit_ratings = PointerProperty(  # for uploads, not now...
        type=IxamKitRatingProps)

    # MATERIALS
    bpy.types.Scene.ixamkit_mat = PointerProperty(
        type=IxamKitMaterialSearchProps)
    bpy.types.Material.ixamkit = PointerProperty(  # for uploads, not now...
        type=IxamKitMaterialUploadProps)
    bpy.types.Material.bkit_ratings = PointerProperty(  # for uploads, not now...
        type=IxamKitRatingProps)

    # BRUSHES
    bpy.types.Scene.ixamkit_brush = PointerProperty(
        type=IxamKitBrushSearchProps)
    bpy.types.Brush.ixamkit = PointerProperty(  # for uploads, not now...
        type=IxamKitBrushUploadProps)
...
def unregister():
    ...
    del bpy.types.Scene.ixamkit_models
    del bpy.types.Scene.ixamkit_scene
    del bpy.types.Scene.ixamkit_brush
    del bpy.types.Scene.ixamkit_mat

    del bpy.types.Scene.ixamkit
    del bpy.types.Object.ixamkit
    del bpy.types.Material.ixamkit
    del bpy.types.Brush.ixamkit
