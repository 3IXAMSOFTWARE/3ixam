...
if "bpy" in locals():
    ...
    from ixamkit import paths, utils, rerequests
...
class StarRatingOperator(bpy.types.Operator):
    """Tooltip"""
    bl_idname = "object.ixamkit_rating"
...
class UploadRatingOperator(bpy.types.Operator):
    ...
    bl_idname = "object.ixamkit_rating_upload"
...
def draw_rating(layout, props, prop_name, name):
    ...
    for a in range(0, 10):
        ...
        op = row.operator('object.ixamkit_rating', icon=icon, emboss=False, text='')
