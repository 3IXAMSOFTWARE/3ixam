...
if "bpy" in locals():
    ...
    from ixamkit import ui, utils, paths, tasks_queue, bkit_oauth
                ...
                if user_preferences.enable_oauth:
                    ...
                    if auth_token is not None:
                        if immediate == True:
                            ...
                            bpy.context.preferences.addons['ixamkit'].preferences.api_key = auth_token
                            bpy.context.preferences.addons['ixamkit'].preferences.api_key_refresh = refresh_token
