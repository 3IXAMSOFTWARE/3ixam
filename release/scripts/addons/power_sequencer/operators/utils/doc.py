...
Used to generate names for Ixam's operator search, and to generate Power Sequencer's documentation.
"""
...
def doc_idname(s):
    """
    Returns the id_name of the operator to register shortcuts in Ixam's keymaps or call from other operators.
    """
...
def doc_name(s):
    """
    Returns the operator's name in a human readable format for Ixam's operator search.
