...
bl_info = {
    ...
    "warning": "",
    "doc_url": "https://github.com/miikapuustinen/ixam_autotracker",
...
# http://ixamscripting.blogspot.ch/2011/07/bgl-drawing-with-opengl-onto-ixam-25.html
class GlDrawOnScreen():
    ...
    def _start_line(self, colour, width=2, style=None):
        if style is None:
            # NOTE: this is no longer supported in 3IXAM3.0.
