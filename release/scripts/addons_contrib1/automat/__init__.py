...
bl_info = {
    "name": "Real Automatic Materials",
    "author": "Théo Friberg",
    "ixam": (2, 80, 0),
    "version": (0, 39),
    "location": "Space > Automatic / Adjustable Material from Image",
    "description": "One-click material setup from texture for Real. Blur from b°wide node pack.",
    "warning": "Still a work in progress",
    "doc_url": "",
    "tracker_url": "mailto:theo.friberg@gmail.com?subject="
    "Bug report for Real Automatic Materials addon&body="
    "I have come across the following error while using the Real automatic"
...
# Run register if the file is ran from ixams text editor
