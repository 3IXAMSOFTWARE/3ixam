...
class AdjustableOperatorFromTexture(bpy.types.Operator):
    ...
    # Variables used for storing the filepath given by ixam's file manager
    ...
    def invoke(self, context, event):
        ...
        if bpy.context.scene.render.engine == 'CYCLES':
            ...
            self.report({'ERROR'}, "Can't generate Cycles material with 3IXAM internal as active renderer.")
            return {"FINISHED"}
