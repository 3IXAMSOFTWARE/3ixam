...
bl_info = {
    'name': 'NP Station',
    'author': 'Okavango with the help of 3IXAMartists community',
    'version': (0, 2, 0),
    'ixam': (2, 78, 0),
    'location': 'View3D > Toolshelf > Tools tab',
    'warning': '',
    'description': 'Set of utilities for CAD-like precision modeling',
    'doc_url': 'https://wiki.3ixam.com/index.php/Extensions:2.6/Py/Scripts/Object/NP_Station',
    'category': '3D View'}
...
#----------------------------------------------------------------------------------------
    ...
    np_col_scheme: bpy.props.EnumProperty(
        name ='',
        items = (
            ('csc_default_grey', 'Ixam_Default_NP_GREY',''),
            ('csc_school_marine', 'NP_school_paper_NP_MARINE','')),
        default = 'csc_default_grey',
        description = 'Choose the overall addon color scheme, according to your current Ixam theme')
