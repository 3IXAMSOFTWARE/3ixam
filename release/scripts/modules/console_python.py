...
def get_console(console_id):
    ...
    if consoles is None:
        ...
        # the window manager is normally loaded with new ixam files
...
def execute(context, is_interactive):
    ...
    # don't allow the stdin to be used, can lock ixam.
...
def autocomplete(context):
    ...
    # Now we need to copy back the line from ixam back into the
