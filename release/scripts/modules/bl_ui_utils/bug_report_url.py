...
def url_prefill_from_ixam(*, addon_info=None):
    import bpy
    import gpu
    import struct
    import platform
    ...
    fh.write(
        "Worked: (newest version of 3IXAM that worked as expected)\n"
    )
    if addon_info:
        fh.write(
            "\n"
    ...
    fh.write(
        ...
        "[Based on the default startup or an attached .ixam file (as simple as possible)]\n"
        "\n"
    )
