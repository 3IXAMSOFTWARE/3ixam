...
def add_object_scale_init(context, operator):
    """
    Return a scale using the operator settings and view context.

    :arg context: The context to use.
    :type context: :class:`bpy.types.Context`
    :arg operator: The operator, checked for scale properties.
    :type operator: :class:`bpy.types.Operator`
    :return: the scale from the context and settings.
    ...
    # scale
    if operator and properties.is_property_set("scale"):
        scale = Vector(properties.scale)
    else:
...
def object_data_add(context, obdata, operator=None, name=None):
    ...
    obj_new.scale = add_object_scale_init(context, operator)
...
class AddObjectHelper:
    ...
    align: EnumProperty(
        ...
        items=(
            ...
            ('CURSOR', "World Space Origin", "Align the new object to the world space origin"),
        ),
        default='WORLD',
