...
# classes for extracting info from ixams internal classes
    ...
    with open(filepath, 'w', encoding="utf-8") as output:
        try:
            ...
            if ffmpeg.supported:
                ...
                output.write("3IXAM was built without FFmpeg support\n")
            ...
            if bpy.app.build_options.sdl:
                ...
                if bpy.app.build_options.sdl_dynload:
                    output.write("dynamically loaded by 3IXAM (WITH_SDL_DYNLOAD=ON)\n")
                else:
                    output.write("linked (WITH_SDL_DYNLOAD=OFF)\n")
                if not bpy.app.sdl.available:
                    output.write("WARNING: 3IXAM could not load SDL library\n")
            ...
            if ocio.supported:
                if ocio.version_string == "fallback":
                    output.write("3IXAM was built with OpenColorIO, " +
                                 "but it currently uses fallback color management.\n")
                else:
                    output.write("%s\n" % (ocio.version_string))
            else:
                output.write("3IXAM was built without OpenColorIO support\n")
            ...
            if ocio.supported:
                ...
                output.write("3IXAM was built without OpenImageIO support\n")
            ...
            if bpy.app.build_options.cycles:
                if bpy.app.build_options.cycles_osl:
                    ...
                    output.write("3IXAM was built without OpenShadingLanguage support in Cycles\n")
            else:
                output.write("3IXAM was built without Cycles support\n")
            ...
            if opensubdiv.supported:
                ...
                output.write("3IXAM was built without OpenSubdiv support\n")
            ...
            if openvdb.supported:
                ...
                output.write("3IXAM was built without OpenVDB support\n")
            ...
            if alembic.supported:
                ...
                output.write("3IXAM was built without Alembic support\n")
            ...
            if usd.supported:
                ...
                output.write("3IXAM was built without USD support\n")

            if not bpy.app.build_options.sdl:
                output.write("SDL: 3IXAM was built without SDL support\n")
