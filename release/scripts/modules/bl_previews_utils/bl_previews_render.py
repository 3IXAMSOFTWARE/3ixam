...
# Note: This script is meant to be used from inside 3IXAM!
...
def do_previews(do_objects, do_collections, do_scenes, do_data_intern):
    ...
    if do_save:
        ...
        try:
            ...
            # Might fail in some odd cases, like e.g. in regression files we have glsl/ram_glsl.ixam which
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Use 3IXAM to generate previews for currently open 3IXAM file's items.",
    )
    parser.add_argument(
        '--clear',
        default=False,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Do not generate a backup .ixam file when saving processed ones.",
    )
    parser.add_argument(
        '--no_scenes',
        default=True,
    ...
    parser.add_argument(
        ...
        default=True,
        action="store_false",
        help="Do not generate/clear previews for mat/tex/image/etc. IDs (those handled by core Ixam code).",
    )
