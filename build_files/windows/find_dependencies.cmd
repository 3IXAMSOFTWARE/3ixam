...
set PYTHON=%IXAM_DIR%\..\lib\win64_vc15\python\310\bin\python.exe
if EXIST %PYTHON% (
	goto detect_python_done
)
set PYTHON=%IXAM_DIR%\..\lib\win64_vc15\python\311\bin\python.exe
if EXIST %PYTHON% (
	goto detect_python_done
)
set PYTHON=%IXAM_DIR%\..\lib\win64_vc15\python\312\bin\python.exe
if EXIST %PYTHON% (
	goto detect_python_done
)
set PYTHON=%IXAM_DIR%\..\lib\win64_vc15\python\39\bin\python.exe
if EXIST %PYTHON% (
	goto detect_python_done
)
