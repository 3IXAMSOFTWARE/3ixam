...
set BUILD_VS_LIBDIR="%IXAM_DIR%..\lib\%BUILD_VS_SVNDIR%"
...
if NOT EXIST %BUILD_VS_LIBDIR% (
	...
	if not "%SVN%"=="" (
		...
		if /I "!GetLibs!"=="Y" (
			...
			echo.
:RETRY			
			"%SVN%" checkout https://svn.3ixam.com/svnroot/bf-ixam/trunk/lib/%BUILD_VS_SVNDIR% %BUILD_VS_LIBDIR%
			if errorlevel 1 (
				...
				echo %BUILD_VS_LIBDIR% , until this is resolved you CANNOT make a successful ixam build
				echo.
				exit /b 1
			)
		)
