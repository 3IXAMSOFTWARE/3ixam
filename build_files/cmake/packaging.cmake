...
set(PATCH_VERSION ${IXAM_VERSION_PATCH})
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux")
  ...
  if(RPMBUILD_FOUND)
    ...
    set(CPACK_RPM_USER_BINARY_SPECFILE "${CMAKE_SOURCE_DIR}/build_files/package_spec/rpm/ixam.spec.in")
  endif()
endif()
...
if(WIN32)
  ...
  set(CPACK_WIX_PRODUCT_ICON ${CMAKE_SOURCE_DIR}/release/windows/icons/3ixam.ico)

  set(IXAM_NAMESPACE_GUID "507F933F-5898-404A-9A05-18282FD491A6")

  string(UUID CPACK_WIX_UPGRADE_GUID
    NAMESPACE ${IXAM_NAMESPACE_GUID}
...
set(CPACK_PACKAGE_EXECUTABLES "3ixam-launcher" "3IXAM")
set(CPACK_CREATE_DESKTOP_LINKS "3ixam-launcher" "3IXAM")
...
if(APPLE)
  add_package_archive(
    "${PROJECT_NAME}-${IXAM_VERSION}-${BUILD_REV}-OSX-${CMAKE_OSX_ARCHITECTURES}"
    "zip")
elseif(UNIX)
  ...
  add_package_archive(
    "${PROJECT_NAME}-${IXAM_VERSION}-${BUILD_REV}-${PACKAGE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}"
    "tar.xz")
endif()
