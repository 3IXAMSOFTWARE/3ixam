...
r"""
Example Linux usage:
 python ~/ixam-git/ixam/build_files/cmake/cmake_qtcreator_project.py --build-dir ~/ixam-git/cmake

Example Win32 usage:
 c:\Python32\python.exe c:\ixam_dev\ixam\build_files\cmake\cmake_qtcreator_project.py --build-dir c:\ixam_dev\cmake_build
"""
...
def create_qtc_project_main(name):
    ...
    print("3IXAM project file written to: %r" % qtc_prj)
    # --- end
...
def argparse_create():
    ...
    parser = argparse.ArgumentParser(
        description="This script generates Qt Creator project files for 3IXAM",
    )
    ...
    parser.add_argument(
        ...
        help="Override default project name (\"3IXAM\")",
        required=False,
    )
