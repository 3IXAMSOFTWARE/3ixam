...
function(GET_IXAM_TEST_INSTALL_DIR VARIABLE_NAME)
...
macro(IXAM_SRC_GTEST NAME SRC EXTRA_LIBS)
  IXAM_SRC_GTEST_EX(
    NAME "${NAME}"
    SRC "${SRC}"
...
macro(IXAM_TEST NAME EXTRA_LIBS)
  IXAM_SRC_GTEST_EX(
    NAME "${NAME}"
    SRC "${NAME}_test.cc"
    EXTRA_LIBS "${EXTRA_LIBS}")
...
macro(IXAM_TEST_PERFORMANCE NAME EXTRA_LIBS)
  IXAM_SRC_GTEST_EX(
    NAME "${NAME}"
    SRC "${NAME}_test.cc"
    EXTRA_LIBS "${EXTRA_LIBS}"
