...
include("precompiled_library_directories.cmake")
...
if(EXISTS ${LIBDIR})
  ...
  # not need to be ever discovered for the 3IXAM linking.
...
if(NOT WITH_SYSTEM_FREETYPE)
  ...
  if(EXISTS ${LIBDIR})
    ...
    # See: https://devtalk.3ixam.com/t/22536
...
if(WITH_PYTHON)
  ...
  if(WITH_PYTHON_MODULE AND NOT WITH_INSTALL_PORTABLE)
    ...
    if(EXISTS ${LIBDIR})
      ...
      if(_is_prefix)
        message(WARNING "
Building 3IXAM with the following configuration:
...
if(WITH_INPUT_NDOF)
  ...
  if(SPACENAV_FOUND)
    # use generic names within ixams buildsystem.
...
# use the same libraries as Ixam with a different version or build options.
set(PLATFORM_LINKFLAGS
  "${PLATFORM_LINKFLAGS} -Wl,--version-script='${CMAKE_SOURCE_DIR}/source/creator/ixam.map'"
)

# Don't use position independent executable for portable install since file
# browsers can't properly detect ixam as an executable then. Still enabled
...
function(CONFIGURE_ATOMIC_LIB_IF_NEEDED)
  ...
  if(NOT ATOMIC_OPS_WITHOUT_LIBATOMIC)
    ...
    if(ATOMIC_OPS_WITH_LIBATOMIC)
      ...
      # Atomic operations are required part of 3IXAM and it is not possible to process forward.
