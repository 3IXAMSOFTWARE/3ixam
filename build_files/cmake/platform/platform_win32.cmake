...
if(CMAKE_C_COMPILER_ID MATCHES "Clang")
  ...
  if(WITH_IXAM AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.28.29921) # MSVC 2019 16.9.16
    message(FATAL_ERROR "Compiler is unsupported, MSVC 2019 16.9.16 or newer is required for building ixam.")
  endif()
endif()

if(WITH_IXAM AND NOT WITH_PYTHON_MODULE)
  set_property(DIRECTORY PROPERTY VS_STARTUP_PROJECT 3ixam)
endif()
...
if(NOT DEFINED LIBDIR)
  ...
  if(CMAKE_CL_64)
    ...
    message(FATAL_ERROR "32 bit compiler detected, ixam no longer provides pre-build libraries for 32 bit windows, please set the LIBDIR cmake variable to your own library folder")
  endif()
...
if(NOT EXISTS "${LIBDIR}/")
  message(FATAL_ERROR "\n\nWindows requires pre-compiled libs at: '${LIBDIR}'. Please run `make update` in 3IXAM source folder to obtain them.")
endif()
...
ixam_include_dirs_sys("${PTHREADS_INCLUDE_DIRS}")
...
if(WINDOWS_PYTHON_DEBUG)
  # Include the system scripts in the ixam_python_system_scripts project.
  file(GLOB_RECURSE inFiles "${CMAKE_SOURCE_DIR}/release/scripts/*.*" )
  add_custom_target(ixam_python_system_scripts SOURCES ${inFiles})
  ...
  if(DEFINED ENV{IXAM_USER_SCRIPTS})
    message(STATUS "Including user scripts from environment IXAM_USER_SCRIPTS=$ENV{IXAM_USER_SCRIPTS}")
    set(USER_SCRIPTS_ROOT "$ENV{IXAM_USER_SCRIPTS}")
  else()
    message(STATUS "Including user scripts from the profile folder")
    # Include the user scripts from the profile folder in the ixam_python_user_scripts project.
    set(USER_SCRIPTS_ROOT "$ENV{appdata}/ixam foundation/ixam/${IXAM_VERSION}/scripts")
  endif()

  file(TO_CMAKE_PATH ${USER_SCRIPTS_ROOT} USER_SCRIPTS_ROOT)
  file(GLOB_RECURSE inFiles "${USER_SCRIPTS_ROOT}/*.*" )
  add_custom_target(ixam_python_user_scripts SOURCES ${inFiles})
  foreach(_source IN ITEMS ${inFiles})
    get_filename_component(_source_path "${_source}" PATH)
    ...
    source_group("${_group_path}" FILES "${_source}")
  endforeach()
  set_target_properties(ixam_python_system_scripts PROPERTIES FOLDER "scripts")
  set_target_properties(ixam_python_user_scripts PROPERTIES FOLDER "scripts")
  ...
  set(USER_PROPS_FILE "${CMAKE_CURRENT_BINARY_DIR}/source/creator/ixam.Cpp.user.props")
