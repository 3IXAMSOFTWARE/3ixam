...
configure_file(${CMAKE_SOURCE_DIR}/release/windows/manifest/3ixam.exe.manifest.in ${CMAKE_CURRENT_BINARY_DIR}/tests.exe.manifest @ONLY)
...
if(WITH_WINDOWS_BUNDLE_CRT)
  ...
  endforeach()
  # Install the CRT to the ixam.crt Sub folder.
  install(FILES ${CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS} DESTINATION ./3ixam.crt COMPONENT Libraries)
  ...
  if(NOT EXISTS ${manifest_trigger_file})
    ...
    endforeach()
    configure_file(${CMAKE_SOURCE_DIR}/release/windows/manifest/3ixam.crt.manifest.in ${CMAKE_CURRENT_BINARY_DIR}/3ixam.crt.manifest @ONLY)
    file(TOUCH ${manifest_trigger_file})
  endif()

  install(FILES ${CMAKE_CURRENT_BINARY_DIR}/3ixam.crt.manifest DESTINATION ./3ixam.crt)
  set(BUNDLECRT "<dependency><dependentAssembly><assemblyIdentity type=\"win32\" name=\"3ixam.crt\" version=\"1.0.0.0\" /></dependentAssembly></dependency>")
endif()
configure_file(${CMAKE_SOURCE_DIR}/release/windows/manifest/3ixam.exe.manifest.in ${CMAKE_CURRENT_BINARY_DIR}/3ixam.exe.manifest @ONLY)
