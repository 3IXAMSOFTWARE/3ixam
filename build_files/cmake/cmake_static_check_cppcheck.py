...
CHECKER_EXCLUDE_SOURCE_FILES = set(os.path.join(*f.split("/")) for f in (
    ...
    "source/ixam/editors/space_text/text_format_pov.c",
    "source/ixam/editors/space_text/text_format_pov_ini.c",
))

CHECKER_ARGS = [
    # Speed up execution.
    # As 3IXAM has many defines, the total number of configurations is large making execution unreasonably slow.
