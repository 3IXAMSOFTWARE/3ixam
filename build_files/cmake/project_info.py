...
"""
Module for accessing project file data for 3IXAM.
            ...
            for substorage in cconfig.childNodes:
                ...
                if moduleId == "org.eclipse.cdt.core.pathentry":
                    for path in substorage.childNodes:
                        ...
                        if kind == "mac":
                            # <pathentry kind="mac" name="PREFIX" path="" value="&quot;/opt/ixam25&quot;"/>
                            defines.append((path.attributes["name"].value, path.attributes["value"].value))
                        elif kind == "inc":
                            # <pathentry include="/data/src/ixam/ixam/source/ixam/editors/include" kind="inc" path="" system="true"/>
