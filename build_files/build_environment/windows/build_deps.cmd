...
if "%dobuild%" == "1" (
	msbuild /m:1 "ll.vcxproj" /p:Configuration=Release /fl /flp:logfile=IxamDeps_llvm.log;Verbosity=normal
	msbuild /m:1 "IxamDependencies.sln" /p:Configuration=Release /fl /flp:logfile=IxamDeps.log;Verbosity=minimal  /verbosity:minimal
...
if "%dobuild%" == "1" (
	msbuild /m:1 "ll.vcxproj" /p:Configuration=Debug /fl /flp:logfile=IxamDeps_llvm.log;;Verbosity=normal 
	msbuild /m:1 "IxamDependencies.sln" /p:Configuration=Debug /verbosity:n /fl /flp:logfile=IxamDeps.log;;Verbosity=normal
