 ...
 * ixam::Vector. The allocators defined in this file do not work with standard library
...
/**
 * Use 3IXAM's guarded allocator (aka MEM_*). This should always be used except there is a
 ...
 * used. This can be the case when the allocated memory might live longer than 3IXAM's
