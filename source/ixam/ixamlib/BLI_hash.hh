 ...
 * \ingroup bli
 *
 * A specialization of `ixam::DefaultHash<T>` provides a hash function for values of type T.
 * This hash function is used by default in hash table implementations in ixamlib.
 *
 ...
 *
 * Hash table implementations like ixam::Set support heterogeneous key lookups. That means that
 ...
 *
 *     template<> struct ixam::DefaultHash<TheType> {
