...
#define SCOPED_TIMER(name) ixam::timeit::ScopedTimer scoped_timer(name)
...
#define SCOPED_TIMER_AVERAGED(name) \
  ...
  static ixam::timeit::Nanoseconds total_time_; \
  static ixam::timeit::Nanoseconds min_time_ = ixam::timeit::Nanoseconds::max(); \
  ixam::timeit::ScopedTimerAveraged scoped_timer(name, total_count_, total_time_, min_time_)
