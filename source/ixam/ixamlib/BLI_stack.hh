 ...
 * \ingroup bli
 *
 * A `ixam::Stack<T>` is a dynamically growing FILO (first-in, last-out) data structure. It is
 ...
 * when it grows.
 *
 * ixam::Stack is implemented using a double linked list of chunks. Each chunk contains an array
...
/**
 * Same as a normal Stack, but does not use 3IXAM's guarded allocator. This is useful when
