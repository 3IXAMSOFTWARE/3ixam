...
enum class eSpace {
  /** 3IXAM theme color space (sRGB). */
  Theme,
  /** 3IXAM internal scene linear color space (maps to scene_linear role in OCIO). */
  SceneLinear,
  /** 3IXAM internal scene linear color space compressed to be stored in 4 uint8_t. */
