...
using char3 = ixam::vec_base<int8_t, 3>;

using uchar3 = ixam::vec_base<uint8_t, 3>;
using uchar4 = ixam::vec_base<uint8_t, 4>;
...
using short3 = ixam::vec_base<int16_t, 3>;

using ushort2 = vec_base<uint16_t, 2>;
using ushort3 = ixam::vec_base<uint16_t, 3>;
using ushort4 = ixam::vec_base<uint16_t, 4>;
