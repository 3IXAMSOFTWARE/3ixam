...
TEST(fileops, fstream_open_string_filename)
{
  ...
  const std::string filepath = test_files_dir + "/asset_library/новый/ixam_assets.cats.txt";
...
TEST(fileops, fstream_open_charptr_filename)
{
  ...
  const std::string filepath_str = test_files_dir + "/asset_library/новый/ixam_assets.cats.txt";
