...
TEST(path_util, PathExtensionCheck)
{
  ...
  PATH_EXTENSION_CHECK("correct/path/to/file.IXAM", ".IXAM", ".IXAM");
...
{
  PATH_REL("/foo/bar/ixam.ixam", "/foo/bar/", "//ixam.ixam");
  PATH_REL("/foo/bar/ixam.ixam", "/foo/bar", "//bar/ixam.ixam");

TEST(path_util, PathRelPath_SimpleSubdir)
{
  PATH_REL(ABS_PREFIX "/foo/bar/ixam.ixam", ABS_PREFIX "/foo/bar", "//bar/ixam.ixam");
}
