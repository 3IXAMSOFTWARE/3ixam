...
{
  for (int i = 0; i < 3; i++) {
    benchmark_random_ints<ixam::Map<int, int>>("ixam::Map          ", 1000000, 1);
    benchmark_random_ints<ixam::StdUnorderedMapWrapper<int, int>>("std::unordered_map", 1000000, 1);
  }
  std::cout << "\n";
  for (int i = 0; i < 3; i++) {
    uint32_t factor = (3 << 10);
    benchmark_random_ints<ixam::Map<int, int>>("ixam::Map          ", 1000000, factor);
    benchmark_random_ints<ixam::StdUnorderedMapWrapper<int, int>>(
        "std::unordered_map", 1000000, factor);
  }
}

/**
 * Timer 'ixam::Map           Add' took 61.7616 ms
 * Timer 'ixam::Map           Contains' took 18.4989 ms
 * Timer 'ixam::Map           Remove' took 20.5864 ms
 * Count: 1999755
 ...
 * Count: 1999755
 * Timer 'ixam::Map           Add' took 37.9196 ms
 * Timer 'ixam::Map           Contains' took 16.7361 ms
 * Timer 'ixam::Map           Remove' took 20.9568 ms
 * Count: 1999755
 ...
 * Count: 1999755
 * Timer 'ixam::Map           Add' took 37.3053 ms
 * Timer 'ixam::Map           Contains' took 16.6731 ms
 * Timer 'ixam::Map           Remove' took 18.8304 ms
 * Count: 1999755
 ...
 * Count: 1999755
 *
 * Timer 'ixam::Map           Add' took 50.1131 ms
 * Timer 'ixam::Map           Contains' took 25.0491 ms
 * Timer 'ixam::Map           Remove' took 32.4225 ms
 * Count: 1889920
 ...
 * Count: 1889920
 * Timer 'ixam::Map           Add' took 50.4438 ms
 * Timer 'ixam::Map           Contains' took 25.2677 ms
 * Timer 'ixam::Map           Remove' took 32.3047 ms
 * Count: 1889920
 ...
 * Count: 1889920
 * Timer 'ixam::Map           Add' took 48.6995 ms
 * Timer 'ixam::Map           Contains' took 25.1846 ms
 * Timer 'ixam::Map           Remove' took 33.0283 ms
 * Count: 1889920
