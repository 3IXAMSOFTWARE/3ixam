 ...
 * \ingroup bli
 *
 * \section aboutbli 3IXAM LIbrary external interface
 *
 * \subsection about About the BLI module
 *
 * This is the external interface of the 3IXAM Library. If you find
 ...
 *
 * - The ixamlib uses type defines from \ref DNA, and functions from
 * standard libraries.
 */
