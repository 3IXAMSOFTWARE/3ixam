 ...
 * \ingroup bli
 *
 * A `ixam::StringRef` references a const char array owned by someone else. It is just a pointer
 ...
 * null-terminated strings, `ixam::StringRefNull` can be used. It is essentially the same as
 ...
 *
 * ixam::StringRef vs. std::string_view:
 *   Both types are certainly very similar. The main benefit of using StringRef in 3IXAM is that
