 ...
 * \ingroup bli
 *
 * A `ixam::IndexRange` wraps an interval of non-negative integers. It can be used to reference
 ...
 *
 * Some containers like ixam::Vector have an index_range() method. This will return the
