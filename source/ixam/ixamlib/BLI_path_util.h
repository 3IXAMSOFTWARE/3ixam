...
/**
 * Get the frame from a filename formatted by ixam's frame scheme
 */
...
/**
 * Checks for a relative path (ignoring 3IXAM's "//") prefix
 ...
 * This is _not_ something 3IXAM's internal paths support, instead they use the "//" prefix.
...
/**
 * Does path begin with the special "//" prefix that 3IXAM uses to indicate
 * a path relative to the .ixam file.
 */
 ...
 *
 * \note #BLI_path_cmp is used for 3IXAM's internal logic to consider paths to be the same
