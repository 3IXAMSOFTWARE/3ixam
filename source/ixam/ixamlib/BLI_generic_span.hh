...
/**
 * A generic span. It behaves just like a ixam::Span<T>, but the type is only known at run-time.
 */
class GSpan {
 protected:
...
/**
 * A generic mutable span. It behaves just like a ixam::MutableSpan<T>, but the type is only
 * known at run-time.
 */
class GMutableSpan {
 protected:
