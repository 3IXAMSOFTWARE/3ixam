...
static void add_udim_tiles(Image *image, const ixam::Vector<int> &indices)
{
...
/* Set the 3IXAM material's viewport display color, metallic and roughness
                                       ...
                                       NodePlacementContext *r_ctx) const
{
  ...
  if (usd_input.HasConnectedSource()) {
     ...
     * and attempt to convert the connected USD shader to a 3IXAM node. */
