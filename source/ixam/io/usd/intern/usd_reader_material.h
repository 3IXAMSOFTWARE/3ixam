...
/* Converts USD materials to 3IXAM representation. */

/**
 * By default, the #USDMaterialReader creates a 3IXAM material with
 * the same name as the USD material.  If the USD material has a
 * #UsdPreviewSurface source, the 3IXAM material's viewport display
 ...
 * converts #UsdPreviewSurface to 3IXAM nodes as follows:
 *
 ...
 * scale and bias, will probably require creating 3IXAM Group nodes with
...
class USDMaterialReader {
 ...
 protected:
  ...
  /** Convert the given USD shader input to an input on the given 3IXAM node. */
  ...
  /**
   * This function creates a 3IXAM UV Map node, under the simplifying assumption that
   * UsdPrimvarReader_float2 shaders output UV coordinates.
   * TODO(makowalski): investigate supporting conversion to other 3IXAM node types
