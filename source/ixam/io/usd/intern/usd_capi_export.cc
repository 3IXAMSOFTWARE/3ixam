                            ...
                            float *progress)
{
  ...
  *do_update = true;
  ...
  usd_stage->GetRootLayer()->SetDocumentation(std::string("3IXAM v") +
                ...
                bool as_background_job)
{
  ...
  ixam::io::usd::ensure_usd_plugin_path_registered();

  ixam::io::usd::ExportJobData *job = static_cast<ixam::io::usd::ExportJobData *>(
      MEM_mallocN(sizeof(ixam::io::usd::ExportJobData), "ExportJobData"));
  ...
  if (as_background_job) {
    ...
    WM_jobs_callbacks(wm_job,
                      ixam::io::usd::export_startjob,
                      nullptr,
                      nullptr,
                      ixam::io::usd::export_endjob);
    ...
    ixam::io::usd::export_startjob(job, &stop, &do_update, &progress);
    ixam::io::usd::export_endjob(job);
