...
static void import_startjob(void *customdata, short *stop, short *do_update, float *progress)
{
  ...
  BLI_path_abs(data->filepath, BKE_main_ixamfile_path_from_global());
  ...
  *data->progress = 0.2f;
  ...
  /* Sort readers by name: when creating a lot of objects in 3IXAM,
                                      ...
                                      ListBase *object_paths)
{
  ...
  ixam::io::usd::ImportSettings settings{};
