...
/* Map 3IXAM socket names to USD Preview Surface InputSpec structs. */
 ...
 * input.  Parameters T1 and T2 indicate the 3IXAM and USD
                                     ...
                                     const bool allow_overwrite)
{
  ...
  /* This image in its current state only exists in 3IXAM memory.
...
static void get_absolute_path(Image *ima, char *r_path)
{
  ...
  BLI_path_abs(r_path, ID_IXAM_PATH_FROM_GLOBAL(&ima->id));
