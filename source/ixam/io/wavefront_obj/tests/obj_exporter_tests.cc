...
#include "tests/ixamfile_loading_base_test.h"
...
class obj_exporter_test : public IxamfileLoadingBaseTest {
 public:
  /**
  ...
  {
    if (!ixamfile_load(filepath.c_str())) {
      return false;
    }
...
const std::string all_objects_file = "io_tests/ixam_scene/all_objects.ixam";
const std::string all_curve_objects_file = "io_tests/ixam_scene/all_curves.ixam";
...
{
  /* Because testing doesn't fully initialize 3IXAM, we need the following. */
  BKE_tempdir_init(nullptr);
  std::string out_file_path = ixam::tests::flags_test_release_dir() + "/" + temp_file_path;
  {
    OBJExportParamsDefault _export;
...
class obj_exporter_regression_test : public obj_exporter_test {
 public:
  /**
   * Export the given ixam file with the given parameters and
   * test to see if it matches a golden file (ignoring any difference in 3IXAM version number).
   * \param ixamfile: input, relative to "tests" directory.
   * \param golden_obj: expected output, relative to "tests" directory.
   * \param params: the parameters to be used for export.
   */
  void compare_obj_export_to_golden(const std::string &ixamfile,
                                    const std::string &golden_obj,
                                    const std::string &golden_mtl,
                                    OBJExportParams &params)
  {
    if (!load_file_and_depsgraph(ixamfile)) {
      return;
    }
    /* Because testing doesn't fully initialize 3IXAM, we need the following. */
    BKE_tempdir_init(nullptr);
    ...
    std::string golden_file_path = ixam::tests::flags_test_asset_dir() + "/" + golden_obj;
    ...
    if (!golden_mtl.empty()) {
      ...
      std::string golden_mtl_file_path = ixam::tests::flags_test_asset_dir() + "/" + golden_mtl;
...
{
  OBJExportParamsDefault _export;
  compare_obj_export_to_golden("io_tests/ixam_geometry/all_tris.ixam",
...
TEST_F(obj_exporter_regression_test, all_quads)
{
  ...
  compare_obj_export_to_golden(
      "io_tests/ixam_geometry/all_quads.ixam", "io_tests/obj/all_quads.obj", "", _export.params);
}
...
TEST_F(obj_exporter_regression_test, fgons)
{
  ...
  _export.params.export_materials = false;
  compare_obj_export_to_golden(
      "io_tests/ixam_geometry/fgons.ixam", "io_tests/obj/fgons.obj", "", _export.params);
}
...
TEST_F(obj_exporter_regression_test, edges)
{
  ...
  _export.params.export_materials = false;
  compare_obj_export_to_golden(
      "io_tests/ixam_geometry/edges.ixam", "io_tests/obj/edges.obj", "", _export.params);
}
...
TEST_F(obj_exporter_regression_test, vertices)
{
  ...
  _export.params.export_materials = false;
  compare_obj_export_to_golden(
      "io_tests/ixam_geometry/vertices.ixam", "io_tests/obj/vertices.obj", "", _export.params);
}
...
TEST_F(obj_exporter_regression_test, nurbs_as_nurbs)
{
  ...
  _export.params.export_curves_as_nurbs = true;
  compare_obj_export_to_golden(
      "io_tests/ixam_geometry/nurbs.ixam", "io_tests/obj/nurbs.obj", "", _export.params);
}
}
...
TEST_F(obj_exporter_regression_test, nurbs_as_mesh)
{
  ...
  compare_obj_export_to_golden(
      "io_tests/ixam_geometry/nurbs.ixam", "io_tests/obj/nurbs_mesh.obj", "", _export.params);
}
...
TEST_F(obj_exporter_regression_test, cube_all_data_triangulated)
{
  ...
  compare_obj_export_to_golden("io_tests/ixam_geometry/cube_all_data.ixam",
...
TEST_F(obj_exporter_regression_test, cube_normal_edit)
{
  ...
  _export.params.up_axis = IO_AXIS_Z;
  _export.params.export_materials = false;
  compare_obj_export_to_golden("io_tests/ixam_geometry/cube_normal_edit.ixam",
...
TEST_F(obj_exporter_regression_test, cube_vertex_groups)
{
  ...
  compare_obj_export_to_golden("io_tests/ixam_geometry/cube_vertex_groups.ixam",
...
TEST_F(obj_exporter_regression_test, cubes_positioned)
{
  ...
  _export.params.export_materials = false;
  _export.params.global_scale = 2.0f;
  compare_obj_export_to_golden("io_tests/ixam_geometry/cubes_positioned.ixam",
...
TEST_F(obj_exporter_regression_test, cubes_vertex_colors)
{
  ...
  _export.params.export_uv = false;
  _export.params.export_materials = false;
  compare_obj_export_to_golden("io_tests/ixam_geometry/cubes_vertex_colors.ixam",
...
TEST_F(obj_exporter_regression_test, cubes_with_textures_strip)
{
  ...
  compare_obj_export_to_golden("io_tests/ixam_geometry/cubes_with_textures.ixam",
...
TEST_F(obj_exporter_regression_test, suzanne_all_data)
{
  ...
  compare_obj_export_to_golden("io_tests/ixam_geometry/suzanne_all_data.ixam",
...
TEST_F(obj_exporter_regression_test, all_curves)
{
  ...
  _export.params.export_materials = false;
  compare_obj_export_to_golden(
      "io_tests/ixam_scene/all_curves.ixam", "io_tests/obj/all_curves.obj", "", _export.params);
}
...
TEST_F(obj_exporter_regression_test, all_curves_as_nurbs)
{
  ...
  _export.params.export_materials = false;
  _export.params.export_curves_as_nurbs = true;
  compare_obj_export_to_golden("io_tests/ixam_scene/all_curves.ixam",
...
TEST_F(obj_exporter_regression_test, all_objects)
{
  ...
  _export.params.up_axis = IO_AXIS_Z;
  _export.params.export_smooth_groups = true;
  compare_obj_export_to_golden("io_tests/ixam_scene/all_objects.ixam",
...
TEST_F(obj_exporter_regression_test, materials_without_pbr)
{
  ...
  _export.params.export_normals = false;
  _export.params.path_mode = PATH_REFERENCE_RELATIVE;
  compare_obj_export_to_golden("io_tests/ixam_geometry/materials_pbr.ixam",
