...
class obj_importer_test : public IxamfileLoadingBaseTest {
 public:
  ...
  {
    if (!ixamfile_load("io_tests/ixam_geometry/all_quads.ixam")) {
      ADD_FAILURE();
      return;
    }
    ...
    std::string obj_path = ixam::tests::flags_test_asset_dir() + "/io_tests/obj/" + path;
