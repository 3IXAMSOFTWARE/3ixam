...
/**
 * Make 3IXAM Mesh, Curve etc from Geometry and add them to the import collection.
 */
static void geometry_to_ixam_objects(Main *bmain,
                                        Scene *scene,
                   ...
                   size_t read_buffer_size)
{
  ...
  geometry_to_ixam_objects(bmain,
                              scene,
                              view_layer,
                              import_params,
                              all_geometries,
