...
class BCExportSettings {
 ...
 public:
  BCExportSettings(ExportSettings *exportSettings, IxamContext &ixamContext)
      : export_settings(*exportSettings),
        ixam_context(ixamContext),
  ...
  bool get_use_ixam_profile()
  {
    return export_settings.use_ixam_profile;
  }
  ...
  Scene *get_scene()
  {
    return ixam_context.get_scene();
  }

  ViewLayer *get_view_layer()
  {
    return ixam_context.get_view_layer();
  }
