...
class MeshImporter : public MeshImporterBase {
 private:
  ...
  /**
   * This function is copied from source/ixam/editors/mesh/mesh_data.c
   *
   * TODO: (As discussed with sergey-) :
   * Maybe move this function to `ixamkernel/intern/mesh.c`.
   ...
   * TODO: import uv set names.
   */
  void read_polys(COLLADAFW::Mesh *mesh, Mesh *me, ixam::Vector<ixam::float3> &loop_normals);
  /**
