...
extern void bc_update_scene(IxamContext &ixam_context, float ctime);
...
extern Mesh *bc_get_mesh_copy(IxamContext &ixam_context,
                              Object *ob,
...
/**
 * Get a vector that is stored in 3 custom properties (used in 3IXAM <= 2.78).
 */
 ...
 * accordingly.
 *
 * \note This is old style for 3IXAM <= 2.78 only kept for compatibility.
 */
