...
bool CamerasExporter::exportIxamProfile(COLLADASW::Camera &cm, Camera *cam)
{
  cm.addExtraTechniqueParameter("ixam", "shiftx", cam->shiftx);
  cm.addExtraTechniqueParameter("ixam", "shifty", cam->shifty);
  cm.addExtraTechniqueParameter("ixam", "dof_distance", cam->dof.focus_distance);
  return true;
}
