...
void GeometryExporter::operator()(Object *ob)
{
  ...
  Mesh *me = bc_get_mesh_copy(ixam_context,
                              ob,
                                           ...
                                           std::vector<ulong> &vcount_list)
{
  ...
  const ixam::bke::AttributeAccessor attributes = me->attributes();
  const ixam::VArray<int> material_indices = attributes.lookup_or_default<int>(
