                ...
                bool as_background_job)
{
  ...
  if (as_background_job) {
    ...
    WM_jobs_callbacks(wm_job,
                      ixam::io::alembic::export_startjob,
                      nullptr,
                      nullptr,
                      ixam::io::alembic::export_endjob);
    ...
    ixam::io::alembic::export_startjob(job, &stop, &do_update, &progress);
    ixam::io::alembic::export_endjob(job);
