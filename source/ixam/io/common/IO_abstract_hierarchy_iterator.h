 ...
 * export hierarchy. The former is the parent/child structure in 3IXAM, which can have multiple
...
struct HierarchyContext {
   ...
   *
   * The export hierarchy is kept as close to the hierarchy in 3IXAM as possible. As such, an
   ...
   * it's animated. This is necessary when a parent object in 3IXAM is not part of the export. */
   ...
   * "parent" is not used here to avoid confusion with 3IXAM's meaning of the word (which always
