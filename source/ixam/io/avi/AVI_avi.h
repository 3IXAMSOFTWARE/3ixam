 ...
 * conversions. It has been adapted to make use of 3IXAM memory
 * management functions, and because of this it needs module
 * ixamlib. You need to provide this lib when linking with libavi.a .
 *
 * \subsection avi_issues Known issues with AVI
 *
 * - avi uses #MEM_mallocN, #MEM_freeN from ixamlib.
