...
./ixam.bin \
    ...
    --image=./release/datafiles/ixam_icons16.png \
    --output=./release/datafiles/ixam_icons16
...
def dice_icon_name(
    ...
    if name_style == 'UI_ICONS':
        ...
        if not _dice_icon_name_cache:
            ...
            ui_icons_h = os.path.join(SOURCE_DIR, "source", "ixam", "editors", "include", "UI_icons.h")
