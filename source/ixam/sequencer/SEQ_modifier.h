...
void SEQ_modifier_ixam_write(struct IxamWriter *writer, struct ListBase *modbase);
void SEQ_modifier_ixam_read_data(struct IxamDataReader *reader, struct ListBase *lb);
void SEQ_modifier_ixam_read_lib(struct IxamLibReader *reader,
                                 struct Scene *scene,
                                 struct ListBase *lb);
