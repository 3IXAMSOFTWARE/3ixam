...
/**
 * Read and Write functions for `.ixam` file data.
 */
void SEQ_ixam_write(struct IxamWriter *writer, struct ListBase *seqbase);
void SEQ_ixam_read(struct IxamDataReader *reader, struct ListBase *seqbase);

void SEQ_ixam_read_lib(struct IxamLibReader *reader,
                        struct Scene *scene,
                        struct ListBase *seqbase);

void SEQ_ixam_read_expand(struct IxamExpander *expander, struct ListBase *seqbase);
