...
namespace ixam::nodes::node_geo_sample_nearest_surface_cc {

using namespace ixam::bke::mesh_surface_sample;
...
class SampleNearestSurfaceFunction : public fn::MultiFunction {
 ...
 public:
  ...
  {
    ixam::fn::MFSignatureBuilder signature{"Sample Nearest Surface"};
...
{
  namespace file_ns = ixam::nodes::node_geo_sample_nearest_surface_cc;
