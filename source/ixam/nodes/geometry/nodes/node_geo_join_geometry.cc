...
namespace ixam::nodes::node_geo_join_geometry_cc {
        ...
        [&](const bke::AttributeIDRef &attribute_id, const AttributeMetaData &meta_data) {
          ...
          info.add_or_modify(
              ...
              [&](AttributeMetaData *meta_data_final) {
                meta_data_final->data_type = ixam::bke::attribute_data_type_highest_complexity(
                    {meta_data_final->data_type, meta_data.data_type});
                meta_data_final->domain = ixam::bke::attribute_domain_highest_priority(
...
{
  namespace file_ns = ixam::nodes::node_geo_join_geometry_cc;
