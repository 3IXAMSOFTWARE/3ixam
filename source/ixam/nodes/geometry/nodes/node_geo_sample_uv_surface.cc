...
namespace ixam::nodes::node_geo_sample_uv_surface_cc {
...
class SampleUVSurfaceFunction : public fn::MultiFunction {
 ...
 public:
  ...
  {
    ixam::fn::MFSignatureBuilder signature{"Sample UV Surface"};
...
{
  namespace file_ns = ixam::nodes::node_geo_sample_uv_surface_cc;
