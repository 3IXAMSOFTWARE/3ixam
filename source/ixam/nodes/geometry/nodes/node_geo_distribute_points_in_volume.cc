...
static void geo_node_distribute_points_in_volume_exec(GeoNodeExecParams params)
{
  ...
  params.error_message_add(NodeWarningType::Error,
                           TIP_("Disabled, Ixam was compiled without OpenVDB"));
#endif
}
}  // namespace ixam::nodes
...
void register_node_type_geo_distribute_points_in_volume()
{
  ...
  node_type_init(&ntype, ixam::nodes::node_distribute_points_in_volume_init);
  node_type_update(&ntype, ixam::nodes::node_distribute_points_in_volume_update);
  node_type_size(&ntype, 170, 100, 320);
  ntype.declare = ixam::nodes::geo_node_distribute_points_in_volume_declare;
  ntype.geometry_node_execute = ixam::nodes::geo_node_distribute_points_in_volume_exec;
  ntype.draw_buttons = ixam::nodes::geo_node_distribute_points_in_volume_layout;
