...
namespace ixam::nodes::node_geo_boolean_cc {
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  Mesh *result = ixam::meshintersect::direct_mesh_boolean(
      meshes,
      transforms,
      float4x4::identity(),
      material_remaps,
  ...
  params.error_message_add(NodeWarningType::Error,
                           TIP_("Disabled, Ixam was compiled without GMP"));
  params.set_default_remaining_outputs();
#endif
}
...
{
  namespace file_ns = ixam::nodes::node_geo_boolean_cc;
