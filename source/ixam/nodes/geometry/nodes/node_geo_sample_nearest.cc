...
namespace ixam::nodes::node_geo_sample_nearest_cc {
...
class SampleNearestFunction : public fn::MultiFunction {
 ...
 public:
  ...
  {
    ixam::fn::MFSignatureBuilder signature{"Sample Nearest"};
...
{
  namespace file_ns = ixam::nodes::node_geo_sample_nearest_cc;
