...
namespace ixam::nodes::node_geo_subdivision_surface_cc {
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  params.error_message_add(NodeWarningType::Error,
                           TIP_("Disabled, Ixam was compiled without OpenSubdiv"));
#else
...
{
  namespace file_ns = ixam::nodes::node_geo_subdivision_surface_cc;
