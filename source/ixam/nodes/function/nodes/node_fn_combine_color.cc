...
void register_node_type_fn_combine_color(void)
{
  ...
  ntype.declare = ixam::nodes::fn_node_combine_color_declare;
  node_type_update(&ntype, ixam::nodes::fn_node_combine_color_update);
  node_type_init(&ntype, ixam::nodes::fn_node_combine_color_init);
  node_type_storage(
      &ntype, "NodeCombSepColor", node_free_standard_storage, node_copy_standard_storage);
  ntype.build_multi_function = ixam::nodes::fn_node_combine_color_build_multi_function;
  ntype.draw_buttons = ixam::nodes::fn_node_combine_color_layout;
