...
namespace ixam::nodes::node_fn_slice_string_cc {
...
{
  static ixam::fn::CustomMF_SI_SI_SI_SO<std::string, int, int, std::string> slice_fn{
...
{
  namespace file_ns = ixam::nodes::node_fn_slice_string_cc;
