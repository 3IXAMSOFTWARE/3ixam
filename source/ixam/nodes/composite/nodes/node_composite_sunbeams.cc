 ...
 * Copyright 2014 Ixam Foundation. All rights reserved. */
...
namespace ixam::nodes::node_composite_sunbeams_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_sunbeams_cc;
