...
namespace ixam::nodes::node_composite_separate_color_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_separate_color_cc;
...
namespace ixam::nodes::node_composite_combine_color_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_combine_color_cc;
