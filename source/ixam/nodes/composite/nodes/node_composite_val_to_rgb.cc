...
namespace ixam::nodes::node_composite_color_ramp_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_color_ramp_cc;
...
namespace ixam::nodes::node_composite_rgb_to_bw_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_rgb_to_bw_cc;
