...
namespace ixam::nodes::node_composite_output_file_cc {
...
static void node_composit_buts_file_output(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  if (multilayer) {
    uiItemL(layout, IFACE_("Path:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  }
  else {
    uiItemL(layout, IFACE_("Base Path:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  }
...
static void node_composit_buts_file_output_ex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  ...
  if (active_input_ptr.data) {
    if (multilayer) {
      ...
      uiItemL(col, IFACE_("Layer:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
      ...
      uiItemL(col, IFACE_("File Subpath:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
      row = uiLayoutRow(col, false);
...
{
  namespace file_ns = ixam::nodes::node_composite_output_file_cc;
