...
namespace ixam::nodes::node_composite_separate_hsva_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_separate_hsva_cc;
...
namespace ixam::nodes::node_composite_combine_hsva_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_combine_hsva_cc;
