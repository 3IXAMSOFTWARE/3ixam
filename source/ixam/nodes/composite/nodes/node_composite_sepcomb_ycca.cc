...
namespace ixam::nodes::node_composite_separate_ycca_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_separate_ycca_cc;
...
namespace ixam::nodes::node_composite_combine_ycca_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_combine_ycca_cc;
