...
namespace ixam::nodes::node_composite_vec_blur_cc {
...
static void node_composit_buts_vecblur(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(col, IFACE_("Speed:"), ICON_NONE, UI_BSHAPE_PREFS);
...
{
  namespace file_ns = ixam::nodes::node_composite_vec_blur_cc;
