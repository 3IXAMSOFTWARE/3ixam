...
namespace ixam::nodes::node_composite_separate_rgba_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_separate_rgba_cc;
...
namespace ixam::nodes::node_composite_combine_rgba_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_combine_rgba_cc;
