 ...
 * Copyright 2006 Ixam Foundation. All rights reserved. */
...
namespace ixam::nodes::node_composite_colorcorrection_cc {
...
static void node_composit_buts_colorcorrection(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Saturation"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemL(row, IFACE_("Contrast"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemL(row, IFACE_("Gamma"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemL(row, IFACE_("Gain"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemL(row, IFACE_("Lift"), ICON_NONE, UI_BSHAPE_ROUNDBOX);

  row = uiLayoutRow(layout, false);
  uiItemL(row, IFACE_("Master"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(
  ...
  row = uiLayoutRow(layout, false);
  uiItemL(row, IFACE_("Highlights"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row,
          ptr,
  ...
  row = uiLayoutRow(layout, false);
  uiItemL(row, IFACE_("Midtones"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row,
          ptr,
          "midtones_saturation",
          UI_ITEM_R_SPLIT_EMPTY_NAME | UI_ITEM_R_SLIDER,
  ...
  row = uiLayoutRow(layout, false);
  uiItemL(row, IFACE_("Shadows"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row,
          ptr,
          "shadows_saturation",
          UI_ITEM_R_SPLIT_EMPTY_NAME | UI_ITEM_R_SLIDER,
...
{
  namespace file_ns = ixam::nodes::node_composite_colorcorrection_cc;
