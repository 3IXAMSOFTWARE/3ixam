...
namespace ixam::nodes::node_composite_separate_yuva_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_separate_yuva_cc;
...
namespace ixam::nodes::node_composite_combine_yuva_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_combine_yuva_cc;
