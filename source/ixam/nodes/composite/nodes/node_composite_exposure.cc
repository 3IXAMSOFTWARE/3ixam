 ...
 * Copyright 2020 Ixam Foundation. All rights reserved. */
...
namespace ixam::nodes::node_composite_exposure_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_exposure_cc;
