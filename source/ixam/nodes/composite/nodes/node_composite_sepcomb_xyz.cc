 ...
 * Copyright 2021 Ixam Foundation. All rights reserved. */
...
namespace ixam::nodes::node_composite_separate_xyz_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_separate_xyz_cc;
...
namespace ixam::nodes::node_composite_combine_xyz_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_combine_xyz_cc;
