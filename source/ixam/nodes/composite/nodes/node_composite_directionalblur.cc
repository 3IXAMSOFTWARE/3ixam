...
namespace ixam::nodes::node_composite_directionalblur_cc {
...
static void node_composit_buts_dblur(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(col, IFACE_("Center:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
...
{
  namespace file_ns = ixam::nodes::node_composite_directionalblur_cc;
