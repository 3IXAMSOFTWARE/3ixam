...
namespace ixam::nodes::node_composite_defocus_cc {
...
static void node_composit_buts_defocus(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  ...
  uiItemL(col, IFACE_("Bokeh Type:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
...
{
  namespace file_ns = ixam::nodes::node_composite_defocus_cc;
