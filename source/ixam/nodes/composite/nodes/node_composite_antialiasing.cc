 ...
 * Copyright 2017 Ixam Foundation. All rights reserved. */
...
namespace ixam::nodes::node_composite_antialiasing_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_antialiasing_cc;
