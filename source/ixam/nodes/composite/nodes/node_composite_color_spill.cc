...
namespace ixam::nodes::node_composite_color_spill_cc {
...
static void node_composit_buts_color_spill(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(layout, IFACE_("Despill Channel:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
...
{
  namespace file_ns = ixam::nodes::node_composite_color_spill_cc;
