 ...
 * Copyright 2011 Ixam Foundation. All rights reserved. */
...
namespace ixam::nodes::node_composite_double_edge_mask_cc {
                                                ...
                                                PointerRNA *ptr)
{
  ...
  uiItemL(col, IFACE_("Inner Edge:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(col, ptr, "inner_mode", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemL(col, IFACE_("Buffer Edge:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
...
{
  namespace file_ns = ixam::nodes::node_composite_double_edge_mask_cc;
