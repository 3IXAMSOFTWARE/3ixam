...
static ixam::bke::cryptomatte::CryptomatteSessionPtr cryptomatte_init_from_node_render(
    const bNode &node, const bool use_meta_data)
{
  ixam::bke::cryptomatte::CryptomatteSessionPtr session;
  ...
  if (use_meta_data) {
    ...
    if (render_result) {
      session = ixam::bke::cryptomatte::CryptomatteSessionPtr(
...
static ixam::bke::cryptomatte::CryptomatteSessionPtr cryptomatte_init_from_node_image(
...
static ixam::bke::cryptomatte::CryptomatteSessionPtr cryptomatte_init_from_node(
                            ...
                            float encoded_hash)
{
  ...
  ixam::bke::cryptomatte::CryptomatteSessionPtr session = cryptomatte_init_from_node(
      scene, node, true);
  if (session) {
...
void ntreeCompositCryptomatteUpdateLayerNames(const Scene *scene, bNode *node)
{
  ...
  if (session) {
    for (ixam::StringRef layer_name :
         ixam::bke::cryptomatte::BKE_cryptomatte_layer_names_get(*session)) {
...
{
  ixam::bke::cryptomatte::CryptomatteSessionPtr session_ptr = cryptomatte_init_from_node(
      *scene, *node, true);
  return session_ptr.release();
}

namespace ixam::nodes::node_composite_cryptomatte_cc {
...
{
  namespace file_ns = ixam::nodes::node_composite_cryptomatte_cc;
...
namespace ixam::nodes::node_composite_legacy_cryptomatte_cc {
...
{
  namespace legacy_file_ns = ixam::nodes::node_composite_legacy_cryptomatte_cc;
  namespace file_ns = ixam::nodes::node_composite_cryptomatte_cc;
