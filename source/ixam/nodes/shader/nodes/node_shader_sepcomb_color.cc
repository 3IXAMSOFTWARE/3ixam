 ...
 * Copyright 2022 Ixam Foundation. All rights reserved. */
...
namespace ixam::nodes::node_shader_separate_color_cc {
...
{
  namespace file_ns = ixam::nodes::node_shader_separate_color_cc;
...
namespace ixam::nodes::node_shader_combine_color_cc {
...
{
  namespace file_ns = ixam::nodes::node_shader_combine_color_cc;
