...
namespace ixam::nodes::node_shader_tex_gradient_cc {
...
static void node_shader_buts_tex_gradient(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Gradient Type"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row, ptr, "gradient_type", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
...
{
  namespace file_ns = ixam::nodes::node_shader_tex_gradient_cc;
