...
namespace ixam::nodes::node_shader_bsdf_glass_cc {
...
{
  namespace file_ns = ixam::nodes::node_shader_bsdf_glass_cc;

  static bNodeType ntype;

  sh_node_type_base(&ntype, SH_NODE_BSDF_GLASS, "Glass", NODE_CLASS_SHADER);
