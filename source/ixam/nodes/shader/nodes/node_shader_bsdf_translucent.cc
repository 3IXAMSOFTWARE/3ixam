...
namespace ixam::nodes::node_shader_bsdf_translucent_cc {
...
{
  namespace file_ns = ixam::nodes::node_shader_bsdf_translucent_cc;

  static bNodeType ntype;

  sh_node_type_base(&ntype, SH_NODE_BSDF_TRANSLUCENT, "Translucent", NODE_CLASS_SHADER);
