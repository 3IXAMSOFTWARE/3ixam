...
namespace ixam::nodes::node_shader_tex_white_noise_cc {
...
static void node_shader_buts_white_noise(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemR(row, ptr, "noise_dimensions", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
}
...
{
  namespace file_ns = ixam::nodes::node_shader_tex_white_noise_cc;
