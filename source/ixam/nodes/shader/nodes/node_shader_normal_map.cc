...
namespace ixam::nodes::node_shader_normal_map_cc {
...
static void node_shader_buts_normal_map(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  ...
  uiItemR(row, ptr, "space", UI_ITEM_R_SPLIT_EMPTY_NAME, "", 0);
                                 ...
                                 GPUNodeStack *out)
{
  ...
  if (ELEM(nm->space, SHD_SPACE_IXAM_OBJECT, SHD_SPACE_IXAM_WORLD)) {
    color_to_normal_fnc_name = "color_to_ixam_normal_new_shading";
  }
...
{
  namespace file_ns = ixam::nodes::node_shader_normal_map_cc;
