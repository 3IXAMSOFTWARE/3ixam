...
namespace ixam::nodes::node_shader_vector_math_cc {
...
static void node_shader_buts_vect_math(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemR(row, ptr, "operation", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
}
...
{
  namespace file_ns = ixam::nodes::node_shader_vector_math_cc;
