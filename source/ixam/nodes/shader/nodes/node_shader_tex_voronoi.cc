...
namespace ixam::nodes::node_shader_tex_voronoi_cc {
...
static void node_shader_buts_tex_voronoi(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Dimensions"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row, ptr, "voronoi_dimensions", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);
  
  row = uiLayoutRow(layout, true);
  uiItemL(row, IFACE_("Feature Output"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row, ptr, "feature", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);
  ...
  if (!ELEM(feature, SHD_VORONOI_DISTANCE_TO_EDGE, SHD_VORONOI_N_SPHERE_RADIUS) &&
    ...
    uiItemR(row, ptr, "distance", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
    uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);
  }
}
...
{
  namespace file_ns = ixam::nodes::node_shader_tex_voronoi_cc;
