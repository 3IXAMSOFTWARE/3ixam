...
namespace ixam::nodes::node_shader_tex_magic_cc {
...
static void node_shader_buts_tex_magic(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemR(row, ptr, "turbulence_depth", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
...
{
  namespace file_ns = ixam::nodes::node_shader_tex_magic_cc;
