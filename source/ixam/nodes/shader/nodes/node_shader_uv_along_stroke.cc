...
namespace ixam::nodes::node_shader_uv_along_stroke_cc {
...
static void node_shader_buts_uvalongstroke(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Use Tips"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row, ptr, "use_tips", UI_ITEM_R_SPLIT_EMPTY_NAME, "", 0);
}
...
{
  namespace file_ns = ixam::nodes::node_shader_uv_along_stroke_cc;
