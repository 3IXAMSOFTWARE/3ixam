...
namespace ixam::nodes::node_shader_attribute_cc {
...
static void node_shader_buts_attribute(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemR(row, ptr, "attribute_type", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);

  row = uiLayoutRow(layout, true);
  uiItemL(row, IFACE_("Name"), ICON_NONE, UI_BSHAPE_ROUNDBOX); 
  uiItemR(row, ptr, "attribute_name", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
}
...
{
  namespace file_ns = ixam::nodes::node_shader_attribute_cc;
