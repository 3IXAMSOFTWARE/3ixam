...
namespace ixam::nodes::node_shader_eevee_specular_cc {
...
{
  namespace file_ns = ixam::nodes::node_shader_eevee_specular_cc;

  static bNodeType ntype;

  sh_node_type_base(&ntype, SH_NODE_EEVEE_SPECULAR, "Specular", NODE_CLASS_SHADER);
