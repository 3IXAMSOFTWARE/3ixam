...
namespace ixam::nodes::node_shader_tex_brick_cc {
...
static void node_shader_buts_tex_brick(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Offset"), ICON_NONE, UI_BSHAPE_ROUNDBOX);  
  uiItemR(row,
          ptr,
          "offset",
  ...
  row = uiLayoutRow(col, true);
  uiItemL(row, IFACE_("Frequency"), ICON_NONE, UI_BSHAPE_ROUNDBOX);  
  uiItemR(
      row, ptr, "offset_frequency", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);
  ...
  row = uiLayoutRow(col, true);
  uiItemL(row, IFACE_("Squash"), ICON_NONE, UI_BSHAPE_ROUNDBOX); 
  uiItemR(row, ptr, "squash", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);

  row = uiLayoutRow(col, true);
  uiItemL(row, IFACE_("Frequency"), ICON_NONE, UI_BSHAPE_ROUNDBOX); 
  uiItemR(
      row, ptr, "squash_frequency", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);
}
...
{
  namespace file_ns = ixam::nodes::node_shader_tex_brick_cc;
