...
namespace ixam::nodes::node_shader_wireframe_cc {
...
static void node_shader_buts_wireframe(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Pixel Size"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row, ptr, "use_pixel_size", UI_ITEM_R_SPLIT_EMPTY_NAME, "", 0);
}
...
{
  namespace file_ns = ixam::nodes::node_shader_wireframe_cc;
