...
namespace ixam::nodes::node_shader_volume_principled_cc {
...
{
  namespace file_ns = ixam::nodes::node_shader_volume_principled_cc;

  static bNodeType ntype;

  sh_node_type_base(&ntype, SH_NODE_VOLUME_PRINCIPLED, "Universal Volume", NODE_CLASS_SHADER);
