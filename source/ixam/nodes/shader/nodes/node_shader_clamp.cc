...
namespace ixam::nodes::node_shader_clamp_cc {
...
static void node_shader_buts_clamp(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Clamp Type"), ICON_NONE, UI_BSHAPE_ROUNDBOX);  
  uiItemR(row, ptr, "clamp_type", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
...
{
  namespace file_ns = ixam::nodes::node_shader_clamp_cc;
