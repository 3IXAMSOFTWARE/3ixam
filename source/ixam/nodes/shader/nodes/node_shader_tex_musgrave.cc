...
namespace ixam::nodes::node_shader_tex_musgrave_cc {
...
{  
  ...
  uiItemR(row, ptr, "musgrave_dimensions", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);

  row = uiLayoutRow(layout, true);
  uiItemL(row, IFACE_("Type"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row, ptr, "musgrave_type", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  uiItemS_ex(row, 3.4f, UI_BSHAPE_ROUNDBOX);
}
...
{
  namespace file_ns = ixam::nodes::node_shader_tex_musgrave_cc;
