...
namespace ixam::nodes::node_shader_subsurface_scattering_cc {
...
static void node_shader_buts_subsurface(uiLayout *layout, bContext * /*C*/, PointerRNA *ptr)
{
  ...
  uiItemL(row, IFACE_("Method"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(row, ptr, "falloff", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
...
{
  namespace file_ns = ixam::nodes::node_shader_subsurface_scattering_cc;
