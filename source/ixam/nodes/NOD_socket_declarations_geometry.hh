...
namespace ixam::nodes::decl {

class GeometryBuilder;

class Geometry : public SocketDeclaration {
 private:
  ixam::Vector<GeometryComponentType> supported_types_;
...
class GeometryBuilder : public SocketDeclarationBuilder<Geometry> {
 public:
  ...
  GeometryBuilder &supported_type(ixam::Vector<GeometryComponentType> supported_types);
