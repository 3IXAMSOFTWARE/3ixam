 ...
 * Copyright 2007 Ixam Foundation. All rights reserved. */
...
using ixam::nodes::SocketDeclarationPtr;
...
static void refresh_node(bNodeTree &ntree,
                         bNode &node,
                         ixam::nodes::NodeDeclaration &node_decl,
                         bool do_id_user)
{
...
static bNodeSocketType *make_standard_socket_type(int type, int subtype)
{
  ...
  RNA_struct_ixam_type_set(srna, stype);
...
static bNodeSocketType *make_socket_type_bool()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<bool>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    *(bool *)r_value = ((bNodeSocketValueBoolean *)socket.default_value)->value;
  };
  socktype->geometry_nodes_cpp_type = &ixam::CPPType::get<ValueOrField<bool>>();
...
static bNodeSocketType *make_socket_type_float(PropertySubType subtype)
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<float>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    *(float *)r_value = ((bNodeSocketValueFloat *)socket.default_value)->value;
  };
  socktype->geometry_nodes_cpp_type = &ixam::CPPType::get<ValueOrField<float>>();
  socktype->get_geometry_nodes_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    float value;
    socket.typeinfo->get_base_cpp_value(socket, &value);
...
static bNodeSocketType *make_socket_type_int(PropertySubType subtype)
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<int>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    *(int *)r_value = ((bNodeSocketValueInt *)socket.default_value)->value;
  };
  socktype->geometry_nodes_cpp_type = &ixam::CPPType::get<ValueOrField<int>>();
  socktype->get_geometry_nodes_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    int value;
    socket.typeinfo->get_base_cpp_value(socket, &value);
...
static bNodeSocketType *make_socket_type_vector(PropertySubType subtype)
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<ixam::float3>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    *(ixam::float3 *)r_value = ((bNodeSocketValueVector *)socket.default_value)->value;
  };
  socktype->geometry_nodes_cpp_type = &ixam::CPPType::get<ValueOrField<ixam::float3>>();
  socktype->get_geometry_nodes_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    ixam::float3 value;
    socket.typeinfo->get_base_cpp_value(socket, &value);
    new (r_value) ValueOrField<ixam::float3>(value);
  };
  return socktype;
}
...
static bNodeSocketType *make_socket_type_rgba()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<ixam::ColorGeometry4f>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    *(ixam::ColorGeometry4f *)r_value = ((bNodeSocketValueRGBA *)socket.default_value)->value;
  };
  socktype->geometry_nodes_cpp_type =
      &ixam::CPPType::get<ValueOrField<ixam::ColorGeometry4f>>();
  socktype->get_geometry_nodes_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    ixam::ColorGeometry4f value;
    socket.typeinfo->get_base_cpp_value(socket, &value);
    new (r_value) ValueOrField<ixam::ColorGeometry4f>(value);
  };
  return socktype;
}
...
static bNodeSocketType *make_socket_type_string()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<std::string>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    new (r_value) std::string(((bNodeSocketValueString *)socket.default_value)->value);
  };
  socktype->geometry_nodes_cpp_type = &ixam::CPPType::get<ValueOrField<std::string>>();
  socktype->get_geometry_nodes_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    std::string value;
    value.~basic_string();
    socket.typeinfo->get_base_cpp_value(socket, &value);
...
static bNodeSocketType *make_socket_type_object()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<Object *>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
...
static bNodeSocketType *make_socket_type_geometry()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<GeometrySet>();
  socktype->get_base_cpp_value = [](const bNodeSocket & /*socket*/, void *r_value) {
...
static bNodeSocketType *make_socket_type_collection()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<Collection *>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
...
static bNodeSocketType *make_socket_type_texture()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<Tex *>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
...
static bNodeSocketType *make_socket_type_image()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<Image *>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
...
static bNodeSocketType *make_socket_type_material()
{
  ...
  socktype->base_cpp_type = &ixam::CPPType::get<Material *>();
  socktype->get_base_cpp_value = [](const bNodeSocket &socket, void *r_value) {
