...
/**
 * Adjust paths when saving (kept unless #IxamFileWriteParams.use_save_as_copy is set).
 */
...
/** Similar to #IxamFileReadParams. */
struct IxamFileWriteParams {
  ...
  uint use_userdef : 1;
  const struct IxamThumbnail *thumb;
};
