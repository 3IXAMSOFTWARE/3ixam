...
void blo_do_versions_290(FileData *fd, Library *UNUSED(lib), Main *bmain)
{
  ...
  /** Repair files from duplicate brushes added to ixam files, see: T76738. */
  ...
  if (!MAIN_VERSION_ATLEAST(bmain, 291, 4) && MAIN_VERSION_ATLEAST(bmain, 291, 1)) {
     ...
     * incorrectly. Fortunately, the size of the layers array has been written to the .ixam file
