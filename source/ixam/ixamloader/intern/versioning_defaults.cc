 ...
 * \ingroup ixamloader
 *
 * This file handles updating the `startup.ixam`, this is used when reading old files.
 *
...
static void blo_update_defaults_scene(Main *bmain, Scene *scene)
{
  ...
  /* Change default ffmpeg format */
  scene->r.ffcodecdata.type = 2; // FFMPEG_MPEG4
  scene->r.ffcodecdata.constant_rate_factor = 20; // FFM_CRF_HIGH
  ...
  copy_v3_v3(scene->display.light_direction, ixam::float3(M_SQRT1_3));
...
void BLO_update_defaults_startup_ixam(Main *bmain, const char *app_template)
{
  /* For all app templates. */
