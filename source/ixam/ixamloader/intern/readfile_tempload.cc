                                             ...
                                             struct ReportList *reports)
{
  ...
  temp_lib_ctx->ixamhandle = BLO_ixamhandle_from_file(ixam_file_path,
  ...
  temp_lib_ctx->bmain_lib = BLO_library_link_begin(
      &temp_lib_ctx->ixamhandle, ixam_file_path, &temp_lib_ctx->liblink_params);

  temp_lib_ctx->temp_id = BLO_library_link_named_part(temp_lib_ctx->bmain_lib,
                                                      &temp_lib_ctx->ixamhandle,
                                                      idcode,
                                                      idname,
...
void BLO_library_temp_free(TempLibraryContext *temp_lib_ctx)
{
  ...
  BLO_library_link_end(
      temp_lib_ctx->bmain_lib, &temp_lib_ctx->ixamhandle, &temp_lib_ctx->liblink_params);
  BLO_ixamhandle_close(temp_lib_ctx->ixamhandle);
