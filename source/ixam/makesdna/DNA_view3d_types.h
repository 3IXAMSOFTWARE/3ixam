...
typedef struct View3D {
  ...
  /** Current UI highlighting for elements in PolyForm panel */
  int polyform_ui_highlight_flag;
...
#define V3D_SHOW_GRID (V3D_SHOW_FLOOR | V3D_SHOW_X | V3D_SHOW_Y)
