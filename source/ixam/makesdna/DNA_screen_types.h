...
typedef enum eRegion_Type {
  ...
  RGN_TYPE_XR = 13,
  /* Custom regions for main window*/
  RGN_TYPE_VIEWBAR = 14,
  RGN_TYPE_PRO_MENU = 15,


  /*DO NOT USE*/
  RGN_TYPE_LAST
#define RGN_TYPE_LEN (RGN_TYPE_LAST)
} eRegion_Type;
...
enum {
  ...
  RGN_ALIGN_TOP_RIGHT = 9,
  RGN_ALIGN_BOTTOM_RIGHT = 10,
  
  RGN_ALIGN_TOP_LEFT = 11,
  RGN_ALIGN_BOTTOM_LEFT = 12,
  /* Maximum 15. */
...
/** #ARegion.draw_flag */
enum {
  RGN_DRAW_ANIMATION = (1 << 0),
  RGN_CUSTOM_ALIGNMENT = (1 << 1),
};
#ifdef __cplusplus
}
#endif
