...
/** \file
 * \ingroup DNA
 * \brief ixamloader genfile private function prototypes
 */
 ...
 * used by this version of 3IXAM. It is defined in a file dna.c, which is
...
enum eSDNA_StructCompare {
   ...
   * (values of this struct type will not be loaded by the current 3IXAM) */
  SDNA_CMP_REMOVED = 0,
  /* Struct is the same
...
/* Access for current 3IXAM versions SDNA. */
