...
typedef struct RenderData {
  ...
  /* stamps flags. */
  int stamp;
  /** Select one of 3IXAMs bitmap fonts. */
  short stamp_font_id;
  char _pad3[2];
...
typedef struct Sculpt {
  ...
  /** Constant detail resolution (3IXAM unit / constant_detail). */
...
typedef struct UnifiedPaintSettings {
  ...
  /* unified radius of brush in 3IXAM units */
...
#define R_RENDER_ANIMATION (1 << 22)
...
/** #RenderData.is_animation */
enum {
  R_ANIMATION_RENDER = (1 << 0),
};
...
extern const char *RE_engine_id_IXAM_EEVEE;
extern const char *RE_engine_id_IXAM_WORKBENCH;
