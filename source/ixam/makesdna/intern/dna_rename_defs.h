 ...
 * \ingroup DNA
 *
 * Defines in this header are only used to define ixam file storage.
 ...
 *   without impacting 3IXAM's run-time, besides allowing us to use the new names.
 *
 ...
 *
 *   `sha1sum $BUILD_DIR/source/ixam/makesdna/intern/dna.c`
 *
...
/* Write with a different name, old 3IXAM versions crash loading files with non-NULL
