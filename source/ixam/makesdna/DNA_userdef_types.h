...
typedef struct ThemeUI {
  ...
  uiWidgetColors wcol_regular, wcol_tool, wcol_toolbar_item, wcol_toolbar_item_pro, wcol_text;
  uiWidgetColors wcol_radio, wcol_option, wcol_toggle;
  uiWidgetColors wcol_num, wcol_numslider, wcol_tab;
  uiWidgetColors wcol_menu, wcol_pulldown, wcol_menu_back, wcol_menu_item, wcol_tooltip;
  uiWidgetColors wcol_box, wcol_scroll, wcol_progress, wcol_list_item, wcol_pie_menu;
  uiWidgetColors wcol_view_item;
  uiWidgetColors wcol_animbar, wcol_prefs_regular, wcol_vert_trapezoid;
...
typedef struct bTheme {
  ...
  ThemeSpace space_matlib;
  ThemeSpace space_render;
...
#define UI_THEMESPACE_END(btheme) \
  (CHECK_TYPE_INLINE(btheme, bTheme *), (&((btheme)->space_render) + 1))
...
typedef struct UserDef {
   ...
   *
   * This supports the same layout as 3IXAM's scripts directory `release/scripts`.
   *
   ...
   * launch with a new version of 3IXAM. In this case setting the script path on top of
...
typedef enum eUserPref_Section {
  USER_SECTION_SCENE_PREFERENCES = 0,
...
/** #UserDef.font_weight */
typedef enum eFontWeight_Type {
  FONT_WEIGHT_LIGHT = 0,
  FONT_WEIGHT_MEDIUM = 1,
  FONT_WEIGHT_BOLD = 2,
} eFontWeight_Type;
 ...
 * #UserDef.hand_types
 */
typedef enum eHand_Types {
  USER_HAND_RIGHT = 0,
  USER_HAND_LEFT = 1,
} eHand_Types;

typedef enum eIntroSound_Types {
  USER_INTROSOUND_1 = 0,
  USER_INTROSOUND_2 = 1,
  USER_INTROSOUND_3 = 2,
} eIntroSound_Types;
