...
using ixam::gpu::shader::DualBlend;
using ixam::gpu::shader::Frequency;
using ixam::gpu::shader::ImageType;
using ixam::gpu::shader::ShaderCreateInfo;
using ixam::gpu::shader::StageInterfaceInfo;
using ixam::gpu::shader::Type;

#ifdef USE_PYGPU_SHADER_INFO_IMAGE_METHOD
using ixam::gpu::shader::Qualifier;
...
static int constant_type_size(Type type)
{
  switch (type) {
    ...
    case Type::UCHAR4:
    case Type::CHAR4:
    case ixam::gpu::shader::Type::VEC3_101010I2:
      return 4;
      break;
    case Type::VEC2:
    case Type::UVEC2:
    ...
    case Type::MAT4:
      return 64;
      break;
    case ixam::gpu::shader::Type::UCHAR:
    case ixam::gpu::shader::Type::CHAR:
      return 1;
      break;
    case ixam::gpu::shader::Type::UCHAR2:
    case ixam::gpu::shader::Type::CHAR2:
      return 2;
      break;
    case ixam::gpu::shader::Type::UCHAR3:
    case ixam::gpu::shader::Type::CHAR3:
      return 3;
      break;
  }
  BLI_assert(false);
...
PyDoc_STRVAR(
    ...
    "<https://wiki.ixam.org/wiki/EEVEE_%26_Viewport/GPU_Module/GLSL_Cross_Compilation>`__\n");
