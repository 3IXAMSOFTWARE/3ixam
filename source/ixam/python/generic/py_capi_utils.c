                                                    ...
                                                    PyObject *error_traceback)
{
   ...
   * Since the rule of thumb is for 3IXAM's embedded Python to match stand-alone Python,
...
const char *PyC_UnicodeAsByteAndSize(PyObject *py_str, Py_ssize_t *size, PyObject **coerce)
{
  ...
  if (result) {
     ...
     * chars since 3IXAM doesn't limit this */
    return result;
  }
...
/* Would be nice if python had this built in
 * See: https://wiki.3ixam.com/wiki/Tools/Debugging/PyFromC
 */
