...
#define STR_SOURCE_TYPES "'IMAGE', 'MOVIE', 'IXAM', 'FONT'"
...
static PyObject *bpy_utils_previews_load(PyObject *UNUSED(self), PyObject *args)
{
  ...
  else if (STREQ(path_type_s, "IXAM")) {
    path_type = THB_SOURCE_IXAM;
  }
...
PyDoc_STRVAR(
    ...
    "This object contains basic static methods to handle cached (non-ID) previews in 3IXAM\n"
