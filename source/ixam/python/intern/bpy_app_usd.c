...
static PyTypeObject IxamAppUSDType;

static PyStructSequence_Field app_usd_info_fields[] = {
    {"supported", "Boolean, True when 3IXAM is built with USD support"},
...
static PyStructSequence_Desc app_usd_info_desc = {
    "bpy.app.usd", /* name */
    "This module contains information about the Universal Scene Description library 3IXAM is "
    "linked against",    /* doc */
...
{
  PyObject *usd_info = PyStructSequence_New(&IxamAppUSDType);
...
{
  PyStructSequence_InitType(&IxamAppUSDType, &app_usd_info_desc);

  PyObject *ret = make_usd_info();

  /* prevent user from creating new instances */
  IxamAppUSDType.tp_init = NULL;
  IxamAppUSDType.tp_new = NULL;
  IxamAppUSDType.tp_hash = (hashfunc)
