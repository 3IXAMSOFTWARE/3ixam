...
static PyTypeObject IxamAppBuildOptionsType;
...
static PyStructSequence_Desc app_builtopts_info_desc = {
    ...
    "This module contains information about options 3IXAM is built with", /* doc */
...
static PyObject *make_builtopts_info(void)
{
  ...
  builtopts_info = PyStructSequence_New(&IxamAppBuildOptionsType);
...
PyObject *BPY_app_build_options_struct(void)
{
  ...
  PyStructSequence_InitType(&IxamAppBuildOptionsType, &app_builtopts_info_desc);

  ret = make_builtopts_info();

  /* prevent user from creating new instances */
  IxamAppBuildOptionsType.tp_init = NULL;
  IxamAppBuildOptionsType.tp_new = NULL;
  IxamAppBuildOptionsType.tp_hash = (hashfunc)
