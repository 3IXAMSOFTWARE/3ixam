...
static IxamAppTranslations *_translations = NULL;
...
PyDoc_STRVAR(app_translations_py_messages_register_doc,
             ...
             "\n"
             "   .. note::\n"
             "      Does nothing when 3IXAM is built without internationalization support.\n"
             "\n"
             ...
             "\n");
static PyObject *app_translations_py_messages_register(IxamAppTranslations *self,
                                                       PyObject *args,
                                                       PyObject *kw)
{
#ifdef WITH_INTERNATIONAL
...
PyDoc_STRVAR(app_translations_py_messages_unregister_doc,
             ...
             "   :type module_name: string\n"
             "\n");
static PyObject *app_translations_py_messages_unregister(IxamAppTranslations *self,
                                                         PyObject *args,
                                                         PyObject *kw)
{
#ifdef WITH_INTERNATIONAL
...
static PyTypeObject IxamAppTranslationsContextsType;
...
static PyObject *app_translations_contexts_make(void)
{
  ...
  translations_contexts = PyStructSequence_New(&IxamAppTranslationsContextsType);
...
/* ------------------------------------------------------------------- */
/** \name Main #IxamAppTranslations #PyObject Definition
 * \{ */
...
static PyMemberDef app_translations_members[] = {
    {"contexts",
     T_OBJECT_EX,
     offsetof(IxamAppTranslations, contexts),
     READONLY,
     app_translations_contexts_doc},
    {"contexts_C_to_py",
     T_OBJECT_EX,
     offsetof(IxamAppTranslations, contexts_C_to_py),
     READONLY,
...
PyDoc_STRVAR(app_translations_locale_doc,
             "The actual locale currently in use (will always return a void string when 3IXAM "
             "is built without "
...
PyDoc_STRVAR(app_translations_locales_doc,
             "All locales currently known by 3IXAM (i.e. available as translations).");
...
PyDoc_STRVAR(
    ...
    "      handled by 3IXAM internal code. The only exception are string containing formatting "
    "(like \"File: %r\"),\n"
    "      but you should rather use :func:`pgettext_iface`/:func:`pgettext_tip` in those cases!\n"
    "\n"
    "   .. note::\n"
    "      Does nothing when 3IXAM is built without internationalization support (hence always "
    "returns ``msgid``).\n"
    "\n"
    ...
    "\n");
static PyObject *app_translations_pgettext(IxamAppTranslations *UNUSED(self),
                                           PyObject *args,
                                           PyObject *kw)
{
...
PyDoc_STRVAR(app_translations_pgettext_iface_doc,
             ...
             "   :return: The translated string (or msgid if no translation was found).\n"
             "\n");
static PyObject *app_translations_pgettext_iface(IxamAppTranslations *UNUSED(self),
                                                 PyObject *args,
                                                 PyObject *kw)
{
...
PyDoc_STRVAR(app_translations_pgettext_tip_doc,
             ...
             "   :return: The translated string (or msgid if no translation was found).\n"
             "\n");
static PyObject *app_translations_pgettext_tip(IxamAppTranslations *UNUSED(self),
                                               PyObject *args,
                                               PyObject *kw)
{
...
PyDoc_STRVAR(app_translations_pgettext_data_doc,
             ...
             "   :return: The translated string (or ``msgid`` if no translation was found).\n"
             "\n");
static PyObject *app_translations_pgettext_data(IxamAppTranslations *UNUSED(self),
                                                PyObject *args,
                                                PyObject *kw)
{
...
PyDoc_STRVAR(
    ...
    "\n");
static PyObject *app_translations_locale_explode(IxamAppTranslations *UNUSED(self),
                                                 PyObject *args,
                                                 PyObject *kw)
{
  PyObject *ret_tuple;
                                      ...
                                      PyObject *UNUSED(kw))
{
  ...
  if (!_translations) {
    _translations = (IxamAppTranslations *)type->tp_alloc(type, 0);
    if (_translations) {
      PyObject *py_ctxts;
      BLT_i18n_contexts_descriptor *ctxt;
...
PyDoc_STRVAR(app_translations_doc,
             "This object contains some data/methods regarding internationalization in 3IXAM, "
             "and allows every py script\n"
             "to feature translations for its own UI messages.\n"
             "\n");
static PyTypeObject IxamAppTranslationsType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    /* tp_name */
    "bpy.app._translations_type",
    /* tp_basicsize */
    sizeof(IxamAppTranslations),
    0, /* tp_itemsize */
    /* methods */
...
PyObject *BPY_app_translations_struct(void)
{
  ...
  /* Let's finalize our contexts structseq definition! */
  {
    ...
    PyStructSequence_InitType(&IxamAppTranslationsContextsType,
                              &app_translations_contexts_desc);
  }

  if (PyType_Ready(&IxamAppTranslationsType) < 0) {
    return NULL;
  }

  ret = PyObject_CallObject((PyObject *)&IxamAppTranslationsType, NULL);

  /* prevent user from creating new instances */
  IxamAppTranslationsType.tp_new = NULL;
  /* without this we can't do set(sys.modules) T29635. */
  IxamAppTranslationsType.tp_hash = (hashfunc)_Py_HashPointer;
