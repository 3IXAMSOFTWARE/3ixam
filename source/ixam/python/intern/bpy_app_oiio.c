...
static PyTypeObject IxamAppOIIOType;

static PyStructSequence_Field app_oiio_info_fields[] = {
    {"supported", "Boolean, True when 3IXAM is built with OpenImageIO support"},
...
static PyStructSequence_Desc app_oiio_info_desc = {
    "bpy.app.oiio",                                                                /* name */
    "This module contains information about OpeImageIO 3IXAM is linked against", /* doc */
...
static PyObject *make_oiio_info(void)
{
  ...
  oiio_info = PyStructSequence_New(&IxamAppOIIOType);
  if (oiio_info == NULL) {
    return NULL;
  }
...
PyObject *BPY_app_oiio_struct(void)
{
  ...
  PyStructSequence_InitType(&IxamAppOIIOType, &app_oiio_info_desc);

  ret = make_oiio_info();

  /* prevent user from creating new instances */
  IxamAppOIIOType.tp_init = NULL;
  IxamAppOIIOType.tp_new = NULL;
  IxamAppOIIOType.tp_hash = (hashfunc)
