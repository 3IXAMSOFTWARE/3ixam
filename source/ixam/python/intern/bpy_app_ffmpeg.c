...
static PyTypeObject IxamAppFFmpegType;
...
static PyStructSequence_Field app_ffmpeg_info_fields[] = {
    {"supported", "Boolean, True when 3IXAM is built with FFmpeg support"},
...
static PyStructSequence_Desc app_ffmpeg_info_desc = {
    "bpy.app.ffmpeg",                                                          /* name */
    "This module contains information about FFmpeg 3IXAM is linked against", /* doc */
...
static PyObject *make_ffmpeg_info(void)
{
  ...
  ffmpeg_info = PyStructSequence_New(&IxamAppFFmpegType);
  if (ffmpeg_info == NULL) {
    return NULL;
  }
...
PyObject *BPY_app_ffmpeg_struct(void)
{
  ...
  PyStructSequence_InitType(&IxamAppFFmpegType, &app_ffmpeg_info_desc);

  ret = make_ffmpeg_info();

  /* prevent user from creating new instances */
  IxamAppFFmpegType.tp_init = NULL;
  IxamAppFFmpegType.tp_new = NULL;
  IxamAppFFmpegType.tp_hash = (hashfunc)
