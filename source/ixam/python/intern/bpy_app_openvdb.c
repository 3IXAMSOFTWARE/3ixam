...
static PyTypeObject IxamAppOVDBType;

static PyStructSequence_Field app_openvdb_info_fields[] = {
    {"supported", "Boolean, True when 3IXAM is built with OpenVDB support"},
...
static PyStructSequence_Desc app_openvdb_info_desc = {
    ...
    "This module contains information about OpenVDB 3IXAM is linked against", /* doc */
...
static PyObject *make_openvdb_info(void)
{
  ...
  openvdb_info = PyStructSequence_New(&IxamAppOVDBType);
...
PyObject *BPY_app_openvdb_struct(void)
{
  ...
  PyStructSequence_InitType(&IxamAppOVDBType, &app_openvdb_info_desc);

  ret = make_openvdb_info();

  /* prevent user from creating new instances */
  IxamAppOVDBType.tp_init = NULL;
  IxamAppOVDBType.tp_new = NULL;
  IxamAppOVDBType.tp_hash = (hashfunc)
