 ...
 * (not currently used by 3IXAM itself).
 */
...
PyDoc_STRVAR(
    ...
    "         Python must keep a reference to the strings returned by the callback or 3IXAM\n"
...
static struct PyModuleDef props_module = {
    ...
    "bpy.props",
    "This module defines properties to extend 3IXAM's internal data. The result of these "
    "functions"
    " is used to assign properties to classes registered with 3IXAM and can't be used "
    "directly.\n"
    "\n"
