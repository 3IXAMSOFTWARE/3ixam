...
static PyTypeObject IxamAppABCType;

static PyStructSequence_Field app_alembic_info_fields[] = {
    {"supported", "Boolean, True when 3IXAM is built with Alembic support"},
...
static PyStructSequence_Desc app_alembic_info_desc = {
    ...
    "This module contains information about Alembic 3IXAM is linked against", /* doc */
...
{
  PyObject *alembic_info = PyStructSequence_New(&IxamAppABCType);
...
{
  PyStructSequence_InitType(&IxamAppABCType, &app_alembic_info_desc);

  PyObject *ret = make_alembic_info();

  /* prevent user from creating new instances */
  IxamAppABCType.tp_init = NULL;
  IxamAppABCType.tp_new = NULL;
  IxamAppABCType.tp_hash = (hashfunc)
