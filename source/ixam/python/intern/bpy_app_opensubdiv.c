...
static PyTypeObject IxamAppOpenSubdivType;

static PyStructSequence_Field app_opensubdiv_info_fields[] = {
    {"supported", "Boolean, True when 3IXAM is built with OpenSubdiv support"},
...
static PyStructSequence_Desc app_opensubdiv_info_desc = {
    ...
    "This module contains information about OpenSubdiv 3IXAM is linked against", /* doc */
...
static PyObject *make_opensubdiv_info(void)
{
  ...
  opensubdiv_info = PyStructSequence_New(&IxamAppOpenSubdivType);
...
PyObject *BPY_app_opensubdiv_struct(void)
{
  ...
  PyStructSequence_InitType(&IxamAppOpenSubdivType, &app_opensubdiv_info_desc);

  ret = make_opensubdiv_info();

  /* prevent user from creating new instances */
  IxamAppOpenSubdivType.tp_init = NULL;
  IxamAppOpenSubdivType.tp_new = NULL;
  /* without this we can't do set(sys.modules) T29635. */
  IxamAppOpenSubdivType.tp_hash = (hashfunc)_Py_HashPointer;
