...
/* Used for PolyFill */
#ifndef MATH_STANDALONE /* define when building outside ixam */
#  include "BKE_curve.h"
...
/*-------------------------DOC STRINGS ---------------------------*/
PyDoc_STRVAR(M_Geometry_doc, "3IXAM geometry module");
...
PyDoc_STRVAR(M_Geometry_tessellate_polygon_doc,
             ...
             "   :rtype: list\n");
/* PolyFill function, uses Ixams scan-fill to fill multiple poly lines. */
