...
static void test_shader_builtin()
{
  ...
  test_compile_builtin_shader(GPU_SHADER_SIMPLE_IMG_LIGHTING, GPU_SHADER_CFG_DEFAULT);
  ...
  test_compile_builtin_shader(GPU_SHADER_2D_ANIMATION, GPU_SHADER_CFG_DEFAULT);
  ...
  test_compile_builtin_shader(GPU_SHADER_2D_WIDGET_HEX_INST, GPU_SHADER_CFG_DEFAULT);
  test_compile_builtin_shader(GPU_SHADER_BILLBOARD, GPU_SHADER_CFG_DEFAULT);
  test_compile_builtin_shader(GPU_SHADER_2D_WIDGET_HEX, GPU_SHADER_CFG_DEFAULT);
}
