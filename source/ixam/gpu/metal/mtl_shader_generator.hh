...
class MSLGeneratorInterface {
 ...
 public:
  ...
  ixam::Vector<MSLUniformBlock> uniform_blocks;
  ixam::Vector<MSLUniform> uniforms;
  ixam::Vector<MSLTextureSampler> texture_samplers;
  ixam::Vector<MSLVertexInputAttribute> vertex_input_attributes;
  ixam::Vector<MSLVertexOutputAttribute> vertex_output_varyings;
  ...
  ixam::Vector<MSLVertexOutputAttribute> fragment_input_varyings;
  ixam::Vector<MSLFragmentOutputAttribute> fragment_outputs;
  /* Transform feedback interface. */
  ixam::Vector<MSLVertexOutputAttribute> vertex_output_varyings_tf;
  /* Clip Distances. */
  ixam::Vector<std::string> clip_distances;
