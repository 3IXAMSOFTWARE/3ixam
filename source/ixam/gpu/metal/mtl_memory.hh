...
class MTLBufferPool {
 ...
 private:
  ...
  ixam::Map<MTLBufferResourceOptions, MTLBufferPoolOrderedList *> buffer_pools_;
  ixam::Vector<gpu::MTLBuffer *> allocations_;
  ...
  ixam::Vector<MTLSafeFreeList *> completed_safelist_queue_;
