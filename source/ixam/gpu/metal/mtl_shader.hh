...
struct MTLRenderPipelineStateInstance {
  ...
  ixam::Vector<MTLBufferArgumentData> buffer_bindings_reflection_data_vert;
  ixam::Vector<MTLBufferArgumentData> buffer_bindings_reflection_data_frag;
};
...
class MTLShader : public Shader {
 ...
 private:
  ...
  ixam::Vector<std::string> tf_output_name_list_;
  ...
  ixam::Map<MTLRenderPipelineStateDescriptor, MTLRenderPipelineStateInstance *> pso_cache_;
