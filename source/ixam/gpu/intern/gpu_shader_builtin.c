...
extern char datatoc_gpu_shader_2D_hex_frag_glsl[];
extern char datatoc_gpu_shader_2D_hex_vert_glsl[];
extern char datatoc_gpu_shader_2D_animation_frag_glsl[];
extern char datatoc_gpu_shader_2D_animation_vert_glsl[];
extern char datatoc_gpu_shader_billboard_vert_glsl[];
extern char datatoc_gpu_shader_billboard_geom_glsl[];
extern char datatoc_gpu_shader_billboard_frag_glsl[];
...
const struct GPUShaderConfigData GPU_shader_cfg_data[GPU_SHADER_CFG_LEN] = {
    [GPU_SHADER_CFG_DEFAULT] =
        {
            .lib = "",
            .def = "#define ixam_srgb_to_framebuffer_space(a) a\n",
        },
    [GPU_SHADER_CFG_CLIPPED] =
        {
            .lib = datatoc_gpu_shader_cfg_world_clip_lib_glsl,
            .def = "#define USE_WORLD_CLIP_PLANES\n"
                   "#define ixam_srgb_to_framebuffer_space(a) a\n",
        },
};
...
static const GPUShaderStages builtin_shader_stages[GPU_SHADER_BUILTIN_LEN] = {
    ...
    [GPU_SHADER_SIMPLE_IMG_LIGHTING] =
        {
            .name = "GPU_SHADER_SIMPLE_IMG_LIGHTING",
            .create_info = "gpu_shader_simple_img_lighting",
        },
    [GPU_SHADER_3D_IMAGE] =
        {
    ...
    [GPU_SHADER_2D_WIDGET_HEX] =
      {
          .name = "GPU_SHADER_2D_WIDGET_HEX",
          .vert = datatoc_gpu_shader_2D_hex_vert_glsl,
          .frag = datatoc_gpu_shader_2D_hex_frag_glsl,
      },
    [GPU_SHADER_2D_WIDGET_HEX_INST] =
      {
          .name = "GPU_SHADER_2D_WIDGET_HEX_INST",
          .vert = datatoc_gpu_shader_2D_hex_vert_glsl,
          .frag = datatoc_gpu_shader_2D_hex_frag_glsl,
          .defs = "#define USE_INSTANCE\n",
      },
    [GPU_SHADER_2D_ANIMATION] = 
      {
          .name = "GPU_SHADER_2D_ANIMATION",
          .vert = datatoc_gpu_shader_2D_animation_vert_glsl,
          .frag = datatoc_gpu_shader_2D_animation_frag_glsl,
      },
    ...
    [GPU_SHADER_BILLBOARD] =
        {
            .name = "GPU_SHADER_BILLBOARD",
            .create_info = "gpu_shader_billboard",
        },
