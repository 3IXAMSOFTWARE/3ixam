 ...
 * We use the same vector and matrix types as 3IXAM C++. Some math functions are defined to use
...
using ixam::uint4;
using bool1 = int;
using bool2 = ixam::int2;
using bool3 = ixam::int3;
using bool4 = ixam::int4;
