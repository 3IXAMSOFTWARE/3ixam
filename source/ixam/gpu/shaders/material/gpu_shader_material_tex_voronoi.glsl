#pragma IXAM_REQUIRE(gpu_shader_common_hash.glsl)
#pragma IXAM_REQUIRE(gpu_shader_common_math_utils.glsl)
 ...
 * Smooth Voronoi:
 *
 * - https://wiki.3ixam.com/wiki/User:OmarSquircleArt/GSoC2019/Documentation/Smooth_Voronoi
 *
