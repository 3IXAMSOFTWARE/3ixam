...
class IxamTextureShader : public StrokeShader {
 private:
  MTex *_mtex;
  bNodeTree *_nodeTree;
 ...
 public:
  /** Builds the shader.
   *  \param mtex:
   *    The ixam texture to use.
   */
  IxamTextureShader(MTex *mtex)
  {
    _mtex = mtex;
    _nodeTree = NULL;
  }
   ...
   */
  IxamTextureShader(bNodeTree *nodetree)
  {
    _nodeTree = nodetree;
    _mtex = NULL;
  }
