...
#include "StrokeShader/BPy_IxamTextureShader.h"
...
int StrokeShader_Init(PyObject *module)
{
  ...
  if (PyType_Ready(&IxamTextureShader_Type) < 0) {
    return -1;
  }
  Py_INCREF(&IxamTextureShader_Type);
  PyModule_AddObject(module, "IxamTextureShader", (PyObject *)&IxamTextureShader_Type);
