...
const char *IxamStrokeRenderer::uvNames[] = {"along_stroke", "along_stroke_tips"};

IxamStrokeRenderer::IxamStrokeRenderer(Render *re, int render_count)
{
  ...
  // Reset serial mesh ID (used for IxamStrokeRenderer::NewMesh())
  _mesh_id = 0xffffffff;

  // Create a bNodeTree-to-Material hash table
  _nodetree_hash = BLI_ghash_ptr_new("IxamStrokeRenderer::_nodetree_hash");
...
IxamStrokeRenderer::~IxamStrokeRenderer()
{
...
float IxamStrokeRenderer::get_stroke_vertex_z() const
{
  float z = _z;
  IxamStrokeRenderer *self = const_cast<IxamStrokeRenderer *>(this);
...
uint IxamStrokeRenderer::get_stroke_mesh_id() const
{
...
Material *IxamStrokeRenderer::GetStrokeShader(Main *bmain,
                                                 bNodeTree *iNodeTree,
                                                 bool do_id_user)
{
...
void IxamStrokeRenderer::RenderStrokeRep(StrokeRep *iStrokeRep) const
{
  RenderStrokeRepBasic(iStrokeRep);
}

void IxamStrokeRenderer::RenderStrokeRepBasic(StrokeRep *iStrokeRep) const
{
  bNodeTree *nt = iStrokeRep->getNodeTree();
  Material *ma = (Material *)BLI_ghash_lookup(_nodetree_hash, nt);
  if (!ma) {
    ma = IxamStrokeRenderer::GetStrokeShader(freestyle_bmain, nt, false);
  ...
  IxamStrokeRenderer *self = const_cast<IxamStrokeRenderer *>(this);  // FIXME
...
bool IxamStrokeRenderer::test_triangle_visibility(StrokeVertexRep *svRep[3]) const
{
  int xl, xu, yl, yu;
  Vec2r p;
...
void IxamStrokeRenderer::test_strip_visibility(Strip::vertex_container &strip_vertices,
                                                  int *visible_faces,
...
void IxamStrokeRenderer::FreeStrokeGroups()
{
...
int IxamStrokeRenderer::GenerateScene()
{
  vector<StrokeGroup *>::const_iterator it, itend;
...
int IxamStrokeRenderer::get_stroke_count() const
{
  return strokeGroups.size() + texturedStrokeGroups.size();
}

// Build a mesh object representing a group of stylized strokes
void IxamStrokeRenderer::GenerateStrokeMesh(StrokeGroup *group, bool hasTex)
{
#if 0
...
Object *IxamStrokeRenderer::NewMesh() const
{
  Object *ob;
...
Render *IxamStrokeRenderer::RenderScene(Render * /*re*/, bool render)
{
