...
class IxamStrokeRenderer : public StrokeRenderer {
 public:
  IxamStrokeRenderer(Render *re, int render_count);
  virtual ~IxamStrokeRenderer();
  ...
  struct StrokeGroup {
    ...
    ixam::Map<Material *, int> materials;
    int totvert;
    int totedge;
    int totpoly;
    int totloop;
 ...
 protected:
  ...
  MEM_CXX_CLASS_ALLOC_FUNCS("Freestyle:IxamStrokeRenderer")
#endif
};
