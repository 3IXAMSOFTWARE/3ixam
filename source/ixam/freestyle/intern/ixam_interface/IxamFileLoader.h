...
class IxamFileLoader {
 public:
  /** Builds a MaxFileLoader */
  IxamFileLoader(Render *re, ViewLayer *view_layer, Depsgraph *depsgraph);
  virtual ~IxamFileLoader();
...
#ifdef WITH_CXX_GUARDEDALLOC
  MEM_CXX_CLASS_ALLOC_FUNCS("Freestyle:IxamFileLoader")
#endif
};
