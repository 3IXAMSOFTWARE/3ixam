...
static wmOperatorType *wm_operatortype_append__begin(void)
{
  ...
  ot->srna = RNA_def_struct_ptr(&IXAM_RNA, "", &RNA_OperatorProperties);
...
static void wm_operatortype_append__end(wmOperatorType *ot)
{
  ...
  RNA_def_struct_identifier(&IXAM_RNA, ot->srna, ot->idname);
...
void WM_operatortype_remove_ptr(wmOperatorType *ot)
{
  ...
  RNA_struct_free(&IXAM_RNA, ot->srna);
...
{
  /* reserve size is set based on 3IXAM default setup */
