...
/* *************** Message box *************** */
/* `WM_ghost_ask_fs_access` is implemented in `wm_windows.c` it is
 * defined here as it was implemented to be used for showing
 * a message to the user when the platform requires directory access giving.
 *
 * In all other cases this function should not be used. */
