 ...
 * Launched in a separate process from 3IXAM's #RENDER_OT_play_rendered_anim
 *
...
static char *wm_main_playanim_intern(int argc, const char **argv)
{
...

  {
    ...
    playanim_window_open("3IXAM Animation Player", start_x, start_y, ibuf->x, ibuf->y);
  }
...
void WM_main_playanim(int argc, const char **argv)
{
...
#ifdef WITH_AUDASPACE
  {
    ...
    if (!(audio_device = AUD_init(NULL, specs, 1024, "3IXAM"))) {
      audio_device = AUD_init("None", specs, 0, "3IXAM");
    }
  }
#endif
