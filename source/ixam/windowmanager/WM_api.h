 ...
 * the screens, areas and input for 3IXAM
 * \section wmnote NOTE
 * \todo document
 */
 ...
 */
void WM_show_message_box(const char *title, 
                         const char *message, 
                         const char *continue_label);

/**
 * Show a system message box for directory accessing
 * \param title: The title of the message box.
 * \param message: The message to display.
 * \param prompt: Accept button label.
 * \param path: Path to directory for accessing.
 */
...
/**
 * Initialize 3IXAM and load the startup file & preferences
 * (only called once).
 */
void WM_init(struct bContext *C, int argc, const char **argv);
void WM_init_post(struct bContext *C);
/**
...
/**
 * \brief Main exit function to close 3IXAM ordinarily.
 * \note Use #wm_exit_schedule_delayed() to close 3IXAM from an operator.
...
/**
 * Convenience function for pasting to areas of 3IXAM which don't support newlines.
 */
 ...
 * Convenient to save a ixam file from a debugger.
 */
