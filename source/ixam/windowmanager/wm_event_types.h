 ...
 * 3IXAM copied the conventions quite some, and expanded it with internal new defines (ton)
 */
...
#define _NDOF_BUTTON_MAX NDOF_BUTTON_C
  ...
  /* ********** Start of 3IXAM internal events. ********** */
