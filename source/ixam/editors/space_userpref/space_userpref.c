...
static void userpref_region_layout(const bContext *C, ARegion *region)
{
...
static void userpref_ixam_write(IxamWriter *writer, SpaceLink *sl)
{
...
void ED_spacetype_userpref(void)
{
  ...
  st->ixam_write = userpref_ixam_write;
