...
static void console_ixam_read_data(IxamDataReader *reader, SpaceLink *sl)
{
...
static void console_ixam_write(IxamWriter *writer, SpaceLink *sl)
{
...
void ED_spacetype_console(void)
{
  ...
  st->ixam_read_data = console_ixam_read_data;
  st->ixam_write = console_ixam_write;
