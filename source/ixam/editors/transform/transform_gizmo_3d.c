...
#define GIZMO_NEW_ARROW(v, draw_style) \
  ...
  ((void)0)
#define GIZMOS_NEW_ARROW_COORD(v, draw_style, c) \
  { \
    ggd->gizmos[v] = WM_gizmo_new_ptr(gzt_arrow, gzgroup, NULL); \
    ggd->gizmos[v]->coord = c;                                   \
    RNA_enum_set(ggd->gizmos[v]->ptr, "draw_style", draw_style); \
  } \
  ((void)0)
...
#define GIZMO_NEW_PRIM(v, draw_style) \
  ...
  GIZMOS_NEW_ARROW_COORD(MAN_AXIS_SCALE_X, ED_GIZMO_ARROW_STYLE_BOX, 'x');
  GIZMOS_NEW_ARROW_COORD(MAN_AXIS_SCALE_Y, ED_GIZMO_ARROW_STYLE_BOX, 'y');
  GIZMOS_NEW_ARROW_COORD(MAN_AXIS_SCALE_Z, ED_GIZMO_ARROW_STYLE_BOX, 'z');
  ...
  GIZMOS_NEW_ARROW_COORD(MAN_AXIS_TRANS_X, ED_GIZMO_ARROW_STYLE_NORMAL, 'x');
  GIZMOS_NEW_ARROW_COORD(MAN_AXIS_TRANS_Y, ED_GIZMO_ARROW_STYLE_NORMAL, 'y');
  GIZMOS_NEW_ARROW_COORD(MAN_AXIS_TRANS_Z, ED_GIZMO_ARROW_STYLE_NORMAL, 'z');
