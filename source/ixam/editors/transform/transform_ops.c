...
const EnumPropertyItem rna_enum_transform_mode_types[] = {
    ...
    {TFM_BONESIZE, "BONE_SIZE", 0, "Joint Size", ""},
    {TFM_BONE_ENVELOPE, "BONE_ENVELOPE", 0, "Joint Envelope", ""},
    {TFM_BONE_ENVELOPE_DIST, "BONE_ENVELOPE_DIST", 0, "Joint Envelope Distance", ""},
    ...
    {TFM_BONE_ROLL, "BONE_ROLL", 0, "Joint Roll", ""},
