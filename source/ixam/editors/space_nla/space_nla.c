...
static void nla_ixam_read_data(IxamDataReader *reader, SpaceLink *sl)
{
  SpaceNla *snla = (SpaceNla *)sl;
  BLO_read_data_address(reader, &snla->ads);
}

static void nla_ixam_read_lib(IxamLibReader *reader, ID *parent_id, SpaceLink *sl)
{
  SpaceNla *snla = (SpaceNla *)sl;
...
static void nla_ixam_write(IxamWriter *writer, SpaceLink *sl)
{
  SpaceNla *snla = (SpaceNla *)sl;
...
void ED_spacetype_nla(void)
{
  ...
  st->ixam_read_data = nla_ixam_read_data;
  st->ixam_read_lib = nla_ixam_read_lib;
  st->ixam_write = nla_ixam_write;
