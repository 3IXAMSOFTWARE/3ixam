...
static int apply_armature_pose2bones_exec(bContext *C, wmOperator *op)
{
  ...
  if (BKE_object_obdata_is_libdata(ob)) {
    BKE_report(op->reports, RPT_ERROR, "Cannot apply pose to lib-linked rig");
    return OPERATOR_CANCELLED;
  }
  ...
  if (ob->adt && ob->adt->action) {
    BKE_report(op->reports,
               RPT_WARNING,
               "Actions on this rig will be destroyed by this new rest pose as the "
...
void POSE_OT_armature_apply(wmOperatorType *ot)
{
  ...
  RNA_def_boolean(ot->srna,
                  ...
                  false,
                  "Selected Only",
                  "Only apply the selected joints (with propagation to children)");
}
...
void POSE_OT_visual_transform_apply(wmOperatorType *ot)
{
  ...
  ot->description = "Apply final constrained position of pose joints to their transform";
...
static int pose_copy_exec(bContext *C, wmOperator *op)
{
  ...
  STRNCPY(temp_bmain->filepath, BKE_main_ixamfile_path_from_global());
  ...
  BLI_path_join(str, sizeof(str), BKE_tempdir_base(), "copybuffer_pose.ixam");
...
void POSE_OT_copy(wmOperatorType *ot)
{
  ...
  ot->description = "Copies the current pose of the selected joints to copy/paste buffer";
...
static int pose_paste_exec(bContext *C, wmOperator *op)
{
  ...
  /* Read copy buffer .ixam file. */
  char str[FILE_MAX];
  Main *tmp_bmain = BKE_main_new();
  STRNCPY(tmp_bmain->filepath, BKE_main_ixamfile_path_from_global());
...
void POSE_OT_paste(wmOperatorType *ot)
{
  ...
  RNA_def_boolean(ot->srna,
                  ...
                  false,
                  "On Selected Only",
                  "Only paste the stored pose on to selected joints in the current pose");
}
...
static void pchan_clear_rot(bPoseChannel *pchan)
{
  ...
  } /* Duplicated in source/ixam/editors/object/object_transform.cc */
  else {
    if (pchan->rotmode == ROT_MODE_QUAT) {
      unit_qt(pchan->quat);
    }
...
void POSE_OT_scale_clear(wmOperatorType *ot)
{
  ...
  ot->description = "Reset scaling of selected joints to their default values";
...
void POSE_OT_rot_clear(wmOperatorType *ot)
{
  ...
  ot->description = "Reset rotations of selected joints to their default values";
...
void POSE_OT_loc_clear(wmOperatorType *ot)
{
  ...
  ot->description = "Reset locations of selected joints to their default values";
...
void POSE_OT_transforms_clear(wmOperatorType *ot)
{
  ...
  ot->description =
      "Reset location, rotation, and scaling of selected joints to their default values";
...
void POSE_OT_user_transforms_clear(wmOperatorType *ot)
{
  ...
  ot->description = "Reset pose joint transforms to keyframed state";
  ...
  /* properties */
  RNA_def_boolean(ot->srna, "only_selected", true, "Only Selected", "Only visible/selected joints");
}
