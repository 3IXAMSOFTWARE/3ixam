...
void POSE_OT_select_linked_pick(wmOperatorType *ot)
{
  ...
  ot->description = "Select joints linked by parent/child connections under the mouse cursor";
...
{
  /* identifiers */
  ot->name = "Select Parent Joint";
  ot->idname = "POSE_OT_select_parent";
  ot->description = "Select joints that are parents of the currently selected joints";
...
void POSE_OT_select_constraint_target(wmOperatorType *ot)
{
  ...
  ot->description = "Select joints used as targets for the currently selected joints";
...
void POSE_OT_select_grouped(wmOperatorType *ot)
{
  static const EnumPropertyItem prop_select_grouped_types[] = {
      ...
      {POSE_SEL_SAME_KEYINGSET,
       ...
       0,
       "Keying Set",
       "All joints affected by active Keying Set"},
      {0, NULL, 0, NULL, NULL},
  };

  /* identifiers */
  ot->name = "Select Grouped";
  ot->description = "Select all visible joints grouped by similar properties";
