...
void ARMATURE_OT_select_linked(wmOperatorType *ot)
{
  ...
  ot->description = "Select all joints linked by parent/child connections to the current selection";
...
void ARMATURE_OT_select_linked_pick(wmOperatorType *ot)
{
  ...
  ot->description = "(De)select joints linked by parent/child connections under the mouse cursor";
...
void ARMATURE_OT_select_all(wmOperatorType *ot)
{
  ...
  ot->description = "Toggle selection status of all joints";
...
void ARMATURE_OT_select_more(wmOperatorType *ot)
{
  ...
  ot->description = "Select those joints connected to the initial selection";
...
void ARMATURE_OT_select_less(wmOperatorType *ot)
{
  ...
  ot->description = "Deselect those joints at the boundary of each selection region";
...
void ARMATURE_OT_select_similar(wmOperatorType *ot)
{
  ...
  ot->poll = ED_operator_editarmature;
  ot->description = "Select similar joints by property types";
...
void ARMATURE_OT_select_hierarchy(wmOperatorType *ot)
{
  ...
  ot->description = "Select immediate parent/children of selected joints";
...
void ARMATURE_OT_select_mirror(wmOperatorType *ot)
{
  ...
  ot->description = "Mirror the joint selection";
  ...
  /* properties */
  RNA_def_boolean(
      ot->srna, "only_active", false, "Active Only", "Only operate on the active joint");
  RNA_def_boolean(ot->srna, "extend", false, "Extend", "Extend the selection");
}
...
static int armature_shortest_path_pick_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  ...
  BKE_report(op->reports, RPT_WARNING, "Unselectable joint in chain");
  return OPERATOR_CANCELLED;
}
...
void ARMATURE_OT_shortest_path_pick(wmOperatorType *ot)
{
  ...
  ot->description = "Select shortest path between two joints";
