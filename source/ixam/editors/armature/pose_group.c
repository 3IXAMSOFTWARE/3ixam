...
static bool pose_group_poll(bContext *C)
{
  ...
  if ((obpose->proxy != NULL) || (obpose->proxy_group != NULL) || ID_IS_OVERRIDE_LIBRARY(obpose)) {
    CTX_wm_operator_poll_msg_set(C, "Cannot edit joint groups for proxies or library overrides");
    return false;
  }
...
{
  /* identifiers */
  ot->name = "Add Joint Group";
  ot->idname = "POSE_OT_group_add";
  ot->description = "Add a new joint group";
...
{
  /* identifiers */
  ot->name = "Remove Joint Group";
  ot->idname = "POSE_OT_group_remove";
  ot->description = "Remove the active joint group";
...
{
  /* identifiers */
  ot->name = "Add Selected to Joint Group";
  ot->idname = "POSE_OT_group_assign";
  ot->description = "Add selected joints to the chosen joint group";
  ...
  /* properties */
  RNA_def_int(ot->srna, "type", 0, 0, INT_MAX, "Joint Group Index", "", 0, 10);
}
...
{
  /* identifiers */
  ot->name = "Remove Selected from Joint Groups";
  ot->idname = "POSE_OT_group_unassign";
  ot->description = "Remove selected joints from all joint groups";
...
void POSE_OT_group_move(wmOperatorType *ot)
{
  ...
  /* identifiers */
  ot->name = "Move Joint Group";
  ot->idname = "POSE_OT_group_move";
  ot->description = "Change position of active Joint Group in list of Joint Groups";
  ...
  RNA_def_enum(ot->srna,
               ...
               0,
               "Direction",
               "Direction to move the active Joint Group towards");
}
...
static int group_sort_exec(bContext *C, wmOperator *UNUSED(op))
{
  ...
  agrp_array = MEM_mallocN(sizeof(tSortActionGroup) * agrp_count, "sort joint groups");
  int i;
...
{
  /* identifiers */
  ot->name = "Sort Joint Groups";
  ot->idname = "POSE_OT_group_sort";
  ot->description = "Sort Joint Groups by their names in ascending order";
...
{
  /* identifiers */
  ot->name = "Select Joints of Joint Group";
  ot->idname = "POSE_OT_group_select";
  ot->description = "Select joints in active Joint Group";
...
{
  /* identifiers */
  ot->name = "Deselect Joint Group";
  ot->idname = "POSE_OT_group_deselect";
  ot->description = "Deselect joints of active Joint Group";
