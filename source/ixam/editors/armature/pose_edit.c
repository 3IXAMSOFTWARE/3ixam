...
static int pose_calculate_paths_exec(bContext *C, wmOperator *op)
{
  ...
  /* set default settings for operator */
  bAnimVizSettings *avs = &ob->pose->avs;
  PointerRNA avs_ptr;
...
{
  /* identifiers */
  ot->name = "Calculate Joint Paths";
  ot->idname = "POSE_OT_paths_calculate";
  ot->description = "Calculate paths for the selected joints";
  ...
  RNA_def_enum(ot->srna,
               ...
               0,
               "Bake Location",
               "Which point on the joints is used when calculating paths");
}
...
{
  /* identifiers */
  ot->name = "Update Joint Paths";
  ot->idname = "POSE_OT_paths_update";
  ot->description = "Recalculate paths for joints that already have them";
...
{
  /* identifiers */
  ot->name = "Clear Joint Paths";
  ot->idname = "POSE_OT_paths_clear";
  ot->description = "Clear path caches for all joints, hold Shift key for selected joints only";
  ...
  ot->prop = RNA_def_boolean(
      ot->srna, "only_selected", false, "Only Selected", "Only clear paths from selected joints");
...
void POSE_OT_flip_names(wmOperatorType *ot)
{
  ...
  ot->description = "Flips (and corrects) the axis suffixes of the names of selected joints";
...
void POSE_OT_autoside_names(wmOperatorType *ot)
{
  ...
  ot->description =
      "Automatically renames the selected joints according to which side of the target axis they "
      "fall on";
...
void POSE_OT_rotation_mode_set(wmOperatorType *ot)
{
  ...
  ot->description = "Set the rotation representation used by selected joints";
...
void ARMATURE_OT_layers_show_all(wmOperatorType *ot)
{
  ...
  ot->description = "Make all rig layers visible";
...
{
  /* identifiers */
  ot->name = "Change Rig Layers";
  ot->idname = "ARMATURE_OT_armature_layers";
  ot->description = "Change the visible rig layers";
  ...
  RNA_def_boolean_layer_member(
      ot->srna, "layers", 32, NULL, "Layer", "Rig layers to make visible");
}
...
{
  /* identifiers */
  ot->name = "Change Joint Layers";
  ot->idname = "POSE_OT_bone_layers";
  ot->description = "Change the layers that the selected joints belong to";
  ...
  /* properties */
  RNA_def_boolean_layer_member(
      ot->srna, "layers", 32, NULL, "Layer", "Rig layers that joint belongs to");
}
...
void POSE_OT_hide(wmOperatorType *ot)
{
  ...
  ot->description = "Tag selected joints to not be visible in Pose Mode";
...
void POSE_OT_reveal(wmOperatorType *ot)
{
  ...
  ot->description = "Reveal all joints hidden in Pose Mode";
