...
static void script_main_region_draw(const bContext *C, ARegion *region)
{
  ...
  /* data... */
  // BPY_script_exec(C, "/root/ixam-svn/ixam25/test.py", NULL);
...
static void script_ixam_read_lib(IxamLibReader *reader, ID *parent_id, SpaceLink *sl)
{
...
static void script_ixam_write(IxamWriter *writer, SpaceLink *sl)
{
...
void ED_spacetype_script(void)
{
  ...
  st->ixam_read_lib = script_ixam_read_lib;
  st->ixam_write = script_ixam_write;
