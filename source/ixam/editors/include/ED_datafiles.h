...
/* Datafiles embedded in 3IXAM */

extern int datatoc_startup_ixam_size;
extern const char datatoc_startup_ixam[];

extern int datatoc_preview_ixam_size;
extern const char datatoc_preview_ixam[];

extern int datatoc_preview_grease_pencil_ixam_size;
extern const char datatoc_preview_grease_pencil_ixam[];

extern int datatoc_ixam_icons16_png_size;
extern const char datatoc_ixam_icons16_png[];

extern int datatoc_ixam_icons32_png_size;
extern const char datatoc_ixam_icons32_png[];
...
extern int datatoc_ixam_logo_png_size;
extern const char datatoc_ixam_logo_png[];
...
extern const char datatoc_topbar_logo_png[];

extern int datatoc_logo_3ixam_png_size;
extern const char datatoc_logo_3ixam_png[];

extern int datatoc_logo_3ixam_black_png_size;
extern const char datatoc_logo_3ixam_black_png[];

extern int datatoc_spheremap_png_size;
extern const char datatoc_spheremap_png[];

/* head sprite sheet */

extern int datatoc_pie_menu_sheet_png_size;
extern const char datatoc_pie_menu_sheet_png[];
...
extern const char datatoc_about_png[];

/* internal data */
extern const int datatoc_scripts_zip_size;
extern const char datatoc_scripts_zip[];
