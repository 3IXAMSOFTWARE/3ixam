...
bool ED_operator_matpro_active(struct bContext *C);
bool ED_operator_matpro_editable(struct bContext *C);
bool ED_operator_graphedit_active(struct bContext *C);
bool ED_operator_graphedit_actionedit_active(struct bContext *C);
