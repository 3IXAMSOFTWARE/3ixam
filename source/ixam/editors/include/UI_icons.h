...
DEF_ICON(SNAP_ROTATION)
DEF_ICON(SNAP_TRANSLATION)
DEF_ICON(UNDO)
DEF_ICON(REDO)
DEF_ICON(ALIGN_OBJECTS)
DEF_ICON(208) 
DEF_ICON(ZOOM_TOOL)
DEF_ICON(TRACKING)
...
DEF_ICON(QUADVIEW_8)
DEF_ICON(QUADVIEW_9)
DEF_ICON(QUADVIEW_10)
DEF_ICON(QUADVIEW_11)
DEF_ICON_BLANK(773)
...
/* Images. */
DEF_ICON(TOPBAR_LOGO)
DEF_ICON(LOGO_3IXAM)
DEF_ICON(LOGO_3IXAM_BLACK)
DEF_ICON(SPHEREMAP)
