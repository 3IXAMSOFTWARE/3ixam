...
static void clip_ixam_read_data(IxamDataReader *UNUSED(reader), SpaceLink *sl)
{
...
static void clip_ixam_read_lib(IxamLibReader *reader, ID *parent_id, SpaceLink *sl)
{
  SpaceClip *sclip = (SpaceClip *)sl;
...
static void clip_ixam_write(IxamWriter *writer, SpaceLink *sl)
{
...
void ED_spacetype_clip(void)
{
  ...
  st->ixam_read_data = clip_ixam_read_data;
  st->ixam_read_lib = clip_ixam_read_lib;
  st->ixam_write = clip_ixam_write;
