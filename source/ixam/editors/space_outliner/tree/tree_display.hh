 ...
 *
 * Each Outliner display mode (e.g View Layer, Scenes, 3IXAM File) is implemented as a
 ...
 * implement the #buildTree() function, which based on 3IXAM data (#TreeSourceData), builds a
...
class AbstractTreeDisplay {
 public:
  ...
  /**
   * Build a tree for this display mode with the 3IXAM context data given in \a source_data and
