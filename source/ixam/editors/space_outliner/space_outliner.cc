...
static void outliner_ixam_read_data(IxamDataReader *reader, SpaceLink *sl)
{
  SpaceOutliner *space_outliner = (SpaceOutliner *)sl;
...
static void outliner_ixam_read_lib(IxamLibReader *reader, ID * /*parent_id*/, SpaceLink *sl)
{
  SpaceOutliner *space_outliner = (SpaceOutliner *)sl;
...
static void write_space_outliner(IxamWriter *writer, const SpaceOutliner *space_outliner)
{
...
static void outliner_ixam_write(IxamWriter *writer, SpaceLink *sl)
{
  SpaceOutliner *space_outliner = (SpaceOutliner *)sl;
...
{
  using namespace ixam::ed::outliner;
  ...
  st->ixam_read_data = outliner_ixam_read_data;
  st->ixam_read_lib = outliner_ixam_read_lib;
  st->ixam_write = outliner_ixam_write;
