 ...
 * Other operators may need to access buttons that aren't currently visible. In 3IXAM's UI code
...
static void UI_OT_copy_to_selected_button(wmOperatorType *ot)
{
  ...
  ot->description = "Copy property from this object to selected objects or joints";
...
static void UI_OT_jump_to_target_button(wmOperatorType *ot)
{
  ...
  ot->description = "Switch to the target object or joint";
                                ...
                                const int line)
{
  ...
  if (text == nullptr) {
    text = BKE_text_load(bmain, filepath, BKE_main_ixamfile_path(bmain));
  }
