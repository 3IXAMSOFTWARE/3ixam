...
static void srender_image_view_all(struct SpaceImage *sima, struct ARegion *region, struct wmOperator *op)
{
...
static int image_view_all_exec(bContext *C, wmOperator *op)
{
  ...
  srender_image_view_all(sima, region, op);
...
static int image_open_exec(bContext *C, wmOperator *op)
{
  ...
  LISTBASE_FOREACH (ImageFrameRange *, range, &ranges) {
    Image *ima_range = image_open_single(
        bmain, op, range, BKE_main_ixamfile_path(bmain), is_relative_path, use_multiview);
