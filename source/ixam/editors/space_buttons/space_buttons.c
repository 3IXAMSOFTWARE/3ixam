...
static void buttons_ixam_read_data(IxamDataReader *UNUSED(reader), SpaceLink *sl)
{
  SpaceProperties *sbuts = (SpaceProperties *)sl;
...
static void buttons_ixam_read_lib(IxamLibReader *reader, ID *parent_id, SpaceLink *sl)
{
  SpaceProperties *sbuts = (SpaceProperties *)sl;
...
static void buttons_ixam_write(IxamWriter *writer, SpaceLink *sl)
{
...
void ED_spacetype_buttons(void)
{
  ...
  st->ixam_read_data = buttons_ixam_read_data;
  st->ixam_read_lib = buttons_ixam_read_lib;
  st->ixam_write = buttons_ixam_write;
