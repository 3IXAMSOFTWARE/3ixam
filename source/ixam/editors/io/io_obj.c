...
static void ui_obj_export_settings(uiLayout *layout, PointerRNA *imfptr)
{
  ...
  uiItemL(box, IFACE_("Animation"), ICON_ANIM, UI_BSHAPE_ROUNDBOX);
  ...
  uiItemL(box, IFACE_("Object Properties"), ICON_OBJECT_DATA, UI_BSHAPE_ROUNDBOX);
  ...
  /* Geometry options. */
  box = uiLayoutBox(layout);
  uiItemL(box, IFACE_("Geometry Export"), ICON_EXPORT, UI_BSHAPE_ROUNDBOX);
  col = uiLayoutColumn(box, false);
  ...
  /* Grouping options. */
  box = uiLayoutBox(layout);
  uiItemL(box, IFACE_("Grouping"), ICON_GROUP, UI_BSHAPE_ROUNDBOX);
  col = uiLayoutColumn(box, false);
...
static void ui_obj_import_settings(uiLayout *layout, PointerRNA *imfptr)
{
  ...
  uiLayout *box = uiLayoutBox(layout);
  uiItemL(box, IFACE_("Transform"), ICON_OBJECT_DATA, UI_BSHAPE_ROUNDBOX);
  uiLayout *col = uiLayoutColumn(box, false);
  uiLayout *sub = uiLayoutColumn(col, false);
  ...
  box = uiLayoutBox(layout);
  uiItemL(box, IFACE_("Options"), ICON_EXPORT, UI_BSHAPE_ROUNDBOX);
  col = uiLayoutColumn(box, false);
