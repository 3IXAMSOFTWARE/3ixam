...
static bool edbm_select_mode_poll(bContext *C)
{
  Object *ob = CTX_data_active_object(C);
  return ED_operator_object_active_editable_ex(C, ob) && OB_TYPE_SUPPORT_EDITMODE(ob->type);
}
