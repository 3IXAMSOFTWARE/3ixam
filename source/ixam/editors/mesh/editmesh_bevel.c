...
static void edbm_bevel_exit(bContext *C, wmOperator *op)
{
  ...
  /* update PolyForm panel flag, operator finished */
...
static int edbm_bevel_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  ...
  CTX_wm_view3d_polyform_ui_highlight_flag_set(C, POLYFORM_UI_HIGHLIGHT_BEVEL);
...
void MESH_OT_bevel(wmOperatorType *ot)
{
  ...
  RNA_def_boolean(ot->srna, "popover", false, "Popover", "");
}
