 ...
 *
 * - Index files are created for each ixam file in the asset library, even when the ixam file
 ...
 * - ixam files without any assets can be determined by the size of the index file for some
