...
ixam::bke::AssetCatalog *ED_asset_catalog_add(AssetLibrary *library,
                                                 ixam::StringRefNull name,
                                                 ixam::StringRef parent_path = nullptr);
void ED_asset_catalog_remove(AssetLibrary *library, const ixam::bke::CatalogID &catalog_id);

void ED_asset_catalog_rename(AssetLibrary *library,
                             ixam::bke::CatalogID catalog_id,
                             ixam::StringRefNull new_name);
/**
...
void ED_asset_catalog_move(
    ...
    ixam::bke::CatalogID src_catalog_id,
    std::optional<ixam::bke::CatalogID> dst_parent_catalog_id = std::nullopt);
