...
static int animchannels_expand_toggle_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  bool onlysel = true;
  ...
  /* modify setting */
  setflag_anim_channels(&ac, ACHANNEL_SETTING_EXPAND, ACHANNEL_SETFLAG_TOGGLE, onlysel, false);
...
static void ANIM_OT_channels_expand_toggle(wmOperatorType *ot) 
{
  /* identifiers */
  ot->name = "Toggle Expand Channels";
  ot->idname = "ANIM_OT_channels_expand_toggle";
  ot->description = "Toggle all selected expandable animation channels";

  /* api callbacks */
  ot->exec = animchannels_expand_toggle_exec;
  ot->poll = animedit_poll_channels_active;
  ...
  /* props */
  ot->prop = RNA_def_boolean(
      ot->srna, "all", true, "All", "Toggle all channels (not just selected ones)");
}
...
void ED_operatortypes_animchannels(void)
{
  ...
  WM_operatortype_append(ANIM_OT_channels_expand_toggle);
