...
/* ************************************************************ */
/* 3IXAM Context <-> Animation Context mapping */
...
/* ************************************************************ */
/* 3IXAM Data <-- Filter --> Channels to be operated on */
 ...
 *       It used to be Material/Light/World before the 3IXAM Internal removal for 2.8
 */
