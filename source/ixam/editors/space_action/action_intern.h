...
/**
 * GET keyframes in each channel.
 */
ListBase *get_channel_keyframes(const struct bContext *C, struct bAnimContext *ac);
/**
 * Select all keyframes in cfra.
 */
void select_keyframes_cfra(const struct bContext *C, struct bAnimContext *ac);
/**
...
void ACTION_OT_new_empty(struct wmOperatorType *ot);
