...
void PAINT_OT_weight_from_bones(wmOperatorType *ot)
{
  ...
  /* identifiers */
  ot->name = "Weight from Joints";
  ot->idname = "PAINT_OT_weight_from_bones";
  ot->description =
      ("Set the weights of the groups matching the attached rig's selected joints, "
       "using the distance between the vertices and the joints");
