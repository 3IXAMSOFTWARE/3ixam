...
namespace ixam::ed::sculpt_paint::paint::image {

using namespace ixam::bke::pbvh::pixels;
using namespace ixam::bke::image;
...
using namespace ixam::ed::sculpt_paint::paint::image;
