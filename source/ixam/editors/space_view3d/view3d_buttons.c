...
static void v3d_transform_butsR(uiLayout *layout, PointerRNA *ptr)
{
  ...
  uiItemL(colsub, "", ICON_NONE, UI_BSHAPE_ROUNDBOX);
  uiItemR(colsub,
          ptr,
          "lock_location",
...
static void v3d_posearmature_buts(uiLayout *layout, Object *ob)
{
  ...
  if (!pchan) {
    uiItemL(layout, IFACE_("No Joint Active"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
    return;
  }
...
static void v3d_editarmature_buts(uiLayout *layout, Object *ob)
{
  ...
  if (!ebone || (ebone->layer & arm->layer) == 0) {
    uiItemL(layout, IFACE_("Nothing selected"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
    return;
  }
...
static void v3d_editmetaball_buts(uiLayout *layout, Object *ob)
{
  ...
  switch (RNA_enum_get(&ptr, "type")) {
    case MB_BALL:
      break;
    case MB_CUBE:
      uiItemL(col, IFACE_("Size:"), ICON_NONE, UI_BSHAPE_ROUNDBOX);
