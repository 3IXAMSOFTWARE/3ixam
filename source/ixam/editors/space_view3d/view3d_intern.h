...
/* view3d_edit.c */
void VIEW3D_OT_outliner_move(struct wmOperatorType *ot);
...
void VIEW3D_OT_camera_to_view_contextfree(struct wmOperatorType *ot);
...
typedef struct CollectionDropFolder {
  struct Collection *from;
  struct Collection *to;
} CollectionDropFolder;

bool folder_drop_init(struct bContext *C,
                      struct wmDrag *drag,
...
void VIEW3D_GGT_right_menu(struct wmGizmoGroupType *gzgt);
void VIEW3D_GGT_view_menu(struct wmGizmoGroupType *gzgt);
