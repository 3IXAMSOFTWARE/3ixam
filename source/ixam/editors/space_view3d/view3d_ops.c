...
static int view3d_copybuffer_exec(bContext *C, wmOperator *op)
{
  ...
  BLI_path_join(str, sizeof(str), BKE_tempdir_base(), "copybuffer.ixam");
...
void view3d_operatortypes(void)
{
  ...
  WM_operatortype_append(VIEW3D_OT_outliner_move);
  ...
  WM_operatortype_append(VIEW3D_OT_camera_to_view_contextfree);
  ...
  WM_operatortype_append(VIEW3D_OT_view_translation_add);
