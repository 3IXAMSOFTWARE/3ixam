...
typedef struct BevelParams {
  ...
  /** The argument BMesh. */
  BMesh *bm;
  /** 3IXAM units to offset each side of a beveled edge. */
  float offset;
...
/* Only for debugging, this file shouldn't be in ixam repository. */
// #include "bevdebug.c"
                                 ...
                                 float r_mat[4][4])
{
   ...
   * 3IXAM transform matrices are stored such that m[i][*] is ith column;
 ...
 * and `1/2{va+vb+vc-vd}`
 * and 3IXAM matrices have cols at m[i][*].
 */
