...
/**
 * Make a #ixam::meshintersect::Mesh from #BMesh bm.
...
{
  return ixam::meshintersect::bmesh_boolean(
      bm,
      looptris,
      looptris_tot,
      test_fn,
      ...
      keep_hidden,
      hole_tolerant,
      static_cast<ixam::meshintersect::BoolOpType>(boolean_mode));
}
...
bool BM_mesh_boolean_knife(BMesh *bm,
                           ...
                           const bool keep_hidden)
{
  return ixam::meshintersect::bmesh_boolean(bm,
                                               looptris,
                                               looptris_tot,
                                               test_fn,
                                               user_data,
                                               ...
                                               keep_hidden,
                                               hole_tolerant,
                                               ixam::meshintersect::BoolOpType::None);
}
#else
bool BM_mesh_boolean(BMesh * /*bm*/,
                     struct BMLoop *(*looptris)[3],
