 ...
 * though the rest of 3IXAM (i.e. DNA and evaluated Mesh) does not support this.
 ...
 *
 * See source/ixam/bmesh/bmesh_query.h for more misc. queries.
 ...
 *
 * Operators are an integral part of BMesh. Unlike regular ixam operators,
