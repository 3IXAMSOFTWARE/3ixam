...
void BKE_animdata_ixam_write(struct IxamWriter *writer, struct AnimData *adt);
void BKE_animdata_ixam_read_data(struct IxamDataReader *reader, struct AnimData *adt);
void BKE_animdata_ixam_read_lib(struct IxamLibReader *reader,
                                 struct ID *id,
                                 struct AnimData *adt);
void BKE_animdata_ixam_read_expand(struct IxamExpander *expander, struct AnimData *adt);
