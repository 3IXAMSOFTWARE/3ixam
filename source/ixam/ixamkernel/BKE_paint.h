...
void BKE_paint_ixam_write(struct IxamWriter *writer, struct Paint *paint);
void BKE_paint_ixam_read_data(struct IxamDataReader *reader,
                               const struct Scene *scene,
                               struct Paint *paint);
void BKE_paint_ixam_read_lib(struct IxamLibReader *reader,
                              struct Scene *scene,
                              struct Paint *paint);
