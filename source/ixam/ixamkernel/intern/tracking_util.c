    ...
    const MovieTrackingCamera *camera, libmv_CameraIntrinsicsOptions *camera_intrinsics_options)
{
  ...
  /* Unknown distortion model, which might be due to opening newer file in older 3IXAM.
    ...
    const libmv_CameraIntrinsicsOptions *camera_intrinsics_options, MovieTrackingCamera *camera)
{
  ...
  /* Libmv returned distortion model which is not known to 3IXAM. This is a logical error in code
   * and 3IXAM side is to be updated to match Libmv. */
