...
bUserMenu *BKE_ixam_user_menu_find(ListBase *lb, char space_type, const char *context)
{
...
bUserMenu *BKE_ixam_user_menu_ensure(ListBase *lb, char space_type, const char *context)
{
  bUserMenu *um = BKE_ixam_user_menu_find(lb, space_type, context);
  if (um == NULL) {
...
bUserMenuItem *BKE_ixam_user_menu_item_add(ListBase *lb, int type)
{
  uint size;
...
void BKE_ixam_user_menu_item_free(bUserMenuItem *umi)
{
...
void BKE_ixam_user_menu_item_free_list(ListBase *lb)
{
