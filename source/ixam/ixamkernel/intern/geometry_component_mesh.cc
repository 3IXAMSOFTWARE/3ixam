...
static ixam::GVArray adapt_mesh_attribute_domain(const Mesh &mesh,
                                                    const ixam::GVArray &varray,
                                                    ...
                                                    const eAttrDomain to_domain)
{
  ...
  switch (from_domain) {
    case ATTR_DOMAIN_CORNER: {
      switch (to_domain) {
        case ATTR_DOMAIN_POINT:
          return ixam::bke::adapt_mesh_domain_corner_to_point(mesh, varray);
        case ATTR_DOMAIN_FACE:
          return ixam::bke::adapt_mesh_domain_corner_to_face(mesh, varray);
        case ATTR_DOMAIN_EDGE:
          return ixam::bke::adapt_mesh_domain_corner_to_edge(mesh, varray);
        default:
          break;
      }
      break;
    ...
    case ATTR_DOMAIN_POINT: {
      switch (to_domain) {
        case ATTR_DOMAIN_CORNER:
          return ixam::bke::adapt_mesh_domain_point_to_corner(mesh, varray);
        case ATTR_DOMAIN_FACE:
          return ixam::bke::adapt_mesh_domain_point_to_face(mesh, varray);
        case ATTR_DOMAIN_EDGE:
          return ixam::bke::adapt_mesh_domain_point_to_edge(mesh, varray);
        default:
          break;
      }
      break;
    ...
    case ATTR_DOMAIN_FACE: {
      switch (to_domain) {
        case ATTR_DOMAIN_POINT:
          return ixam::bke::adapt_mesh_domain_face_to_point(mesh, varray);
        case ATTR_DOMAIN_CORNER:
          return ixam::bke::adapt_mesh_domain_face_to_corner(mesh, varray);
        case ATTR_DOMAIN_EDGE:
          return ixam::bke::adapt_mesh_domain_face_to_edge(mesh, varray);
        default:
          break;
      }
      break;
    ...
    case ATTR_DOMAIN_EDGE: {
      switch (to_domain) {
        case ATTR_DOMAIN_CORNER:
          return ixam::bke::adapt_mesh_domain_edge_to_corner(mesh, varray);
        case ATTR_DOMAIN_POINT:
          return ixam::bke::adapt_mesh_domain_edge_to_point(mesh, varray);
        case ATTR_DOMAIN_FACE:
          return ixam::bke::adapt_mesh_domain_edge_to_face(mesh, varray);
        default:
          break;
      }
      break;
...
static AttributeAccessorFunctions get_mesh_accessor_functions()
{
  ...
  fn.adapt_domain = [](const void *owner,
                       const ixam::GVArray &varray,
                       const eAttrDomain from_domain,
                       const eAttrDomain to_domain) -> ixam::GVArray {
    if (owner == nullptr) {
      return {};
    }
    const Mesh &mesh = *static_cast<const Mesh *>(owner);
...
ixam::bke::AttributeAccessor Mesh::attributes() const
{
  return ixam::bke::AttributeAccessor(this, ixam::bke::get_mesh_accessor_functions_ref());
}

ixam::bke::MutableAttributeAccessor Mesh::attributes_for_write()
{
  return ixam::bke::MutableAttributeAccessor(this,
                                                ixam::bke::get_mesh_accessor_functions_ref());
}

std::optional<ixam::bke::AttributeAccessor> MeshComponent::attributes() const
{
  return ixam::bke::AttributeAccessor(mesh_, ixam::bke::get_mesh_accessor_functions_ref());
}

std::optional<ixam::bke::MutableAttributeAccessor> MeshComponent::attributes_for_write()
{
  Mesh *mesh = this->get_for_write();
  return ixam::bke::MutableAttributeAccessor(mesh,
                                                ixam::bke::get_mesh_accessor_functions_ref());
}
