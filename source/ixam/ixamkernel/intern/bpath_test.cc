...
#define BASE_DIR ABSOLUTE_ROOT "ixamfiles" SEP_STR
#define REBASE_DIR BASE_DIR "rebase" SEP_STR

#define IXAMFILE_NAME "bpath.ixam"
#define IXAMFILE_PATH BASE_DIR IXAMFILE_NAME
...
class BPathTest : public testing::Test {
 public:
  ...
  {
    bmain = BKE_main_new();
    STRNCPY(bmain->filepath, IXAMFILE_PATH);
