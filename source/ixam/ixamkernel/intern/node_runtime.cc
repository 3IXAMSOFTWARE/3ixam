...
namespace ixam::bke::node_tree_runtime {
...
void preprocess_geometry_node_tree_for_evaluation(bNodeTree &tree_cow)
{
  ...
  ixam::nodes::ensure_geometry_nodes_lazy_function_graph(tree_cow);
}
...
{
  ixam::bke::node_tree_runtime::ensure_topology_cache(*this);
}
