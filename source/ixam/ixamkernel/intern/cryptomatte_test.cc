...
namespace ixam::bke::cryptomatte::tests {
...
{
  ixam::bke::cryptomatte::CryptomatteLayer layer;
...
{
  EXPECT_EQ(expected,
            ixam::bke::cryptomatte::CryptomatteLayer::read_from_manifest(manifest)->manifest());
}
...
{
  EXPECT_EQ("eb4c67b",
            ixam::bke::cryptomatte::CryptomatteStampDataCallbackData::extract_layer_hash(
...
static void validate_cryptomatte_session_from_stamp_data(void * /*data*/,
                                                         ...
                                                         int /*len*/)
{
  ixam::StringRefNull prop_name(propname);
