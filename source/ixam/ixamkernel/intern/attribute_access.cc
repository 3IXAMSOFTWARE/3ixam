...
using ixam::GSpan;
using ixam::GVArrayImpl_For_GSpan;
using ixam::Set;
using ixam::StringRef;
using ixam::StringRefNull;
using ixam::bke::AttributeIDRef;
...
{
  const CPPType *type = ixam::bke::custom_data_type_to_cpp_type(data_type);
  ...
  const ixam::bke::DataTypeConversions &conversions =
      ixam::bke::get_implicit_type_conversions();
...
static ixam::GVArray try_adapt_data_type(ixam::GVArray varray,
                                            const ixam::CPPType &to_type)
{
  const ixam::bke::DataTypeConversions &conversions =
      ixam::bke::get_implicit_type_conversions();
