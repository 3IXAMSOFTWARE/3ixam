...
static std::optional<ixam::bke::MutableAttributeAccessor> get_attribute_accessor_for_write(
    ID &id)
{
  switch (GS(id.name)) {
    case ID_ME: {
...
{
  return ixam::bke::allow_procedural_attribute_access(attribute_name);
}
...
bool BKE_id_attribute_calc_unique_name(ID *id, const char *name, char *outname)
{
  ...
  return BLI_uniquename_cb(
      unique_name_cb, &data, nullptr, '_', outname, MAX_CUSTOMDATA_LAYER_NAME);
}
