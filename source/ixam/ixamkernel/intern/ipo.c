...
static void ipo_ixam_read_data(IxamDataReader *reader, ID *id)
{
  Ipo *ipo = (Ipo *)id;
...
static void ipo_ixam_read_lib(IxamLibReader *reader, ID *id)
{
  Ipo *ipo = (Ipo *)id;
...
static void ipo_ixam_read_expand(IxamExpander *expander, ID *id)
{
  Ipo *ipo = (Ipo *)id;
...
IDTypeInfo IDType_ID_IP = {
    ...
    .ixam_write = NULL,
    .ixam_read_data = ipo_ixam_read_data,
    .ixam_read_lib = ipo_ixam_read_lib,
    .ixam_read_expand = ipo_ixam_read_expand,
                           ...
                           ListBase *drivers)
{
  ...
  for (icu = ipo->curve.first; icu; icu = icu->next) {
    ...
    if (icu->driver) {
      /* 3IXAM 2.4x allowed empty drivers,
