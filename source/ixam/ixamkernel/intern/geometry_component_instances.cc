...
const ixam::bke::Instances *InstancesComponent::get_for_read() const
{
  return instances_;
}

ixam::bke::Instances *InstancesComponent::get_for_write()
{
  BLI_assert(this->is_mutable());
...
ixam::bke::AttributeAccessor Instances::attributes() const
{
  return ixam::bke::AttributeAccessor(this,
                                         ixam::bke::get_instances_accessor_functions_ref());
}

ixam::bke::MutableAttributeAccessor Instances::attributes_for_write()
{
  return ixam::bke::MutableAttributeAccessor(
      this, ixam::bke::get_instances_accessor_functions_ref());
}

}  // namespace ixam::bke

std::optional<ixam::bke::AttributeAccessor> InstancesComponent::attributes() const
{
  return ixam::bke::AttributeAccessor(instances_,
                                         ixam::bke::get_instances_accessor_functions_ref());
}

std::optional<ixam::bke::MutableAttributeAccessor> InstancesComponent::attributes_for_write()
{
  return ixam::bke::MutableAttributeAccessor(
      instances_, ixam::bke::get_instances_accessor_functions_ref());
}
