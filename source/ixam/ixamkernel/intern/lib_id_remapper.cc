...
namespace ixam::bke::id::remapper {
struct IDRemapper {
 private:
  Map<ID *, ID *> mappings;
...
static IDRemapper *wrap(ixam::bke::id::remapper::IDRemapper *remapper)
{
  return static_cast<IDRemapper *>(static_cast<void *>(remapper));
}

/** \brief wrap C handle to a CPP IDRemapper. */
static ixam::bke::id::remapper::IDRemapper *unwrap(IDRemapper *remapper)
{
  return static_cast<ixam::bke::id::remapper::IDRemapper *>(static_cast<void *>(remapper));
}

/** \brief wrap C handle to a CPP IDRemapper. */
static const ixam::bke::id::remapper::IDRemapper *unwrap(const IDRemapper *remapper)
{
  return static_cast<const ixam::bke::id::remapper::IDRemapper *>(
...
{
  ixam::bke::id::remapper::IDRemapper *remapper =
      MEM_new<ixam::bke::id::remapper::IDRemapper>(__func__);
  return wrap(remapper);
}

void BKE_id_remapper_free(IDRemapper *id_remapper)
{
  ixam::bke::id::remapper::IDRemapper *remapper = unwrap(id_remapper);
  MEM_delete<ixam::bke::id::remapper::IDRemapper>(remapper);
}
...
{
  const ixam::bke::id::remapper::IDRemapper *remapper = unwrap(id_remapper);
