    ...
    ListBase *list, const char idname[], const char name[], short flag, short keyingflag)
{
  ...
  BLI_uniquename(
      list, ks, DATA_("KeyingSet"), '_', offsetof(KeyingSet, idname), sizeof(ks->idname));

  /* Make sure KeyingSet has a unique label (this helps with identification) */
  BLI_uniquename(list, ks, DATA_("Keying Set"), '_', offsetof(KeyingSet, name), sizeof(ks->name));
...
void BKE_keyingsets_ixam_write(IxamWriter *writer, ListBase *list)
{
...
void BKE_keyingsets_ixam_read_data(IxamDataReader *reader, ListBase *list)
{
  LISTBASE_FOREACH (KeyingSet *, ks, list) {
    /* paths */
...
void BKE_keyingsets_ixam_read_lib(IxamLibReader *reader, ID *id, ListBase *list)
{
  LISTBASE_FOREACH (KeyingSet *, ks, list) {
    LISTBASE_FOREACH (KS_Path *, ksp, &ks->paths) {
...
void BKE_keyingsets_ixam_read_expand(IxamExpander *expander, ListBase *list)
{
  LISTBASE_FOREACH (KeyingSet *, ks, list) {
    LISTBASE_FOREACH (KS_Path *, ksp, &ks->paths) {
