...
void BKE_curveprofile_ixam_write(struct IxamWriter *writer, const struct CurveProfile *profile)
{
...
void BKE_curveprofile_ixam_read(struct IxamDataReader *reader, struct CurveProfile *profile)
{
