...
{
  ixam::bke::CurvesGeometry &curves = *static_cast<ixam::bke::CurvesGeometry *>(owner);
...
std::optional<ixam::bke::AttributeAccessor> CurveComponent::attributes() const
{
  return ixam::bke::AttributeAccessor(curves_ ? &curves_->geometry : nullptr,
                                         ixam::bke::get_curves_accessor_functions_ref());
}

std::optional<ixam::bke::MutableAttributeAccessor> CurveComponent::attributes_for_write()
{
  Curves *curves = this->get_for_write();
  return ixam::bke::MutableAttributeAccessor(curves ? &curves->geometry : nullptr,
                                                ixam::bke::get_curves_accessor_functions_ref());
}
