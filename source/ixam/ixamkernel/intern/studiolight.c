...
void BKE_studiolight_init(void)
{
  ...
  if (!BKE_appdir_app_is_portable_install()) {
    studiolight_add_files_from_datafolder(IXAM_USER_DATAFILES,
  ...
  studiolight_add_files_from_datafolder(IXAM_SYSTEM_DATAFILES,
                                        STUDIOLIGHT_LIGHTS_FOLDER,
                                        STUDIOLIGHT_TYPE_STUDIO |
                                            STUDIOLIGHT_SPECULAR_HIGHLIGHT_PASS);
  studiolight_add_files_from_datafolder(
      IXAM_SYSTEM_DATAFILES, STUDIOLIGHT_WORLD_FOLDER, STUDIOLIGHT_TYPE_WORLD);
  studiolight_add_files_from_datafolder(
      IXAM_SYSTEM_DATAFILES, STUDIOLIGHT_MATCAP_FOLDER, STUDIOLIGHT_TYPE_MATCAP);
