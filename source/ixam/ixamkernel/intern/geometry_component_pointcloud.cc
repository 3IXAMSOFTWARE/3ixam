...
ixam::bke::AttributeAccessor PointCloud::attributes() const
{
  return ixam::bke::AttributeAccessor(this,
                                         ixam::bke::get_pointcloud_accessor_functions_ref());
}

ixam::bke::MutableAttributeAccessor PointCloud::attributes_for_write()
{
  return ixam::bke::MutableAttributeAccessor(
      this, ixam::bke::get_pointcloud_accessor_functions_ref());
}

std::optional<ixam::bke::AttributeAccessor> PointCloudComponent::attributes() const
{
  return ixam::bke::AttributeAccessor(pointcloud_,
                                         ixam::bke::get_pointcloud_accessor_functions_ref());
}

std::optional<ixam::bke::MutableAttributeAccessor> PointCloudComponent::attributes_for_write()
{
  PointCloud *pointcloud = this->get_for_write();
  return ixam::bke::MutableAttributeAccessor(
      pointcloud, ixam::bke::get_pointcloud_accessor_functions_ref());
}
