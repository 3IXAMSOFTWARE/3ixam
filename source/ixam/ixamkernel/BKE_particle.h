...
void BKE_particle_partdeflect_ixam_read_data(struct IxamDataReader *reader,
                                              struct PartDeflect *pd);
void BKE_particle_partdeflect_ixam_read_lib(struct IxamLibReader *reader,
                                             struct ID *id,
                                             struct PartDeflect *pd);
void BKE_particle_system_ixam_write(struct IxamWriter *writer, struct ListBase *particles);
void BKE_particle_system_ixam_read_data(struct IxamDataReader *reader,
                                         struct ListBase *particles);
void BKE_particle_system_ixam_read_lib(struct IxamLibReader *reader,
                                        struct Object *ob,
                                        struct ID *id,
                                        struct ListBase *particles);
