...
using CPPTypeHandle = ixam::CPPType;
using NodeMultiFunctionBuildFunction = void (*)(ixam::nodes::NodeMultiFunctionBuilder &builder);
using NodeGeometryExecFunction = void (*)(ixam::nodes::GeoNodeExecParams params);
using NodeDeclareFunction = void (*)(ixam::nodes::NodeDeclarationBuilder &builder);
...
using NodeGatherSocketLinkOperationsFunction =
    void (*)(ixam::nodes::GatherLinkSearchOpParams &params);

using NodeGetCompositorOperationFunction = ixam::realtime_compositor::NodeOperation
    *(*)(ixam::realtime_compositor::Context &context, ixam::nodes::DNode node);
using NodeGetCompositorShaderNodeFunction =
    ixam::realtime_compositor::ShaderNode *(*)(ixam::nodes::DNode node);
 ...
 */
void ntreeIxamWrite(struct IxamWriter *writer, struct bNodeTree *ntree);
/**
 * \note `ntree` itself has been read!
 */
void ntreeIxamReadData(struct IxamDataReader *reader,
                        struct ID *owner_id,
                        struct bNodeTree *ntree);
void ntreeIxamReadLib(struct IxamLibReader *reader, struct bNodeTree *ntree);
void ntreeIxamReadExpand(struct IxamExpander *expander, struct bNodeTree *ntree);
