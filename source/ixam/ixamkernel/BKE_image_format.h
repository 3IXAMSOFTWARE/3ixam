...
void BKE_image_format_ixam_read_data(struct IxamDataReader *reader, struct ImageFormatData *imf);
void BKE_image_format_ixam_write(struct IxamWriter *writer, struct ImageFormatData *imf);
