...
void BKE_constraint_ixam_write(struct IxamWriter *writer, struct ListBase *conlist);
void BKE_constraint_ixam_read_data(struct IxamDataReader *reader, struct ListBase *lb);
void BKE_constraint_ixam_read_lib(struct IxamLibReader *reader,
                                   struct ID *id,
                                   struct ListBase *conlist);
void BKE_constraint_ixam_read_expand(struct IxamExpander *expander, struct ListBase *lb);
