...
void BKE_curvemapping_ixam_write(struct IxamWriter *writer, const struct CurveMapping *cumap);
void BKE_curvemapping_curves_ixam_write(struct IxamWriter *writer,
                                         const struct CurveMapping *cumap);
/**
 * \note `cumap` itself has been read already.
 */
void BKE_curvemapping_ixam_read(struct IxamDataReader *reader, struct CurveMapping *cumap);
...
void BKE_color_managed_view_settings_ixam_write(struct IxamWriter *writer,
                                                 struct ColorManagedViewSettings *settings);
void BKE_color_managed_view_settings_ixam_read_data(struct IxamDataReader *reader,
                                                     struct ColorManagedViewSettings *settings);
