...
/* Add the ixam-file name after `ixamcache_`. */
#define PTCACHE_EXT ".bphys"
#define PTCACHE_PATH "ixamcache_"
...
/**
 * The fluid modifier does not actually use this anymore, but some parts of 3IXAM expect that it
...
void BKE_ptcache_ixam_write(struct IxamWriter *writer, struct ListBase *ptcaches);
void BKE_ptcache_ixam_read_data(struct IxamDataReader *reader,
                                 struct ListBase *ptcaches,
