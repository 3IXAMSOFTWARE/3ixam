...
typedef enum eIDTypeInfoCacheCallbackFlags {
  /** Indicates to the callback that cache may be stored in the .ixam file,
...
typedef void (*IDTypeIxamWriteFunction)(struct IxamWriter *writer,
                                         struct ID *id,
                                         const void *id_address);
typedef void (*IDTypeIxamReadDataFunction)(struct IxamDataReader *reader, struct ID *id);
typedef void (*IDTypeIxamReadLibFunction)(struct IxamLibReader *reader, struct ID *id);
typedef void (*IDTypeIxamReadExpandFunction)(struct IxamExpander *expander, struct ID *id);

typedef void (*IDTypeIxamReadUndoPreserve)(struct IxamLibReader *reader,
                                            struct ID *id_new,
                                            struct ID *id_old);
...
typedef struct IDTypeInfo {
   ...
   */
  IDTypeIxamReadUndoPreserve ixam_read_undo_preserve;
