...
void BKE_defvert_ixam_write(struct IxamWriter *writer,
                             int count,
                             const struct MDeformVert *dvlist);
void BKE_defvert_ixam_read(struct IxamDataReader *reader,
                            int count,
                            struct MDeformVert *mdverts);
void BKE_defbase_ixam_write(struct IxamWriter *writer, const ListBase *defbase);
