...
/** \file
 * \ingroup bke
 * \brief 3IXAM kernel action and pose functionality.
 */
...
void BKE_pose_ixam_write(struct IxamWriter *writer, struct bPose *pose, struct bArmature *arm);
void BKE_pose_ixam_read_data(struct IxamDataReader *reader, struct bPose *pose);
void BKE_pose_ixam_read_lib(struct IxamLibReader *reader, struct Object *ob, struct bPose *pose);
void BKE_pose_ixam_read_expand(struct IxamExpander *expander, struct bPose *pose);
