 ...
 *
 * \note "session-wise" here means while editing a given .ixam file. Once a new .ixam file is
...
void BKE_id_ixam_write(struct IxamWriter *writer, struct ID *id);
