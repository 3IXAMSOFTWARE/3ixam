 ...
 *
 * Will return the same pointer for repeated calls, until another ixam file is loaded.
 *
 ...
 *
 * The design is made to find an appropriate asset library path from a .ixam file path, but
 ...
 *   directory a .ixam file is in as asset library root).
 * * If \a input_path is empty or doesn't have a parent path (e.g. because a .ixam wasn't saved
