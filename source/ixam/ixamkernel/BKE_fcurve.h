...
/* ************* F-Curve .ixam file API ******************** */

void BKE_fmodifiers_ixam_write(struct IxamWriter *writer, struct ListBase *fmodifiers);
void BKE_fmodifiers_ixam_read_data(struct IxamDataReader *reader,
                                    ListBase *fmodifiers,
                                    struct FCurve *curve);
void BKE_fmodifiers_ixam_read_lib(struct IxamLibReader *reader,
                                   struct ID *id,
                                   struct ListBase *fmodifiers);
void BKE_fmodifiers_ixam_read_expand(struct IxamExpander *expander, struct ListBase *fmodifiers);

void BKE_fcurve_ixam_write(struct IxamWriter *writer, struct ListBase *fcurves);
void BKE_fcurve_ixam_read_data(struct IxamDataReader *reader, struct ListBase *fcurves);
void BKE_fcurve_ixam_read_lib(struct IxamLibReader *reader,
                               struct ID *id,
                               struct ListBase *fcurves);
void BKE_fcurve_ixam_read_expand(struct IxamExpander *expander, struct ListBase *fcurves);
