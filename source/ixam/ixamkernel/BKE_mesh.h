 ...
 * (invalid data that will crash 3IXAM, or cause some features to behave incorrectly),
...
/**
 * If the mesh is from a very old ixam version,
...
inline ixam::Span<MVert> Mesh::verts() const
{
  return {BKE_mesh_verts(this), this->totvert};
}
inline ixam::MutableSpan<MVert> Mesh::verts_for_write()
{
  return {BKE_mesh_verts_for_write(this), this->totvert};
}

inline ixam::Span<MEdge> Mesh::edges() const
{
  return {BKE_mesh_edges(this), this->totedge};
}
inline ixam::MutableSpan<MEdge> Mesh::edges_for_write()
{
  return {BKE_mesh_edges_for_write(this), this->totedge};
}

inline ixam::Span<MPoly> Mesh::polys() const
{
  return {BKE_mesh_polys(this), this->totpoly};
}
inline ixam::MutableSpan<MPoly> Mesh::polys_for_write()
{
  return {BKE_mesh_polys_for_write(this), this->totpoly};
}

inline ixam::Span<MLoop> Mesh::loops() const
{
  return {BKE_mesh_loops(this), this->totloop};
}
inline ixam::MutableSpan<MLoop> Mesh::loops_for_write()
{
  return {BKE_mesh_loops_for_write(this), this->totloop};
}

inline ixam::Span<MDeformVert> Mesh::deform_verts() const
{
...
inline ixam::MutableSpan<MDeformVert> Mesh::deform_verts_for_write()
{
