 ...
 *
 * \param data: The custom-data to tweak for .ixam file writing (modified in place).
...
void CustomData_ixam_write_prepare(CustomData &data,
                                    ixam::Vector<CustomDataLayer, 16> &layers_to_write,
                                    const ixam::Set<std::string> &skip_names = {});

/**
 * \param layers_to_write: Layers created by #CustomData_ixam_write_prepare.
 */
void CustomData_ixam_write(IxamWriter *writer,
                            CustomData *data,
                            ixam::Span<CustomDataLayer> layers_to_write,
                            int count,
...
void CustomData_ixam_read(struct IxamDataReader *reader, struct CustomData *data, int count);
