...
void BKE_gpencil_modifier_ixam_write(struct IxamWriter *writer, struct ListBase *modbase);
void BKE_gpencil_modifier_ixam_read_data(struct IxamDataReader *reader, struct ListBase *lb);
void BKE_gpencil_modifier_ixam_read_lib(struct IxamLibReader *reader, struct Object *ob);
