...
void BKE_keyingsets_ixam_write(struct IxamWriter *writer, struct ListBase *list);
void BKE_keyingsets_ixam_read_data(struct IxamDataReader *reader, struct ListBase *list);
void BKE_keyingsets_ixam_read_lib(struct IxamLibReader *reader,
                                   struct ID *id,
                                   struct ListBase *list);
void BKE_keyingsets_ixam_read_expand(struct IxamExpander *expander, struct ListBase *list);
