...
void BKE_packedfile_ixam_write(struct IxamWriter *writer, struct PackedFile *pf);
void BKE_packedfile_ixam_read(struct IxamDataReader *reader, struct PackedFile **pf_p);
