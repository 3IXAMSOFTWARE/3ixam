...
inline ixam::Span<bNode *> bNodeTree::nodes_by_type(const ixam::StringRefNull type_idname)
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->nodes_by_type.lookup(nodeTypeFind(type_idname.c_str()));
}

inline ixam::Span<const bNode *> bNodeTree::nodes_by_type(
    const ixam::StringRefNull type_idname) const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->nodes_by_type.lookup(nodeTypeFind(type_idname.c_str()));
}

inline ixam::Span<const bNode *> bNodeTree::toposort_left_to_right() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->toposort_left_to_right;
}

inline ixam::Span<const bNode *> bNodeTree::toposort_right_to_left() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->toposort_right_to_left;
}

inline ixam::Span<const bNode *> bNodeTree::all_nodes() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->nodes;
}

inline ixam::Span<bNode *> bNodeTree::all_nodes()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->nodes;
}

inline ixam::Span<const bNode *> bNodeTree::group_nodes() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->group_nodes;
}

inline ixam::Span<bNode *> bNodeTree::group_nodes()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->group_nodes;
}
...
inline ixam::Span<const bNodeSocket *> bNodeTree::all_input_sockets() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->input_sockets;
}

inline ixam::Span<bNodeSocket *> bNodeTree::all_input_sockets()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->input_sockets;
}

inline ixam::Span<const bNodeSocket *> bNodeTree::all_output_sockets() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->output_sockets;
}

inline ixam::Span<bNodeSocket *> bNodeTree::all_output_sockets()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->output_sockets;
}

inline ixam::Span<const bNodeSocket *> bNodeTree::all_sockets() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->sockets;
}

inline ixam::Span<bNodeSocket *> bNodeTree::all_sockets()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->sockets;
}
...
inline ixam::Span<bNodeSocket *> bNode::input_sockets()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->inputs;
}

inline ixam::Span<bNodeSocket *> bNode::output_sockets()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->outputs;
}

inline ixam::Span<const bNodeSocket *> bNode::input_sockets() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->inputs;
}

inline ixam::Span<const bNodeSocket *> bNode::output_sockets() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->outputs;
}
...
inline const bNodeSocket &bNode::input_by_identifier(ixam::StringRef identifier) const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return *this->runtime->inputs_by_identifier.lookup_as(identifier);
}

inline const bNodeSocket &bNode::output_by_identifier(ixam::StringRef identifier) const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
...
inline ixam::StringRefNull bNode::label_or_name() const
{
  if (this->label[0] == '\0') {
    return this->name;
  }
...
inline ixam::Span<const bNodeLink *> bNode::internal_links_span() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->internal_links;
}

inline const ixam::nodes::NodeDeclaration *bNode::declaration() const
{
...
inline ixam::Span<const bNodeSocket *> bNodeSocket::logically_linked_sockets() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->logically_linked_sockets;
}

inline ixam::Span<const bNodeLink *> bNodeSocket::directly_linked_links() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->directly_linked_links;
}

inline ixam::Span<bNodeLink *> bNodeSocket::directly_linked_links()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->directly_linked_links;
}

inline ixam::Span<const bNodeSocket *> bNodeSocket::directly_linked_sockets() const
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->directly_linked_sockets;
}

inline ixam::Span<bNodeSocket *> bNodeSocket::directly_linked_sockets()
{
  BLI_assert(ixam::bke::node_tree_runtime::topology_cache_is_available(*this));
  return this->runtime->directly_linked_sockets;
}
