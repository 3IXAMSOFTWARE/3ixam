...
/**
 * Helper to fix older pre-2.80 ixam-files.
 *
...
void BKE_view_layer_ixam_write(struct IxamWriter *writer,
                                const struct Scene *scene,
                                struct ViewLayer *view_layer);
void BKE_view_layer_ixam_read_data(struct IxamDataReader *reader, struct ViewLayer *view_layer);
void BKE_view_layer_ixam_read_lib(struct IxamLibReader *reader,
                                   struct Library *lib,
                                   struct ViewLayer *view_layer);
