...
typedef struct ModifierTypeInfo {
   ...
   * stored in the file.
   */
  void (*ixamWrite)(struct IxamWriter *writer,
   ...
   */
  void (*ixamRead)(struct IxamDataReader *reader, struct ModifierData *md);
} ModifierTypeInfo;
...
/**
 * Initializes `path` with either the ixam file or temporary directory.
 */
...
void BKE_modifier_ixam_write(struct IxamWriter *writer,
                              const struct ID *id_owner,
                              struct ListBase *modbase);
void BKE_modifier_ixam_read_data(struct IxamDataReader *reader,
                                  struct ListBase *lb,
                                  struct Object *ob);
void BKE_modifier_ixam_read_lib(struct IxamLibReader *reader, struct Object *ob);
