...
/** \file
 * \ingroup bke
 * \brief General operations, lookup, etc. for ixam objects.
 */
...
/**
 * Returns true if the Object is from an external ixam file (libdata).
 */
bool BKE_object_is_libdata(const struct Object *ob);
/**
 * Returns true if the Object data is from an external ixam file (libdata).
 */
 ...
 * Used for bundles orientation in 3d space relative to parented ixam camera.
 */
