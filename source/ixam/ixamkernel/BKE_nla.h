...
void BKE_nla_ixam_write(struct IxamWriter *writer, struct ListBase *tracks);
void BKE_nla_ixam_read_data(struct IxamDataReader *reader, struct ListBase *tracks);
void BKE_nla_ixam_read_lib(struct IxamLibReader *reader, struct ID *id, struct ListBase *tracks);
