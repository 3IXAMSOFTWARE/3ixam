...
void BKE_collection_ixam_write_nolib(struct IxamWriter *writer, struct Collection *collection);
void BKE_collection_ixam_read_data(struct IxamDataReader *reader,
                                    struct Collection *collection,
                                    struct ID *owner_id);
void BKE_collection_ixam_read_lib(struct IxamLibReader *reader, struct Collection *collection);
void BKE_collection_ixam_read_expand(struct IxamExpander *expander,
                                      struct Collection *collection);

void BKE_collection_compat_ixam_read_data(struct IxamDataReader *reader,
                                           struct SceneCollection *sc);
void BKE_collection_compat_ixam_read_lib(struct IxamLibReader *reader,
                                          struct Library *lib,
                                          struct SceneCollection *sc);
