...
void BKE_shaderfx_ixam_write(struct IxamWriter *writer, struct ListBase *fxbase);
void BKE_shaderfx_ixam_read_data(struct IxamDataReader *reader, struct ListBase *lb);
void BKE_shaderfx_ixam_read_lib(struct IxamLibReader *reader, struct Object *ob);
