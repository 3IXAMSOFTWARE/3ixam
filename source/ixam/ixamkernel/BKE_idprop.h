...
void IDP_IxamWrite(struct IxamWriter *writer, const struct IDProperty *prop);
void IDP_IxamReadData_impl(struct IxamDataReader *reader,
                            struct IDProperty **prop,
                            const char *caller_func_id);
#define IDP_IxamDataRead(reader, prop) IDP_IxamReadData_impl(reader, prop, __func__)
void IDP_IxamReadLib(struct IxamLibReader *reader, struct Library *lib, struct IDProperty *prop);
void IDP_IxamReadExpand(struct IxamExpander *expander, struct IDProperty *prop);
