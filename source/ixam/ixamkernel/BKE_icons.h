...
void BKE_previewimg_ixam_write(struct IxamWriter *writer, const struct PreviewImage *prv);
void BKE_previewimg_ixam_read(struct IxamDataReader *reader, struct PreviewImage *prv);
