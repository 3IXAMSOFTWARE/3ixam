...
const EnumPropertyItem rna_enum_region_type_items[] = {
    ...
    {RGN_TYPE_XR, "XR", 0, "XR", ""},
    {RGN_TYPE_VIEWBAR, "VIEWBAR", 0, "View Bar", ""},
    {RGN_TYPE_PRO_MENU, "PRO_MENU", 0, "Pro Menu", ""},
    {0, NULL, 0, NULL, NULL},
};
...
/* Area.spaces */
static void rna_def_area_spaces(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_area(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_view2d(IxamRNA *brna)
{
  StructRNA *srna;
  /* PropertyRNA *prop; */
...
static void rna_def_region(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  prop = RNA_def_property(srna, "draw_flag", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_int_sdna(prop, NULL, "draw_flag");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  RNA_def_property_ui_text(prop, "Animation panel", "Region animation panel flag");
...
static void rna_def_screen(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_screen(IxamRNA *brna)
{
  rna_def_screen(brna);
  rna_def_area(brna);
  rna_def_region(brna);
