...
static bToolRef *rna_WorkSpace_tools_from_space_matpro(WorkSpace *workspace, bool create)
{
  return rna_WorkSpace_tools_from_tkey(workspace,
                                       &(bToolKey){
                                           .space_type = SPACE_MATPRO,
                                           .mode = 0,
                                       },
                                       create);
}
...
static void rna_def_workspace_owner(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_workspace_owner_ids(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_workspace_tool(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_workspace_tools(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  ...
  func = RNA_def_function(srna, "from_space_matpro", "rna_WorkSpace_tools_from_space_matpro");
  RNA_def_function_ui_description(func, "");
  RNA_def_boolean(func, "create", false, "Create", "");
  /* return type */
  parm = RNA_def_pointer(func, "result", "WorkSpaceTool", "", "");
...
static void rna_def_workspace(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_workspace(IxamRNA *brna)
{
