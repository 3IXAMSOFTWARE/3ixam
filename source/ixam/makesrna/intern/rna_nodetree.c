...
static const EnumPropertyItem prop_shader_output_target_items[] = {
    ...
    {SHD_OUTPUT_EEVEE, "STANDART", 0, "Play", "Use shaders for Play renderer"},
    {SHD_OUTPUT_CYCLES, "PHOTOREALISTIC", 0, "Real", "Use shaders for Real renderer"},
    {0, NULL, 0, NULL, NULL},
};
...
{
  bNodeTreeType *nt = RNA_struct_ixam_type_get(type);
                                        ...
                                        StructFreeFunc free)
{
  ...
  nt->rna_ext.srna = RNA_def_struct_ptr(&IXAM_RNA, nt->idname, &RNA_NodeTree);
  nt->rna_ext.data = data;
  nt->rna_ext.call = call;
  nt->rna_ext.free = free;
  RNA_struct_ixam_type_set(nt->rna_ext.srna, nt);
...
{
  return (RNA_struct_ixam_type_get(type) != NULL);
}
                                         ...
                                         StructFreeFunc free)
{
  ...
  nt->rna_ext.srna = RNA_def_struct_ptr(&IXAM_RNA, nt->idname, basetype);
  nt->rna_ext.data = data;
  nt->rna_ext.call = call;
  nt->rna_ext.free = free;
  RNA_struct_ixam_type_set(nt->rna_ext.srna, nt);
...
{
  bNodeSocketType *st = RNA_struct_ixam_type_get(type);
  if (!st) {
    return;
  }
                                          ...
                                          StructFreeFunc free)
{
  ...
  if (st->ext_socket.srna) {
    ...
    RNA_struct_free(&IXAM_RNA, srna);
  }
  st->ext_socket.srna = RNA_def_struct_ptr(&IXAM_RNA, st->idname, &RNA_NodeSocket);
  st->ext_socket.data = data;
  st->ext_socket.call = call;
  st->ext_socket.free = free;
  RNA_struct_ixam_type_set(st->ext_socket.srna, st);
                                                   ...
                                                   StructFreeFunc free)
{
  ...
  st->ext_interface.srna = RNA_def_struct_ptr(&IXAM_RNA, identifier, &RNA_NodeSocketInterface);
  st->ext_interface.data = data;
  st->ext_interface.call = call;
  st->ext_interface.free = free;
  RNA_struct_ixam_type_set(st->ext_interface.srna, st);
...
{
  bNodeType *ntype = RNA_struct_ixam_type_get(srna);
  ...
  if (nss->mode != value) {
    ...
    if (node->id) {
      ...
      if (value == NODE_IES_EXTERNAL && text->filepath) {
        ...
        BLI_path_rel(nss->filepath, BKE_main_ixamfile_path_from_global());
      }
...
static void def_custom_group(IxamRNA *brna,
...
static void def_sh_normal_map(StructRNA *srna)
{
  static const EnumPropertyItem prop_space_items[] = {
      ...
      {SHD_SPACE_IXAM_OBJECT,
       "IXAM_OBJECT",
       0,
       "3IXAM Object Space",
       "Object space normal mapping, compatible with 3IXAM render baking"},
      {SHD_SPACE_IXAM_WORLD,
       "IXAM_WORLD",
       0,
       "3IXAM World Space",
       "World space normal mapping, compatible with 3IXAM render baking"},
      {0, NULL, 0, NULL, NULL},
  };
...
static void rna_def_cmp_output_file_slot_file(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_cmp_output_file_slot_layer(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_cmp_output_file_slots_api(IxamRNA *brna,
                                              PropertyRNA *cprop,
                                              const char *struct_name)
{
  StructRNA *srna;
...
static void def_cmp_output_file(IxamRNA *brna, StructRNA *srna)
{
  PropertyRNA *prop;
...
static void def_cmp_zcombine(StructRNA *srna)
{
  ...
  RNA_def_property_ui_text(
      prop,
      "Anti-Alias Z",
      "Anti-alias the z-buffer to try to avoid artifacts, mostly useful for 3IXAM renders");
  RNA_def_property_update(prop, NC_NODE | NA_EDITED, "rna_Node_update");
}
...
static void def_cmp_cryptomatte_entry(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_shader_node(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_compositor_node(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
...
static void rna_def_texture_node(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_geometry_node(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_function_node(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_node_socket(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  PropertyRNA *parm;
...
static void rna_def_node_socket_interface(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  PropertyRNA *parm;
...
static void rna_def_node_socket_float(IxamRNA *brna,
                                      const char *idname,
...
static void rna_def_node_socket_int(IxamRNA *brna,
                                    const char *identifier,
                                    const char *interface_idname,
                                    PropertySubType subtype)
{
...
static void rna_def_node_socket_bool(IxamRNA *brna,
                                     const char *identifier,
                                     const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_vector(IxamRNA *brna,
                                       const char *identifier,
                                       const char *interface_idname,
                                       PropertySubType subtype)
{
...
static void rna_def_node_socket_color(IxamRNA *brna,
                                      const char *identifier,
                                      const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_string(IxamRNA *brna,
                                       const char *identifier,
                                       const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_shader(IxamRNA *brna,
                                       const char *identifier,
                                       const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_virtual(IxamRNA *brna, const char *identifier)
{
  StructRNA *srna;
...
static void rna_def_node_socket_object(IxamRNA *brna,
                                       const char *identifier,
                                       const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_image(IxamRNA *brna,
                                      const char *identifier,
                                      const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_geometry(IxamRNA *brna,
                                         const char *identifier,
                                         const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_collection(IxamRNA *brna,
                                           const char *identifier,
                                           const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_texture(IxamRNA *brna,
                                        const char *identifier,
                                        const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_material(IxamRNA *brna,
                                         const char *identifier,
                                         const char *interface_idname)
{
  StructRNA *srna;
...
static void rna_def_node_socket_standard_types(IxamRNA *brna)
{
...
static void rna_def_internal_node(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_node_sockets_api(IxamRNA *brna, PropertyRNA *cprop, int in_out)
{
  StructRNA *srna;
  PropertyRNA *parm;
  FunctionRNA *func;
...
static void rna_def_node(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
static void rna_def_node_link(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_nodetree_nodes_api(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *parm, *prop;
  FunctionRNA *func;
...
static void rna_def_nodetree_link_api(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *parm;
  FunctionRNA *func;
...
static void rna_def_node_tree_sockets_api(IxamRNA *brna, PropertyRNA *cprop, int in_out)
{
  StructRNA *srna;
  PropertyRNA *parm;
  FunctionRNA *func;
...
static void rna_def_nodetree(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
static void rna_def_composite_nodetree(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_shader_nodetree(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_texture_nodetree(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_geometry_nodetree(IxamRNA *brna)
{
  StructRNA *srna;
...
static StructRNA *define_specific_node(IxamRNA *brna,
                                       const char *struct_name,
                                       const char *base_name,
                                       const char *ui_name,
                                       const char *ui_desc,
...
static void rna_def_node_instance_hash(IxamRNA *brna)
{
  StructRNA *srna;
...
void RNA_def_nodetree(IxamRNA *brna)
{
  StructRNA *srna;
