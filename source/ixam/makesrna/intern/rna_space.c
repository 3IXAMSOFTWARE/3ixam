...
const EnumPropertyItem rna_enum_render_common_preference_section_items[] = {
  {MATLIB_SECTION_COMMON, "COMMON", 0, "Common", ""},
  {0, "", 0, NULL, NULL},
  {0, "", 0, NULL, NULL},
  {MATLIB_SECTION_SCENE, "SCENE", 0, "Scene", ""},
  {0, "", 0, NULL, NULL},
  {0, "", 0, NULL, NULL},
  {MATLIB_SECTION_CAMERA, "CAMERA", 0, "Camera", ""},
  {0, "", 0, NULL, NULL},
  {0, "", 0, NULL, NULL},
  {MATLIB_SECTION_RENDER_ELEMENTS, "RENDER_ELEMENTS", 0, "Render Elements", ""},
  {0, NULL, 0, NULL, NULL}
};

const EnumPropertyItem rna_enum_render_post_effects_section_items[] = {
  {MATLIB_SECTION_COMMON, "TONE_MAPPING", 0, "Tone Mapping", ""},
  {0, "", 0, NULL, NULL},
  {0, "", 0, NULL, NULL},
  {MATLIB_SECTION_SCENE, "BLOOM_GLARE", 0, "Bloom/Glare", ""},
  {0, "", 0, NULL, NULL},
  {0, "", 0, NULL, NULL},
  {MATLIB_SECTION_CAMERA, "SHARPENING_BLURING", 0, "Sharpening/Blurring", ""},
  {0, NULL, 0, NULL, NULL}
};


const EnumPropertyItem rna_enum_render_statistics_section_items[] = {
  {MATLIB_SECTION_COMMON, "STATISTICS", 0, "Statistics", ""},
  {0, "", 0, NULL, NULL},
  {0, "", 0, NULL, NULL},
  {MATLIB_SECTION_SCENE, "COMMON_PARAMETERS", 0, "Common Parameters", ""},
  {0, NULL, 0, NULL, NULL}
};

const EnumPropertyItem rna_enum_palette_section_items[] = {
  {MATPRO_SECTION_INPUT, "INPUT", 0, "Input", ""},
  {MATPRO_SECTION_OUTPUT, "OUTPUT", 0, "Output", ""},
  {MATPRO_SECTION_SHADER, "SHADER", 0, "Shader", ""},
  {MATPRO_SECTION_TEXTURE, "TEXTURE", 0, "Texture", ""},
  {MATPRO_SECTION_COLOR, "COLOR", 0, "Color", ""},
  {MATPRO_SECTION_VECTOR, "VECTOR", 0, "Vector", ""},
  {MATPRO_SECTION_CONVERTER, "CONVERTER", 0, "Converter", ""},
  {0, NULL, 0, NULL, NULL}
};
...
#define SACT_ITEM_ACTION \
  { \
    SACTCONT_ACTION, "ACTION", ICON_OBJECT_DATA, "Clip Editor", \
...
const EnumPropertyItem rna_enum_shading_type_items[] = {
    ...
    {OB_SOLID, "SOLID", ICON_SHADING_SOLID, "Clay", "Display in solid mode"},
    {OB_MATERIAL,
     "MATERIAL",
     ICON_SHADING_TEXTURE,
     "Preview",
     "Display in Material Preview mode"},
    {OB_RENDER, "RENDERED", ICON_SHADING_RENDERED, "Render", "Display render preview"},
    {0, NULL, 0, NULL, NULL},
};
...
static const EnumPropertyItem buttons_context_items[] = {
    ...
    {BCONTEXT_BONE, "BONE", ICON_BONE_DATA, "Joint", "Joint Properties"},
...
static const EnumPropertyItem fileselectparams_recursion_level_items[] = {
    ...
    {1, "IXAM", 0, "ixam file", "List .ixam files' content"},
...
static StructRNA *rna_Space_refine(struct PointerRNA *ptr)
{
  ...
  switch ((eSpace_Type)space->spacetype) {
    ...
    case SPACE_MATLIB:
      return &RNA_SpaceMatLib;
    case SPACE_RENDER:
      return &RNA_SpaceRender;
    case SPACE_MATPRO:
      return &RNA_SpaceMatProEditor;
...
/* Pro Menu and Toolbar Regions. */

static bool rna_Space_show_regions_pro_menu_and_toolbar_get(PointerRNA *ptr)
{
  bool ret = rna_Space_bool_from_region_flag_get_by_type(ptr, RGN_TYPE_PRO_MENU, RGN_FLAG_HIDDEN);
  ret &= rna_Space_bool_from_region_flag_get_by_type(ptr, RGN_TYPE_TOOLS, RGN_FLAG_HIDDEN);
  return !ret;
}
static void rna_Space_show_regions_pro_menu_and_toolbar_set(PointerRNA *ptr, bool value)
{
  rna_Space_bool_from_region_flag_set_by_type(ptr, RGN_TYPE_PRO_MENU, RGN_FLAG_HIDDEN, !value);
  rna_Space_bool_from_region_flag_set_by_type(ptr, RGN_TYPE_TOOLS, RGN_FLAG_HIDDEN, !value);
}
static void rna_Space_show_regions_pro_menu_and_toolbar_update(bContext *C, PointerRNA *ptr)
{
  rna_Space_bool_from_region_flag_update_by_type(C, ptr, RGN_TYPE_PRO_MENU, RGN_FLAG_HIDDEN);
  rna_Space_bool_from_region_flag_update_by_type(C, ptr, RGN_TYPE_TOOLS, RGN_FLAG_HIDDEN);
}

/* Pro Menu Region. */
static bool rna_Space_show_region_pro_menu_get(PointerRNA *ptr)
{
  return !rna_Space_bool_from_region_flag_get_by_type(ptr, RGN_TYPE_PRO_MENU, RGN_FLAG_HIDDEN);
}
static void rna_Space_show_region_pro_menu_set(PointerRNA *ptr, bool value)
{
  rna_Space_bool_from_region_flag_set_by_type(ptr, RGN_TYPE_PRO_MENU, RGN_FLAG_HIDDEN, !value);
}
static void rna_Space_show_region_pro_menu_update(bContext *C, PointerRNA *ptr)
{
  rna_Space_bool_from_region_flag_update_by_type(C, ptr, RGN_TYPE_PRO_MENU, RGN_FLAG_HIDDEN);
}
...
/* ViewBar Region */
static bool rna_Space_show_region_viewbar_get(PointerRNA *ptr)
{
  return !rna_Space_bool_from_region_flag_get_by_type(ptr, RGN_TYPE_VIEWBAR, RGN_FLAG_HIDDEN_BY_USER);
}
static void rna_Space_show_region_viewbar_set(PointerRNA *ptr, bool value)
{
  rna_Space_bool_from_region_flag_set_by_type(ptr, RGN_TYPE_VIEWBAR, RGN_FLAG_HIDDEN_BY_USER, !value);
}
static void rna_Space_show_region_viewbar_update(bContext *C, PointerRNA *ptr)
{
  rna_Space_bool_from_region_flag_update_by_type(C, ptr, RGN_TYPE_VIEWBAR, RGN_FLAG_HIDDEN_BY_USER);
}
...
static void rna_RegionView3D_view_update(bContext *C,
                                         PointerRNA *ptr)
{
  PointerRNA ptr_props;
  RegionView3D *rv3d = (RegionView3D *)(ptr->data);
  const char *opstring = "VIEW3D_OT_view_axis";
  
  WM_operator_properties_create(&ptr_props, opstring);
  RNA_enum_set(&ptr_props, "type",  rv3d->view);

  WM_operator_name_call(C, opstring, WM_OP_EXEC_DEFAULT, &ptr_props, NULL);
}
...
static void rna_3DViewShading_type_update(Main *bmain, Scene *scene, PointerRNA *ptr)
{
  ...
  if (shading->type == OB_MATERIAL ||
      (shading->type == OB_RENDER && !STREQ(scene->r.engine, RE_engine_id_IXAM_WORKBENCH))) {
...
static int rna_3DViewShading_type_get(PointerRNA *ptr)
{
  ...
  if (scene == NULL || BKE_scene_uses_ixam_eevee(scene)) {
    return shading->type;
  }
  else if (BKE_scene_uses_ixam_workbench(scene)) {
                                                                   ...
                                                                   bool *r_free)
{
  ...
  const bool eevee_next_active = STREQ(scene->r.engine, "IXAM_EEVEE_NEXT");
...
static const EnumPropertyItem *rna_SpaceImageEditor_pivot_itemf(bContext *UNUSED(C),
                                                                ...
                                                                bool *UNUSED(r_free))
{
  static const EnumPropertyItem pivot_items_original[] = {
  ...
  static const EnumPropertyItem pivot_items[] = {
      {V3D_AROUND_CENTER_BOUNDS, "CENTER", ICON_PIVOT_BOUNDBOX, "Contain", ""},
      {V3D_AROUND_CENTER_MEDIAN, "MEDIAN", ICON_PIVOT_MEDIAN, "Median", ""},
      {V3D_AROUND_LOCAL_ORIGINS,
       "INDIVIDUAL_ORIGINS",
       ICON_PIVOT_INDIVIDUAL,
       "Individual",
...
static void rna_matlib_ui_update(Main *UNUSED(bmain),
                                  Scene *UNUSED(scene),
                                  PointerRNA *UNUSED(ptr))
{
...
static PointerRNA rna_SpaceMatPro_overlay_get(PointerRNA *ptr)
{
  return rna_pointer_inherit_refine(ptr, &RNA_SpaceMatProOverlay, ptr->data);
}
...
static void rna_SpaceMatProEditor_path_get(PointerRNA *ptr, char *value)
{
  SpaceNode *smatpro = ptr->data;
  ED_node_tree_path_get(smatpro, value);
}
...
static int rna_SpaceMatProEditor_path_length(PointerRNA *ptr)
{
  SpaceNode *smatpro = ptr->data;
  return ED_node_tree_path_length(smatpro);
}
...
static void rna_SpaceMatProEditor_path_clear(SpaceMatPro *smatpro, bContext *C)
{
  ED_node_tree_start((SpaceNode *)smatpro, NULL, NULL, NULL);
  ED_node_tree_update(C);
}
...
static void rna_SpaceMatProEditor_path_start(SpaceMatPro *smatpro, bContext *C, PointerRNA *node_tree)
{
  ED_node_tree_start((SpaceNode *)smatpro, (bNodeTree *)node_tree->data, NULL, NULL);
  ED_node_tree_update(C);
}

static void rna_SpaceMatProEditor_path_append(SpaceMatPro *smatpro,
                                            bContext *C,
                                            PointerRNA *node_tree,
                                            PointerRNA *node)
{
  ED_node_tree_push((SpaceNode *)smatpro, node_tree->data, node->data);
  ED_node_tree_update(C);
}
...
static void rna_SpaceMatProEditor_path_pop(SpaceMatPro *smatpro, bContext *C)
{
  ED_node_tree_pop((SpaceNode *)smatpro);
  ED_node_tree_update(C);
}
...
static void rna_SpaceMatProEditor_cursor_location_from_region(SpaceMatPro *smatpro,
                                                              bContext *C,
                                                              int x,
                                                              int y)
{
  ...
  ED_node_cursor_location_set((SpaceNode *)smatpro, cursor_location);
}
...
static PointerRNA rna_FileBrowser_FileSelectEntry_asset_data_get(PointerRNA *ptr)
{
   ...
   * Local IDs (`entry->id`) own their asset metadata themselves. Asset metadata from other ixam
...
static struct IDFilterEnumPropertyItem rna_enum_space_file_id_filter_categories[] = {
    ...
    {FILTER_ID_AR | FILTER_ID_CU_LEGACY | FILTER_ID_LT | FILTER_ID_MB | FILTER_ID_ME |
     ...
     ICON_GEOMETRY_NODES,
     "Geometry",
     "Show meshes, curves, lattice, rigs and metaballs data"},
...
#  define DEF_SHOW_REGION_PROPERTY(identifier, label, description) \
  ...
  if (region_type_mask & (1 << RGN_TYPE_PRO_MENU)) {
    region_type_mask &= ~(1 << RGN_TYPE_PRO_MENU);
    DEF_SHOW_REGION_PROPERTY(show_region_pro_menu, "Pro menu", "");
  }
  ...
  if (region_type_mask & (1 << RGN_TYPE_VIEWBAR)) {
    region_type_mask &= ~(1 << RGN_TYPE_VIEWBAR);
    DEF_SHOW_REGION_PROPERTY(show_region_viewbar, "View Bar", "");
  }
  BLI_assert(region_type_mask == 0);
}

static void rna_def_space(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_image_uv(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_outliner(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  static const EnumPropertyItem display_mode_items[] = {
      ...
      {SO_DATA_API,
       ...
       ICON_RNA,
       "Data API",
       "Display low level 3IXAM data and its properties"},
  ...
  RNA_def_property_ui_text(prop, "Show Rigs", "Show rig objects");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_OUTLINER, NULL);
...
static void rna_def_space_view3d_shading(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_view3d_overlay(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_boolean_sdna(prop, NULL, "gridflag", V3D_SHOW_GRID);
  RNA_def_property_ui_text(prop, "Display Grid", "Show grid in view");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, NULL);
  ...
  RNA_def_property_ui_text(
      prop, "Show Joints", "Display joints (disable to show motion paths only)");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, NULL);
  ...
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(prop, "Show Joint X-Ray", "Show the joint selection overlay");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, "rna_GPencil_update");
  ...
  RNA_def_property_ui_text(prop, "Opacity", "Opacity to use for joint selection");
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, "rna_GPencil_update");
  ...
  RNA_def_property_ui_text(
      prop, "Joint Wireframe Opacity", "Maximim opacity of joint in wireframe display mode");
  RNA_def_property_range(prop, 0.0f, FLT_MAX);
  RNA_def_property_ui_range(prop, 0.0f, 1.0f, 1, 2);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, "rna_GPencil_update");
...
static void rna_def_space_view3d(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  rna_def_space_generic_show_region_toggles(srna,
                                            ((1 << RGN_TYPE_TOOL_HEADER) | (1 << RGN_TYPE_TOOLS) |
                                             ...
                                             (1 << RGN_TYPE_VIEWBAR)| (1 << RGN_TYPE_PRO_MENU)));

  prop = RNA_def_property(srna, "show_regions_pro_menu_and_toolbar", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_flag(prop, PROP_CONTEXT_UPDATE); 
  RNA_def_property_boolean_funcs(prop, 
                                   "rna_Space_show_regions_pro_menu_and_toolbar_get",
                                   "rna_Space_show_regions_pro_menu_and_toolbar_set");
  RNA_def_property_ui_text(prop, "show_regions_pro_menu_and_toolbar", ""); 
  RNA_def_property_update(prop, 0, "rna_Space_show_regions_pro_menu_and_toolbar_update");
  ...
  prop = RNA_def_property(srna, "polyform_ui_highlight_flag", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_int_sdna(prop, NULL, "polyform_ui_highlight_flag");
  RNA_def_property_ui_text(prop, "polyform_ui_highlight_flag", "Defines current UI highlighting for elements in Polyform panel");
  RNA_def_property_flag(prop, PROP_EDITABLE);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, NULL);
  ...
  RNA_def_property_ui_text(
      prop, "Lock to Joint", "3D View center is locked to this joint's position");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, NULL);
  ...
  prop = RNA_def_property(srna, "view", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_int_sdna(prop, NULL, "view");
  RNA_def_property_range(prop, 0, 8);
  RNA_def_property_ui_text(prop, "View", "View");
  RNA_def_property_flag(prop, PROP_CONTEXT_UPDATE);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, "rna_RegionView3D_view_update");
...
static void rna_def_space_properties(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_image_overlay(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_image(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_sequencer_preview_overlay(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_sequencer_timeline_overlay(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_sequencer(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_text(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
static void rna_def_space_dopesheet(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_graph(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_matlib(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;

  srna = RNA_def_struct(brna, "SpaceMatLib", "Space");
  RNA_def_struct_sdna(srna, "SpaceMatLib");
  RNA_def_struct_ui_text(srna, "Space Material Library Editor", "Material Library editor space data");

  prop = RNA_def_property(srna, "groups_len", PROP_INT, PROP_NONE);
  RNA_def_property_int_sdna(prop, NULL, "groups_len");
  RNA_def_property_range(prop, 0, 255);
  RNA_def_property_ui_text(prop, "Groups lenght", "Material groups size");
  prop = RNA_def_property(srna, "group_width", PROP_INT, PROP_NONE);
  RNA_def_property_int_sdna(prop, NULL, "group_width");
  RNA_def_property_range(prop, 0, 255);
  RNA_def_property_ui_text(prop, "Groups lenght", "Material groups size");  
  prop = RNA_def_property(srna, "group_height", PROP_INT, PROP_NONE);
  RNA_def_property_int_sdna(prop, NULL, "group_height");
  RNA_def_property_range(prop, 0, 255);
  RNA_def_property_ui_text(prop, "Groups height", "Material groups height");  
  prop = RNA_def_property(srna, "active_material", PROP_POINTER, PROP_NONE);
  RNA_def_property_struct_type(prop, "Material");
  RNA_def_property_pointer_sdna(prop, NULL, "active_material");
  RNA_def_property_ui_text(prop, "Active material", "Active material");
  rna_def_space_generic_show_region_toggles(srna, (1 << RGN_TYPE_UI));
}

static void rna_def_space_render(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;

  srna = RNA_def_struct(brna, "SpaceRender", "Space");
  RNA_def_struct_sdna(srna, "SpaceRender");
  RNA_def_struct_ui_text(srna, "Space Render Settings Editor", "Render Settings Editor space data");
  ...
  RNA_def_property_ui_text(
      ...
      "Image User",
      "Parameters defining which layer, pass and frame of the image is displayed");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_RENDER, NULL);

  prop = RNA_def_property(srna, "menu_active_section", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_sdna(prop, NULL, "menu_section_active");
  RNA_def_property_enum_items(prop, rna_enum_render_common_preference_section_items);
  RNA_def_property_ui_text(
      prop, "Menu Active Section", "Active section of the menu preferences");
  RNA_def_property_update(prop, 0, "rna_matlib_ui_update");

  prop = RNA_def_property(srna, "post_active_section", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_sdna(prop, NULL, "post_section_active");
  RNA_def_property_enum_items(prop, rna_enum_render_post_effects_section_items);
  RNA_def_property_ui_text(
      prop, "Post Effects Active Section", "Active section of the post effects");
  RNA_def_property_update(prop, 0, "rna_matlib_ui_update");

  prop = RNA_def_property(srna, "statistic_active_section", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_sdna(prop, NULL, "statistic_section_active");
  RNA_def_property_enum_items(prop, rna_enum_render_statistics_section_items);
  RNA_def_property_ui_text(
      prop, "Post Effects Active Section", "Active section of the post effects");
  RNA_def_property_update(prop, 0, "rna_matlib_ui_update");
...
static void rna_def_space_nla(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_console_line(IxamRNA *brna)
{
...
static void rna_def_space_console(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fileselect_idfilter(IxamRNA *brna)
{
...
static void rna_def_fileselect_asset_idfilter(IxamRNA *brna)
{
...
static void rna_def_fileselect_entry(IxamRNA *brna)
{
  PropertyRNA *prop;
...
static void rna_def_fileselect_params(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop, "Library Browser", "Whether we may browse 3IXAM files' content or not");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  ...
  prop = RNA_def_property(srna, "use_filter_ixam", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "filter", FILE_TYPE_IXAM);
  RNA_def_property_ui_text(prop, "Filter 3IXAM", "Show .ixam files");
  RNA_def_property_ui_icon(prop, ICON_FILE_IXAM, 0);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_FILE_PARAMS, NULL);

  prop = RNA_def_property(srna, "use_filter_backup", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "filter", FILE_TYPE_IXAM_BACKUP);
  RNA_def_property_ui_text(
      prop, "Filter 3IXAM Backup Files", "Show .ixam, .ixam2, etc. files");
  ...
  prop = RNA_def_property(srna, "use_filter_ixamid", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "filter", FILE_TYPE_IXAMLIB);
  RNA_def_property_ui_text(
      prop, "Filter 3IXAM IDs", "Show .ixam files items (objects, materials, etc.)");
  RNA_def_property_ui_icon(prop, ICON_IXAM, 0);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_FILE_PARAMS, NULL);
  ...
  RNA_def_property_ui_text(
      prop, "Only Assets", "Hide .ixam files items that are not data-blocks with asset metadata");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_FILE_PARAMS, NULL);
...
static void rna_def_fileselect_asset_params(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_filemenu_entry(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_filebrowser(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_info(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_userpref(IxamRNA *brna)
{
  ...
  RNA_def_struct_ui_text(srna, "Space Preferences", "3IXAM preferences space data");
  ...
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_NODE | ND_SPACE_MATPRO, NULL);
...
static void rna_def_node_tree_path(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_node_path_api(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_space_matpro_path_api(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop, *parm;
  FunctionRNA *func;

  RNA_def_property_srna(cprop, "SpaceMatProEditorPath");
  srna = RNA_def_struct(brna, "SpaceMatProEditorPath", NULL);
  RNA_def_struct_sdna(srna, "SpaceMatPro");
  RNA_def_struct_ui_text(srna, "Space Pro Material Editor Path", "History of node trees in the editor");

  prop = RNA_def_property(srna, "to_string", PROP_STRING, PROP_NONE);
  RNA_def_property_string_funcs(
      prop, "rna_SpaceMatProEditor_path_get", "rna_SpaceMatProEditor_path_length", NULL);
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  RNA_def_struct_ui_text(srna, "Path", "Get the node tree path as a string");

  func = RNA_def_function(srna, "clear", "rna_SpaceMatProEditor_path_clear");
  RNA_def_function_ui_description(func, "Reset the node tree path");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);

  func = RNA_def_function(srna, "start", "rna_SpaceMatProEditor_path_start");
  RNA_def_function_ui_description(func, "Set the root node tree");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
  parm = RNA_def_pointer(func, "node_tree", "NodeTree", "Node Tree", "");
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED | PARM_RNAPTR);

  func = RNA_def_function(srna, "append", "rna_SpaceMatProEditor_path_append");
  RNA_def_function_ui_description(func, "Append a node group tree to the path");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
  parm = RNA_def_pointer(
      func, "node_tree", "NodeTree", "Node Tree", "Node tree to append to the node editor path");
  ...
  func = RNA_def_function(srna, "pop", "rna_SpaceMatProEditor_path_pop");
  RNA_def_function_ui_description(func, "Remove the last node tree from the path");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
}

static void rna_def_space_node_overlay(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_matpro_overlay(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;

  srna = RNA_def_struct(brna, "SpaceMatProOverlay", NULL);
  RNA_def_struct_sdna(srna, "SpaceMatPro");
  RNA_def_struct_nested(brna, srna, "SpaceMatProEditor");
  RNA_def_struct_path_func(srna, "rna_SpaceNodeOverlay_path");
  RNA_def_struct_ui_text(
      srna, "Overlay Settings", "Settings for display of overlays in the Node Editor");
...
static void rna_def_space_node(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
#  endif
  ...
  RNA_def_property_ui_text(prop, "Node Tree", "Base node tree from context");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_NODE | ND_SPACE_MATPRO, "rna_SpaceNodeEditor_node_tree_update");
  ...
  RNA_def_property_update(
      prop, NC_SPACE | ND_SPACE_NODE_VIEW | ND_SPACE_MATPRO_VIEW, "rna_SpaceNodeEditor_show_backdrop_update");

  prop = RNA_def_property(srna, "show_annotation", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "flag", SNODE_SHOW_GPENCIL);
  RNA_def_property_ui_text(prop, "Show Annotation", "Show annotations for this view");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_NODE_VIEW | ND_SPACE_MATPRO_VIEW, NULL);
...
static void rna_def_space_matpro(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
#  endif
  ...
  static const EnumPropertyItem dummy_items1[] = {
      {0, "DUMMY", 0, "", ""},
      {0, NULL, 0, NULL, NULL},
  };


  srna = RNA_def_struct(brna, "SpaceMatProEditor", "Space");
  RNA_def_struct_sdna(srna, "SpaceMatPro");
  RNA_def_struct_ui_text(srna, "Space Pro Material Editor", "Material editor space data");
  ...
  RNA_def_property_ui_text(
      prop, "Node Tree Path", "Path from the data-block to the currently edited node tree");
  rna_def_space_matpro_path_api(brna, prop);
  ...
  prop = RNA_def_property(srna, "overlay", PROP_POINTER, PROP_NONE);
  RNA_def_property_flag(prop, PROP_NEVER_NULL);
  RNA_def_property_struct_type(prop, "SpaceMatProOverlay");
  RNA_def_property_pointer_funcs(prop, "rna_SpaceMatPro_overlay_get", NULL, NULL, NULL);
  RNA_def_property_ui_text(
      prop, "Overlay Settings", "Settings for display of overlays in the Node Editor");

  /* Pallete */
  prop = RNA_def_property(srna, "palette_active_section", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_sdna(prop, NULL, "palette_section_active");
  RNA_def_property_enum_items(prop, rna_enum_palette_section_items);
  RNA_def_property_ui_text(
      prop, "Palette Active Section", "Active section of the palette");
  RNA_def_property_update(prop, 0, "rna_matlib_ui_update");
  ...
  rna_def_space_matpro_overlay(brna);
  RNA_api_space_matpro(srna);
}

static void rna_def_space_clip(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop, "Display Hidden", "Include channels from objects/joint that aren't visible");
...
static void rna_def_spreadsheet_column_id(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_spreadsheet_column(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_spreadsheet_row_filter(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_viewer_path_elem(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_id_viewer_path_elem(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_viewer_path_elem(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_node_viewer_path_elem(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_viewer_path(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_space_spreadsheet(IxamRNA *brna)
{
  PropertyRNA *prop;
  StructRNA *srna;
...
void RNA_def_space(IxamRNA *brna)
{
  rna_def_space(brna);
  ...
  rna_def_space_matlib(brna);
  rna_def_space_render(brna);
