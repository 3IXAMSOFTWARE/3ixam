...
static void rna_def_fluid_domain_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
#  endif /* WITH_FLUID */
  ...
  RNA_def_property_ui_text(
      ...
      "particles) in Mantaflow directly (outside of 3IXAM) after baking the simulation");
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_update(prop, NC_OBJECT | ND_MODIFIER, "rna_Fluid_domain_data_reset");
...
static void rna_def_fluid_flow_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fluid_effector_settings(IxamRNA *brna)
{
...
void RNA_def_fluid(IxamRNA *brna)
{
