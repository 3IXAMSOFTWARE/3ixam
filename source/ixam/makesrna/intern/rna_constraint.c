...
const EnumPropertyItem rna_enum_constraint_type_items[] = {
    ...
    {CONSTRAINT_TYPE_KINEMATIC,
     ...
     ICON_CON_KINEMATIC,
     "Inverse Kinematics",
     "Control a chain of joints by specifying the endpoint target (Joints only)"},
    ...
    //  ICON_CON_SPLINEIK,
    //  "Spline IK",
    //  "Align chain of joints along a curve (Joints only)"},
    ...
    //  ICON_CON_ARMATURE,
    //  "Rig",
    //  "Apply weight-blended transformation from multiple joints like the Rig modifier"},
    ...
    {CONSTRAINT_TYPE_FOLLOWPATH,
     ...
     ICON_CON_FOLLOWPATH,
     "Path Follow",
     "Use to animate an object/joint following a path"},
...
static const EnumPropertyItem target_space_pchan_items[] = {
    ...
    {CONSTRAINT_SPACE_CUSTOM,
     ...
     0,
     "Custom Space",
     "The transformation of the target is evaluated relative to a custom object/joint/vertex "
     "group"},
    {0, "", 0, NULL, NULL},
    {CONSTRAINT_SPACE_POSE,
     ...
     "the target rig object transformation is ignored"},
    {CONSTRAINT_SPACE_PARLOCAL,
     "LOCAL_WITH_PARENT",
     0,
     "Local With Parent",
     "The transformation of the target joint is evaluated relative to its rest pose "
    ...
    {CONSTRAINT_SPACE_OWNLOCAL,
     ...
     "The transformation of the target joint is evaluated relative to its local coordinate "
...
static const EnumPropertyItem owner_space_pchan_items[] = {
    ...
    {CONSTRAINT_SPACE_CUSTOM,
     ...
     0,
     "Custom Space",
     "The constraint is applied in local space of a custom object/joint/vertex group"},
    {0, "", 0, NULL, NULL},
    {CONSTRAINT_SPACE_POSE,
     "POSE",
     0,
    ...
    {CONSTRAINT_SPACE_PARLOCAL,
     ...
     "of the joint, thus including the parent-induced transformation"},
    {CONSTRAINT_SPACE_LOCAL,
     "LOCAL",
     0,
     "Local Space",
...
static void rna_def_constraint_headtail_common(StructRNA *srna)
{
  ...
  RNA_def_property_ui_text(prop, "Head/Tail", "Target along length of joint: Head is 0, Tail is 1");
  ...
  RNA_def_property_ui_text(prop,
                           "Follow B-Joint",
                           "Follow shape of B-Joint segments when calculating Head/Tail position");
...
static void rna_def_constraint_target_common(StructRNA *srna)
{
  ...
  RNA_def_property_pointer_funcs(prop, NULL, NULL, NULL, "rna_Unprotected_object_poll");
  RNA_def_property_flag(prop, PROP_EDITABLE);
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_dependency_update");

  prop = RNA_def_property(srna, "subtarget", PROP_STRING, PROP_NONE);
  RNA_def_property_string_sdna(prop, NULL, "subtarget");
  RNA_def_property_ui_text(prop, "Sub-Target", "Rig joint, mesh or lattice vertex group, ...");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_dependency_update");

  RNA_define_lib_overridable(false);
}

static void rna_def_constrainttarget(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constrainttarget_bone(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_struct_ui_text(
      srna, "Constraint Target Joint", "Target joint for multi-target constraints");
  RNA_def_struct_path_func(srna, "rna_ConstraintTarget_path");
  RNA_def_struct_sdna(srna, "bConstraintTarget");
  ...
  prop = RNA_def_property(srna, "target", PROP_POINTER, PROP_NONE);
  RNA_def_property_pointer_sdna(prop, NULL, "tar");
  RNA_def_property_ui_text(prop, "Target", "Target rig");
  ...
  prop = RNA_def_property(srna, "subtarget", PROP_STRING, PROP_NONE);
  RNA_def_property_string_sdna(prop, NULL, "subtarget");
  RNA_def_property_ui_text(prop, "Sub-Target", "Target rig joint");
  RNA_def_property_update(
      prop, NC_OBJECT | ND_CONSTRAINT, "rna_ConstraintTarget_dependency_update");
  ...
  RNA_def_property_ui_text(prop, "Blend Weight", "Blending weight of this joint");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_ConstraintTarget_update");

  RNA_define_lib_overridable(false);
}

static void rna_def_constraint_childof(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_python(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_armature_deform_targets(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
  ...
  RNA_def_struct_ui_text(
      srna, "Rig Deform Constraint Targets", "Collection of target joints and weights");
  ...
  parm = RNA_def_pointer(func, "target", "ConstraintTargetBone", "", "New target joint");
...
static void rna_def_constraint_armature_deform(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_struct_ui_text(
      srna, "Rig Constraint", "Applies transformations done by the Rig modifier");
  ...
  RNA_def_property_ui_text(prop, "Targets", "Target Joints");
  ...
  RNA_def_property_ui_text(
      prop,
      "Use Envelopes",
      "Multiply weights by envelope for all joints, instead of acting like Vertex Group based "
      "blending. "
      "The specified weights are still used, and only the listed joints are considered");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_update");
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "Use the current joint location for envelopes and choosing B-Joint "
...
static void rna_def_constraint_kinematic(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop, "Chain Length", "How many joints are included in the IK effect - 0 uses all joints");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_dependency_update");

  prop = RNA_def_property(srna, "use_tail", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "flag", CONSTRAINT_IK_TIP);
  RNA_def_property_ui_text(prop, "Use Tail", "Include joint's tail as last element in chain");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_dependency_update");
  ...
  RNA_def_property_ui_text(
      prop, "Axis Reference", "Constraint axis Lock options relative to Joint or Target reference");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_dependency_update");
...
static void rna_def_constraint_track_to(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_locate_like(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_rotate_like(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_size_like(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_same_volume(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(prop, "Volume", "Volume of the joint at rest");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_update");

  RNA_define_lib_overridable(false);
}

static void rna_def_constraint_transform_like(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_minmax(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_action(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_struct_ui_text(
      srna, "Action Constraint", "Map an action to the transform axes of a joint");
  ...
  RNA_def_property_ui_text(prop,
                           "Object Action",
                           "Joints only: apply the object's transformation channels of the action "
                           "to the constrained joint, instead of joint's channels");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_update");
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "Time slider instead of the Target object/joint");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_update");

  RNA_define_lib_overridable(false);
}

static void rna_def_constraint_locked_track(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_follow_path(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_stretch_to(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_clamp_to(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_transform(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_location_limit(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_rotation_limit(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_size_limit(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_distance_limit(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_shrinkwrap(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_damped_track(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_spline_ik(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  static const EnumPropertyItem splineik_xz_scale_mode[] = {
      ...
      {CONSTRAINT_SPLINEIK_XZS_ORIGINAL,
       ...
       0,
       "Joint Original",
       "Use the original scaling of the joints"},
      ...
      {CONSTRAINT_SPLINEIK_XZS_VOLUMETRIC,
       ...
       0,
       "Volume Preservation",
       "Scale of the X and Z axes are adjusted to preserve the volume of the joints"},
      {0, NULL, 0, NULL, NULL},
  };
  ...
  static const EnumPropertyItem splineik_y_scale_mode[] = {
      ...
      {CONSTRAINT_SPLINEIK_YS_FIT_CURVE,
       ...
       0,
       "Fit Curve",
       "Scale the joints to fit the entire length of the curve"},
      {CONSTRAINT_SPLINEIK_YS_ORIGINAL,
       "BONE_ORIGINAL",
       0,
       "Joint Original",
       "Use the original Y scale of the joint"},
      {0, NULL, 0, NULL, NULL},
  };

  srna = RNA_def_struct(brna, "SplineIKConstraint", "Constraint");
  RNA_def_struct_ui_text(srna, "Spline IK Constraint", "Align 'n' joints along a curve");
  ...
  RNA_def_property_ui_text(prop, "Chain Length", "How many joints are included in the chain");
  ...
  RNA_def_property_ui_text(prop,
                           "Even Divisions",
                           "Ignore the relative lengths of the joints when fitting to the curve");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_update");
  ...
  RNA_def_property_ui_text(
      prop,
      "Use Curve Radius",
      "Average radius of the endpoints is used to tweak the X and Z Scaling of the joints, "
  ...
  RNA_def_property_ui_text(
      prop,
      "XZ Scale Mode",
      "Method used for determining the scaling of the X and Z axes of the joints");
  RNA_def_property_update(prop, NC_OBJECT | ND_CONSTRAINT, "rna_Constraint_update");
  ...
  RNA_def_property_ui_text(prop,
                           "Y Scale Mode",
                           "Method used for determining the scaling of the Y axis of the joints, "
...
static void rna_def_constraint_pivot(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_follow_track(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_camera_solver(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_object_solver(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_constraint_transform_cache(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_constraint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_struct_ui_text(
      srna, "Constraint", "Constraint modifying the transformation of objects and joints");
  ...
  RNA_def_property_ui_text(
      prop,
      "Proxy Local",
      "Constraint was added in this proxy instance (i.e. did not belong to source Rig)");
  ...
  RNA_def_property_ui_text(
      prop,
      "Lin error",
      "Amount of residual error in 3IXAM space unit for constraints that work on position");
