...
void RNA_api_armature_edit_bone(StructRNA *srna)
{
  ...
  RNA_def_function_ui_description(func,
                                  "Align the joint to a local-space roll so the Z axis "
...
void RNA_api_bone(StructRNA *srna)
{
  ...
  RNA_def_function_ui_description(func, "Calculate joint envelope at given point");
  ...
  RNA_def_function_ui_description(func,
                                  ...
                                  "omitted, the joint is assumed to have no parent.");
  ...
  RNA_def_property_multi_array(parm, 2, rna_matrix_dimsize_4x4);
  RNA_def_property_ui_text(parm, "", "The custom rest matrix of this joint (Joint.matrix_local)");
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
  parm = RNA_def_property(func, "parent_matrix", PROP_FLOAT, PROP_MATRIX);
  RNA_def_property_multi_array(parm, 2, rna_matrix_dimsize_4x4);
  RNA_def_property_ui_text(
      parm, "", "The custom pose matrix of the parent joint (PoseJoint.matrix)");
  parm = RNA_def_property(func, "parent_matrix_local", PROP_FLOAT, PROP_MATRIX);
  RNA_def_property_multi_array(parm, 2, rna_matrix_dimsize_4x4);
  RNA_def_property_ui_text(
      parm, "", "The custom rest matrix of the parent joint (Joint.matrix_local)");
  ...
  RNA_def_property_ui_text(parm, "", "The main axis of the joint (tail - head)");
  RNA_def_parameter_flags(parm, PROP_NEVER_NULL, PARM_REQUIRED);
  parm = RNA_def_property(func, "roll", PROP_FLOAT, PROP_NONE);
  RNA_def_property_ui_text(parm, "", "The roll of the joint");
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
  ...
  parm = RNA_def_property(func, "matrix", PROP_FLOAT, PROP_MATRIX);
  RNA_def_property_multi_array(parm, 2, rna_matrix_dimsize_3x3);
  RNA_def_property_ui_text(parm, "", "The orientation matrix of the joint");
  RNA_def_parameter_flags(parm, PROP_NEVER_NULL, PARM_REQUIRED);
  ...
  RNA_def_property_array(parm, 3);
  RNA_def_property_ui_text(parm, "", "The main axis of the joint");
  RNA_def_function_output(func, parm);
