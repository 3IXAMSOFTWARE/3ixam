...
static const EnumPropertyItem rna_enum_rigidbody_constraint_spring_type_items[] = {
    {RBC_SPRING_TYPE1,
     ...
     ICON_NONE,
     "3IXAM 2.7",
     "Spring implementation used in 3IXAM 2.7. Damping is capped at 1.0"},
    {RBC_SPRING_TYPE2,
     "SPRING2",
     ICON_NONE,
     "3IXAM 2.8",
...
static void rna_def_rigidbody_world(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_rigidbody_object(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_rigidbody_constraint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_rigidbody(IxamRNA *brna)
{
