...
const EnumPropertyItem rna_enum_object_modifier_type_items_without_physics[] = {
    {0, "", 0, N_("Generate"), ""},
    ...
    {eModifierType_Solidify, "SOLIDIFY", ICON_MOD_SOLIDIFY, "Solidify Surface", "Make the surface thick"},
    ...
    {eModifierType_Armature,
     ...
     ICON_MOD_ARMATURE,
     "Skeleton Rig",
     "Deform the shape using an rig object"},
    {eModifierType_Curve, "CURVE", ICON_MOD_CURVE, "Curve Ruler", "Bend the mesh using a curve object"},
...
const EnumPropertyItem rna_enum_object_modifier_type_items[] = {
    ...
    {eModifierType_Mask,
     ...
     ICON_MOD_MASK,
     "Mask",
     "Dynamically hide vertices based on a vertex group or rig"},
    {eModifierType_Mirror,
     "MIRROR",
     ICON_MOD_MIRROR,
     "Mirror",
...
const EnumPropertyItem rna_enum_dt_layers_select_src_items[] = {
    ...
    {DT_LAYERS_VGROUP_SRC_BONE_SELECT,
     ...
     "Transfer all vertex groups used by selected pose joints"},
    {DT_LAYERS_VGROUP_SRC_BONE_DEFORM,
     "BONE_DEFORM",
     0,
     "Deform Pose Joints",
     "Transfer all vertex groups used by deform joints"},
    {0, NULL, 0, NULL, NULL},
};
...
static void rna_def_modifier_subsurf(IxamRNA *brna)
{
...
static void rna_def_modifier_generic_map_info(StructRNA *srna)
{
  ...
  RNA_def_property_ui_text(prop, "Texture Coordinate Joint", "Joint to set the texture coordinates");
  RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");

  RNA_define_lib_overridable(false);
}

static void rna_def_modifier_warp(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(prop, "Joint From", "Joint to transform from");
  RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");
  ...
  RNA_def_property_ui_text(prop, "Joint To", "Joint defining offset");
  RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");
...
static void rna_def_modifier_multires(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop, "External", "Store multires displacements outside the .ixam file, to save memory");
...
static void rna_def_modifier_lattice(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_curve(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_build(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_mirror(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_decimate(IxamRNA *brna)
{
...
static void rna_def_modifier_wave(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_armature(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;

  srna = RNA_def_struct(brna, "ArmatureModifier", "Modifier");
  RNA_def_struct_ui_text(srna, "Rig Modifier", "Rig deformation modifier");
  ...
  prop = RNA_def_property(srna, "object", PROP_POINTER, PROP_NONE);
  RNA_def_property_ui_text(prop, "Object", "Rig object to deform with");
  RNA_def_property_pointer_funcs(
  ...
  RNA_def_property_ui_text(prop, "Use Joint Envelopes", "Bind Joint envelopes to rig modifier");
  RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");

  prop = RNA_def_property(srna, "use_vertex_groups", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "deformflag", ARM_DEF_VGROUP);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(prop, "Use Vertex Groups", "Bind vertex groups to rig modifier");
  RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");
...
static void rna_def_modifier_hook(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
  ...
  RNA_def_property_ui_text(
      prop,
      "Sub-Target",
      "Name of Parent Joint for hook (if applicable), also recalculates and clears offset");
...
static void rna_def_modifier_softbody(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_boolean(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_pointer_funcs(prop, NULL, NULL, NULL, "rna_Collection_poll");
  ...
  RNA_def_property_enum_default(prop, eBooleanModifierSolver_Fast);
...
static void rna_def_modifier_array(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_pointer_funcs(
      prop, NULL, NULL, NULL, "rna_Mesh_object_poll");
  RNA_def_property_ui_text(
      prop,
      "Object Offset",
...
static void rna_def_modifier_edgesplit(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_displace(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_uvproject(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_pointer_funcs(
      prop, "rna_UVProjector_object_get", "rna_UVProjector_object_set", NULL, "rna_Unprotected_object_poll");
  RNA_def_property_flag(prop, PROP_EDITABLE | PROP_ID_SELF_CHECK);
...
static void rna_def_modifier_smooth(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_correctivesmooth(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_laplaciansmooth(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_cast(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_meshdeform(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
#  if 0
...
static void rna_def_modifier_particlesystem(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_particleinstance(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_explode(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_cloth(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_fluid(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_dynamic_paint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_collision(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_bevel(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_shrinkwrap(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_mask(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  static const EnumPropertyItem modifier_mask_mode_items[] = {
      ...
      {MOD_MASK_MODE_ARM, "ARMATURE", 0, "Rig", ""},
      {0, NULL, 0, NULL, NULL},
  };
  ...
  RNA_def_property_ui_text(prop, "Rig", "Rig to use as source of joints to mask");
  RNA_def_property_pointer_funcs(
...
static void rna_def_modifier_simpledeform(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_surface(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_modifier_solidify(IxamRNA *brna)
{
...
static void rna_def_modifier_screw(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_uvwarp(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(prop, "Joint From", "Joint defining offset");
  RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");
...
static void rna_def_modifier_weightvg_mask(IxamRNA *UNUSED(brna),
                                           StructRNA *srna,
                                           ...
                                           const char *mask_uvlayer_setter)
{
  ...
  RNA_def_property_ui_text(
      prop, "Texture Coordinate Joint", "Which joint to take texture coordinates from");
  RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");

  RNA_define_lib_overridable(false);
}

static void rna_def_modifier_weightvgedit(IxamRNA *brna)
{
...
static void rna_def_modifier_weightvgmix(IxamRNA *brna)
{
...
static void rna_def_modifier_weightvgproximity(IxamRNA *brna)
{
...
static void rna_def_modifier_remesh(IxamRNA *brna)
{
  static const EnumPropertyItem mode_items[] = {
...
static void rna_def_modifier_ocean(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_skin(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_triangulate(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_meshcache(IxamRNA *brna)
{
...
static void rna_def_modifier_meshseqcache(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_laplaciandeform(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_weld(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_wireframe(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_datatransfer(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_normaledit(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_surfacedeform(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_weightednormal(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_nodes(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_mesh_to_volume(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_modifier_volume_displace(IxamRNA *brna)
{
...
static void rna_def_modifier_volume_to_mesh(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_modifier(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
