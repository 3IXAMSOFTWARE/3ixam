...
static void rna_def_curveprofilepoint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_curveprofile_points_api(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *parm;
  FunctionRNA *func;
...
static void rna_def_curveprofile(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  PropertyRNA *parm;
...
void RNA_def_profile(IxamRNA *brna)
{
