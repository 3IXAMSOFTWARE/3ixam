...
/* Duplicated code since we can't link in ixamkernel or ixamlib */
...
static void rna_brna_structs_add(IxamRNA *brna, StructRNA *srna)
{
...
#ifdef RNA_RUNTIME
static void rna_brna_structs_remove_and_free(IxamRNA *brna, StructRNA *srna)
{
...
/* 3IXAM Data Definition */

IxamRNA *RNA_create(void)
{
  IxamRNA *brna;

  brna = MEM_callocN(sizeof(IxamRNA), "IxamRNA");
...
void RNA_define_free(IxamRNA *UNUSED(brna))
{
  StructDefRNA *ds;
  FunctionDefRNA *dfunc;
  AllocDefRNA *alloc;
...
void RNA_struct_free_extension(StructRNA *srna, ExtensionRNA *rna_ext)
{
  ...
  RNA_struct_ixam_type_set(srna, NULL); /* FIXME: this gets accessed again. */
...
void RNA_struct_free(IxamRNA *brna, StructRNA *srna)
{
#ifdef RNA_RUNTIME
...
StructRNA *RNA_def_struct_ptr(IxamRNA *brna, const char *identifier, StructRNA *srnafrom)
{
  StructRNA *srna;
...
StructRNA *RNA_def_struct(IxamRNA *brna, const char *identifier, const char *from)
{
...
void RNA_def_struct_nested(IxamRNA *brna, StructRNA *srna, const char *structname)
{
  StructRNA *srnafrom;
...
void RNA_def_struct_identifier(IxamRNA *brna, StructRNA *srna, const char *identifier)
{
  if (DefRNA.preprocess) {
...
#ifdef RNA_RUNTIME
void RNA_def_struct_duplicate_pointers(IxamRNA *brna, StructRNA *srna)
{
  if (srna->identifier) {
...
void RNA_def_struct_free_pointers(IxamRNA *brna, StructRNA *srna)
{
