...
static void rna_IxamRNA_structs_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
  IxamRNA *brna = ptr->data;
  rna_iterator_listbase_begin(iter, &brna->structs, rna_struct_is_publc);
}

/* optional, for faster lookups */
static int rna_IxamRNA_structs_length(PointerRNA *ptr)
{
  IxamRNA *brna = ptr->data;
  BLI_assert(brna->structs_len == BLI_listbase_count(&brna->structs));
  return brna->structs_len;
}
static int rna_IxamRNA_structs_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
  IxamRNA *brna = ptr->data;
...
static int rna_IxamRNA_structs_lookup_string(PointerRNA *ptr,
                                                const char *key,
                                                PointerRNA *r_ptr)
{
  IxamRNA *brna = ptr->data;
...
static void rna_def_struct(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_property(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_function(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_enum_property(IxamRNA *brna, StructRNA *srna)
{
  PropertyRNA *prop;

  /* the itemf func is used instead, keep ixam happy */
...
void RNA_def_rna(IxamRNA *brna)
{
  ...
  /* 3IXAM RNA */
  srna = RNA_def_struct(brna, "IxamRNA", NULL);
  RNA_def_struct_ui_text(srna, "3IXAM RNA", "3IXAM RNA structure definitions");
  RNA_def_struct_ui_icon(srna, ICON_RNA);
...
#  if 0
                                    ...
                                    NULL);
#  else
                                    "rna_IxamRNA_structs_length",
                                    "rna_IxamRNA_structs_lookup_int",
                                    "rna_IxamRNA_structs_lookup_string",
                                    NULL);
#  endif
