...
static void rna_def_depsgraph_instance(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_struct_ui_text(srna,
                         ...
                         "(Warning: All data here is 'evaluated' one, not original .ixam IDs)");
...
static void rna_def_depsgraph_update(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_depsgraph(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
void RNA_def_depsgraph(IxamRNA *brna)
{
