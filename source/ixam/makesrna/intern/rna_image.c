...
static void rna_def_imageuser(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
/* image.packed_files */
static void rna_def_image_packed_files(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_render_slot(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_render_slots(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *prop, *parm;
...
static void rna_def_udim_tile(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_udim_tiles(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_image(IxamRNA *brna)
{
