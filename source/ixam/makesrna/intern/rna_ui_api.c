...
const EnumPropertyItem rna_enum_tab_types_items[] = {
    {UI_TAB_TYPE_MATPRO, "MATPRO", 0, "MatPro Tab", "MatPro Tab with a cross on the right"},
    {0, NULL, 0, NULL, NULL},
};
                        ...
                        bool invert_checkbox)
{
  ...
  flag |= (shape << UI_ITEM_SHAPE_FIELD_OFFSET);
...
static PointerRNA rna_uiItemTab(uiLayout *layout,
                              const char *opname,
                              const char *name,
                              const char *text_ctxt,
                              bool translate,
                              ...
                              int shape)
{
  ...
  PointerRNA opptr;
  uiItemFullOTab_ptr(layout, ot, name, icon, tab_type, tab_index, NULL, uiLayoutGetOperatorContext(layout), flag, &opptr);
  return opptr;
}

static PointerRNA rna_uiItemML_O(uiLayout *layout,
                              const char *opname,
                              const char *name,
                              const char *text_ctxt,
                              bool translate,
                              ...
                              int shape)
{
  ...
  PointerRNA opptr;
  uiItemFullML_O(layout, ot, name, icon, material, NULL, uiLayoutGetOperatorContext(layout), flag, &opptr);
  return opptr;
}

static void rna_uiItemMaterialOperator(uiLayout *layout, struct Material* material, int icon_value)
{
  uiItemMOperator(layout, material, icon_value);
}

static void rna_uiItemOutlinerObject(uiLayout *layout, Object* object)
{
  uiItemOObject(layout, object);
}

static void rna_uiItemOutlinerFolder(uiLayout *layout, struct Collection* collection)
{
  uiItemOFolder(layout, collection);
}
                        ...
                        int shape)
{
  ...
  uiItemL(layout, name, icon, shape);
}
                        ...
                        int shape)
{
  ...
  uiItemM(layout, menuname, name, icon, shape);
}

static void rna_uiItemM_image(uiLayout *layout,
                        const char *menuname,
                        const char *name,
                        const char *text_ctxt,
                        bool translate,
                        ...
                        int icon_value)
{
  ...
  uiItemImg(layout, NULL, menuname, name);
}
...
static void rna_uiItemSearch(uiLayout *layout)
{
  uiItemSearch(layout);
}

static void rna_uiItemDimensions(uiLayout *layout, bContext *C)
{
  uiItemDimensions(layout, C);
}

static void rna_uiItemAnimBar(uiLayout *layout, bContext *C)
{
  uiItemAnimBar(C, layout);
}

static void rna_uiItemUVAxis(uiLayout *layout, bContext *C, int axis)
{
  uiItemUVAxis(C, layout, axis);
}
                                   ...
                                   int align)
{
  ...
  uiItemPopoverPanel(layout, C, panel_type, name, icon, shape, align, depress);
}

static void rna_uiItemPopoverPanel_vc(uiLayout *layout,
                                   bContext *C,
                                   const char *panel_type)
{
  uiItemPopoverPanel_vc(layout, C, panel_type);
}
                             ...
                             int icon_value)
{
  ...
  uiTemplateID(layout, C, ptr, propname, newop, openop, unlinkop, filter, live_icon, name, icon_value, show_description);
}
...
static uiLayout *rna_uiLayoutVertRow(
    uiLayout *layout, bool align, const char *heading, const char *heading_ctxt, bool translate)
{
  return uiLayoutVertRow(layout, align);
}
...
void RNA_api_ui_layout(StructRNA *srna)
{
  ...
  static const EnumPropertyItem popover_to_region_align_items[] = {
    {UI_POPOVER_ALIGN_NONE, "NONE", 0, "Don't align", ""},
    {UI_POPOVER_ALIGN_LEFT, "LEFT", 0, "Align popup to left side of the region", ""},
    {UI_POPOVER_ALIGN_RIGHT, "RIGHT", 0, "Align popup to right side of the region", ""},
    {0, NULL, 0, NULL, NULL},
  };
  ...
  func = RNA_def_function(srna, "hex_flow", "uiLayoutHexFlow");
  RNA_def_int(func, "columns", 0, 0, INT_MAX, "", "Number of columns, 0 is automatic", 0, INT_MAX);
  parm = RNA_def_pointer(func, "layout", "UILayout", "", "Sub-layout to put items in");
  RNA_def_function_return(func, parm);
  RNA_def_boolean(func, "align", false, "", "Align buttons to each other");

  func = RNA_def_function(srna, "overlap", "uiLayoutOverlap");
  parm = RNA_def_pointer(func, "layout", "UILayout", "", "Sub-layout to put items in");
  RNA_def_function_return(func, parm);
  
  func = RNA_def_function(srna, "absolute", "uiLayoutAbsolute");
  parm = RNA_def_pointer(func, "layout", "UILayout", "", "Sub-layout to put items in");
  RNA_def_function_return(func, parm);
  RNA_def_boolean(func, "align", false, "", "Align buttons to each other");
  ...
  func = RNA_def_function(srna, "vert_row", "rna_uiLayoutVertRow");
  parm = RNA_def_pointer(func, "layout", "UILayout", "", "Sub-layout to put items in");
  RNA_def_function_return(func, parm);
  RNA_def_function_ui_description(
      func,
  ...
  func = RNA_def_function(srna, "tab", "rna_uiItemTab");
  api_ui_item_op_common(func);
  RNA_def_enum(func, "tab_type", rna_enum_tab_types_items, UI_TAB_TYPE_MATPRO, "", "Tab Type");
  RNA_def_int(func, "tab_index", 0, 0, 100, "Tab Index", "", 0, 100);
  RNA_def_boolean(func, "emboss", true, "", "Draw the button itself, not just the icon/text");
  RNA_def_boolean(func, "depress", false, "", "Draw pressed in");
  parm = RNA_def_property(func, "icon_value", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_ui_text(parm, "Icon Value", "Override automatic icon of the item");
  ...
  func = RNA_def_function(srna, "matlist_operator", "rna_uiItemML_O");
  api_ui_item_op_common(func);
  parm = RNA_def_pointer(func, "material", "Material", "", "Material reference");
...
#  endif
  ...
  func = RNA_def_function(srna, "search", "rna_uiItemSearch");
  RNA_def_function_ui_description(func, "Search menu. Displays a search over all menus in the current context");
  
  func = RNA_def_function(srna, "anim_bar", "rna_uiItemAnimBar");
  RNA_def_function_ui_description(func, "Animation bar. Displays current frame");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);

  func = RNA_def_function(srna, "uv_coords", "rna_uiItemUVAxis");
  RNA_def_function_ui_description(func, "UV Vertex");
  RNA_def_enum(func, "axis", rna_enum_axis_xy_items, 0, "", "Axis to display");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);

  func = RNA_def_function(srna, "material_operator", "rna_uiItemMaterialOperator");
  parm = RNA_def_pointer(func, "material", "Material", "", "Material reference");
  RNA_def_parameter_flags(parm, PROP_NEVER_NULL, PARM_REQUIRED);
  parm = RNA_def_property(func, "icon_value", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_ui_text(parm, "Icon Value", "Override automatic icon of the item");
  ...
  func = RNA_def_function(srna, "dimensions_panel", "rna_uiItemDimensions");
  RNA_def_function_ui_description(func, "Dimension panel from Item/Transform");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);

  func = RNA_def_function(srna, "outliner_object", "rna_uiItemOutlinerObject");
  parm = RNA_def_pointer(func, "object", "Object", "", "Object to add");
  RNA_def_parameter_flags(parm, PROP_NEVER_NULL, PARM_REQUIRED);
  
  func = RNA_def_function(srna, "outliner_folder", "rna_uiItemOutlinerFolder");
  parm = RNA_def_pointer(func, "collection", "Collection", "", "Collection to add");
  RNA_def_parameter_flags(parm, PROP_NEVER_NULL, PARM_REQUIRED);
  
  func = RNA_def_function(srna, "menu_image", "rna_uiItemM_image");
  // parm = RNA_def_string(func, "image", NULL, 0, "", "Path to backgroud image of menu");
  // RNA_def_pointer(func, "image", "Image", "", "Backgroud image of menu");
  // RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
  parm = RNA_def_string(func, "menu", NULL, 0, "", "Identifier of the menu");
  api_ui_item_common(func);
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
  ...
  parm = RNA_def_property(func, "icon_value", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_ui_text(parm, "Icon Value", "Override automatic icon of the item");
  RNA_def_enum(func, "shape", rna_enum_button_shape_items, UI_BSHAPE_ROUNDBOX, "", "Shape of button");
  ...
  RNA_def_enum(func,
              "region_align",
              popover_to_region_align_items,
              UI_POPOVER_ALIGN_LEFT,
              "",
              "Optionally, popover to region alignment");

  func = RNA_def_function(srna, "viewport_configuration", "rna_uiItemPopoverPanel_vc");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
  parm = RNA_def_string(func, "panel", NULL, 0, "", "Identifier of the panel");
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
  ...
  RNA_def_boolean(func, "show_description", true, "", "show the description");
  api_ui_item_common_text(func);
  parm = RNA_def_property(func, "icon_value", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_ui_text(parm, "Icon Value", "Override automatic icon of the item");
  ...
  func = RNA_def_function(srna, "template_modifiers_panel", "uiTemplateModifiers_panel");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
  RNA_def_function_ui_description(func, "Generates the UI layout for the modifier stack on the panel");
  
  func = RNA_def_function(srna, "template_physics_panel", "uiTemplatePhysics_panel");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
  RNA_def_function_ui_description(func, "Generates the UI layout for the modifier stack on the panel");
  ...
  RNA_def_boolean(func,
                  ...
                  true,
                  "",
                  "Add panels for joint constraints instead of object constraints");

  func = RNA_def_function(srna, "template_constraints_panel", "uiTemplateConstraints_panel");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
  RNA_def_function_ui_description(func, "Generates the panels for the constraint stack on the panel");
  RNA_def_boolean(func,
                  "use_bone_constraints",
                  true,
                  "",
  ...
  RNA_def_boolean(func, "show_resize", true, "", "Show resize block?");
  ...
  RNA_def_boolean(func, "show_new", true, "", "Show \"New\" button");
  
  func = RNA_def_function(srna, "template_image_pass_selector_only", "uiTemplateImagePassSelectorOnly");
  RNA_def_function_ui_description(
      func, "Item(s). User interface for selecting images and their source paths");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
  api_ui_item_rna_common(func);
  ...
  func = RNA_def_function(srna, "template_render_jobs", "uiTemplateRenderJobs");
  RNA_def_function_flag(func, FUNC_USE_CONTEXT);
...
#  endif
  ...
  RNA_def_function_ui_description(func, "Show list of recently saved .ixam files");
  ...
  parm = RNA_def_string(func,
                        ...
                        "views and to idenify an asset view read from a .ixam");
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
  parm = RNA_def_pointer(func,
                         "asset_library_dataptr",
                         "AnyType",
