...
static void rna_def_pointcache_common(StructRNA *srna)
{
  ...
  RNA_def_property_ui_text(
      prop, "Disk Cache", "Save cache files to disk (.ixam file must be saved first)");
...
static void rna_def_ptcache_point_caches(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_pointcache_active(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_collision(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_effector_weight(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_field(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_softbody(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_object_force(IxamRNA *brna)
{
