                                     ...
                                     StructFreeFunc free)
{
  ...
  dummygt.rna_ext.srna = RNA_def_struct_ptr(&IXAM_RNA, dummygt.idname, &RNA_Gizmo);
...
static void rna_Gizmo_unregister(struct Main *bmain, StructRNA *type)
{
  wmGizmoType *gzt = RNA_struct_ixam_type_get(type);
                                          ...
                                          StructFreeFunc free)
{
  ...
  dummywgt.rna_ext.srna = RNA_def_struct_ptr(&IXAM_RNA, dummywgt.idname, &RNA_GizmoGroup);
...
static void rna_GizmoGroup_unregister(struct Main *bmain, StructRNA *type)
{
  wmGizmoGroupType *gzgt = RNA_struct_ixam_type_get(type);
...
/* GizmoGroup.gizmos */
static void rna_def_gizmos(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_gizmo(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_gizmogroup(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_wm_gizmo(IxamRNA *brna)
{
