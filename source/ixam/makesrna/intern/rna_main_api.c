                                 ...
                                 bool is_internal)
{
  ...
  errno = 0;
  txt = BKE_text_load_ex(bmain, filepath, BKE_main_ixamfile_path(bmain), is_internal);
...
void RNA_def_main_cameras(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataCameras");
  srna = RNA_def_struct(brna, "IxamDataCameras", NULL);
  ...
  RNA_def_function_ui_description(func, "Remove a camera from the current ixamfile");
...
void RNA_def_main_scenes(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataScenes");
  srna = RNA_def_struct(brna, "IxamDataScenes", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  RNA_def_function_ui_description(func, "Remove a scene from the current ixamfile");
...
void RNA_def_main_objects(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataObjects");
  srna = RNA_def_struct(brna, "IxamDataObjects", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_ui_description(func, "Remove an object from the current ixamfile");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
...
void RNA_def_main_materials(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataMaterials");
  srna = RNA_def_struct(brna, "IxamDataMaterials", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a material from the current ixamfile");
...
void RNA_def_main_node_groups(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
  ...
  RNA_def_property_srna(cprop, "IxamDataNodeTrees");
  srna = RNA_def_struct(brna, "IxamDataNodeTrees", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a node tree from the current ixamfile");
...
void RNA_def_main_meshes(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataMeshes");
  srna = RNA_def_struct(brna, "IxamDataMeshes", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  RNA_def_boolean(func,
                  ...
                  "By default 3IXAM only computes the subset of data layers needed for viewport "
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a mesh from the current ixamfile");
...
void RNA_def_main_lights(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataLights");
  srna = RNA_def_struct(brna, "IxamDataLights", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a light from the current ixamfile");
...
void RNA_def_main_libraries(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataLibraries");
  srna = RNA_def_struct(brna, "IxamDataLibraries", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a library from the current ixamfile");
...
void RNA_def_main_screens(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataScreens");
  srna = RNA_def_struct(brna, "IxamDataScreens", NULL);
  RNA_def_struct_sdna(srna, "Main");
...
void RNA_def_main_window_managers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataWindowManagers");
  srna = RNA_def_struct(brna, "IxamDataWindowManagers", NULL);
  RNA_def_struct_sdna(srna, "Main");
...
void RNA_def_main_images(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataImages");
  srna = RNA_def_struct(brna, "IxamDataImages", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove an image from the current ixamfile");
...
void RNA_def_main_lattices(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataLattices");
  srna = RNA_def_struct(brna, "IxamDataLattices", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a lattice from the current ixamfile");
...
void RNA_def_main_curves(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataCurves");
  srna = RNA_def_struct(brna, "IxamDataCurves", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a curve from the current ixamfile");
...
void RNA_def_main_metaballs(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataMetaBalls");
  srna = RNA_def_struct(brna, "IxamDataMetaBalls", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a metaball from the current ixamfile");
...
void RNA_def_main_fonts(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataFonts");
  srna = RNA_def_struct(brna, "IxamDataFonts", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a font from the current ixamfile");
...
void RNA_def_main_textures(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataTextures");
  srna = RNA_def_struct(brna, "IxamDataTextures", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a texture from the current ixamfile");
...
void RNA_def_main_brushes(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataBrushes");
  srna = RNA_def_struct(brna, "IxamDataBrushes", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a brush from the current ixamfile");
...
void RNA_def_main_worlds(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataWorlds");
  srna = RNA_def_struct(brna, "IxamDataWorlds", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a world from the current ixamfile");
...
void RNA_def_main_collections(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataCollections");
  srna = RNA_def_struct(brna, "IxamDataCollections", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_ui_description(func, "Remove a collection from the current ixamfile");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
...
void RNA_def_main_speakers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataSpeakers");
  srna = RNA_def_struct(brna, "IxamDataSpeakers", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a speaker from the current ixamfile");
...
void RNA_def_main_texts(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataTexts");
  srna = RNA_def_struct(brna, "IxamDataTexts", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_ui_description(func, "Remove a text from the current ixamfile");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
...
void RNA_def_main_sounds(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataSounds");
  srna = RNA_def_struct(brna, "IxamDataSounds", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a sound from the current ixamfile");
...
void RNA_def_main_armatures(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataArmatures");
  srna = RNA_def_struct(brna, "IxamDataArmatures", NULL);
  RNA_def_struct_sdna(srna, "Main");
  RNA_def_struct_ui_text(srna, "Main Rigs", "Collection of rigs");

  func = RNA_def_function(srna, "new", "rna_Main_armatures_new");
  RNA_def_function_ui_description(func, "Add a new rig to the main database");
  parm = RNA_def_string(func, "name", "Armature", 0, "", "New name for the data-block");
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
  /* return type */
  parm = RNA_def_pointer(func, "armature", "Armature", "", "New rig data-block");
  RNA_def_function_return(func, parm);

  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove an armature from the current ixamfile");
  parm = RNA_def_pointer(func, "armature", "Armature", "", "Rig to remove");
  RNA_def_parameter_flags(parm, PROP_NEVER_NULL, PARM_REQUIRED | PARM_RNAPTR);
  RNA_def_parameter_clear_flags(parm, PROP_THICK_WRAP, 0);
  RNA_def_boolean(func,
                  "do_unlink",
                  true,
                  "",
                  "Unlink all usages of this rig before deleting it "
                  "(WARNING: will also delete objects instancing that rig data)");
  RNA_def_boolean(func,
                  "do_id_user",
                  true,
                  "",
                  "Decrement user counter of all datablocks used by this rig data");
  RNA_def_boolean(
      func, "do_ui_user", true, "", "Make sure interface does not reference this rig data");

  func = RNA_def_function(srna, "tag", "rna_Main_armatures_tag");
  parm = RNA_def_boolean(func, "value", 0, "Value", "");
  RNA_def_parameter_flags(parm, 0, PARM_REQUIRED);
}
void RNA_def_main_actions(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataActions");
  srna = RNA_def_struct(brna, "IxamDataActions", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove an action from the current ixamfile");
...
void RNA_def_main_particles(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataParticles");
  srna = RNA_def_struct(brna, "IxamDataParticles", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(
      func, "Remove a particle settings instance from the current ixamfile");
...
void RNA_def_main_palettes(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataPalettes");
  srna = RNA_def_struct(brna, "IxamDataPalettes", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a palette from the current ixamfile");
...
void RNA_def_main_cachefiles(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataCacheFiles");
  srna = RNA_def_struct(brna, "IxamDataCacheFiles", NULL);
  RNA_def_struct_sdna(srna, "Main");
...
void RNA_def_main_paintcurves(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataPaintCurves");
  srna = RNA_def_struct(brna, "IxamDataPaintCurves", NULL);
  RNA_def_struct_sdna(srna, "Main");
...
void RNA_def_main_gpencil(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataGreasePencils");
  srna = RNA_def_struct(brna, "IxamDataGreasePencils", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func,
                                  "Remove a grease pencil instance from the current ixamfile");
...
void RNA_def_main_movieclips(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataMovieClips");
  srna = RNA_def_struct(brna, "IxamDataMovieClips", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a movie clip from the current ixamfile.");
...
void RNA_def_main_masks(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataMasks");
  srna = RNA_def_struct(brna, "IxamDataMasks", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a mask from the current ixamfile");
...
void RNA_def_main_linestyles(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataLineStyles");
  srna = RNA_def_struct(brna, "IxamDataLineStyles", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a line style instance from the current ixamfile");
...
void RNA_def_main_workspaces(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataWorkSpaces");
  srna = RNA_def_struct(brna, "IxamDataWorkSpaces", NULL);
  RNA_def_struct_sdna(srna, "Main");
...
void RNA_def_main_lightprobes(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataProbes");
  srna = RNA_def_struct(brna, "IxamDataProbes", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a light probe from the current ixamfile");
...
void RNA_def_main_hair_curves(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataHairCurves");
  srna = RNA_def_struct(brna, "IxamDataHairCurves", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a curves data-block from the current ixamfile");
...
void RNA_def_main_pointclouds(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataPointClouds");
  srna = RNA_def_struct(brna, "IxamDataPointClouds", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a point cloud from the current ixamfile");
...
void RNA_def_main_volumes(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataVolumes");
  srna = RNA_def_struct(brna, "IxamDataVolumes", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a volume from the current ixamfile");
...
#  ifdef WITH_SIMULATION_DATABLOCK
void RNA_def_main_simulations(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;

  RNA_def_property_srna(cprop, "IxamDataSimulations");
  srna = RNA_def_struct(brna, "IxamDataSimulations", NULL);
  RNA_def_struct_sdna(srna, "Main");
  ...
  func = RNA_def_function(srna, "remove", "rna_Main_ID_remove");
  RNA_def_function_flag(func, FUNC_USE_REPORTS);
  RNA_def_function_ui_description(func, "Remove a simulation from the current ixamfile");
