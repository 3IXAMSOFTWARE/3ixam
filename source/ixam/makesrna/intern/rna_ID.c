                                      ...
                                      StructFreeFunc UNUSED(free))
{
   ...
   * owns the string pointer which it could potentially free while ixam
   * is running. */
  ...
  return RNA_def_struct_ptr(&IXAM_RNA, identifier, &RNA_PropertyGroup); /* XXX */
}
...
static void rna_def_ID_properties(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_ID_materials(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_image_preview(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "and is no more auto-generated by 3IXAM");
...
static void rna_def_ID_override_library_property_operation(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_ID_override_library_property_operations(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_ID_override_library_property(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_ID_override_library_properties(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_ID_override_library(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
static void rna_def_ID(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  ...
  RNA_def_property_ui_text(
      prop,
      "Is Evaluated",
      "Whether this ID is runtime-only, evaluated data-block, or actual data from .ixam file");
  ...
  RNA_def_property_ui_text(
      prop,
      "Original ID",
      "Actual data-block from .ixam file (Main database) that generated that evaluated one");
  ...
  prop = RNA_def_pointer(srna,
                         ...
                         "Weak reference to a data-block in another library .ixam file (used to "
  ...
  RNA_def_function_ui_description(
      ...
      "The result is added to the Ixam-File Data (Main database), with all references to other "
      "data-blocks ensured to be from within the same Ixam-File Data");
  RNA_def_function_flag(func, FUNC_USE_MAIN);
  parm = RNA_def_pointer(func, "id", "ID", "", "New copy of the ID");
  RNA_def_function_return(func, parm);
  ...
  RNA_def_function_ui_description(
      func, "Replace all usage in the .ixam file of this ID by new given one");
  RNA_def_function_flag(func, FUNC_USE_MAIN);
...
static void rna_def_library(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *prop;
  ...
  RNA_def_struct_ui_text(srna, "Library", "External .ixam file from which data is linked");
  RNA_def_struct_ui_icon(srna, ICON_LIBRARY_DATA_DIRECT);

  prop = RNA_def_property(srna, "filepath", PROP_STRING, PROP_FILEPATH);
  RNA_def_property_string_sdna(prop, NULL, "filepath");
  RNA_def_property_ui_text(prop, "File Path", "Path to the library .ixam file");
  ...
  prop = RNA_def_int_vector(srna,
                            ...
                            INT_MAX,
                            "Version",
                            "Version of 3IXAM the library .ixam was saved with",
                            0,
                            INT_MAX);
...
static void rna_def_library_weak_reference(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop,
      "ID name",
      "Full ID name in the library .ixam file (including the two leading 'id type' chars)");
}
 ...
 */
static void rna_def_idproperty_wrap_ptr(IxamRNA *brna)
{
  StructRNA *srna;
