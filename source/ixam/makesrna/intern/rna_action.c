...
static void rna_def_dopesheet(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop, "Show Hidden", "Include channels from objects/joint that are not visible");
  ...
  RNA_def_property_ui_text(
      prop, "Display Rig", "Include visualization of rig related animation data");
...
static void rna_def_action_group(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_action_groups(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_action_fcurves(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_action_pose_markers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_action(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_action(IxamRNA *brna)
{
  rna_def_action(brna);
