...
#else
static void rna_def_maskParent(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_maskSplinePointUW(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_maskSplinePoint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_mask_splines(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *prop;
...
static void rna_def_maskSplinePoints(IxamRNA *brna)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_maskSpline(IxamRNA *brna)
{
...
static void rna_def_mask_layer(IxamRNA *brna)
{
...
static void rna_def_masklayers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_mask(IxamRNA *brna)
{
