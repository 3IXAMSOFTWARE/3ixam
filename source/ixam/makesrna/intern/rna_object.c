...
static const EnumPropertyItem parent_type_items[] = {
    ...
    {PARBONE, "BONE", 0, "Joint", "The object is parented to a joint"},
    {0, NULL, 0, NULL, NULL},
};
...
const EnumPropertyItem rna_enum_object_type_items[] = {
    ...
    {0, "", 0, NULL, NULL},
    {OB_ARMATURE, "ARMATURE", ICON_OUTLINER_OB_ARMATURE, "Rig", ""},
...
bool rna_Unprotected_object_poll(PointerRNA *UNUSED(ptr), PointerRNA value)
{
  return !(((Object *)value.owner_id)->protectflag & OB_LOCK_DELETE);
}
...
{
  return (((Object *)value.owner_id)->type == OB_MESH && rna_Unprotected_object_poll(NULL, value));
}
...
static void rna_def_vertex_group(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
  ...
  RNA_def_struct_ui_text(
      srna, "Vertex Group", "Group of vertices, used for rig deform and other purposes");
...
static void rna_def_material_slot(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_object_constraints(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
/* object.modifiers */
static void rna_def_object_modifiers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
#  if 0
  ...
  RNA_def_property_flag(prop, PROP_EDITABLE);
  RNA_def_property_ui_text(prop, "Active EditBone", "Rig active edit joint");
...
static void rna_def_object_grease_pencil_modifiers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
/* object.shaderfxs */
static void rna_def_object_shaderfxs(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_object_particle_systems(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_object_vertex_groups(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
/* object.face_maps */
static void rna_def_object_face_maps(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_object_display(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_object_lineart(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_object(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop, "Parent Joint", "Name of parent joint in case of a joint parenting relation");
  RNA_def_property_update(prop, NC_OBJECT | ND_DRAW, "rna_Object_dependency_update");
...
#  endif
  ...
  /* delete lock */
  prop = RNA_def_property(srna, "protect", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "protectflag", OB_LOCK_DELETE);
  RNA_def_property_update(prop, NC_OBJECT | ND_TRANSFORM, "rna_Object_internal_update");
  ...
  RNA_def_property_ui_text(
      ...
      "Warning: Only takes into account object parenting, so e.g. in case of joint parenting "
      "you get a matrix relative to the Rig object, not to the actual parent joint");
  RNA_def_property_float_funcs(
...
#  endif
  ...
  RNA_def_property_ui_text(prop, "Pose Library", "Action used as a pose library for rigs");

  prop = RNA_def_property(srna, "pose", PROP_POINTER, PROP_NONE);
  RNA_def_property_pointer_sdna(prop, NULL, "pose");
  RNA_def_property_struct_type(prop, "Pose");
  RNA_def_property_ui_text(prop, "Pose", "Current pose for rigs");
...
void RNA_def_object(IxamRNA *brna)
{
  rna_def_object(brna);
