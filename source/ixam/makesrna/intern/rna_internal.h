...
extern IxamDefRNA DefRNA;

/* Define functions for all types */
#ifndef __RNA_ACCESS_H__
extern IxamRNA IXAM_RNA;
#endif

void RNA_def_ID(struct IxamRNA *brna);
void RNA_def_action(struct IxamRNA *brna);
void RNA_def_animation(struct IxamRNA *brna);
void RNA_def_animviz(struct IxamRNA *brna);
void RNA_def_armature(struct IxamRNA *brna);
void RNA_def_attribute(struct IxamRNA *brna);
void RNA_def_asset(struct IxamRNA *brna);
void RNA_def_boid(struct IxamRNA *brna);
void RNA_def_brush(struct IxamRNA *brna);
void RNA_def_cachefile(struct IxamRNA *brna);
void RNA_def_camera(struct IxamRNA *brna);
void RNA_def_cloth(struct IxamRNA *brna);
void RNA_def_collections(struct IxamRNA *brna);
void RNA_def_color(struct IxamRNA *brna);
void RNA_def_constraint(struct IxamRNA *brna);
void RNA_def_context(struct IxamRNA *brna);
void RNA_def_curve(struct IxamRNA *brna);
void RNA_def_depsgraph(struct IxamRNA *brna);
void RNA_def_dynamic_paint(struct IxamRNA *brna);
void RNA_def_fcurve(struct IxamRNA *brna);
void RNA_def_gpencil(struct IxamRNA *brna);
void RNA_def_greasepencil_modifier(struct IxamRNA *brna);
void RNA_def_shader_fx(struct IxamRNA *brna);
void RNA_def_curves(struct IxamRNA *brna);
void RNA_def_image(struct IxamRNA *brna);
void RNA_def_key(struct IxamRNA *brna);
void RNA_def_light(struct IxamRNA *brna);
void RNA_def_lattice(struct IxamRNA *brna);
void RNA_def_linestyle(struct IxamRNA *brna);
void RNA_def_main(struct IxamRNA *brna);
void RNA_def_material(struct IxamRNA *brna);
void RNA_def_mesh(struct IxamRNA *brna);
void RNA_def_meta(struct IxamRNA *brna);
void RNA_def_modifier(struct IxamRNA *brna);
void RNA_def_nla(struct IxamRNA *brna);
void RNA_def_nodetree(struct IxamRNA *brna);
void RNA_def_object(struct IxamRNA *brna);
void RNA_def_object_force(struct IxamRNA *brna);
void RNA_def_packedfile(struct IxamRNA *brna);
void RNA_def_palette(struct IxamRNA *brna);
void RNA_def_particle(struct IxamRNA *brna);
void RNA_def_pointcloud(struct IxamRNA *brna);
void RNA_def_pose(struct IxamRNA *brna);
void RNA_def_profile(struct IxamRNA *brna);
void RNA_def_lightprobe(struct IxamRNA *brna);
void RNA_def_render(struct IxamRNA *brna);
void RNA_def_rigidbody(struct IxamRNA *brna);
void RNA_def_rna(struct IxamRNA *brna);
void RNA_def_scene(struct IxamRNA *brna);
void RNA_def_simulation(struct IxamRNA *brna);
void RNA_def_view_layer(struct IxamRNA *brna);
void RNA_def_screen(struct IxamRNA *brna);
void RNA_def_sculpt_paint(struct IxamRNA *brna);
void RNA_def_sequencer(struct IxamRNA *brna);
void RNA_def_fluid(struct IxamRNA *brna);
void RNA_def_space(struct IxamRNA *brna);
void RNA_def_speaker(struct IxamRNA *brna);
void RNA_def_test(struct IxamRNA *brna);
void RNA_def_text(struct IxamRNA *brna);
void RNA_def_texture(struct IxamRNA *brna);
void RNA_def_timeline_marker(struct IxamRNA *brna);
void RNA_def_sound(struct IxamRNA *brna);
void RNA_def_ui(struct IxamRNA *brna);
void RNA_def_userdef(struct IxamRNA *brna);
void RNA_def_vfont(struct IxamRNA *brna);
void RNA_def_volume(struct IxamRNA *brna);
void RNA_def_wm(struct IxamRNA *brna);
void RNA_def_wm_gizmo(struct IxamRNA *brna);
void RNA_def_workspace(struct IxamRNA *brna);
void RNA_def_world(struct IxamRNA *brna);
void RNA_def_movieclip(struct IxamRNA *brna);
void RNA_def_tracking(struct IxamRNA *brna);
void RNA_def_mask(struct IxamRNA *brna);
void RNA_def_xr(struct IxamRNA *brna);
...
void rna_def_mtex_common(struct IxamRNA *brna,
                         struct StructRNA *srna,
                         const char *begin,
...
void rna_def_texpaint_slots(struct IxamRNA *brna, struct StructRNA *srna);
void rna_def_view_layer_common(struct IxamRNA *brna, struct StructRNA *srna, bool scene);
...
void rna_def_freestyle_settings(struct IxamRNA *brna);
...
bool rna_Unprotected_object_poll(struct PointerRNA *ptr, struct PointerRNA value);
...
bool rna_Collection_poll(struct PointerRNA *ptr, struct PointerRNA value);
...
void RNA_api_space_matpro(struct StructRNA *srna);
...
void RNA_api_sequences(IxamRNA *brna, PropertyRNA *cprop, bool metastrip);
void RNA_api_sequence_elements(IxamRNA *brna, PropertyRNA *cprop);
...
/* Duplicated code since we can't link in ixamlib */
