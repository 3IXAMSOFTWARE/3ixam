...
const EnumPropertyItem rna_enum_snap_element_items[] = {
    {SCE_SNAP_MODE_VERTEX, "VERTEX", ICON_SNAP_VERTEX, "Points", "Snap to points"},
    {SCE_SNAP_MODE_EDGE, "EDGE", ICON_SNAP_EDGE, "Edges", "Snap to edges"},
...
static const char *rna_Scene_render_statistics_string_get(Scene *UNUSED(scene), bContext *C)
{
  if (!CTX_wm_space_render(C)) {
    return "";
  }
  return ED_render_statistics_string(C);
}
                                                                        ...
                                                                        bool *r_free)
{
   ...
   * as RGBA, this is age old ixam convention and not sure how useful
...
static void rna_def_gpencil_interpolate(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_transform_orientation(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_transform_orientation_slot(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_view3d_cursor(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_tool_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  static const EnumPropertyItem vertex_group_select_items[] = {
      ...
      {WT_VGROUP_BONE_DEFORM,
       ...
       0,
       "Deform",
       "Vertex Groups assigned to Deform Joints"},
      {WT_VGROUP_BONE_DEFORM_OFF,
       "OTHER_DEFORM",
       0,
       "Other",
       "Vertex Groups assigned to non Deform Joints"},
      {0, NULL, 0, NULL, NULL},
  };
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "Ensure all joint-deforming vertex groups add up "
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "Display joint-deforming groups as if all locked deform groups "
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "Paint across the weights of all selected joints, "
  ...
  RNA_def_property_ui_text(
      prop, "Proportional Editing Curves", "Proportional editing in Curve editor");
  RNA_def_property_ui_icon(prop, ICON_PROP_OFF, 1);
  RNA_def_property_update(prop, NC_SCENE | ND_TOOLSETTINGS, NULL); /* header redraw */
  ...
  prop = RNA_def_property(srna, "snap_degree", PROP_INT, PROP_UNSIGNED);
  RNA_def_property_int_default(prop, 5);
  RNA_def_property_int_sdna(prop, NULL, "snap_degree");
  RNA_def_property_range(prop, 1, 360);
  RNA_def_property_update(prop, NC_SCENE | ND_TOOLSETTINGS, NULL); /* header redraw */
  ...
  RNA_def_property_ui_text(
      prop, "Auto Keying", "Automatic keyframe insertion for Objects, Joints and Masks");
  ...
  RNA_def_property_ui_text(prop,
                           "Auto-Keying Mode",
                           "Mode of automatic keyframe insertion for Objects, Joints and Masks");
...
static void rna_def_sequencer_tool_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_unified_paint_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(prop, "Unprojected Radius", "Radius of brush in 3IXAM units");
  RNA_def_property_update(prop, 0, "rna_UnifiedPaintSettings_radius_update");
...
static void rna_def_curve_paint_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_enum_default(prop, CURVE_PAINT_PROJECT_SURFACE);
...
static void rna_def_statvis(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_unit_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  static const EnumPropertyItem unit_systems[] = {
      ...
      {USER_UNIT_IMPERIAL, "IMPERIAL", 0, "US Standard", ""},
      {0, NULL, 0, NULL, NULL},
  };
  ...
  RNA_def_property_ui_text(
      prop,
      "Unit Scale",
      "Scale to use when converting between ixam units and dimensions."
...
static void rna_def_view_layer_eevee(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  srna = RNA_def_struct(brna, "ViewLayerEEVEE", NULL);
  RNA_def_struct_path_func(srna, "rna_ViewLayerEEVEE_path");
  RNA_def_struct_ui_text(srna, "Play Settings", "View layer settings for Play");
...
static void rna_def_view_layer_aovs(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  /*  PropertyRNA *prop; */
...
static void rna_def_view_layer_aov(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_view_layer_lightgroups(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  /*  PropertyRNA *prop; */
...
static void rna_def_view_layer_lightgroup(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void rna_def_view_layer_common(IxamRNA *brna, StructRNA *srna, const bool scene)
{
  PropertyRNA *prop;
  ...
  if (scene) {
    ...
    RNA_def_property_ui_text(prop, "Play Settings", "View layer settings for Play");
...
static void rna_def_freestyle_modules(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_freestyle_linesets(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
void rna_def_freestyle_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_bake_data(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_view_layers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_scene_render_view(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_render_views(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_image_format_stereo3d_format(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_scene_image_format_data(IxamRNA *brna)
{
...
static void rna_def_scene_ffmpeg_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
#  ifdef WITH_FFMPEG
  ...
  RNA_def_property_enum_default(prop, FFMPEG_MPEG4);
  ...
  RNA_def_property_enum_default(prop, FFM_CRF_HIGH);
  RNA_def_property_ui_text(
      prop,
      "Output Quality",
...
static void rna_def_scene_render_data(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_boolean_sdna(prop, NULL, "is_animation", R_ANIMATION_RENDER);
  RNA_def_property_boolean_default(prop, false);
  RNA_def_property_ui_text(
      prop,
      "Animation",
      "Render active scene to animation");
  RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, NULL);
  ...
  RNA_def_property_range(prop, 1, IXAM_MAX_THREADS);
...
#  endif
  ...
  RNA_def_property_range(prop, 0.0, 1000.0);
  RNA_def_property_ui_text(
      prop, "Bias", "Bias towards faces further away from the object (in 3IXAM units)");
  RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, NULL);
  ...
  RNA_def_property_ui_text(
      prop, "Stamp Filename", "Include the .ixam filename in image/video metadata");
  RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, NULL);
...
/* scene.objects */
static void rna_def_scene_objects(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_timeline_markers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
/* scene.keying_sets */
static void rna_def_scene_keying_sets(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_scene_keying_sets_all(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
 ...
 */
static void rna_def_selected_uv_element(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_display_safe_areas(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_scene_display(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_scene_eevee(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_scene_gpencil(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_scene(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  prop = RNA_def_property(srna, "is_rendering", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE | PROP_EDITABLE);
  RNA_def_property_boolean_sdna(prop, NULL, "r.is_rendering", 1);
  RNA_def_property_ui_text(prop,
                           "Is Rendering",
                           "Displays if scene is being rendered");
  ...
  prop = RNA_def_property(srna, "frame_start", PROP_INT, PROP_FACTOR);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_int_sdna(prop, NULL, "r.sfra");
  RNA_def_property_int_funcs(prop, NULL, "rna_Scene_start_frame_set", NULL);
  RNA_def_property_range(prop, MINFRAME, MAXFRAME);
  RNA_def_property_ui_text(prop, "", "First frame of the playback/rendering range");
  RNA_def_property_update(prop, NC_SCENE | ND_FRAME_RANGE, NULL);

  prop = RNA_def_property(srna, "frame_end", PROP_INT, PROP_FACTOR);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_int_sdna(prop, NULL, "r.efra");
  RNA_def_property_int_funcs(prop, NULL, "rna_Scene_end_frame_set", NULL);
  RNA_def_property_range(prop, MINFRAME, MAXFRAME);
  RNA_def_property_ui_text(prop, "", "Final frame of the playback/rendering range");
  RNA_def_property_update(prop, NC_SCENE | ND_FRAME_RANGE, NULL);
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "Consider keyframes for active object and/or its selected joints only "
...
#  endif
  ...
  func = RNA_def_function(srna, "render_statistics", "rna_Scene_render_statistics_string_get");
  ...
  RNA_def_property_ui_text(prop, "Play", "Play settings for the scene");
