...
static void rna_def_canvas_surfaces(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_canvas_surface(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  PropertyRNA *parm;
...
#  endif
  ...
  RNA_def_property_ui_text(
      prop, "Premultiply Alpha", "Multiply color by alpha (recommended for 3IXAM input)");
...
static void rna_def_dynamic_paint_canvas_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_dynamic_paint_brush_settings(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      prop, "Max Velocity", "Velocity considered as maximum influence (3IXAM units per frame)");
...
void RNA_def_dynamic_paint(IxamRNA *brna)
{
