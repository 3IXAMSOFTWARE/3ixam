...
static void rna_def_fmodifier_generator(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier_function_generator(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier_envelope_ctrl(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier_envelope_control_points(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_fmodifier_envelope(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier_cycles(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier_python(IxamRNA *brna)
{
  StructRNA *srna;
  // PropertyRNA *prop;
...
static void rna_def_fmodifier_limits(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier_noise(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier_stepped(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fmodifier(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_drivertarget(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(prop, "Joint Name", "Name of PoseJoint to use as target");
  RNA_def_property_update(prop, 0, "rna_DriverTarget_update_data");
...
static void rna_def_drivervar(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  static const EnumPropertyItem prop_type_items[] = {
      ...
      {DVAR_TYPE_TRANSFORM_CHAN,
       ...
       "Transform Channel",
       "Final transformation value of object or joint"},
      {DVAR_TYPE_ROT_DIFF,
       "ROTATION_DIFF",
       ICON_DRIVER_ROTATIONAL_DIFFERENCE,
       "Rotational Difference",
       "Use the angle between two joints"},
      {DVAR_TYPE_LOC_DIFF,
       "LOC_DIFF",
       ICON_DRIVER_DISTANCE,
       "Distance",
       "Distance between two joints or objects"},
      {0, NULL, 0, NULL, NULL},
  };
...
static void rna_def_channeldriver_variables(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  /* PropertyRNA *prop; */
...
static void rna_def_channeldriver(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(
      ...
      "so drivers can easily reference the data being modified (object, joint, etc...)");
...
static void rna_def_fpoint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
 ...
 */
static void rna_def_fkeyframe(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fcurve_modifiers(IxamRNA *brna, PropertyRNA *cprop)
{
  /* add modifiers */
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_fcurve_keyframe_points(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_fcurve(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
void RNA_def_fcurve(IxamRNA *brna)
{
  rna_def_fcurve(brna);
