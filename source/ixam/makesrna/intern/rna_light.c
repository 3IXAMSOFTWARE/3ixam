...
static void rna_def_light(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_point_light(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_area_light(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_spot_light(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_sun_light(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_light(IxamRNA *brna)
{
  rna_def_light(brna);
