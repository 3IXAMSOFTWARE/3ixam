  ...
  for (screen = bmain->screens.first; screen; screen = screen->id.next) {
    ...
    for (area = screen->areabase.first; area; area = area->next) {
      ...
      for (slink = area->spacedata.first; slink; slink = slink->next) {
        if (ELEM(slink->spacetype, SPACE_IMAGE, SPACE_RENDER)) {
...
static void rna_def_paint_curve(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_paint_tool_slot(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_paint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_sculpt(IxamRNA *brna)
{
  ...
  RNA_def_property_ui_text(prop,
                           ...
                           "of 3IXAM unit - higher value means smaller edge length)");
  RNA_def_property_update(prop, NC_SCENE | ND_TOOLSETTINGS, NULL);
...
static void rna_def_uv_sculpt(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_gp_paint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_gp_vertexpaint(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_gp_sculptpaint(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_gp_weightpaint(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_vertex_paint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_paint_mode(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_image_paint(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
static void rna_def_particle_edit(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_gpencil_guides(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_gpencil_sculpt(IxamRNA *brna)
{
...
static void rna_def_curves_sculpt(IxamRNA *brna)
{
  StructRNA *srna;
...
void RNA_def_sculpt_paint(IxamRNA *brna)
{
  /* *** Non-Animated *** */
