...
static void rna_def_brush_texture_slot(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_sculpt_capabilities(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_brush_capabilities(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_image_paint_capabilities(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_vertex_paint_capabilities(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_weight_paint_capabilities(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_gpencil_options(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_curves_sculpt_options(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_brush(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
 ...
 * - Time
 */
static void rna_def_operator_stroke_element(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  /* XXX: i don't think ixam currently supports the ability to properly do a remappable modifier
   *      in the middle of a stroke */
}

void RNA_def_brush(IxamRNA *brna)
{
  rna_def_brush(brna);
