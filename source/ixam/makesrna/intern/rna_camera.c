...
static void rna_def_camera_background_image(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_camera_background_images(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  FunctionRNA *func;
  PropertyRNA *parm;
...
static void rna_def_camera_stereo_data(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_camera_dof_settings_data(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_camera(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
