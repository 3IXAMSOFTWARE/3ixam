...
static void rna_def_asset_tag(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_asset_tags_api(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_asset_data(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  RNA_def_property_ui_text(prop,
                           "Catalog UUID",
                           "Identifier for the asset's catalog, used by 3IXAM to look up the "
...
static void rna_def_asset_handle(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_asset_catalog_path(IxamRNA *brna)
{
  StructRNA *srna = RNA_def_struct(brna, "AssetCatalogPath", NULL);
  RNA_def_struct_ui_text(srna, "Catalog Path", "");
}

static void rna_def_asset_library_reference(IxamRNA *brna)
{
...
void RNA_def_asset(IxamRNA *brna)
{
