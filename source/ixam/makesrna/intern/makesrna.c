                                                 ...
                                                 const char *item_type)
{
  ...
  /* XXX extern declaration could be avoid by including RNA_ixam.h, but this has lots of unknown
...
static void rna_sort(IxamRNA *brna)
{
  StructDefRNA *ds;
  StructRNA *srna;
...
static void rna_generate_struct_rna_prototypes(IxamRNA *brna, FILE *f)
{
  StructRNA *srna;
...
static void rna_generate_ixam(IxamRNA *brna, FILE *f)
{
  StructRNA *srna;
...
static void rna_generate_external_property_prototypes(IxamRNA *brna, FILE *f)
{
...
static void rna_generate_internal_property_prototypes(IxamRNA *UNUSED(brna),
                                                      StructRNA *srna,
                                                      FILE *f)
{
  PropertyRNA *prop;
...
static void rna_generate_parameter_prototypes(IxamRNA *UNUSED(brna),
                                              StructRNA *srna,
                                              FunctionRNA *func,
                                              FILE *f)
{
...
static void rna_generate_function_prototypes(IxamRNA *brna, StructRNA *srna, FILE *f)
{
  FunctionRNA *func;
  StructRNA *base;
...
static void rna_generate_static_function_prototypes(IxamRNA *UNUSED(brna),
                                                    StructRNA *srna,
                                                    FILE *f)
{
  FunctionRNA *func;
...
static void rna_generate_struct(IxamRNA *UNUSED(brna), StructRNA *srna, FILE *f)
{
  FunctionRNA *func;
  FunctionDefRNA *dfunc;
...
static void rna_generate(IxamRNA *brna, FILE *f, const char *filename, const char *api_filename)
{
  StructDefRNA *ds;
  PropertyDefRNA *dp;
  FunctionDefRNA *dfunc;
  ...
  fprintf(f, "#include \"BLI_ixamlib.h\"\n\n");
  ...
  if (filename && STREQ(filename, "rna_ID.c")) {
     ...
     * makesrna and ixam with some build systems at the moment */
    fprintf(f, "#include \"rna_define.c\"\n\n");

    rna_generate_ixam(brna, f);
  }
}

static void rna_generate_header(IxamRNA *UNUSED(brna), FILE *f)
{
  StructDefRNA *ds;
  PropertyDefRNA *dp;
  StructRNA *srna;
  ...
  fprintf(f, "\n#ifndef __RNA_IXAM_H__\n");
  fprintf(f, "#define __RNA_IXAM_H__\n\n");
  ...
  fprintf(f, "#endif /* __RNA_IXAM_H__ */\n\n");
}
...
static void rna_generate_header_cpp(IxamRNA *UNUSED(brna), FILE *f)
{
  StructDefRNA *ds;
  PropertyDefRNA *dp;
  StructRNA *srna;
  ...
  fprintf(f, "\n#ifndef __RNA_IXAM_CPP_H__\n");
  fprintf(f, "#define __RNA_IXAM_CPP_H__\n\n");

  fprintf(f,
          "/* Automatically generated classes for the Data API.\n"
          " * Do not edit manually, changes will be overwritten. */\n\n");

  fprintf(f, "#include \"RNA_ixam.h\"\n");
  fprintf(f, "#include \"RNA_types.h\"\n");
...
static int rna_preprocess(const char *outfile, const char *public_header_outfile)
{
  ...
  /* create RNA_ixam_cpp.h */
  strcpy(deffile, outfile);
  strcat(deffile, "RNA_ixam_cpp.h" TMP_EXT);
  ...
  /* create RNA_ixam.h */
  strcpy(deffile, outfile);
  strcat(deffile, "RNA_ixam.h" TMP_EXT);
