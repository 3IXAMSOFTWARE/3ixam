...
{
  KeyingSetInfo *ksi = RNA_struct_ixam_type_get(type);
                                             ...
                                             StructFreeFunc free)
{
  ...
  ksi->rna_ext.srna = RNA_def_struct_ptr(&IXAM_RNA, ksi->idname, &RNA_KeyingSetInfo);
  ksi->rna_ext.data = data;
  ksi->rna_ext.call = call;
  ksi->rna_ext.free = free;
  RNA_struct_ixam_type_set(ksi->rna_ext.srna, ksi);
...
static void rna_def_keyingset_info(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  FunctionRNA *func;
...
static void rna_def_keyingset_path(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
/* keyingset.paths */
static void rna_def_keyingset_paths(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_keyingset(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_api_animdata_nla_tracks(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *parm;
  FunctionRNA *func;
...
static void rna_api_animdata_drivers(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *parm;
  FunctionRNA *func;
...
static void rna_def_animdata(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_animation(IxamRNA *brna)
{
