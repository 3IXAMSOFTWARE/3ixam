 ...
 * "internal implementation detail" of 3IXAM, rather than a public, reliable part of the API.
 *
...
const EnumPropertyItem rna_enum_event_type_items[] = {
    ...
    RNA_ENUM_ITEM_SEPR,
    {EVT_LEFTCTRLKEY, "LEFT_CTRL", 0, "Ctrl", "CtrlL"},
    {EVT_LEFTALTKEY, "LEFT_ALT", 0, "Left Option", "AltL"},
    {EVT_LEFTSHIFTKEY, "LEFT_SHIFT", 0, "Left Shift", "ShiftL"},
    {EVT_RIGHTALTKEY, "RIGHT_ALT", 0, "Right Option", "AltR"},
    {EVT_RIGHTCTRLKEY, "RIGHT_CTRL", 0, "Ctrl", "CtrlR"},
...
const EnumPropertyItem rna_enum_operator_type_flag_items[] = {
    ...
    {OPTYPE_REDO_OVERRIDE, "REDO_OVERRIDE", 0, "Redo Override", "Overrides undo depth"},
    {0, NULL, 0, NULL, NULL},
};
...
const EnumPropertyItem rna_enum_operator_return_items[] = {
    {OPERATOR_RUNNING_MODAL,
     ...
     0,
     "Running Modal",
     "Keep the operator running with ixam"},
    {OPERATOR_CANCELLED,
     "CANCELLED",
     0,
     "Cancelled",
...
{
  wmKeyConfigPrefType_Runtime *kpt_rt = RNA_struct_ixam_type_get(type);
                                               ...
                                               StructFreeFunc free)
{
  ...
  kpt_rt->rna_ext.srna = RNA_def_struct_ptr(&IXAM_RNA, identifier, &RNA_KeyConfigPreferences);
  kpt_rt->rna_ext.data = data;
  kpt_rt->rna_ext.call = call;
  kpt_rt->rna_ext.free = free;
  RNA_struct_ixam_type_set(kpt_rt->rna_ext.srna, kpt_rt);
                                        ...
                                        StructFreeFunc free)
{
  ...
  dummyot.rna_ext.srna = RNA_def_struct_ptr(&IXAM_RNA, dummyot.idname, &RNA_Operator);
...
{
  const char *idname;
  wmOperatorType *ot = RNA_struct_ixam_type_get(type);
  wmWindowManager *wm;
 ...
 * (some are read-only).
 */
static void rna_def_operator_options_runtime(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_operator(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_macro_operator(IxamRNA *brna)
{
  StructRNA *srna;
...
static void rna_def_operator_type_macro(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_operator_utils(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_operator_filelist_element(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_event(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_timer(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_popup_menu_wrapper(IxamRNA *brna,
                                       const char *rna_type,
                                       const char *c_type,
...
static void rna_def_window(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
/* curve.splines */
static void rna_def_wm_keyconfigs(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_windowmanager(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
/* keyconfig.items */
static void rna_def_keymap_items(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_wm_keymaps(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_keyconfig_prefs(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_keyconfig(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  prop = RNA_def_property(srna, "only_debug", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_ui_text(prop, "only_debug", "Debug only");
  ...
  prop = RNA_def_property(srna, "workspace_type", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_sdna(prop, NULL, "workspaceid");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  RNA_def_property_enum_items(prop, rna_enum_workspace_type_items);
  RNA_def_property_ui_text(prop, "Workspace Type", "Optional workspace type keymap is associated with");
  ...
  RNA_def_property_ui_icon(prop, ICON_DISCLOSURE_TRI_DOWN, 0);
  ...
  prop = RNA_def_property(srna, "extra_tip", PROP_STRING, PROP_NONE);
  RNA_def_property_string_sdna(prop, NULL, "extra_tip");
  RNA_def_property_ui_text(prop, "extra_tip", "More detail title");
