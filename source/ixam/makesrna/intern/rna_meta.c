...
static void rna_def_metaelement(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
/* mball.elements */
static void rna_def_metaball_elements(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_metaball(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_meta(IxamRNA *brna)
{
