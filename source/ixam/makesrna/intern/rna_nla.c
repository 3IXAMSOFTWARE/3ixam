...
static void rna_def_strip_fcurves(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
...
static void rna_def_nlastrip(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_api_nlatrack_strips(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *parm;
  FunctionRNA *func;
...
static void rna_def_nlatrack(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
