...
static void rna_def_movieclip_proxy(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_movieclipUser(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_movieClipScopes(IxamRNA *brna)
{
  StructRNA *srna;
...
void RNA_def_movieclip(IxamRNA *brna)
{
