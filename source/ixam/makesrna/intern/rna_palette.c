...
/* palette.colors */
static void rna_def_palettecolors(IxamRNA *brna, PropertyRNA *cprop)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_palettecolor(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
static void rna_def_palette(IxamRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
...
void RNA_def_palette(IxamRNA *brna)
{
  /* *** Non-Animated *** */
