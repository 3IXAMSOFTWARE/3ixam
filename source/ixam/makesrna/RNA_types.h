...
#include "../ixamlib/BLI_sys_types.h"
...
typedef enum PropertyOverrideFlag {
   ...
   * Also for runtime data that should never be considered as part of actual ixam data (e.g.
...
typedef enum StructFlag {
  ...
  /** Added to type-map #IxamRNA.structs_map */
 ...
 */
typedef struct IxamRNA IxamRNA;
