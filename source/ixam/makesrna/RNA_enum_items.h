...
DEF_ENUM(rna_enum_workspace_type_items)
...
DEF_ENUM(rna_enum_object_modifier_type_items_without_physics)
...
DEF_ENUM(rna_enum_render_common_preference_section_items)
DEF_ENUM(rna_enum_render_post_effects_section_items)
DEF_ENUM(rna_enum_render_statistics_section_items)

DEF_ENUM(rna_enum_palette_section_items)

DEF_ENUM(rna_enum_button_shape_items)
