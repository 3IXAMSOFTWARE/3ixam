...
typedef struct RenderEngineType {
   ...
   *
   * All the pending data is to be communicated from the engine back to 3IXAM. In a possibly
   * most memory-efficient manner (engine might free its database before making 3IXAM to allocate
...
void RE_engine_free_ixam_memory(struct RenderEngine *engine);
