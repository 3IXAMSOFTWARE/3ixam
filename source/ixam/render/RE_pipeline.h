...
/**
 * The name is used as identifier, so elsewhere in ixam the result can retrieved.
...
/**
 * General 3IXAM frame render call.
 *
 * \note Only #RE_NewRender() needed, main 3IXAM render calls.
 *
