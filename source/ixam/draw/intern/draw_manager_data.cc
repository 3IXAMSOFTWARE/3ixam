...
#else
  #define SCULPT_DEBUG_BUFFERS (false)
#endif // DEBUG
                                            ...
                                            Object *ob)
{
  ...
  ixam::Array<PBVHAttrReq, 16> attrs(attrs_num, PBVHAttrReq{});
...
#if defined(DRW_DEBUG_CULLING) && defined(DEBUG)
  if (G.debug_value != 0) {
    DRW_debug_sphere(
...
#include "../../ixamlib/intern/list_sort_impl.h"
