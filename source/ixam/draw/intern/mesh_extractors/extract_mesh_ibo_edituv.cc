...
const MeshExtract extract_edituv_tris = ixam::draw::create_extractor_edituv_tris();
const MeshExtract extract_edituv_lines = ixam::draw::create_extractor_edituv_lines();
const MeshExtract extract_edituv_points = ixam::draw::create_extractor_edituv_points();
const MeshExtract extract_edituv_fdots = ixam::draw::create_extractor_edituv_fdots();
