                         ...
                         const DRW_AttributeRequest &request)
{
   ...
   * 3IXAM convention, it should be `vec4(s, s, s, 1)`. This could be resolved using a similar
...
#define CREATE_EXTRACTOR_ATTR(index) \
  ixam::draw::create_extractor_attr<index>(ixam::draw::extract_attr_init##index, \
                                              ixam::draw::extract_attr_init_subdiv##index)
...
const MeshExtract extract_attr_viewer = ixam::draw::create_extractor_attr_viewer();
