                                               ...
                                               void * /*data*/)
{
  ...
  ixam::Span<DRWSubdivLooseEdge> loose_edges = draw_subdiv_cache_get_loose_edges(subdiv_cache);
  ...
  ixam::Span<DRWSubdivLooseVertex> loose_verts = draw_subdiv_cache_get_loose_verts(
      subdiv_cache);
...
const MeshExtract extract_poly_idx = ixam::draw::create_extractor_poly_idx();
const MeshExtract extract_edge_idx = ixam::draw::create_extractor_edge_idx();
const MeshExtract extract_vert_idx = ixam::draw::create_extractor_vert_idx();
const MeshExtract extract_fdot_idx = ixam::draw::create_extractor_fdot_idx();
