...
const MeshExtract extract_fdots_nor = ixam::draw::create_extractor_fdots_nor();
const MeshExtract extract_fdots_nor_hq = ixam::draw::create_extractor_fdots_nor_hq();
