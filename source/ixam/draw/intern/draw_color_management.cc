...
namespace ixam::draw::color_management {
                                                                 ...
                                                                 const View3D &v3d)
{
  ...
  const bool use_workbench = BKE_scene_uses_ixam_workbench(&scene);
...
{
  ixam::draw::color_management::viewport_color_management_set(*viewport);
}
