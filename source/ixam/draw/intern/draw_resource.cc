 ...
 * This function mirrors lookup_instance_property in cycles/ixam/ixam_object.cpp
 */
bool ObjectAttribute::sync(const ixam::draw::ObjectRef &ref, const GPUUniformAttr &attr)
{
