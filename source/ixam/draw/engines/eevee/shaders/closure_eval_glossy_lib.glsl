...
#pragma IXAM_REQUIRE(common_utiltex_lib.glsl)
#pragma IXAM_REQUIRE(lights_lib.glsl)
#pragma IXAM_REQUIRE(lightprobe_lib.glsl)
#pragma IXAM_REQUIRE(ambient_occlusion_lib.glsl)
#pragma IXAM_REQUIRE(bsdf_common_lib.glsl)
#pragma IXAM_REQUIRE(closure_eval_lib.glsl)
#pragma IXAM_REQUIRE(renderpass_lib.glsl)
