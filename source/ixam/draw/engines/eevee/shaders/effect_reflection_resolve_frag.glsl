...
#pragma IXAM_REQUIRE(common_math_geom_lib.glsl)
#pragma IXAM_REQUIRE(closure_eval_glossy_lib.glsl)
#pragma IXAM_REQUIRE(closure_eval_lib.glsl)
#pragma IXAM_REQUIRE(lightprobe_lib.glsl)
#pragma IXAM_REQUIRE(bsdf_common_lib.glsl)
#pragma IXAM_REQUIRE(surface_lib.glsl)
#pragma IXAM_REQUIRE(effect_reflection_lib.glsl)
