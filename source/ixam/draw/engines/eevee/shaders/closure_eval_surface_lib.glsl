...
#pragma IXAM_REQUIRE(closure_eval_diffuse_lib.glsl)
#pragma IXAM_REQUIRE(closure_eval_glossy_lib.glsl)
#pragma IXAM_REQUIRE(closure_eval_refraction_lib.glsl)
#pragma IXAM_REQUIRE(closure_eval_translucent_lib.glsl)
