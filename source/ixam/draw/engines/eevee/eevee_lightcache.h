...
void EEVEE_lightcache_ixam_write(struct IxamWriter *writer, struct LightCache *cache);
void EEVEE_lightcache_ixam_read_data(struct IxamDataReader *reader, struct LightCache *cache);
