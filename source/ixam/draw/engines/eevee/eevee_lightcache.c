...
static void write_lightcache_texture(IxamWriter *writer, LightCacheTexture *tex)
{
  if (tex->data) {
...
void EEVEE_lightcache_ixam_write(IxamWriter *writer, LightCache *cache)
{
...
static void direct_link_lightcache_texture(IxamDataReader *reader, LightCacheTexture *lctex)
{
  lctex->tex = NULL;
...
void EEVEE_lightcache_ixam_read_data(IxamDataReader *reader, LightCache *cache)
{
