...
#pragma IXAM_REQUIRE(workbench_common_lib.glsl)
#pragma IXAM_REQUIRE(workbench_image_lib.glsl)
#pragma IXAM_REQUIRE(workbench_matcap_lib.glsl)
#pragma IXAM_REQUIRE(workbench_world_light_lib.glsl)
