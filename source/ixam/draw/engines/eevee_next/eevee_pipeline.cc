...
PassMain::Sub *ForwardPipeline::prepass_opaque_add(::Material *ixam_mat,
                                                   GPUMaterial *gpumat,
                                                   bool has_motion)
{
  PassMain::Sub *pass = (ixam_mat->blend_flag & MA_BL_CULL_BACKFACE) ?
...
PassMain::Sub *ForwardPipeline::material_opaque_add(::Material *ixam_mat, GPUMaterial *gpumat)
{
  PassMain::Sub *pass = (ixam_mat->blend_flag & MA_BL_CULL_BACKFACE) ? opaque_single_sided_ps_ :
...
PassMain::Sub *ForwardPipeline::prepass_transparent_add(const Object *ob,
                                                        ...
                                                        GPUMaterial *gpumat)
{
  if ((ixam_mat->blend_flag & MA_BL_HIDE_BACKFACE) == 0) {
    return nullptr;
  }
  DRWState state = DRW_STATE_WRITE_DEPTH | DRW_STATE_DEPTH_LESS_EQUAL;
  if (ixam_mat->blend_flag & MA_BL_CULL_BACKFACE) {
