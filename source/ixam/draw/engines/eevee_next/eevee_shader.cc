...
{
  using namespace ixam::gpu::shader;
...
GPUMaterial *ShaderModule::material_shader_get(::Material *ixam_mat,
                                               ...
                                               bool deferred_compilation)
{
  ...
  return DRW_shader_from_material(
      ixam_mat, nodetree, shader_uuid, is_volume, deferred_compilation, codegen_callback, this);
}

GPUMaterial *ShaderModule::world_shader_get(::World *ixam_world, struct bNodeTree *nodetree)
{
  ...
  return DRW_shader_from_world(ixam_world,
                               nodetree,
                               shader_uuid,
                               is_volume,
