...
#pragma IXAM_REQUIRE(common_hair_lib.glsl) /* TODO rename to curve. */
#pragma IXAM_REQUIRE(common_math_lib.glsl)
#pragma IXAM_REQUIRE(common_view_lib.glsl)
#pragma IXAM_REQUIRE(eevee_attributes_lib.glsl)
#pragma IXAM_REQUIRE(eevee_nodetree_lib.glsl)
#pragma IXAM_REQUIRE(eevee_surf_lib.glsl)
#pragma IXAM_REQUIRE(eevee_velocity_lib.glsl)
