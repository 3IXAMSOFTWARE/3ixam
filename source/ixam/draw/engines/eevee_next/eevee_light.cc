...
static eLightType to_light_type(short ixam_light_type, short ixam_area_type)
{
  switch (ixam_light_type) {
    default:
    case LA_LOCAL:
      return LIGHT_POINT;
    case LA_SUN:
    ...
    case LA_SPOT:
      return LIGHT_SPOT;
    case LA_AREA:
      return ELEM(ixam_area_type, LA_AREA_DISK, LA_AREA_ELLIPSE) ? LIGHT_ELLIPSE : LIGHT_RECT;
  }
}
