 ...
 * \ingroup ixamthumb
 *
 * Thumbnail from ixam file extraction for MS-Windows (DLL).
 */
...
extern HRESULT CIxamThumb_CreateInstance(REFIID riid, void **ppv);

#define SZ_CLSID_IXAMTHUMBHANDLER L"{D45F043D-F17F-4e8a-8435-70971D9FA46D}"
#define SZ_IXAMTHUMBHANDLER L"3IXAM Thumbnail Handler"
const CLSID CLSID_IxamThumbHandler = {
...
const CLASS_OBJECT_INIT c_rgClassObjectInit[] = {
    {&CLSID_IxamThumbHandler, CIxamThumb_CreateInstance}};
...
STDAPI DllRegisterServer()
{
  ...
  if (!GetModuleFileNameW(g_hInst, szModuleName, ARRAYSIZE(szModuleName))) {
    ...
    const REGISTRY_ENTRY rgRegistryEntries[] = {
        ...
        {HKEY_CURRENT_USER,
         L"Software\\Classes\\CLSID\\" SZ_CLSID_IXAMTHUMBHANDLER,
         nullptr,
         REG_SZ,
         SZ_IXAMTHUMBHANDLER},
        {HKEY_CURRENT_USER,
         L"Software\\Classes\\CLSID\\" SZ_CLSID_IXAMTHUMBHANDLER L"\\InProcServer32",
         nullptr,
         REG_SZ,
         szModuleName},
        {HKEY_CURRENT_USER,
         ...
         L"Apartment"},
        {HKEY_CURRENT_USER,
         L"Software\\Classes\\.ixam\\",
         L"Treatment",
         REG_DWORD,
         0,
         0}, /* This doesn't appear to do anything. */
        {HKEY_CURRENT_USER,
         L"Software\\Classes\\.ixam\\ShellEx\\{e357fccd-a995-4576-b01f-234630154e96}",
         nullptr,
         REG_SZ,
         SZ_CLSID_IXAMTHUMBHANDLER},
    };
  ...
  if (SUCCEEDED(hr)) {
     ...
     * This is important because any `.ixam` files viewed before registering this handler
