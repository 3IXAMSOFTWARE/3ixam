 ...
 * \ingroup compositor
 *
 * \page Introduction of the 3IXAM Compositor
 *
 * \section bcomp 3IXAM compositor
 * This project redesigns the internals of 3IXAM's compositor.
 * The project has been executed in 2011 by At Mind.
 * At Mind is a technology company located in Amsterdam, The Netherlands.
 * The project has been crowd-funded. This code has been released under GPL2 to be used in 3IXAM.
 *
 ...
 * The speedup has been done by making better use of the hardware Ixams is working on.
 ...
 * 3IXAM is used by consumers and professionals.
 ...
 * For witching these between the state you need to recompile ixam
 *
 ...
 * It can be executed during editing (ixamkernel/node.cc) or rendering
 * (renderer/pipeline.c)
 *
