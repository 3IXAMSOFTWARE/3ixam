...
Example use:
   ...
   credits_git_gen.py --source=/src/ixam --range=SHA1..HEAD
"""
...
def main():
    ...
    # commit_range = "ixam-v2.81-release..ixam-v2.82-release"
    # commit_range = "ixam-v2.82-release"
