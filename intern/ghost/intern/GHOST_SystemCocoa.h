...
class GHOST_SystemCocoa : public GHOST_System {
 public:
  ...
  GHOST_TSuccess showMessageBox(const char *title,
    ...
    /**
   * Show a system message box if does not have access to directory
   * \param title: The title of the message box.
   * \param message: The message to display.
   * \param prompt: Help button label.
   * \param path: Continue button label.
   */
  GHOST_TSuccess askFileSystemAccess(const char *title,
                                     const char *message,
                                     const char *prompt,
                                     const char *path) const;


  void *findSidecarScreen() const;
  GHOST_IWindow *findSidecarWindow() const;

  /**
   * Move system window to SideCar display
   * \param systemhandle: The handle to the system.
   * \param windowhandle: The handle to the window.
   */
  GHOST_TSuccess moveWindowToSidecar(GHOST_IWindow *window) const;
  ...
  GHOST_TSuccess handleWindowEvent(GHOST_TEventType eventType, GHOST_PanelCocoa *panel);
  ...
  GHOST_TSuccess handleTouchBarToolSelectEvent(GHOST_TTouchbarToolSelectEventType eventType, GHOST_WindowCocoa *window);
  GHOST_TSuccess handleTouchBarCreatePrimitiveEvent(GHOST_TTouchbarCreatePrimitiveEventType eventType, GHOST_WindowCocoa *window);
  GHOST_TSuccess handleTouchBarDeleteEvent(GHOST_WindowCocoa *window);
  GHOST_TSuccess handleTouchBarZoomEvent(GHOST_WindowCocoa *window);
  GHOST_TSuccess handleTouchBarShadingEvent(GHOST_TTouchbarShadingType shadingType, GHOST_WindowCocoa *window);
