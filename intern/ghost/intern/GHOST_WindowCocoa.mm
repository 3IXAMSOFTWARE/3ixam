...
#define COCOA_VIEW_WINDOW_CLASS GHOST_WindowCocoa
      ...
      m_is_dialog(is_dialog)
{
  ...
  // Forbid to resize the window below the ixam defined minimum one
  minSize.width = 320;
  minSize.height = 240;
...
GHOST_WindowCocoa::~GHOST_WindowCocoa()
{
  ...
  /* Check for other ixam opened windows and make the front-most key
