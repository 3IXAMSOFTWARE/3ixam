...
void GHOST_SystemX11::processEvent(XEvent *xe)
{
  ...
  switch (xe->type) {
    ...
    case KeyRelease: {
       ...
       * - This enforces users to use an ASCII-compatible key-map with 3IXAM -
    ...
    case ClientMessage: {
      ...
      if (((Atom)xcme.data.l[0]) == m_atom.WM_DELETE_WINDOW) {
         ...
         * or this call fail and close ixam.
         */
 ...
 * Basically it will not crash ixam now if you have a X device that
