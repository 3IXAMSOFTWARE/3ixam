 ...
 *     ima = bpy.data.images.load('ixam%d.png' % resolution)
 *     w, h = ima.size
 *     pixels = []
...
/**
 * See the python script above to regenerate the icons within ixam
 *
 * \note Using 'unsigned' to avoid `-Wnarrowing` warning.
 */
static const unsigned long IXAM_ICONS_WM_X11[] = {
