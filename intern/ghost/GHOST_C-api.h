...
/**
 * Show a system message box to choose working directory access
 * \param systemhandle: The handle to the system.
 * \param title: Title of the message box.
 * \param message: Message of the message box.
 * \param prompt: Text to show on the accept button.
 * \param path: Path to accessing directory.
 */
extern bool GHOST_AskFileSystemAccess(GHOST_SystemHandle systemhandle,
                                      const char *path,
                                      const char *title,
                                      const char *message,
                                      const char *prompt);
 ...
 */
extern bool GHOST_MoveWindowToSidecar(GHOST_SystemHandle systemhandle, GHOST_WindowHandle windowhandle);
...
/**
 * Get action set custom data (owned by 3IXAM, not GHOST).
 */
void *GHOST_XrGetActionSetCustomdata(GHOST_XrContextHandle xr_context,
                                     const char *action_set_name);

/**
 * Get action custom data (owned by 3IXAM, not GHOST).
 */
