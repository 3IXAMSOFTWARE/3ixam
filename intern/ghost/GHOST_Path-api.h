 ...
 * \return Unsigned char string pointing to system dir (eg `/usr/share/ixam/`).
 *
 * \note typically: `BKE_appdir_resource_path_id(IXAM_RESOURCE_PATH_SYSTEM, false)` should be
 ...
 *
 * \note typically: `BKE_appdir_resource_path_id(IXAM_RESOURCE_PATH_USER, false)` should be
 * used instead of this function directly as it ensures environment variable overrides are used.
 */
