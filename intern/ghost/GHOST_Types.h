...
typedef enum {
  ...
  GHOST_kEventOpenMainFile, /* Needed for Cocoa to open double-clicked .ixam file at startup. */
  ...
  GHOST_kEventTouchbarSelect,
  GHOST_kEventTouchbarMove,
  GHOST_kEventTouchbarRotate,
  GHOST_kEventTouchbarScale,
  GHOST_kEventTouchbarZoom,
  GHOST_kEventTouchbarDelete,

  GHOST_kEventTouchbarShading,

  GHOST_kEventCreateCube,
  GHOST_kEventCreateSphere,
  GHOST_kEventCreateTorus,
  GHOST_kEventCreateCylinder,
  GHOST_kEventCreateCon,
  GHOST_kEventCreateTube,
  GHOST_kEventCreateHexagon,
  GHOST_kEventCreatePyramid,
...
typedef enum {
  GHOST_kTouchbarEventEnableSelect = 0,
  GHOST_kTouchbarEventEnableMove,
  GHOST_kTouchbarEventEnableRotate,
  GHOST_kTouchbarEventEnableScale,
  GHOST_kTouchbarEventCreatePrimitive,
} GHOST_TTouchbarToolSelectEventType;

typedef enum {
  GHOST_kTouchbarEventCreateCube = 0,
  GHOST_kTouchbarEventCreateSphere,
  GHOST_kTouchbarEventCreateTorus,
  GHOST_kTouchbarEventCreateCylinder,
  GHOST_kTouchbarEventCreateCone,
  GHOST_kTouchbarEventCreateTube,
  GHOST_kTouchbarEventCreateHexagon,
  GHOST_kTouchbarEventCreatePyramid,
} GHOST_TTouchbarCreatePrimitiveEventType;

typedef enum {
  GHOST_kTouchbarEventWireframeShading = 0,
  GHOST_kTouchbarEventClayShading,
  GHOST_kTouchbarEventPreviewShading,
  GHOST_kTouchbarEventRenderShading,
} GHOST_TTouchbarShadingType;
...
typedef struct {
   ...
   * These use ixam standard view coordinates,
