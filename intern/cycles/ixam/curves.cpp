...
bool IxamSync::object_has_particle_hair(BL::Object b_ob)
{
...
/* Old particle hair. */
void IxamSync::sync_particle_hair(
    Hair *hair, BL::Mesh &b_mesh, BObjectInfo &b_ob_info, bool motion, int motion_step)
{
   ...
   * ixam to handle deforming objects */
  if (!motion) {
...
static void export_hair_curves(Scene *scene,
                               ...
                               const float motion_scale)
{
  /* TODO: optimize so we can straight memcpy arrays from 3IXAM? */
...
/* Hair object. */
void IxamSync::sync_hair(Hair *hair, BObjectInfo &b_ob_info, bool motion, int motion_step)
{
  ...
  /* Convert 3IXAM hair to Cycles curves. */
...
void IxamSync::sync_hair(BL::Depsgraph b_depsgraph, BObjectInfo &b_ob_info, Hair *hair)
{
...
void IxamSync::sync_hair_motion(BL::Depsgraph b_depsgraph,
