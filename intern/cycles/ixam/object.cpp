...
bool IxamSync::BKE_object_is_modified(BL::Object &b_ob)
{
...
bool IxamSync::object_is_geometry(BObjectInfo &b_ob_info)
{
...
bool IxamSync::object_can_have_geometry(BL::Object &b_ob)
{
...
bool IxamSync::object_is_light(BL::Object &b_ob)
{
...
bool IxamSync::object_is_camera(BL::Object &b_ob)
{
  BL::ID b_ob_data = b_ob.data();
...
void IxamSync::sync_object_motion_init(BL::Object &b_parent, BL::Object &b_ob, Object *object)
{
...
Object *IxamSync::sync_object(BL::Depsgraph &b_depsgraph,
                                 BL::ViewLayer &b_view_layer,
                                 BL::DepsgraphObjectInstance &b_instance,
                                 float motion_time,
                                 bool use_particle_hair,
                                 bool show_lights,
                                 IxamObjectCulling &culling,
                                 bool *use_portal,
...
bool IxamSync::sync_object_attributes(BL::DepsgraphObjectInstance &b_instance, Object *object)
{
  ...
  foreach (AttributeRequest &req, requests.requests) {
    ...
    IxamAttributeType type = ixam_attribute_name_split_type(name, &real_name);
...
void IxamSync::sync_procedural(BL::Object &b_ob,
                                  ...
                                  bool has_subdivision_modifier)
{
  ...
  string absolute_path = ixam_absolute_path(b_data, b_ob, b_mesh_cache.cache_file().filepath());
  ...
  for (BL::CacheFileLayer &layer : cache_file.layers) {
    ...
    absolute_path = ixam_absolute_path(b_data, b_ob, layer.filepath());
...
void IxamSync::sync_objects(BL::Depsgraph &b_depsgraph,
                               ...
                               float motion_time)
{
  ...
  /* initialize culling */
  IxamObjectCulling culling(scene, b_scene);

  /* object loop */
  bool cancel = false;
  bool use_portal = false;
  const bool show_lights = IxamViewportParameters(b_v3d, use_developer_ui).use_scene_lights;
  ...
  for (b_depsgraph.object_instances.begin(b_instance_iter);
    ...
    if (b_instance.show_self()) {
      ...
      /* Experimental as 3IXAM does not have good support for procedurals at the moment. */
      if (experimental) {
...
void IxamSync::sync_motion(BL::RenderSettings &b_render,
