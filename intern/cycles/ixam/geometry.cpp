...
array<Node *> IxamSync::find_used_shaders(BL::Object &b_ob)
{
...
Geometry *IxamSync::sync_geometry(BL::Depsgraph &b_depsgraph,
...
void IxamSync::sync_geometry_motion(BL::Depsgraph &b_depsgraph,
                                       BObjectInfo &b_ob_info,
                                       Object *object,
                                       float motion_time,
                                       bool use_particle_hair,
