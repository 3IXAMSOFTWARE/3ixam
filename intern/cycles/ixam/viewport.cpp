...
IxamViewportParameters::IxamViewportParameters()
...
IxamViewportParameters::IxamViewportParameters(BL::SpaceView3D &b_v3d, bool use_developer_ui)
...
bool IxamViewportParameters::shader_modified(const IxamViewportParameters &other) const
{
...
bool IxamViewportParameters::film_modified(const IxamViewportParameters &other) const
{
  return display_pass != other.display_pass || show_active_pixels != other.show_active_pixels;
}

bool IxamViewportParameters::modified(const IxamViewportParameters &other) const
{
  return shader_modified(other) || film_modified(other);
}

bool IxamViewportParameters::use_custom_shader() const
{
