...
#ifndef __IXAM_SYNC_H__
#define __IXAM_SYNC_H__
...
class IxamSync {
 public:
  IxamSync(BL::RenderEngine &b_engine,
              BL::IxamData &b_data,
              BL::Scene &b_scene,
              Scene *scene,
              bool preview,
  ...
  void reset(BL::IxamData &b_data, BL::Scene &b_scene);
 ...
 private:
  ...
  void *world_map;
  bool world_recalc;
  IxamViewportParameters viewport_parameters;
