...
void IxamSync::sync_light(BL::Object &b_parent,
...
void IxamSync::sync_background_light(BL::SpaceView3D &b_v3d, bool use_portal)
{
  ...
  world_recalc = false;
  viewport_parameters = IxamViewportParameters(b_v3d, use_developer_ui);
}
