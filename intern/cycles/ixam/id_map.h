...
#ifndef __IXAM_ID_MAP_H__
#define __IXAM_ID_MAP_H__
...
/* ID Map
 *
 * Utility class to map between 3IXAM datablocks and Cycles data structures,
...
enum { OBJECT_PERSISTENT_ID_SIZE = 8 /* MAX_DUPLI_RECUR in 3IXAM. */ };
