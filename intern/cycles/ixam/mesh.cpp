...
void IxamSync::sync_mesh(BL::Depsgraph b_depsgraph, BObjectInfo &b_ob_info, Mesh *mesh)
{
  ...
  if (view_layer.use_surfaces) {
     ...
     * exact mapping to the 3IXAM mesh. */
...
void IxamSync::sync_mesh_motion(BL::Depsgraph b_depsgraph,
                                   BObjectInfo &b_ob_info,
                                   Mesh *mesh,
                                   int motion_step)
{
