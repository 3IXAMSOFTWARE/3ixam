...
IxamObjectCulling::IxamObjectCulling(Scene *scene, BL::Scene &b_scene)
...
void IxamObjectCulling::init_object(Scene *scene, BL::Object &b_ob)
{
...
bool IxamObjectCulling::test(Scene *scene, BL::Object &b_ob, Transform &tfm)
{
  if (!use_camera_cull_ && !use_distance_cull_) {
    return false;
  }
 ...
 */
bool IxamObjectCulling::test_camera(Scene *scene, float3 bb[8])
{
...
bool IxamObjectCulling::test_distance(Scene *scene, float3 bb[8])
{
