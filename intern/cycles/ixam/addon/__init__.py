...
bl_info = {
    "name": "Real Render Engine",
    "author": "",
    "ixam": (2, 80, 0),
    "description": "Real renderer integration",
    "warning": "",
    "doc_url": "https://docs.3ixam.com/manual/en/latest/render/real/",
    "tracker_url": "",
    "support": 'OFFICIAL',
    "category": "Render"}
...
class CyclesRender(bpy.types.RenderEngine):
    ...
    def view_update(self, context, depsgraph):
        if not self.session:
            ...
            engine.create(self, context.ixam_data,
                          context.region, context.space_data, context.region_data)

        engine.reset(self, context.ixam_data, depsgraph)
        engine.sync(self, depsgraph, context.ixam_data)
