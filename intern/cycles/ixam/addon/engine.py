...
def _configure_argument_parser():
    ...
    parser = argparse.ArgumentParser(description="Real Addon argument parser",
                                     add_help=False)
    parser.add_argument("--cycles-print-stats",
                        help="Print rendering statistics to stderr",
                        action='store_true')
    parser.add_argument("--cycles-device",
                        help="Set the device to use for Real, overriding user preferences and the scene setting."
