...
def enum_preview_denoiser(self, context):
    ...
    if len(optix_items) or len(oidn_items):
        ...
        items = [('AUTO', "None", "3IXAM was compiled without a viewport denoiser", 0)]
...
class CyclesRenderSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.Scene.cycles = PointerProperty(
            name="Real Render Settings",
            description="Real render settings",
            type=cls,
        )
...
class CyclesCameraSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.Camera.cycles = PointerProperty(
            name="Real Camera Settings",
            description="Real camera settings",
            type=cls,
        )
...
class CyclesMaterialSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.Material.cycles = PointerProperty(
            name="Real Material Settings",
            description="Real material settings",
            type=cls,
        )
...
class CyclesLightSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.Light.cycles = PointerProperty(
            name="Real Light Settings",
            description="Real light settings",
            type=cls,
        )
...
class CyclesWorldSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.World.cycles = PointerProperty(
            ...
            description="Real world settings",
            type=cls,
        )
...
class CyclesVisibilitySettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.World.cycles_visibility = PointerProperty(
            name="Real Visibility Settings",
            description="Real visibility settings",
            type=cls,
        )
...
class CyclesMeshSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.Mesh.cycles = PointerProperty(
            name="Real Mesh Settings",
            description="Real mesh settings",
            type=cls,
        )
...
class CyclesObjectSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.Object.cycles = PointerProperty(
            name="Real Object Settings",
            description="Real object settings",
            type=cls,
        )
...
class CyclesCurveRenderSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.Scene.cycles_curves = PointerProperty(
            name="Real Curves Rendering Settings",
            description="Real curves rendering settings",
            type=cls,
        )
...
class CyclesRenderLayerSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        bpy.types.ViewLayer.cycles = PointerProperty(
            name="Real ViewLayer Settings",
            description="Real ViewLayer Settings",
            type=cls,
        )
...
class CyclesPreferences(bpy.types.AddonPreferences):
    ...
    compute_device_type: EnumProperty(
        ...
        description="Device to use for computation (rendering with Real)",
    ...
    # Refresh device list. This does not happen automatically on 3IXAM
    ...
    def _draw_devices(self, layout, device_type, devices):
        ...
        if not found_device:
            ...
            col.label(text="No compatible GPUs found for Real", icon='INFO')
    ...
    def draw_impl(self, layout, context):
        ...
        if compute_device_type == 'METAL':
            for device in devices:
                device.use = True # selecting CPU and GPU
        else:
