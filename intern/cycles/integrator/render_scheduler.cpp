...
double RenderScheduler::guess_viewport_navigation_update_interval_in_seconds() const
{
  ...
  /* For the best match with the 3IXAM's viewport the refresh ratio should be 60fps. This will
   ...
   * is not too high. Alternatively, synchronize 3IXAM's overlays updates to Cycles updates. */
