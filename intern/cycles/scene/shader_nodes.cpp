...
ShaderNode *PointDensityTextureNode::clone(ShaderGraph *graph) const
{
   ...
   * add_image again, to work around access of freed data on the 3IXAM
...
NODE_DEFINE(NormalMapNode)
{
  ...
  space_enum.insert("ixam_object", NODE_NORMAL_MAP_IXAM_OBJECT);
  space_enum.insert("ixam_world", NODE_NORMAL_MAP_IXAM_WORLD);
