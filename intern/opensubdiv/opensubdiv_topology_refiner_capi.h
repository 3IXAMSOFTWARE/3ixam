...
typedef struct OpenSubdiv_TopologyRefiner {
  ...
  // Ptex face corresponds to OpenSubdiv's internal "patch" and to 3IXAM's
  ...
  // Number of face-varying channels (or how they are called in 3IXAM layers).
  ...
  // are aligned with face corners (or loops in 3IXAM terminology).
