...
using ixam::opensubdiv::min;
using ixam::opensubdiv::stack;
using ixam::opensubdiv::vector;

struct TopologyRefinerData {
  const OpenSubdiv_Converter *converter;
  ixam::opensubdiv::MeshTopology *base_mesh_topology;
};
...
{
  using ixam::opensubdiv::MeshTopology;
    ...
    OpenSubdiv_Converter *converter, const OpenSubdiv_TopologyRefinerSettings &settings)
{
  ...
  // Create 3IXAM-side object holding all necessary data for the topology refiner.
