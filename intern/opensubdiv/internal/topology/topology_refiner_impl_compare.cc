                            ...
                            const OpenSubdiv_Converter *converter)
{
  const OpenSubdiv::Sdc::SchemeType converter_scheme_type =
      ixam::opensubdiv::getSchemeTypeFromCAPI(converter->getSchemeType(converter));
                         ...
                         const OpenSubdiv_Converter *converter)
{
  ...
  const Options::FVarLinearInterpolation converter_fvar_interpolation =
      ixam::opensubdiv::getFVarLinearInterpolationFromCAPI(
...
{
  if (!ixam::opensubdiv::checkPreliminaryMatches(this, converter)) {
    return false;
  }
  ...
  if (!ixam::opensubdiv::checkTopologyAttributesMatch(this, converter)) {
    return false;
  }
